...
gameplay-trailer and thumbnail links, logos, 176 localized full-resolution
screenshots, and the aligned capsule art layers and Aseprite source. It packages
both capsule artwork and screenshots
...
itch.io, and press PNG exports; each screenshot bundle contains 16 1920 × 1080
gameplay PNGs.
...
Localized screenshots are built directly from
`../pixel-globe/promotional-materials/steam-screenshots`. The website and press
kit therefore use the same reviewed captures and Steam language suffixes as the
store page.
