...
function localizedPressKitReadme(locale) {
  return [
    ...
    "- Permanent download links for the release-date trailer, demo-launch trailer, and trailer thumbnail",
    "",
    "PRESS MEDIA",
    `- Release-date trailer: ${pressMedia.launchDateTrailerUrl}`,
    `- Demo-launch trailer: ${pressMedia.demoLaunchTrailerUrl}`,
