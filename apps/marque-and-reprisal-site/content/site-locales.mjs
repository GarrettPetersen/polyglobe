...
About the game|English screenshots|Nine full-resolution gameplay screenshots with the English interface.|Download English screenshots
...
游戏介绍|简体中文截图|九张采用简体中文界面的全分辨率游戏截图。|下载简体中文截图
...
Об игре|Русские скриншоты|Девять полноразмерных игровых скриншотов с русским интерфейсом.|Скачать русские скриншоты
...
Acerca del juego|Capturas en español|Nueve capturas de juego a resolución completa con la interfaz en español.|Descargar capturas en español
...
Sobre o jogo|Capturas em português|Nove capturas em resolução completa com a interface em português do Brasil.|Baixar capturas em português
...
ゲーム紹介|日本語スクリーンショット|日本語インターフェイスのフル解像度ゲーム画面9点。|日本語スクリーンショットをダウンロード
...
Über das Spiel|Deutsche Screenshots|Neun hochauflösende Spielszenen mit deutscher Oberfläche.|Deutsche Screenshots herunterladen
...
À propos du jeu|Captures françaises|Neuf captures de jeu en pleine résolution avec l'interface française.|Télécharger les captures françaises
...
O grze|Polskie zrzuty ekranu|Dziewięć pełnowymiarowych zrzutów z polskim interfejsem.|Pobierz polskie zrzuty
...
遊戲介紹|繁體中文截圖|九張採用繁體中文介面的完整解析度遊戲截圖。|下載繁體中文截圖
...
게임 소개|한국어 스크린샷|한국어 인터페이스의 전체 해상도 게임 스크린샷 9장.|한국어 스크린샷 다운로드
...
Iron Pagoda 개발 및 배급.|개인정보 보호|쓰촨에서 판다 만나기
`)
});
