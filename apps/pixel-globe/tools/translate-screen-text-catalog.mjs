...
const REVIEWED_OVERRIDES = Object.freeze({
  ...
  ...reviewedCatalogRange1700Overrides(),
  ...reviewedCatalogRange1750Overrides(),
  ...reviewedCatalogRange1800Overrides(),
  ...reviewedCatalogRange1850Overrides(),
  ...reviewedCatalogRange1900Overrides(),
...
function reviewedCatalogRange1200Overrides() {
  const entries = [
    ["Deliver {0} {1} db", ["交付{0}；报酬{1}达布隆", "Доставить {0}; награда — {1} дублонов", "Entrega {0}; recompensa: {1} doblones", "Entregue {0}; recompensa: {1} dobrões", "{0}を納品（報酬：{1}ダブロン）", "{0} abliefern; Belohnung: {1} Dublonen", "Livrer {0} ; récompense : {1} doublons", "Dostarcz {0}; nagroda: {1} dublonów", "交付{0}；報酬{1}達布隆", "{0} 전달; 보상 {1} 더블룬"]],
    ["Deliver {0} {1}/{2}", ["交付{0}：{1}/{2}", "Доставить {0}: {1}/{2}", "Entrega {0}: {1}/{2}", "Entregue {0}: {1}/{2}", "{0}を納品：{1}/{2}", "{0} abliefern: {1}/{2}", "Livrer {0} : {1}/{2}", "Dostarcz {0}: {1}/{2}", "交付{0}：{1}/{2}", "{0} 전달: {1}/{2}"]],
    ["Delivered {0} x{1}. {2} still needed.", ["已交付{0}×{1}。还需{2}。", "Доставлено: {0} × {1}. Осталось: {2}.", "Entregado: {0} × {1}. Falta: {2}.", "Entregue: {0} × {1}. Ainda falta: {2}.", "{0}を{1}個納品。残り必要数：{2}。", "{0} × {1} geliefert. Noch benötigt: {2}.", "{0} × {1} livré(s). Il en manque encore {2}.", "Dostarczono: {0} × {1}. Pozostało: {2}.", "已交付{0}×{1}。還需{2}。", "{0} × {1} 전달 완료. 남은 수량: {2}."]],
    ["Delivered {0}; {1} still needed.", ["已交付{0}；还需{1}。", "Доставлено: {0}. Осталось: {1}.", "Entregado: {0}. Falta: {1}.", "Entregue: {0}. Ainda falta: {1}.", "{0}を納品。残り必要数：{1}。", "{0} geliefert. Noch benötigt: {1}.", "{0} livré(s). Il en faut encore {1}.", "Dostarczono: {0}. Pozostało: {1}.", "已交付{0}；還需{1}。", "{0} 전달 완료. 남은 수량: {1}."]],
    ["Delivered the last {0} {1}.", ["最后一批{0}{1}已交付。", "Доставлена последняя партия: {0} {1}.", "Se entregó el último lote: {0} {1}.", "O último lote de {0} {1} foi entregue.", "最後の{0}{1}を納品した。", "Die letzte Lieferung {0} {1} wurde abgeliefert.", "La dernière livraison de {0} {1} est arrivée.", "Dostarczono ostatnią partię: {0} {1}.", "最後一批{0}{1}已交付。", "마지막 {0} {1}을(를) 전달했습니다."]],
    ["DEFEAT 1 {0} SHIP OFF NINGBO", ["在宁波外海击败{0}方的一艘船", "Потопите один корабль державы {0} у берегов Нинбо", "Derrota un barco de {0} frente a Ningbo", "Derrote um navio de {0} ao largo de Ningbo", "寧波沖で{0}の船を一隻撃破せよ", "Besiegt ein Schiff von {0} vor Ningbo", "Battez un navire de {0} au large de Ningbo", "Pokonaj jeden statek państwa {0} u wybrzeży Ningbo", "在寧波外海擊敗{0}方的一艘船", "닝보 앞바다에서 {0} 측의 선박 한 척을 격파하세요"]],
    ["Daoist", ["道教徒", "даос", "taoísta", "taoísta", "道教徒", "Daoist", "taoïste", "taoista", "道教徒", "도교 신자"]],
    ["Decline", ["拒绝", "Отклонить", "Rechazar", "Recusar", "断る", "Ablehnen", "Refuser", "Odrzuć", "拒絕", "거절"]],
    ["CUSTOMS ASSIGNMENT SEALED", ["关税收入让渡协议已签署", "Передача таможенных доходов закреплена договором", "Cesión de ingresos aduaneros formalizada", "Cessão das receitas aduaneiras formalizada", "関税収入の譲渡契約が締結された", "Abtretung der Zolleinnahmen besiegelt", "Cession des recettes douanières formalisée", "Przeniesienie dochodów celnych zatwierdzone", "關稅收入讓渡協議已簽署", "관세 수입 양도 계약이 체결되었습니다"]],
    ["COVER", ["船员防护", "Защита экипажа", "Protección de la tripulación", "Proteção da tripulação", "乗組員の防護", "Besatzungsschutz", "Protection de l’équipage", "Ochrona załogi", "船員防護", "선원 보호"]],
    ["Court notice: {0} is gone. {1} now rules {2}.", ["宫廷消息：{0}已不再执政；{1}现统治{2}。", "Весть из дворца: {0} больше не правит. Теперь у власти в {2} — {1}.", "Aviso de la corte: {0} ya no gobierna. {1} ocupa ahora el poder en {2}.", "Notícia da corte: {0} já não governa. Agora {1} está no poder em {2}.", "宮廷からの知らせだ。{0}に代わり、{1}が{2}を治めている。", "Hofnachricht: {0} herrscht nicht mehr. Nun regiert {1} über {2}.", "Annonce de la cour : {0} ne règne plus. {1} gouverne désormais {2}.", "Wieść z dworu: {0} już nie rządzi. Teraz {1} włada państwem {2}.", "宮廷消息：{0}已不再執政；{1}現統治{2}。", "궁정 소식입니다. {0}은(는) 더 이상 통치하지 않습니다. 이제 {1}이(가) {2}을(를) 다스립니다."]],
    ["Cranes, locks, hoops, and sugar-mill repairs", ["起重机、锁具、桶箍和糖厂修缮物资", "Подъёмные краны, замки, обручи и материалы для ремонта сахарных мельниц", "grúas, cerraduras, aros de barril y materiales para reparar ingenios azucareros", "guindastes, fechaduras, aros de barril e materiais para reparar engenhos de açúcar", "クレーン、錠前、樽の箍、製糖工場の修理部材", "Kräne, Schlösser, Fassreifen und Material für Reparaturen an Zuckermühlen", "grues, serrures, cercles de tonneau et matériel pour réparer les moulins à sucre", "dźwigi, zamki, obręcze beczek i materiały do naprawy cukrowni", "起重機、鎖具、桶箍和糖廠修繕物資", "기중기, 자물쇠, 통 테두리, 제당소 수리 자재"]],
    ["Creation and destruction from one furnace. Mark the fresh flows separately from the cultivated slopes; the island's prosperity and danger share a source.", ["同一座火山既孕育也摧毁。请把新近的熔岩流与耕作山坡分别标出；这座岛的繁荣与危险同出一源。", "Один вулкан и созидает, и разрушает. Отметьте свежие потоки лавы отдельно от возделанных склонов: процветание и опасность острова имеют один источник.", "Un mismo volcán crea y destruye. Señala los flujos recientes de lava por separado de las laderas cultivadas: la prosperidad y el peligro de la isla tienen un origen común.", "O mesmo vulcão cria e destrói. Marque os fluxos recentes de lava separadamente das encostas cultivadas: a prosperidade e o perigo da ilha têm a mesma origem.", "一つの火山が創造と破壊をもたらす。新しい溶岩流と耕作された斜面を別々に記録しよう。島の繁栄も危険も、同じ火山から生まれている。", "Ein Vulkan bringt zugleich Schöpfung und Zerstörung. Haltet die frischen Lavaströme getrennt von den bewirtschafteten Hängen fest; Wohlstand und Gefahr der Insel haben dieselbe Quelle.", "Un même volcan crée et détruit. Notez les coulées de lave récentes à part des pentes cultivées : la prospérité et le danger de l’île ont la même origine.", "Jeden wulkan tworzy i niszczy. Zaznacz świeże potoki lawy oddzielnie od uprawianych zboczy; dobrobyt i zagrożenia wyspy mają wspólne źródło.", "同一座火山既孕育也摧毀。請把新近的熔岩流與耕作山坡分別標出；這座島的繁榮與危險同出一源。", "한 화산이 창조와 파괴를 모두 일으킵니다. 새 용암류와 경작지를 따로 표시하세요. 섬의 번영과 위험은 같은 화산에서 비롯됩니다."]],
    ["CREW {0} GUNS {1}", ["船员 {0} • 火炮 {1}", "Экипаж: {0} • Пушки: {1}", "Tripulación: {0} • Cañones: {1}", "Tripulação: {0} • Canhões: {1}", "乗組員 {0} • 大砲 {1}", "Besatzung: {0} • Kanonen: {1}", "Équipage : {0} • Canons : {1}", "Załoga: {0} • Działa: {1}", "船員 {0} • 火砲 {1}", "선원 {0} • 대포 {1}"]],
    ["CREW {0} GUNS {1} FOOD {2}D WATER {3}D", ["船员 {0} • 火炮 {1} • 食物 {2}天 • 淡水 {3}天", "Экипаж: {0} • Пушки: {1} • Провиант: {2} дн. • Вода: {3} дн.", "Tripulación: {0} • Cañones: {1} • Comida: {2} días • Agua: {3} días", "Tripulação: {0} • Canhões: {1} • Comida: {2} dias • Água: {3} dias", "乗組員 {0} • 大砲 {1} • 食料 {2}日分 • 水 {3}日分", "Besatzung: {0} • Kanonen: {1} • Proviant: {2} Tage • Wasser: {3} Tage", "Équipage : {0} • Canons : {1} • Vivres : {2} jours • Eau : {3} jours", "Załoga: {0} • Działa: {1} • Żywność: {2} dni • Woda: {3} dni", "船員 {0} • 火砲 {1} • 食物 {2}天 • 淡水 {3}天", "선원 {0} • 대포 {1} • 식량 {2}일분 • 물 {3}일분"]],
    ["Continue the circuit", ["继续巡回行程", "Продолжить поездку по городам", "Continuar la ruta", "Continuar o percurso", "巡回の旅を続ける", "Die Rundreise fortsetzen", "Poursuivre la tournée", "Kontynuuj objazd", "繼續巡迴行程", "순회 일정을 계속하기"]],
    ["Composite Recurve Bows", ["复合反曲弓", "Композитные луки с обратным изгибом", "Arcos recurvos compuestos", "Arcos recurvos compostos", "複合反曲弓", "Komposit-Recurvebögen", "Arcs composites à double courbure", "Kompozytowe łuki refleksyjne", "複合反曲弓", "복합 반곡궁"]],
    ["Costly self-igniting pistols are deadly at close range and useful in a landing party.", ["昂贵的轮簧式手枪近战威力极强，也适合登陆小队使用。", "Дорогие колесцовые пистолеты смертоносны вблизи и полезны в десантном отряде.", "Las costosas pistolas de rueda son mortíferas a corta distancia y útiles en un grupo de desembarco.", "As caras pistolas de roda são letais a curta distância e úteis numa tropa de desembarque.", "高価なホイールロック式ピストルは近距離で威力を発揮し、上陸部隊でも役立つ。", "Teure Radschlosspistolen sind auf kurze Distanz tödlich und für Landungstrupps nützlich.", "Les coûteux pistolets à rouet sont redoutables à courte portée et utiles dans une troupe de débarquement.", "Drogie pistolety kołowe są zabójcze z bliska i przydatne w oddziale desantowym.", "昂貴的輪簧式手槍近戰威力極強，也適合登陸小隊使用。", "값비싼 휠록 권총은 근거리에서 치명적이며 상륙 부대에 유용합니다."]],
    ["Compact horn-and-sinew bows loose quickly from a crowded deck.", ["角与筋制成的短弓便于在拥挤的甲板上快速放箭。", "Компактные луки из рога и сухожилий позволяют быстро стрелять даже на тесной палубе.", "Los arcos compactos de cuerno y tendón permiten disparar con rapidez incluso en una cubierta abarrotada.", "Arcos compactos de chifre e tendão permitem disparar rapidamente, mesmo num convés lotado.", "角と腱で作られた小型の弓なら、混み合う甲板でも素早く矢を放てる。", "Kompakte Horn-Sehnen-Bögen ermöglichen rasche Schüsse selbst auf einem überfüllten Deck.", "Les arcs compacts en corne et en tendon permettent de tirer rapidement, même sur un pont encombré.", "Kompaktowe łuki z rogu i ścięgien pozwalają szybko strzelać nawet na zatłoczonym pokładzie.", "角與筋製成的短弓便於在擁擠的甲板上快速放箭。", "작고 가벼운 뿔·힘줄 활은 혼잡한 갑판에서도 빠르게 쏠 수 있습니다."]],
    ["Concepcion is asking for powder, not ceremony.", ["康塞普西翁要的是火药，不是仪式。", "Консепсьону нужен порох, а не церемонии.", "Concepción pide pólvora, no ceremonias.", "Concepción precisa de pólvora, não de cerimônia.", "コンセプシオンが求めているのは儀式ではなく火薬だ。", "Concepción braucht Schießpulver, keine Feierlichkeiten.", "Concepción réclame de la poudre à canon, pas des cérémonies.", "Concepción potrzebuje prochu, nie ceremonii.", "康塞普西翁要的是火藥，不是儀式。", "콘셉시온이 원하는 것은 의식이 아니라 화약입니다."]],
    ["CMD", ["CMD", "CMD", "CMD", "CMD", "CMD", "CMD", "CMD", "CMD", "CMD", "CMD"]],
    ["Cloves drew the Portuguese to your shore. Your family mistook their appetite for a guarantee.", ["丁香吸引葡萄牙人来到你的海岸。你的家人却把他们对丁香的渴求当成了可靠的保证。", "Гвоздика привлекла португальцев к вашим берегам. Ваша семья приняла их страсть к пряностям за надёжную гарантию.", "El clavo atrajo a los portugueses a tus costas. Tu familia tomó su afán por obtenerlo como una garantía.", "O cravo atraiu os portugueses à sua costa. Sua família tomou o interesse deles pela especiaria como garantia.", "クローブに引かれてポルトガル人が君の海岸に来た。彼らの香辛料への欲を、君の家族は保証と取り違えた。", "Die Nelken lockten die Portugiesen an Eure Küste. Eure Familie hielt ihr Verlangen danach für eine verlässliche Zusage.", "Les clous de girofle ont attiré les Portugais sur vos côtes. Votre famille a pris leur convoitise pour une garantie.", "Goździki przyciągnęły Portugalczyków na twoje wybrzeże. Twoja rodzina wzięła ich żądzę przypraw za gwarancję.", "丁香吸引葡萄牙人來到你的海岸。你的家人卻把他們對丁香的渴求當成了可靠的保證。", "정향이 포르투갈인들을 해안으로 끌어들였습니다. 가족은 그들의 정향 욕심을 믿을 만한 보증으로 착각했습니다."]],
    ["Chaldiran scattered armies and caravans. Your debt alone kept formation.", ["查尔迪兰之战冲散了军队与商队，只有你欠下的债始终未变。", "При Чалдыране армии и караваны рассеялись. Лишь ваш долг остался в силе.", "La batalla de Chaldiran dispersó ejércitos y caravanas. Solo tu deuda permaneció intacta.", "A batalha de Chaldiran dispersou exércitos e caravanas. Só a sua dívida permaneceu de pé.", "チャルディラーンの戦いで軍も隊商も散り散りになった。あなたの借金だけは消えずに残った。", "Die Schlacht von Tschaldiran zerstreute Heere und Karawanen. Nur Eure Schuld blieb bestehen.", "La bataille de Tchaldiran dispersa armées et caravanes. Seule votre dette resta intacte.", "Bitwa pod Czaldiran rozproszyła armie i karawany. Tylko twój dług pozostał bez zmian.", "查爾迪蘭之戰沖散了軍隊與商隊，只有你欠下的債始終未變。", "찰디란 전투로 군대와 대상이 흩어졌지만, 당신의 빚만은 그대로 남았습니다."]],
    ["Chittagong changed hands enough. Your estate need only change hands once.", ["吉大港已多次易主。你的产业只需再易主一次，债务便可了结。", "Читтагонг и так достаточно раз переходил из рук в руки. Чтобы погасить ваш долг, поместью достаточно сменить владельца лишь раз.", "Chittagong ya ha cambiado de manos bastantes veces. Para saldar tu deuda, basta con que tu hacienda cambie de dueño una sola vez.", "Chittagong já mudou de mãos vezes demais. Para quitar sua dívida, basta sua propriedade mudar de dono uma única vez.", "チッタゴンは何度も支配者が変わった。君の借金を返すには、屋敷の持ち主が一度変われば十分だ。", "Chittagong hat oft genug den Besitzer gewechselt. Um Eure Schuld zu tilgen, muss Euer Besitz nur ein einziges Mal den Eigentümer wechseln.", "Chittagong a suffisamment changé de mains. Pour régler votre dette, il suffit que votre domaine change de propriétaire une seule fois.", "Chittagong dość często zmieniał władców. By spłacić twój dług, twoja posiadłość musi zmienić właściciela tylko raz.", "吉大港已多次易主。你的產業只需再易主一次，債務便可了結。", "치타공은 이미 여러 번 주인이 바뀌었습니다. 당신의 빚을 갚으려면 재산은 한 번만 주인이 바뀌면 되겠군요."]],
    ["Check your purse before we leave.", ["出发前先检查一下钱袋。", "Перед отплытием проверьте кошелёк.", "Revisa tu monedero antes de zarpar.", "Confira sua bolsa de moedas antes de partirmos.", "出航前に財布を確かめておけ。", "Prüft vor unserer Abreise Euren Geldbeutel.", "Vérifiez votre bourse avant le départ.", "Przed wypłynięciem sprawdź sakiewkę.", "出發前先檢查一下錢袋。", "떠나기 전에 지갑을 확인하세요."]],
    ["Captain {0}'s map is whole. The island is marked; now we must find the treasure.", ["{0}船长的藏宝图已拼完整。岛屿的位置标出来了；现在该去找宝藏。", "Карта капитана {0} собрана целиком. Остров отмечен; теперь нужно найти сокровище.", "El mapa del capitán {0} está completo. La isla ya está marcada; ahora debemos encontrar el tesoro.", "O mapa do capitão {0} está completo. A ilha está marcada; agora precisamos encontrar o tesouro.", "{0}船長の地図は完成した。島の場所も記された。あとは宝を見つけるだけだ。", "Kapitän {0}s Karte ist vollständig. Die Insel ist markiert; nun müssen wir den Schatz finden.", "La carte du capitaine {0} est complète. L’île est indiquée ; il ne nous reste qu’à trouver le trésor.", "Mapa kapitana {0} jest kompletny. Wyspa jest zaznaczona; teraz musimy odnaleźć skarb.", "{0}船長的藏寶圖已拼完整。島嶼的位置標出來了；現在該去找寶藏。", "{0} 선장의 지도가 완성됐습니다. 섬의 위치도 표시했으니 이제 보물을 찾으면 됩니다."]],
    ["Can tether a surfaced whale", ["可将浮出水面的鲸鱼系住", "Позволяет удержать гарпуном всплывшего кита", "Permite sujetar a un cetáceo cuando sale a la superficie", "Permite prender um arpão em uma baleia quando ela vem à tona", "浮上したクジラに銛を打ち、綱でつなぎ留められる", "Kann einen an der Oberfläche aufgetauchten Wal harpunieren und festhalten", "Permet d’harponner et de retenir une baleine lorsqu’elle fait surface", "Pozwala przywiązać harpunem wieloryba, który wynurzył się na powierzchnię", "可將浮出水面的鯨魚繫住", "수면 위로 떠오른 고래를 작살로 걸어 붙잡을 수 있습니다"]],
    ["Caravans bring stories from the north, and ships bring stories from the horizon. I will test both against the world itself.", ["商队带来北方的传闻，船只带来远方的见闻。我会亲自查证这些说法。", "Караваны приносят вести с севера, а корабли — вести из-за горизонта. Я проверю их по самой действительности.", "Las caravanas traen noticias del norte y los barcos, de tierras lejanas. Comprobaré esos relatos sobre el terreno.", "As caravanas trazem notícias do norte, e os navios, de terras além do horizonte. Vou conferir esses relatos no mundo real.", "隊商は北から、船は地平線の向こうから知らせを運んでくる。どちらの話も、自分の目で確かめよう。", "Karawanen bringen Kunde aus dem Norden, Schiffe von jenseits des Horizonts. Ich werde beide Berichte an der Wirklichkeit prüfen.", "Les caravanes apportent des nouvelles du nord, les navires des contrées lointaines. J’irai vérifier ces récits sur place.", "Karawany przynoszą wieści z północy, a statki z dalekich stron. Sprawdzę te opowieści na własne oczy.", "商隊帶來北方的傳聞，船隻帶來遠方的見聞。我會親自查證這些說法。", "대상은 북쪽 소식을, 배는 지평선 너머 먼 곳의 소식을 전합니다. 그 이야기들이 사실인지 직접 확인하겠습니다."]],
    ["Can turn a promising fishery into a laden hold.", ["能把一处有潜力的渔场变成满载的船舱。", "Даже богатый промысел может довести трюм до отказа.", "Puede llenar la bodega con la pesca de un buen caladero.", "Pode encher o porão com a produção de uma boa área de pesca.", "有望な漁場を、獲物で満載の船倉に変えられる。", "Kann einen ergiebigen Fanggrund in einen vollen Laderaum verwandeln.", "Peut remplir la cale grâce à un banc de pêche prometteur.", "Potrafi zapełnić ładownię połowem z obiecującego łowiska.", "能把一處有潛力的漁場變成滿載的船艙。", "유망한 어장에서 잡은 물고기로 화물창을 가득 채울 수 있습니다."]],
    ["Canoes from neighboring islands lie along the beach, their crews trading news as eagerly as cargo.", ["邻岛的独木舟沿岸停泊，船员们热切地交换消息与货物。", "У берега стоят каноэ с соседних островов; их команды охотно обмениваются новостями и товарами.", "Las canoas de las islas vecinas descansan en la playa; sus tripulaciones intercambian noticias y mercancías con el mismo entusiasmo.", "Canoas das ilhas vizinhas estão na praia; suas tripulações trocam notícias e mercadorias com o mesmo entusiasmo.", "近隣の島から来たカヌーが浜辺に並び、乗組員たちは品物と同じくらい熱心に情報を交換している。", "Kanus von den Nachbarinseln liegen am Strand. Ihre Besatzungen tauschen ebenso eifrig Neuigkeiten wie Waren aus.", "Des canoës des îles voisines sont tirés sur la plage ; leurs équipages échangent avec autant d’ardeur des nouvelles que des marchandises.", "Kajaki z sąsiednich wysp stoją na plaży, a ich załogi równie chętnie wymieniają się wieściami i towarami.", "鄰島的獨木舟沿岸停泊，船員們熱切地交換消息與貨物。", "이웃 섬에서 온 카누들이 해변에 올라와 있고, 선원들은 물건을 거래하듯 열심히 소식을 나눕니다."]],
    ["By imperial command, I present the court's determination concerning {0}.", ["奉皇帝之命，现宣读宫廷对{0}的裁定。", "По повелению императора представляю решение императорского двора по вопросу о {0}.", "Por orden imperial, presento la decisión de la corte sobre {0}.", "Por ordem imperial, apresento a decisão da corte sobre {0}.", "勅命により、{0}に関する宮廷の裁定を申し渡す。", "Auf kaiserlichen Befehl verkünde ich den Beschluss des Kaiserhofs zu {0}.", "Par ordre impérial, je présente la décision de la cour concernant {0}.", "Z rozkazu cesarza przedstawiam orzeczenie dworu w sprawie {0}.", "奉皇帝之命，現宣讀宮廷對{0}的裁定。", "황명에 따라 {0}에 관한 황실의 결정을 전합니다."]],
    ["By order of {0}, {1} denies passage to your armed vessel. Turn away.", ["奉{0}之命，{1}拒绝你的武装船只通行。掉头离开。", "По приказу {0} государство {1} не пропустит ваш вооружённый корабль. Поворачивайте обратно.", "Por orden de {0}, {1} niega el paso a tu barco armado. Da media vuelta.", "Por ordem de {0}, {1} impede a passagem do seu navio armado. Dê meia-volta.", "{0}の命により、{1}は貴船の通航を拒否する。引き返せ。", "Auf Anordnung von {0} verweigert {1} Eurem bewaffneten Schiff die Durchfahrt. Kehrt um.", "Sur ordre de {0}, {1} refuse le passage à votre navire armé. Faites demi-tour.", "Na rozkaz {0} państwo {1} odmawia przepuszczenia twojego uzbrojonego statku. Zawróć.", "奉{0}之命，{1}拒絕你的武裝船隻通行。掉頭離開。", "{0}의 명령에 따라 {1}이(가) 무장 선박의 통행을 거부합니다. 뱃머리를 돌리세요."]],
    ["By the ship's log, {0} all share a birthday. What are the odds? Happy birthday to every one of you.", ["船上日志显示，{0}你们全都同一天生日。真巧！祝大家生日快乐。", "Судовой журнал показывает: у всех вас, {0}, день рождения в один день. Каковы шансы? Поздравляю каждого из вас!", "Según el diario de a bordo, todos ustedes, {0}, cumplen años el mismo día. ¡Qué coincidencia! Feliz cumpleaños a todos.", "Pelo diário de bordo, todos vocês, {0}, fazem aniversário no mesmo dia. Que coincidência! Parabéns a todos.", "航海日誌によると、{0}の皆は同じ誕生日だ。そんな偶然があるとは！皆、おめでとう。", "Laut Schiffslogbuch haben alle von Euch, {0}, am selben Tag Geburtstag. Wie wahrscheinlich ist das? Alles Gute Euch allen!", "D’après le journal de bord, vous avez tous, {0}, le même anniversaire. Quelle coïncidence ! Joyeux anniversaire à chacun de vous.", "Z dziennika pokładowego wynika, że wszyscy, {0}, obchodzicie urodziny tego samego dnia. Co za zbieg okoliczności! Wszystkiego najlepszego!", "由船上日誌可知，{0}你們全都同一天生日。真巧！祝大家生日快樂。", "선박 일지를 보니 {0} 여러분 모두 생일이 같군요. 이런 우연이 다 있네요! 모두 생일 축하합니다."]],
    ["By royal and imperial grace, Malta is granted to the Order in perpetual fief{0}. Each year, on All Saints' Day, one falcon shall be rendered to the Viceroy of Sicily.", ["奉王室与皇帝之恩，马耳他永久封予骑士团为采邑{0}。骑士团每年须于诸圣节向西西里总督进献一只猎鹰。", "По королевской и императорской милости Мальта передаётся Ордену в вечное феодальное владение{0}. Каждый год, в День всех святых, Орден будет преподносить сокола наместнику Сицилии.", "Por gracia real e imperial, Malta se concede a la Orden como feudo perpetuo{0}. Cada Día de Todos los Santos, la Orden entregará un halcón al virrey de Sicilia.", "Por graça real e imperial, Malta é concedida à Ordem como feudo perpétuo{0}. A cada Dia de Todos os Santos, a Ordem entregará um falcão ao vice-rei da Sicília.", "王室および皇帝の恩寵により、マルタは騎士団に永久封土として与えられる{0}。騎士団は毎年諸聖人の日に、シチリア副王へ鷹を一羽献上する。", "Durch königliche und kaiserliche Gnade wird Malta dem Orden als ewiges Lehen übertragen{0}. Jedes Jahr zu Allerheiligen übergibt der Orden dem Vizekönig von Sizilien einen Falken.", "Par grâce royale et impériale, Malte est accordée à l’Ordre en fief perpétuel{0}. Chaque année, à la Toussaint, l’Ordre remettra un faucon au vice-roi de Sicile.", "Z łaski królewskiej i cesarskiej Malta zostaje nadana Zakonowi jako lenno wieczyste{0}. Każdego roku w dzień Wszystkich Świętych Zakon przekaże sokoła wicekrólowi Sycylii.", "奉王室與皇帝之恩，馬爾他永久封予騎士團為采邑{0}。騎士團每年須於諸聖節向西西里總督進獻一隻獵鷹。", "왕실과 황제의 은총으로 몰타는 기사단에 영구 봉토로 주어집니다{0}. 기사단은 해마다 모든 성인의 날에 시칠리아 부왕에게 매 한 마리를 바칩니다."]],
    ["Buy {0} {1} db", ["买入{0}，花费{1}达布隆", "Купить {0} за {1} дублонов", "Comprar {0} por {1} doblones", "Comprar {0} por {1} dobrões", "{0}を{1}ダブロンで購入", "{0} für {1} Dublonen kaufen", "Acheter {0} pour {1} doublons", "Kup {0} za {1} dublonów", "買入{0}，花費{1}達布隆", "{0}을(를) {1} 더블룬에 구매"]],
    ["Buy 1 {0} {1} db", ["买入1件{0}，花费{1}达布隆", "Купить 1 ед. «{0}» за {1} дублонов", "Comprar 1 {0} por {1} doblones", "Comprar 1 {0} por {1} dobrões", "{0}を1個、{1}ダブロンで購入", "1 {0} für {1} Dublonen kaufen", "Acheter 1 {0} pour {1} doublons", "Kup 1 szt. {0} za {1} dublonów", "買入1件{0}，花費{1}達布隆", "{0} 1개를 {1} 더블룬에 구매"]],
    ["Bought {0} for {1} db.", ["买入{0}，花费{1}达布隆。", "Куплено: {0}. Цена: {1} дублонов.", "Compraste {0} por {1} doblones.", "Você comprou {0} por {1} dobrões.", "{0}を{1}ダブロンで購入。", "{0} für {1} Dublonen gekauft.", "{0} acheté pour {1} doublons.", "Kupiono: {0}. Cena: {1} dublonów.", "買入{0}，花費{1}達布隆。", "{0}을(를) {1} 더블룬에 구매했습니다."]],
    ["Breaking shore ice carried a sailor into the freezing sea. The search found no trace.", ["岸边冰层断裂，一名水手被带入冰冷的海中。搜寻一无所获。", "Береговой лёд треснул, и моряка унесло в ледяное море. Поиски не дали результатов.", "El hielo costero se quebró y arrastró a un marinero al mar helado. La búsqueda no dejó rastro.", "O gelo costeiro se rompeu e levou um marinheiro ao mar congelante. As buscas não encontraram vestígios.", "岸の氷が割れ、船乗りが凍てつく海へ流された。捜索しても跡は見つからなかった。", "Das Küsteneis brach und riss einen Seemann ins eiskalte Meer. Die Suche blieb erfolglos.", "La glace côtière s’est rompue et a entraîné un marin dans la mer glaciale. Les recherches n’ont rien révélé.", "Przybrzeżny lód pękł i porwał marynarza do lodowatego morza. Poszukiwania nie przyniosły śladu.", "岸邊冰層斷裂，一名水手被帶入冰冷的海中。搜尋一無所獲。", "해안의 얼음이 깨져 선원이 얼음장 같은 바다로 휩쓸려 갔습니다. 수색했지만 흔적을 찾지 못했습니다."]],
    ["Bound for {0}.", ["驶往{0}。", "Следует в порт {0}.", "Rumbo a {0}.", "A caminho de {0}.", "{0}へ向かう。", "Auf dem Weg nach {0}.", "En route vers {0}.", "W drodze do {0}.", "駛往{0}。", "{0}(으)로 향합니다."]],
    ["Both houses have laid their tallies before me, and their escorts are waiting outside the harbor. I can enter a joint register, or you may settle the quarrel at sea.", ["两家商号已把账册呈给我，护航船则候在港外。我可以将双方一并登记，也可以由你们出海决一胜负。", "Обе торговые компании представили мне свои реестры, а их эскорт ждёт за пределами гавани. Я могу внести обе стороны в общий реестр, а вы можете разрешить спор в море.", "Ambas casas comerciales me han presentado sus registros, y sus escoltas esperan fuera del puerto. Puedo inscribirlas en un registro común, o pueden resolver la disputa en el mar.", "Ambas as casas comerciais me apresentaram seus registros, e suas escoltas aguardam fora do porto. Posso inscrever as duas em um registro conjunto, ou vocês podem resolver a disputa no mar.", "両商家は帳簿を私に提出し、護衛船は港の外で待っている。両者を共同の名簿に登録することもできるし、海上で争いに決着をつけてもよい。", "Beide Handelshäuser haben mir ihre Register vorgelegt, und ihre Geleitschiffe warten außerhalb des Hafens. Ich kann beide gemeinsam eintragen, oder Ihr könnt den Streit auf See austragen.", "Les deux maisons de commerce m’ont présenté leurs registres, et leurs escortes attendent hors du port. Je peux les inscrire ensemble, ou vous pouvez régler le différend en mer.", "Oba domy handlowe przedstawiły mi swoje rejestry, a ich eskorty czekają poza portem. Mogę wpisać je do wspólnego rejestru albo pozwolić wam rozstrzygnąć spór na morzu.", "兩家商號已把帳冊呈給我，護航船則候在港外。我可以將雙方一併登記，也可以由你們出海決一勝負。", "두 상회가 장부를 내게 제출했고, 호위선들은 항구 밖에서 기다리고 있습니다. 양측을 공동 장부에 올리거나, 바다에서 직접 분쟁을 해결하게 할 수 있습니다."]],
    ["Borobudur climbs in stone terraces, each level ringed with carved stories. At the summit, bell-shaped stupas surround a final dome above the green plain.", ["婆罗浮屠由层层石砌台阶向上延展，每层都饰有叙事浮雕。山顶上，钟形佛塔环绕着一座圆顶，俯瞰绿色平原。", "Боробудур поднимается террасами из камня, каждый ярус украшен резными повествовательными панно. На вершине колоколообразные ступы окружают главный купол над зелёной равниной.", "Borobudur se eleva en terrazas de piedra, cuyos niveles están cubiertos de relieves narrativos. En la cima, estupas acampanadas rodean una cúpula sobre la llanura verde.", "Borobudur se ergue em terraços de pedra, com relevos narrativos esculpidos em cada nível. No alto, estupas em forma de sino cercam uma cúpula sobre a planície verde.", "ボロブドゥールは石造りの段状テラスを重ね、各層を物語の浮彫で飾っている。頂上では鐘形のストゥーパが、緑の平原を見下ろす中央のドームを囲む。", "Borobudur erhebt sich über steinerne Terrassen, deren Ebenen mit erzählenden Reliefs geschmückt sind. Auf dem Gipfel umgeben glockenförmige Stupas eine Kuppel über der grünen Ebene.", "Borobudur s’élève en terrasses de pierre ornées de bas-reliefs narratifs. Au sommet, des stupas en forme de cloche entourent un dôme dominant la plaine verdoyante.", "Borobudur wznosi się tarasami z kamienia, których poziomy zdobią płaskorzeźby układające się w opowieści. Na szczycie stupy w kształcie dzwonów otaczają kopułę górującą nad zieloną równiną.", "婆羅浮屠由層層石砌台階向上延展，每層都飾有敘事浮雕。山頂上，鐘形佛塔環繞著一座圓頂，俯瞰綠色平原。", "보로부두르는 돌 테라스가 층층이 솟아 있으며 각 층에는 이야기를 담은 부조가 새겨져 있습니다. 정상에서는 종 모양의 스투파들이 푸른 평원을 내려다보는 돔을 둘러싸고 있습니다."]],
    ["Beneath a stand of trees, the party uncovered a freshwater spring.", ["一行人在一片树林下发现了一处淡水泉。", "Под деревьями путешественники нашли источник пресной воды.", "Bajo un grupo de árboles, el grupo descubrió un manantial de agua dulce.", "Sob um grupo de árvores, o grupo encontrou uma nascente de água doce.", "一行は木立の下で淡水の湧き水を見つけた。", "Unter einer Baumgruppe entdeckte die Gruppe eine Süßwasserquelle.", "Sous un bosquet, le groupe a découvert une source d’eau douce.", "Pod kępą drzew grupa odkryła źródło słodkiej wody.", "一行人在一片樹林下發現了一處淡水泉。", "일행은 나무숲 아래에서 담수 샘을 발견했습니다."]],
    ["Beyond the Nile I found a field of steep, narrow pyramids rising from the red earth. They are smaller than Giza's giant, but so numerous they resemble a stone fleet under sail.", ["尼罗河以外，我发现一片红土上耸立着陡峭、狭长的金字塔群。它们比吉萨那座巨型金字塔小，却数量众多，宛如扬帆的石头舰队。", "За Нилом я увидел целое поле узких крутых пирамид, поднимающихся над красной землёй. Они меньше великой пирамиды Гизы, но их так много, что они напоминают каменный флот под парусами.", "Más allá del Nilo encontré un conjunto de pirámides estrechas y empinadas que se alzan sobre la tierra roja. Son más pequeñas que la Gran Pirámide de Guiza, pero tan numerosas que parecen una flota de piedra a vela.", "Além do Nilo, encontrei um campo de pirâmides estreitas e íngremes que se erguem da terra vermelha. Elas são menores que a Grande Pirâmide de Gizé, mas tão numerosas que parecem uma frota de pedra a vela.", "ナイル川の先で、赤土からそびえる細く急峻なピラミッドが一面に並ぶ光景を見た。ギザの大ピラミッドより小さいが、数が多く、帆を張った石の艦隊のようだ。", "Jenseits des Nils entdeckte ich ein Feld steiler, schmaler Pyramiden, die sich aus der roten Erde erheben. Sie sind kleiner als die große Pyramide von Gizeh, aber so zahlreich, dass sie einer steinernen Flotte unter Segeln gleichen.", "Au-delà du Nil, j’ai découvert un champ de pyramides étroites et abruptes qui émergent de la terre rouge. Elles sont plus petites que la grande pyramide de Gizeh, mais si nombreuses qu’elles ressemblent à une flotte de pierre sous voiles.", "Za Nilem odkryłem pole stromych, wąskich piramid wyrastających z czerwonej ziemi. Są mniejsze od Wielkiej Piramidy w Gizie, lecz tak liczne, że przypominają kamienną flotę pod żaglami.", "尼羅河以外，我發現一片紅土上聳立著陡峭、狹長的金字塔群。它們比吉薩那座巨型金字塔小，卻數量眾多，宛如揚帆的石頭艦隊。", "나일강 너머에서 붉은 땅 위로 솟은 가파르고 좁은 피라미드 무리를 발견했습니다. 기자의 대피라미드보다 작지만 수가 많아, 돛을 편 돌 함대처럼 보입니다."]],
    ["Battle joined", ["战斗开始", "Начался бой", "Comenzó la batalla", "Começou a batalha", "戦闘開始", "Der Kampf hat begonnen", "Le combat a commencé", "Rozpoczęła się bitwa", "戰鬥開始", "전투 시작"]],
    ["Before I provision your ship, choose how you intend to use her.", ["在我为你的船补给之前，先选好用途。", "Прежде чем я снабжу ваш корабль, выберите, для чего будете его использовать.", "Antes de aprovisionar tu barco, elige para qué piensas usarlo.", "Antes de abastecer seu navio, escolha para que pretende usá-lo.", "船に物資を積み込む前に、どのように使うつもりか選んでくれ。", "Bevor ich Euer Schiff versorge, wählt aus, wofür Ihr es einsetzen wollt.", "Avant que j’approvisionne votre navire, choisissez l’usage que vous comptez en faire.", "Zanim zaopatrzę Twój statek, wybierz, do czego zamierzasz go użyć.", "在我為你的船補給之前，先選好用途。", "배에 보급품을 싣기 전에 어떤 용도로 쓸지 선택하세요."]],
    ["Back to menu", ["返回菜单", "Вернуться в меню", "Volver al menú", "Voltar ao menu", "メニューに戻る", "Zurück zum Menü", "Retour au menu", "Wróć do menu", "返回選單", "메뉴로 돌아가기"]],
    ["bandages, bedding, and the first Hotel-Dieu", ["绷带、寝具和第一座济贫医院", "бинты, постельное бельё и первая больница Отель-Дьё", "vendajes, ropa de cama y el primer Hôtel-Dieu", "ataduras, roupas de cama e o primeiro Hôtel-Dieu", "包帯、寝具、そして最初のオテル・デュー", "Verbände, Bettzeug und das erste Hôtel-Dieu", "bandages, literie et premier Hôtel-Dieu", "bandaże, pościel i pierwszy Hôtel-Dieu", "繃帶、寢具和第一座濟貧醫院", "붕대, 침구, 그리고 최초의 오텔디외 병원"]],
    ["Bandages, needles, splints, and spirits improve survival after injury.", ["绷带、针、夹板和烈酒能提高受伤后的存活率。", "Бинты, иглы, шины и крепкий алкоголь повышают шансы выжить после ранения.", "Los vendajes, las agujas, las férulas y el aguardiente mejoran las probabilidades de sobrevivir a una herida.", "Bandagens, agulhas, talas e bebidas destiladas aumentam as chances de sobreviver a um ferimento.", "包帯、針、添え木、そして蒸留酒は、負傷後の生存率を高める。", "Verbände, Nadeln, Schienen und Branntwein erhöhen die Überlebenschancen nach einer Verletzung.", "Les bandages, les aiguilles, les attelles et l’eau-de-vie augmentent les chances de survie après une blessure.", "Bandaże, igły, szyny i mocny alkohol zwiększają szanse przeżycia po zranieniu.", "繃帶、針、夾板和烈酒能提高受傷後的存活率。", "붕대, 바늘, 부목, 독한 술은 부상 후 생존 가능성을 높입니다."]],
    ["AVG {0}", ["均价 {0}", "СРЕДНЯЯ ЦЕНА {0}", "COSTE MEDIO {0}", "CUSTO MÉDIO {0}", "平均取得単価 {0}", "DURCHSCHNITTSPREIS {0}", "COÛT MOYEN {0}", "ŚREDNI KOSZT {0}", "均價 {0}", "평균 매입가 {0}"]],
    ["Ask for provisions", ["索取补给", "Попросить припасы", "Pedir provisiones", "Pedir provisões", "食料を求める", "Um Proviant bitten", "Demander des provisions", "Poproś o zapasy", "索取補給", "보급품을 요청하세요"]],
    ["Ask about pirate havens", ["打听海盗藏身的港湾", "Спросить о пиратских убежищах", "Preguntar por refugios piratas", "Perguntar sobre refúgios piratas", "海賊の隠れ港について尋ねる", "Nach Piratenverstecken fragen", "Se renseigner sur les repaires de pirates", "Zapytaj o kryjówki piratów", "打聽海盜藏身的港灣", "해적 은신처에 대해 묻기"]],
    ["Asuncion has outgrown its first mud-and-thatch fort. It is now the upriver refuge from which new settlements can spread through the Plata basin.", ["亚松森已不再局限于最初那座泥墙茅顶的小堡。如今它是上游的避难所，新聚落可以从这里扩展到拉普拉塔河流域。", "Асунсьон перерос свою первую крепость из глины и соломы. Теперь это убежище вверх по реке, откуда новые поселения могут расселяться по бассейну Ла-Платы.", "Asunción ya dejó atrás su primer fuerte de barro y paja. Ahora es el refugio río arriba desde el que pueden extenderse nuevos asentamientos por la cuenca del Plata.", "Assunção já superou seu primeiro forte de barro e palha. Agora é o refúgio rio acima de onde novos assentamentos podem se espalhar pela bacia do Prata.", "アスンシオンは、最初の泥と茅葺きの砦では収まりきらない町へと成長した。今では川上の拠点となり、ここからラプラタ川流域へ新たな集落が広がっていく。", "Asuncion ist über seine erste Lehm- und Strohfeste hinausgewachsen. Nun ist es ein Zufluchtsort flussaufwärts, von dem aus sich neue Siedlungen im Plata-Becken ausbreiten können.", "Asunción a dépassé son premier fort de terre et de chaume. C’est désormais un refuge en amont, d’où de nouvelles colonies peuvent s’étendre dans le bassin de la Plata.", "Asunción wyrosło ze swojego pierwszego fortu z gliny i strzechy. Teraz jest schronieniem w górnym biegu rzeki, skąd nowe osady mogą rozprzestrzeniać się w dorzeczu La Platy.", "亞松森已不再局限於最初那座泥牆茅頂的小堡。如今它是上游的避難所，新聚落可以從這裡擴展到拉普拉塔河流域。", "아순시온은 진흙과 초가로 지은 첫 요새보다 훨씬 커졌습니다. 이제 강 상류의 피난처가 되어, 이곳에서 새로운 정착지가 플라타강 유역으로 뻗어 나갑니다."]],
    ["And I kept looking for you whenever the sea turned hard. I love you too. Whatever comes next, we meet it together.", ["每当海上风浪险恶，我总在寻找你。我也爱你。无论接下来发生什么，我们都一起面对。", "И я искал тебя каждый раз, когда море становилось суровым. Я тоже тебя люблю. Что бы ни случилось дальше, мы встретим это вместе.", "Y seguí buscándote cada vez que el mar se ponía bravo. Yo también te quiero. Sea lo que sea, lo afrontaremos juntos.", "E continuei procurando por você sempre que o mar ficava bravio. Também amo você. O que vier, enfrentaremos juntos.", "海が荒れるたび、あなたを探し続けた。私も愛している。これから何が起きても、二人で立ち向かおう。", "Und ich habe immer nach Euch gesucht, wenn das Meer stürmisch wurde. Ich liebe Euch auch. Was immer kommt, wir stehen es gemeinsam durch.", "Et je n’ai cessé de te chercher chaque fois que la mer se déchaînait. Moi aussi, je t’aime. Quoi qu’il arrive, nous l’affronterons ensemble.", "I szukałem cię za każdym razem, gdy morze stawało się groźne. Też cię kocham. Cokolwiek nas czeka, stawimy temu czoła razem.", "每當海上風浪險惡，我總在尋找你。我也愛你。無論接下來發生什麼，我們都一起面對。", "바다가 거칠어질 때마다 당신을 찾아다녔어요. 나도 사랑해요. 앞으로 무슨 일이 닥쳐도 함께 맞서요."]],
    ["And share whatever feast the cook can coax from the hold. Christ is born.", ["也把厨子用船上存粮做出的饭菜分给大家。基督降生了。", "И разделите трапезу из того, что повар сумел приготовить из корабельных запасов. Христос родился.", "Y compartan lo que el cocinero haya podido preparar con las provisiones de a bordo. Cristo ha nacido.", "E partilhem o que o cozinheiro conseguir preparar com as provisões de bordo. Cristo nasceu.", "料理人が船の食料で作れるものを分け合おう。キリストがお生まれになった。", "Und teilt, was der Koch aus den Vorräten an Bord zubereiten kann. Christus ist geboren.", "Et partagez ce que le cuisinier aura pu préparer avec les provisions de bord. Le Christ est né.", "Podzielcie się tym, co kucharz zdoła przygotować z pokładowych zapasów. Chrystus się narodził.", "也把廚子用船上存糧做出的飯菜分給大家。基督降生了。", "그리고 요리사가 선상 식량으로 마련한 음식을 함께 나누세요. 그리스도께서 탄생하셨습니다."]],
    ["Another snowy contradiction beneath the hot sun, but broader and heavier than Kilimanjaro in your account. Comparing them will make both descriptions stronger.", ["烈日之下又见一座雪山，这座山在你的记述中比乞力马扎罗山更宽广、更雄伟。将两者比较，能让两段描述都更丰富。", "Ещё одна заснеженная вершина под жарким солнцем; по вашему описанию, она шире и массивнее Килиманджаро. Сравнение дополнит оба описания.", "Otra cumbre nevada bajo el sol abrasador; según tu relato, es más extensa y maciza que el Kilimanjaro. Compararlas enriquecerá ambas descripciones.", "Mais um pico nevado sob o sol escaldante; segundo seu relato, é mais amplo e imponente que o Kilimanjaro. Compará-los enriquecerá ambas as descrições.", "灼熱の太陽の下に、また雪を頂く山がある。君の記録では、キリマンジャロより広く、堂々としている。二つを比べれば、どちらの記述も深まるだろう。", "Noch ein schneebedeckter Gipfel unter der heißen Sonne. Eurem Bericht zufolge ist er breiter und mächtiger als der Kilimandscharo. Der Vergleich wird beide Beschreibungen bereichern.", "Encore un sommet enneigé sous le soleil brûlant ; d’après votre récit, il est plus étendu et plus imposant que le Kilimandjaro. Les comparer enrichira les deux descriptions.", "Kolejny ośnieżony szczyt pod palącym słońcem; według Twojej relacji jest rozleglejszy i masywniejszy od Kilimandżaro. Porównanie wzbogaci oba opisy.", "烈日之下又見一座雪山，這座山在你的記述中比吉力馬札羅山更寬廣、更雄偉。將兩者比較，能讓兩段描述都更豐富。", "뜨거운 태양 아래 또 다른 눈 덮인 봉우리입니다. 당신의 기록으로는 킬리만자로보다 더 넓고 웅장하군요. 두 산을 비교하면 두 묘사 모두 더 풍부해질 겁니다."]],
    ["A port for the great nao from Macau requires more than wooden sheds. Bring", ["供澳门来的大型诺乌帆船停靠的港口，不能只有木棚。带来", "Порту для большого нау из Макао нужны не только деревянные склады. Доставьте", "El puerto para la gran nao de Macao necesita algo más que cobertizos de madera. Trae", "Um porto para a grande nau de Macau precisa de mais do que galpões de madeira. Traga", "マカオから来る大型ナウ船の港には、木造の小屋だけでは足りません。持ってきてください", "Ein Hafen für die große Nau aus Macau braucht mehr als Holzschuppen. Bringt", "Un port destiné au grand nau de Macao exige davantage que de simples hangars en bois. Apportez", "Port dla wielkiej nau z Makau wymaga czegoś więcej niż drewnianych szop. Dostarcz", "供澳門來的大型諾烏帆船停靠的港口，不能只有木棚。帶來", "마카오에서 오는 대형 나우선을 위한 항구에는 나무 창고만으로 부족합니다. 가져오세요"]],
    ["A Portuguese fort and cinnamon factory stand beside the harbor under treaty with the local court.", ["依据与当地朝廷签订的条约，葡萄牙堡垒和肉桂工场并立于港口旁。", "Португальский форт и коричная мануфактура стоят у гавани по договору с местным двором.", "Un fuerte portugués y una fábrica de canela se alzan junto al puerto al amparo de un tratado con la corte local.", "Um forte português e uma fábrica de canela ficam junto ao porto, protegidos por um tratado com a corte local.", "現地の宮廷との条約に基づき、港のそばにポルトガルの砦とシナモン工場が建っています。", "Ein portugiesisches Fort und eine Zimtfabrik stehen aufgrund eines Vertrags mit dem örtlichen Herrscherhof am Hafen.", "Un fort portugais et une manufacture de cannelle se dressent près du port en vertu d'un traité avec la cour locale.", "Portugalski fort i wytwórnia cynamonu stoją przy porcie na mocy traktatu z miejscowym dworem.", "依據與當地朝廷簽訂的條約，葡萄牙堡壘和肉桂工場並立於港口旁。", "현지 궁정과 맺은 조약에 따라 항구 옆에 포르투갈 요새와 계피 공장이 있습니다."]],
    ["A pinch. The rest still belongs to our buyer.", ["只取一小撮。其余的仍归买家所有。", "Щепотка. Остальное по-прежнему принадлежит нашему покупателю.", "Una pizca. El resto sigue siendo de nuestro comprador.", "Só uma pitada. O restante continua pertencendo ao nosso comprador.", "ほんのひとつまみ。残りは買い手のものです。", "Eine Prise. Der Rest gehört weiterhin unserem Käufer.", "Une pincée. Le reste appartient toujours à notre acheteur.", "Szczypta. Reszta nadal należy do naszego kupca.", "只取一小撮。其餘的仍歸買家所有。", "한 꼬집만. 나머지는 여전히 구매자의 몫입니다."]],
    ["a practical coastal trader whose divided triangular lateen sails can be reefed by a small crew when a sudden squall comes down", ["一艘实用的沿海商船，配有分片三角拉丁帆，突遇飑风时少量船员也能迅速收帆。", "Практичное прибрежное торговое судно с раздельными треугольными латинскими парусами, которые небольшой экипаж может быстро убрать при внезапном шквале.", "Un práctico buque mercante costero con velas latinas triangulares divididas, que una tripulación pequeña puede recoger cuando irrumpe un chubasco.", "Um prático navio mercante costeiro com velas latinas triangulares divididas, que uma tripulação pequena consegue recolher quando chega uma rajada repentina.", "急なスコールの際も少人数で帆を畳める、分割式の三角ラテン帆を備えた実用的な沿岸商船です。", "Ein praktisches Küstenhandelsschiff mit geteilten dreieckigen Lateinersegeln, die eine kleine Besatzung bei einer plötzlichen Böe einholen kann.", "Un caboteur pratique doté de voiles latines triangulaires divisées qu'un petit équipage peut carguer à l'arrivée d'un grain soudain.", "Praktyczny statek handlowy do żeglugi przybrzeżnej z dzielonymi trójkątnymi żaglami łacińskimi, które niewielka załoga może zrefować przy nagłym szkwale.", "一艘實用的沿海商船，配有分片三角拉丁帆，突遇颮風時少量船員也能迅速收帆。", "갑작스러운 돌풍이 불면 적은 선원으로도 돛을 내릴 수 있는 분할형 삼각 라틴 돛을 갖춘 실용적인 연안 무역선입니다."]],
    ["A rack of simple bows lets free hands harry an exposed enemy deck.", ["一架简易弓架能让空闲的船员骚扰敌舰上暴露的甲板。", "Стойка с простыми луками позволяет свободным от работы морякам обстреливать открытые участки вражеской палубы.", "Un soporte de arcos sencillos permite a los tripulantes libres hostigar la cubierta expuesta del enemigo.", "Um suporte de arcos simples permite que os tripulantes desocupados ataquem o convés exposto do inimigo.", "簡素な弓を備えれば、手の空いた乗組員が敵艦の露出した甲板を攻撃できます。", "Ein Gestell mit einfachen Bögen ermöglicht es freien Besatzungsmitgliedern, das offene Deck des Gegners zu beschießen.", "Un râtelier d'arcs simples permet aux marins disponibles de harceler le pont découvert de l'ennemi.", "Stojak z prostymi łukami pozwala wolnym marynarzom nękać odsłonięty pokład wroga.", "一架簡易弓架能讓空閒的船員騷擾敵艦上暴露的甲板。", "간단한 활을 비치하면 여유 있는 선원들이 적함의 노출된 갑판을 공격할 수 있습니다."]],
    ["A reputation is another wake: difficult to outrun once made.", ["声誉也是一道航迹：一旦留下，就很难甩在身后。", "Репутация — тоже след за кораблём: однажды оставленный, он не исчезает.", "La reputación es otra estela: una vez trazada, cuesta dejarla atrás.", "A reputação é outro rastro: depois de deixado, é difícil ficar para trás.", "評判もまた航跡のようなもの。一度刻まれたら、追い越すのは難しい。", "Ein Ruf ist wie eine Schiffsspur: Ist sie erst einmal gezogen, lässt sie sich kaum hinter sich lassen.", "La réputation est un sillage : une fois tracé, difficile de le distancer.", "Reputacja jest jak ślad na wodzie: gdy już powstanie, trudno go zostawić za sobą.", "聲譽也是一道航跡：一旦留下，就很難甩在身後。", "평판도 항적과 같습니다. 한번 남으면 앞질러 벗어나기 어렵습니다."]],
    ["A rising whiteout drove the party back before they found fresh water or game.", ["暴风雪造成的白茫茫雾障愈发浓重，一行人还没找到淡水或猎物便被迫折返。", "Нарастающая снежная мгла заставила отряд повернуть назад, прежде чем он нашёл пресную воду или дичь.", "La ventisca creciente obligó al grupo a regresar antes de encontrar agua dulce o caza.", "A nevasca cada vez mais intensa obrigou o grupo a voltar antes de encontrar água potável ou caça.", "吹雪が強まり、一行は真水や獲物を見つける前に引き返しました。", "Ein dichter werdender Schneesturm zwang die Gruppe zur Umkehr, bevor sie frisches Wasser oder Wild fand.", "Un blizzard de plus en plus dense força le groupe à rebrousser chemin avant qu'il ne trouve de l'eau douce ou du gibier.", "Narastająca śnieżyca zmusiła grupę do odwrotu, zanim znalazła świeżą wodę lub zwierzynę.", "暴風雪造成的白茫茫霧障愈發濃重，一行人還沒找到淡水或獵物便被迫折返。", "짙어지는 눈보라에 시야가 가려져 일행은 식수나 사냥감을 찾기도 전에 돌아섰습니다."]],
    ["A sacred mountain rebuilt in stone and surrounded by water. Your description makes its plan sound like a map of the heavens. I want every court and causeway marked.", ["一座以石重建、四面环水的圣山。你说它的布局宛如天象图。请标出每座庭院和每条堤道。", "Священная гора, заново сложенная из камня и окружённая водой. По вашему описанию её план напоминает карту небес. Отметьте каждый двор и каждую дамбу.", "Una montaña sagrada, reconstruida en piedra y rodeada de agua. Por tu descripción, su trazado parece un mapa celeste. Quiero que señales cada patio y cada calzada.", "Uma montanha sagrada reconstruída em pedra e cercada por água. Pela sua descrição, seu traçado parece um mapa dos céus. Quero todos os pátios e caminhos elevados marcados.", "石で再建され、水に囲まれた聖なる山です。配置は天界の地図のようだということですね。中庭も参道もすべて記録してください。", "Ein heiliger Berg, aus Stein wiederaufgebaut und von Wasser umgeben. Eurer Beschreibung nach gleicht sein Grundriss einer Himmelskarte. Zeichnen Sie jeden Innenhof und jeden Damm ein.", "Une montagne sacrée reconstruite en pierre et entourée d'eau. D'après votre description, son plan ressemble à une carte céleste. Je veux que chaque cour et chaque chaussée soit indiquée.", "Święta góra odbudowana z kamienia i otoczona wodą. Z twojego opisu wynika, że jej plan przypomina mapę nieba. Zaznacz każdy dziedziniec i każdą groblę.", "一座以石重建、四面環水的聖山。你說它的布局宛如天象圖。請標出每座庭院和每條堤道。", "돌로 재건되고 물로 둘러싸인 성스러운 산입니다. 배치가 하늘의 지도 같다는 말이군요. 모든 안뜰과 둑길을 표시해 주세요."]],
    ["A sailor collapsed from the heat before the party could carry them back to the shore.", ["一名水手在一行人来得及把他抬回岸边前，便因酷热倒下。", "Матрос потерял сознание от жары прежде, чем отряд успел отнести его к берегу.", "Un marin se desplomó por el calor antes de que el grupo pudiera llevarlo de vuelta a la costa.", "Um marinheiro desmaiou de calor antes que o grupo pudesse carregá-lo de volta à costa.", "一行が岸まで運ぶ前に、船員が暑さで倒れました。", "Ein Seemann brach vor Hitze zusammen, bevor die Gruppe ihn ans Ufer tragen konnte.", "Un marin s'est effondré sous la chaleur avant que le groupe puisse le ramener sur le rivage.", "Marynarz osłabł od upału, zanim grupa zdołała zanieść go z powrotem na brzeg.", "一名水手在一行人來得及把他抬回岸邊前，便因酷熱倒下。", "일행이 해안으로 데려가기 전에 선원 한 명이 더위에 쓰러졌습니다."]],
    ["A sailor succumbed to the cold before the party could carry them back to the ship.", ["一名水手在一行人来得及把他抬回船上前，便冻死了。", "Матрос умер от холода прежде, чем отряд успел отнести его на корабль.", "Un marin murió de frío antes de que el grupo pudiera llevarlo al barco.", "Um marinheiro morreu de frio antes que o grupo pudesse carregá-lo de volta ao navio.", "船へ運ぶ前に、船員は寒さで命を落としました。", "Ein Seemann erlag der Kälte, bevor die Gruppe ihn zum Schiff bringen konnte.", "Un marin a succombé au froid avant que le groupe puisse le ramener à bord.", "Marynarz zmarł z wychłodzenia, zanim grupa zdołała zanieść go na statek.", "一名水手在一行人來得及把他抬回船上前，便凍死了。", "일행이 배로 데려가기 전에 선원 한 명이 추위에 목숨을 잃었습니다."]],
    ["A settlement founded for conscience still needs practical independence. Add", ["因信仰良心而建立的殖民地仍须有实际的自主权。增加", "Поселение, основанное ради свободы совести, нуждается и в реальной самостоятельности. Добавьте", "Una colonia fundada por motivos de conciencia también necesita independencia efectiva. Añade", "Uma colônia fundada por convicção religiosa também precisa de autonomia prática. Acrescente", "信仰に基づいて築かれた入植地にも、実質的な自治が必要です。次を加えてください", "Eine aus Gewissensgründen gegründete Siedlung braucht auch praktische Unabhängigkeit. Ergänzt", "Une colonie fondée au nom de la conscience a aussi besoin d'une véritable autonomie. Ajoutez", "Osada założona w imię sumienia potrzebuje też rzeczywistej samodzielności. Dodaj", "因信仰良心而建立的殖民地仍須有實際的自主權。增加", "양심의 신념으로 세워진 정착촌에도 실질적인 자치권이 필요합니다. 추가하세요"]],
    ["A slow tree-dweller of tropical America.", ["一种生活在美洲热带地区的缓慢树栖动物。", "Медлительный древесный зверь тропической Америки.", "Un perezoso arborícola de la América tropical.", "Um bicho-preguiça arborícola da América tropical.", "熱帯アメリカに暮らす、動きの遅い樹上動物。", "Ein langsames baumbewohnendes Tier aus dem tropischen Amerika.", "Un paresseux arboricole d'Amérique tropicale.", "Powolne zwierzę nadrzewne z tropikalnej Ameryki.", "一種生活在美洲熱帶地區的緩慢樹棲動物。", "열대 아메리카에 사는 느린 나무늘보입니다."]],
    ["A sound choice. The {0} are aboard and ready for work.", ["明智的选择。{0}已上船，随时可以开工。", "Мудрое решение. {0} уже на борту и готовы к работе.", "Una decisión acertada. Los {0} ya están a bordo y listos para trabajar.", "Uma escolha acertada. Os {0} estão a bordo e prontos para o trabalho.", "賢明な選択です。{0}が乗船し、作業の準備ができています。", "Eine gute Wahl. Die {0} sind an Bord und einsatzbereit.", "Un choix judicieux. Les {0} sont à bord et prêts à travailler.", "Dobry wybór. {0} są na pokładzie i gotowi do pracy.", "明智的選擇。{0}已上船，隨時可以開工。", "현명한 선택입니다. {0}이(가) 승선했고 바로 일할 수 있습니다."]],
    ["A sound choice. The {0} is aboard and ready for work.", ["明智的选择。{0}已上船，随时可以开工。", "Мудрое решение. {0} уже на борту и готов к работе.", "Una decisión acertada. El {0} ya está a bordo y listo para trabajar.", "Uma escolha acertada. O {0} está a bordo e pronto para o trabalho.", "賢明な選択です。{0}が乗船し、作業の準備ができています。", "Eine gute Wahl. Die {0} ist an Bord und einsatzbereit.", "Un choix judicieux. Le {0} est à bord et prêt à travailler.", "Dobry wybór. {0} jest na pokładzie i gotowy do pracy.", "明智的選擇。{0}已上船，隨時可以開工。", "현명한 선택입니다. {0}이(가) 승선했고 바로 일할 수 있습니다."]],
    ["a small pinnace suited to coasting, scouting, and carrying messages, the kind of useful tender a larger fleet always finds work for", ["一艘适合沿岸航行、侦察和传递消息的小型平底艇；大型舰队总能给这样实用的辅助艇安排差事。", "Небольшой пинас для каботажа, разведки и доставки сообщений — полезное вспомогательное судно, которому всегда найдётся дело в большом флоте.", "Una pinaza pequeña, apta para navegar cerca de la costa, explorar y llevar mensajes: una embarcación auxiliar siempre útil para una gran flota.", "Uma pequena pinaça para navegação costeira, reconhecimento e transporte de mensagens; um barco de apoio sempre útil a uma grande frota.", "沿岸航行、偵察、伝令に適した小型ピナス。大艦隊なら必ず使い道のある便利な支援艇です。", "Eine kleine Pinasse für Küstenfahrt, Aufklärung und Botengänge – ein nützliches Beiboot, für das eine große Flotte immer Verwendung hat.", "Une petite pinasse pour le cabotage, l'exploration et le transport de dépêches : une annexe utile à toute grande flotte.", "Mała pinasa do żeglugi przybrzeżnej, zwiadu i przewożenia wiadomości; duża flota zawsze znajdzie dla niej pożyteczne zadanie.", "一艘適合沿岸航行、偵察和傳遞消息的小型平底艇；大型艦隊總能給這樣實用的輔助艇安排差事。", "연안 항해와 정찰, 연락 임무에 알맞은 소형 피너스선입니다. 대규모 함대라면 언제나 유용하게 쓸 수 있습니다."]],
    ["a license to trade in the Spanish Indies", ["在西属美洲贸易的许可证", "Лицензия на торговлю в испанских владениях Америки", "una licencia para comerciar en las Indias españolas", "uma licença para comerciar nas Índias Espanholas", "スペイン領アメリカでの貿易許可証", "Handelslizenz für Spanisch-Amerika", "une licence de commerce dans les possessions espagnoles d'Amérique", "licencja na handel w hiszpańskich posiadłościach w Ameryce", "在西屬美洲貿易的許可證", "스페인령 아메리카 무역 허가증"]],
    ["a royal license for our merchants to trade at the Crown's ports in the Indies", ["王室许可我们的商人在西属美洲的王家港口贸易", "королевская лицензия для наших торговцев на торговлю в портах Короны в испанских владениях Америки", "una licencia real para que nuestros mercaderes comercien en los puertos de la Corona en las Indias", "uma licença real para que nossos mercadores comerciem nos portos da Coroa nas Índias", "我が国の商人がスペイン領アメリカの王室港で交易するための王室許可証", "Königliche Lizenz für unsere Händler zum Handel in den Häfen der Krone in Spanisch-Amerika", "une licence royale autorisant nos marchands à commercer dans les ports de la Couronne en Amérique espagnole", "królewska licencja dla naszych kupców na handel w portach Korony w hiszpańskich posiadłościach w Ameryce", "王室許可我們的商人在西屬美洲的王家港口貿易", "우리 상인들이 스페인령 아메리카의 왕실 항구에서 교역할 수 있는 왕실 허가증"]],
    ["an Iberian ocean-going roundship of the kind called a nao, built to carry stores and cargo on long Atlantic voyages and across the Americas", ["一种被称为nao的伊比利亚远洋圆船，适合在漫长的大西洋航程及美洲航线上运载物资和货物。", "Иберийский океанский корабль с округлым корпусом типа нао, предназначенный для перевозки запасов и грузов в дальних плаваниях через Атлантику и вдоль берегов Америки.", "Un navío ibérico de casco redondo, llamado nao, construido para transportar provisiones y carga en largas travesías atlánticas y por las rutas de América.", "Um navio ibérico de casco arredondado, chamado nau, feito para transportar mantimentos e cargas em longas travessias atlânticas e pelas rotas das Américas.", "ナオと呼ばれるイベリアの外洋船。長い大西洋航路やアメリカ航路で物資や貨物を運ぶために造られました。", "Ein iberisches Hochseeschiff mit rundem Rumpf, Nao genannt, für Vorräte und Fracht auf langen Atlantikfahrten und entlang der Küsten Amerikas.", "Un navire ibérique de haute mer à coque arrondie, appelé nao, conçu pour transporter vivres et cargaison lors des longues traversées de l'Atlantique et des voyages vers les Amériques.", "Iberyjski pełnomorski żaglowiec o zaokrąglonym kadłubie, zwany nao, przeznaczony do przewozu zapasów i ładunków podczas długich rejsów przez Atlantyk i wzdłuż wybrzeży Ameryk.", "一種稱為nao的伊比利亞遠洋圓船，適合在漫長的大西洋航程及美洲航線上運載物資和貨物。", "나오라고 불리는 이베리아 원양선으로, 긴 대서양 항해와 아메리카 항로에서 보급품과 화물을 운반하도록 만들어졌습니다."]],
    ["Royal license for trade in the Spanish Indies", ["西属美洲贸易皇家许可证", "Королевская лицензия на торговлю в испанских владениях Америки", "Licencia real de comercio con las Indias españolas", "Licença real de comércio com as Índias Espanholas", "スペイン領アメリカ交易の王室許可証", "Königliche Handelslizenz für Spanisch-Amerika", "Licence royale de commerce dans les possessions espagnoles d'Amérique", "Królewska licencja handlowa w hiszpańskich posiadłościach w Ameryce", "西屬美洲貿易皇家許可證", "스페인령 아메리카 무역 왕실 허가증"]],
    ["Spanish Indies monopoly", ["西班牙在美洲的贸易垄断", "Торговая монополия Испании в Америке", "Monopolio español de comercio con las Indias", "Monopólio espanhol de comércio com as Índias", "スペイン領アメリカ貿易の独占", "Spanisches Handelsmonopol in Amerika", "Monopole espagnol sur le commerce avec les Indes", "Hiszpański monopol handlowy w Ameryce", "西班牙在美洲的貿易壟斷", "스페인의 아메리카 무역 독점"]],
    ["The Crown's Indies monopoly closes this colonial market to unlicensed foreign cargo.", ["王室垄断西属美洲贸易，未获许可的外国货物不得进入此殖民地市场。", "Торговая монополия Короны в испанских владениях Америки закрывает этот колониальный рынок для иностранных грузов без лицензии.", "El monopolio de la Corona sobre el comercio con las Indias españolas impide la entrada de carga extranjera sin licencia en este mercado colonial.", "O monopólio da Coroa sobre o comércio com as Índias Espanholas impede a entrada de cargas estrangeiras sem licença neste mercado colonial.", "王室のスペイン領アメリカ貿易独占により、許可のない外国貨物はこの植民地市場に入れません。", "Das Handelsmonopol der Krone in Spanisch-Amerika sperrt diesen Kolonialmarkt für ausländische Fracht ohne Lizenz.", "Le monopole de la Couronne sur le commerce dans les possessions espagnoles d'Amérique ferme ce marché colonial aux cargaisons étrangères sans licence.", "Monopol Korony na handel w hiszpańskich posiadłościach w Ameryce zamyka ten rynek kolonialny dla zagranicznych ładunków bez licencji.", "王室壟斷西屬美洲貿易，未獲許可的外國貨物不得進入此殖民地市場。", "왕실의 스페인령 아메리카 무역 독점으로 허가받지 않은 외국 화물은 이 식민지 시장에 들어올 수 없습니다."]],
    ["Pirates curse your name across every sea. Honest masters drink to it.", ["海盗在四海咒骂您的名字，守法船主却为它举杯。", "Пираты проклинают ваше имя по всем морям. Честные капитаны поднимают за него бокалы.", "Los piratas maldicen vuestro nombre por todos los mares. Los capitanes honrados brindan por él.", "Os piratas amaldiçoam vosso nome por todos os mares. Os capitães honestos brindam por ele.", "海賊たちはあらゆる海であなたの名を呪い、堅気の船長たちはその名に杯を掲げます。", "Piraten verfluchen Euren Namen auf allen Meeren. Ehrbare Kapitäne trinken auf ihn.", "Les pirates maudissent votre nom sur toutes les mers. Les capitaines honnêtes trinquent en votre honneur.", "Piraci przeklinają wasze imię na wszystkich morzach. Uczciwi kapitanowie wznoszą za nie toast.", "海盜在四海咒罵您的名字，守法船主卻為它舉杯。", "해적들은 모든 바다에서 당신의 이름을 저주하고, 정직한 선장들은 그 이름에 건배합니다."]],
    ["Every league toward {0} brings me closer to being debt-free. Tell me when we make the harbor.", ["每向{0}前进一段路程，我离还清债务就更近一步。到港时告诉我。", "Каждый отрезок пути к {0} приближает меня к жизни без долгов. Скажи, когда мы войдём в гавань.", "Cada tramo hacia {0} me acerca a saldar mis deudas. Avísame cuando lleguemos al puerto.", "Cada trecho até {0} me aproxima de quitar minhas dívidas. Avise-me quando chegarmos ao porto.", "{0}へ一段進むたび、借金の完済も近づきます。港に着いたら教えてください。", "Mit jedem zurückgelegten Abschnitt nach {0} komme ich der Schuldenfreiheit näher. Sagt mir Bescheid, wenn wir den Hafen erreichen.", "Chaque étape vers {0} me rapproche du remboursement de mes dettes. Prévenez-moi à notre arrivée au port.", "Każdy odcinek drogi do {0} przybliża mnie do spłaty długu. Daj mi znać, gdy dotrzemy do portu.", "每向{0}前進一段路程，我離還清債務就更近一步。到港時告訴我。", "{0}을(를) 향해 항해를 한 구간씩 이어 갈 때마다 빚을 청산할 날이 가까워집니다. 항구에 도착하면 알려 주세요."]],
    ["Spanish American trade license", ["西属美洲贸易许可证", "Лицензия на торговлю в испанских владениях Америки", "Licencia de comercio con la América española", "Licença de comércio com a América Espanhola", "スペイン領アメリカ交易許可証", "Handelslizenz für Spanisch-Amerika", "Licence de commerce dans l'Amérique espagnole", "Licencja handlowa w hiszpańskich posiadłościach w Ameryce", "西屬美洲貿易許可證", "스페인령 아메리카 무역 허가증"]],
    ["A remarkably nimble creature. Leave the raccoon in my care and I shall pay you {payment} doubloons. I shall begin by purchasing stronger locks.", ["这种动物灵巧得惊人。把浣熊交给我照料，我付你{payment}达布隆。我先去买几把更牢靠的锁。", "Поразительно ловкое животное. Оставьте енота мне, и я заплачу вам {payment} дублонов. Начну с покупки замков покрепче.", "Un animal extraordinariamente ágil. Déjame cuidar del mapache y te pagaré {payment} doblones. Empezaré comprando cerraduras más resistentes.", "Um animal extraordinariamente ágil. Deixe o guaxinim aos meus cuidados e pagarei {payment} dobrões. Vou começar comprando fechaduras mais resistentes.", "驚くほど身軽な動物です。アライグマを私に預けてください。{payment}ダブロンをお支払いします。まずは頑丈な錠前を買うことにしましょう。", "Ein erstaunlich flinkes Tier. Überlasst mir den Waschbären, dann zahle ich Euch {payment} Dublonen. Ich werde zunächst stärkere Schlösser kaufen.", "Un animal d'une agilité remarquable. Confiez-moi le raton laveur et je vous paierai {payment} doublons. Je commencerai par acheter des serrures plus solides.", "Niezwykle zwinne zwierzę. Zostaw mi szopa pod opieką, a zapłacę ci {payment} dublonów. Zacznę od zakupu mocniejszych zamków.", "這種動物靈巧得驚人。把浣熊交給我照料，我付你{payment}達布隆。我先去買幾把更牢靠的鎖。", "놀라울 만큼 재빠른 동물이군요. 너구리를 제게 맡겨 주시면 더블룬 {payment}닢을 드리겠습니다. 먼저 더 튼튼한 자물쇠부터 사야겠군요."]],
    ["A nimble masked mammal that forages in the Americas.", ["一种行动敏捷、脸上有黑色面罩的美洲哺乳动物。", "Проворное млекопитающее Америки с характерной тёмной маской на морде.", "Un mamífero ágil de las Américas, con un antifaz oscuro, que busca alimento.", "Um mamífero ágil das Américas, com uma máscara escura no rosto, que busca alimento.", "アメリカ大陸に生息する、身軽で顔にマスク模様のある哺乳類。", "Ein flinkes, maskiertes Säugetier aus Amerika, das nach Nahrung sucht.", "Un mammifère agile des Amériques, au masque sombre, qui cherche sa nourriture.", "Zwinny, maskowany ssak z Ameryk, który żeruje.", "一種行動敏捷、臉上有黑色面罩的美洲哺乳動物。", "아메리카 대륙에 사는 민첩한 포유류로, 얼굴에 가면 같은 무늬가 있습니다."]],
    ["A decisive rebuttal! Leave the panda in my care and I shall pay you {payment} doubloons. Think of what we can learn!", ["这可是有力的反证！把熊猫交给我照料，我付你{payment}达布隆。想想我们能从中学到多少！", "Вот вам и опровержение! Оставьте панду мне, и я заплачу вам {payment} дублонов. Подумайте, сколько мы сможем узнать!", "¡Una refutación decisiva! Déjame cuidar al panda y te pagaré {payment} doblones. ¡Piensa en todo lo que podremos aprender!", "Uma refutação decisiva! Deixe o panda aos meus cuidados e pagarei {payment} dobrões. Imagine tudo o que podemos aprender!", "見事な反証です！パンダを私に預けてください。{payment}ダブロンをお支払いします。どれほど多くを学べるか、考えてみてください！", "Ein überzeugender Gegenbeweis! Überlasst mir den Panda, dann zahle ich Euch {payment} Dublonen. Stellt Euch vor, was wir alles lernen können!", "Quelle réfutation décisive ! Confiez-moi le panda et je vous paierai {payment} doublons. Imaginez tout ce que nous pourrons apprendre !", "To rozstrzygający dowód! Zostaw mi pandę pod opieką, a zapłacę ci {payment} dublonów. Pomyśl, ile możemy się dowiedzieć!", "這可是有力的反證！把熊貓交給我照料，我付你{payment}達布隆。想想我們能從中學到多少！", "결정적인 반증이군요! 판다를 제게 맡겨 주시면 더블룬 {payment}닢을 드리겠습니다. 우리가 얼마나 많이 배울 수 있을지 생각해 보세요!"]],
    ["A fair wind on your birthday, {0}. The whole crew wishes you well.", ["{0}，祝你生日顺风！全体船员都祝你一切顺遂。", "Попутного ветра в день рождения, {0}! Вся команда желает тебе счастья.", "¡Que tengas buen viento en tu cumpleaños, {0}! Toda la tripulación te desea lo mejor.", "Bons ventos no seu aniversário, {0}! Toda a tripulação lhe deseja o melhor.", "{0}、誕生日に追い風が吹きますように。乗組員一同、あなたの幸せを願っています。", "Guten Wind zu Eurem Geburtstag, {0}! Die ganze Mannschaft wünscht Euch alles Gute.", "Bon vent pour votre anniversaire, {0} ! Tout l'équipage vous adresse ses vœux.", "Pomyślnych wiatrów w dniu urodzin, {0}! Cała załoga życzy ci wszystkiego najlepszego.", "{0}，祝你生日順風！全體船員都祝你一切順遂。", "{0}님, 생일에 순풍이 함께하길 바랍니다! 선원 모두가 행복을 빕니다."]],
    ["A cartaz costing {0} doubloons licenses this vessel for {1} days under Estado da India patrols. Customs duties and spice levies still apply.", ["一份价值{0}达布隆的通行许可证，可使该船在印度国家巡逻队巡逻期间获准航行{1}天。仍须缴纳关税和香料税。", "Картаз стоимостью {0} дублонов даёт этому судну лицензию на {1} дней под охраной патрулей Estado da India. Таможенные пошлины и сборы на специи сохраняются.", "Un cartaz de {0} doblones autoriza a este barco a navegar durante {1} días bajo las patrullas del Estado da India. Siguen aplicándose los derechos de aduana y los gravámenes sobre las especias.", "Um cartaz de {0} dobrões licencia este navio por {1} dias sob patrulha do Estado da Índia. Continuam valendo os direitos alfandegários e as taxas sobre especiarias.", "{0}ダブロンの通行許可証により、この船はインド領国の哨戒下で{1}日間航行できます。関税と香辛料税は別途かかります。", "Ein Cartaz im Wert von {0} Dublonen berechtigt dieses Schiff unter den Patrouillen des Estado da Índia für {1} Tage zur Fahrt. Zölle und Gewürzabgaben fallen weiterhin an.", "Un cartaz coûtant {0} doublons autorise ce navire à naviguer pendant {1} jours sous les patrouilles de l'Estado da Índia. Les droits de douane et taxes sur les épices restent dus.", "Cartaz za {0} dublonów uprawnia ten statek do {1} dni żeglugi pod ochroną patroli Estado da Índia. Nadal obowiązują cła i opłaty od przypraw.", "一份價值{0}達布隆的通行許可證，可使該船在印度領國巡邏隊巡邏期間獲准航行{1}天。仍須繳納關稅和香料稅。", "더블룬 {0}닢짜리 카르타즈는 Estado da Índia 순찰 아래 이 선박에 {1}일간의 항해 면허를 부여합니다. 관세와 향신료 세금은 계속 부과됩니다."]],
    ["A bear that lives on grass and is built to digest it. Aristotle would object on several grounds, which makes the observation especially valuable.", ["一种以草为食、身体也适于消化草类的熊。亚里士多德会从多方面提出异议，因此这项观察格外珍贵。", "Медведь питается травой и приспособлен её переваривать. Аристотель нашёл бы этому несколько возражений, и потому наблюдение особенно ценно.", "Un oso que se alimenta de hierba y está adaptado para digerirla. Aristóteles pondría varias objeciones, lo que hace que esta observación sea especialmente valiosa.", "Um urso que se alimenta de capim e é adaptado para digeri-lo. Aristóteles teria várias objeções, o que torna esta observação especialmente valiosa.", "草を食べ、それを消化できる体を持つ熊。アリストテレスならいくつもの異論を唱えるだろう。だからこそ、この観察は貴重だ。", "Ein Bär, der Gras frisst und es verdauen kann. Aristoteles hätte daran einiges auszusetzen, was diese Beobachtung besonders wertvoll macht.", "Un ours qui se nourrit d'herbe et dont l'organisme est adapté à sa digestion. Aristote y trouverait plusieurs objections, ce qui rend cette observation particulièrement précieuse.", "Niedźwiedź żywi się trawą i jest przystosowany do jej trawienia. Arystoteles miałby kilka zastrzeżeń, przez co ta obserwacja jest szczególnie cenna.", "一種以草為食、身體也適於消化草類的熊。亞里斯多德會從多方面提出異議，因此這項觀察格外珍貴。", "풀을 먹고 소화하도록 몸이 발달한 곰입니다. 아리스토텔레스라면 여러 근거를 들어 반박했을 테니, 이 관찰은 특히 가치가 있습니다."]],
    ["A bird in formal plumage, marching over ice where no bird like it should survive.", ["一只羽衣华丽的鸟，在本不该有同类存活的冰面上行走。", "Птица в нарядном оперении шагает по льду, где ей, казалось бы, не выжить.", "Un ave de plumaje solemne camina sobre un hielo donde ninguna otra como ella debería sobrevivir.", "Uma ave de plumagem vistosa caminha sobre o gelo, onde nenhuma outra como ela deveria sobreviver.", "礼装のような羽毛をまとった鳥が、同類なら生き延びられないはずの氷上を歩いている。", "Ein Vogel in prächtigem Gefieder schreitet über Eis, auf dem kein Vogel seiner Art überleben sollte.", "Un oiseau au plumage d'apparat marche sur une glace où nul autre de son espèce ne devrait survivre.", "Ptak w okazałym upierzeniu kroczy po lodzie, na którym żaden podobny ptak nie powinien przetrwać.", "一隻羽衣華麗的鳥，在本不該有同類存活的冰面上行走。", "화려한 깃털을 두른 새가 같은 종은 살아남지 못할 법한 얼음 위를 걷고 있습니다."]],
    ["{0}'s court requires sufficient standing and ship strength. Standing {1}/{2}. Strength {3}/{4}.", ["{0}的宫廷要求声望和舰船实力达到标准。声望：{1}/{2}。舰船实力：{3}/{4}。", "Двор державы {0} требует достаточной репутации и силы корабля. Репутация: {1}/{2}. Сила: {3}/{4}.", "La corte de {0} exige suficiente reputación y potencia naval. Reputación: {1}/{2}. Potencia: {3}/{4}.", "A corte de {0} exige reputação e poder naval suficientes. Reputação: {1}/{2}. Poder: {3}/{4}.", "{0}の宮廷に認められるには、十分な評判と船の戦力が必要です。評判：{1}/{2}。戦力：{3}/{4}。", "Der Hof von {0} verlangt ein ausreichendes Ansehen und eine starke Schiffsbesatzung. Ansehen: {1}/{2}. Schiffsstärke: {3}/{4}.", "La cour de {0} exige une réputation et une puissance navale suffisantes. Réputation : {1}/{2}. Puissance : {3}/{4}.", "Dwór państwa {0} wymaga odpowiedniej reputacji i siły okrętu. Reputacja: {1}/{2}. Siła: {3}/{4}.", "{0}的宮廷要求聲望和艦船實力達到標準。聲望：{1}/{2}。艦船實力：{3}/{4}。", "{0}의 궁정은 충분한 평판과 함선 전력을 요구합니다. 평판: {1}/{2}. 전력: {3}/{4}."]],
    ["{0}'s extraordinary commission.", ["{0}的特别使命", "Особое поручение державы {0}", "Misión extraordinaria de {0}", "Missão especial de {0}", "{0}からの特別任務", "Sonderauftrag von {0}", "Mission spéciale de {0}", "Szczególna misja od {0}", "{0}的特別使命", "{0}의 특별 임무"]],
    ["{0}'s ministers receive your envoy. {1}; carry our sealed answer home.", ["{0}的大臣接见了你的使者。{1}；把我们密封的答复带回去。", "Министры державы {0} приняли вашего посланника. {1}; доставьте наш запечатанный ответ домой.", "Los ministros de {0} reciben a tu enviado. {1}; lleva nuestra respuesta sellada de vuelta.", "Os ministros de {0} recebem seu enviado. {1}; leve nossa resposta lacrada de volta.", "{0}の大臣が使節を迎えました。{1}。我々の封印された返書を持ち帰ってください。", "Die Minister von {0} empfangen Euren Gesandten. {1}; bringt unsere versiegelte Antwort zurück.", "Les ministres de {0} reçoivent votre envoyé. {1} ; rapportez notre réponse scellée.", "Ministrowie państwa {0} przyjmują twojego posła. {1}; dostarcz naszą zapieczętowaną odpowiedź.", "{0}的大臣接見了你的使者。{1}；把我們密封的答覆帶回去。", "{0}의 장관들이 사절을 맞이합니다. {1}. 봉인된 답변을 가져가세요."]],
    ["{0}. Carry the grain, and bring a nuncio to oversee its distribution.", ["{0}。带上谷物，并请一位教廷使节监督分发。", "{0}. Доставьте зерно и привезите нунция, который будет наблюдать за его распределением.", "{0}. Lleva el grano y trae a un nuncio para supervisar su distribución.", "{0}. Leve os grãos e traga um núncio para supervisionar a distribuição.", "{0}。穀物を運び、その配給を監督する教皇使節も同行させてください。", "{0}. Bringt das Getreide und nehmt einen Nuntius zur Aufsicht über die Verteilung mit.", "{0}. Transportez le grain et faites venir un nonce pour en superviser la distribution.", "{0}. Dostarcz zboże i sprowadź nuncjusza, który dopilnuje jego rozdania.", "{0}。帶上穀物，並請一位教廷使節監督分發。", "{0}. 곡물을 운반하고 배급을 감독할 교황대사도 함께 데려오세요."]],
    ["{0}'s coastal officers seek a captain to hunt the wokou reported near {1}. Sink or force their surrender, then return for {2} db. Pirates require no marque.", ["{0}的海岸官员正在招募船长，讨伐据报出没于{1}附近的倭寇。将其击沉或迫使其投降，再回来领取{2} DB。讨伐海盗无需私掠许可证。", "Береговые офицеры державы {0} ищут капитана для охоты на вокоу, замеченных у {1}. Потопите их или принудите к сдаче, затем возвращайтесь за {2} DB. Для борьбы с пиратами каперское свидетельство не требуется.", "Los oficiales costeros de {0} buscan un capitán para dar caza a los wokou avistados cerca de {1}. Húndelos o fuérzalos a rendirse y regresa por {2} DB. Para perseguir piratas no hace falta patente de corso.", "Os oficiais costeiros de {0} procuram um capitão para caçar os wokou avistados perto de {1}. Afunde-os ou force sua rendição e volte para receber {2} DB. Não é necessária carta de corso para combater piratas.", "{0}の沿岸官は、{1}付近で目撃された倭寇を討伐する船長を求めています。撃沈するか降伏させ、{2} DBを受け取りに戻ってください。海賊討伐に私掠免許状は不要です。", "Die Küstenbeamten von {0} suchen einen Kapitän, der die nahe {1} gesichteten Wokou jagt. Versenkt sie oder zwingt sie zur Aufgabe und kehrt dann für {2} DB zurück. Zur Jagd auf Piraten ist kein Kaperbrief nötig.", "Les officiers côtiers de {0} cherchent un capitaine pour traquer les wokou signalés près de {1}. Coulez-les ou forcez-les à se rendre, puis revenez toucher {2} DB. La lutte contre les pirates ne nécessite pas de lettre de marque.", "Urzędnicy przybrzeżni państwa {0} szukają kapitana do walki z wokou widzianymi w pobliżu {1}. Zatop ich lub zmusić do poddania się, a potem wróć po {2} DB. Do zwalczania piratów nie potrzeba listu kaperskiego.", "{0}的海岸官員正在招募船長，討伐據報出沒於{1}附近的倭寇。將其擊沉或迫使其投降，再回來領取{2} DB。討伐海盜無需私掠許可證。", "{0}의 해안 관리들이 {1} 근처에서 목격된 왜구를 토벌할 선장을 찾습니다. 침몰시키거나 항복시킨 뒤 {2} DB를 받으러 돌아오세요. 해적 토벌에는 사략 면허장이 필요 없습니다."]],
    ["{0}'s council seeks a captain to hunt the wokou raiding near {1}. Sink or force their surrender, then return for {2} db. Pirates require no marque.", ["{0}的评议会正在招募船长，讨伐侵扰{1}附近的倭寇。将其击沉或迫使其投降，再回来领取{2} DB。讨伐海盗无需私掠许可证。", "Совет державы {0} ищет капитана для борьбы с вокоу, совершающими набеги у {1}. Потопите их или принудите к сдаче, затем возвращайтесь за {2} DB. Для борьбы с пиратами каперское свидетельство не требуется.", "El consejo de {0} busca un capitán para dar caza a los wokou que atacan cerca de {1}. Húndelos o fuérzalos a rendirse y regresa por {2} DB. Para perseguir piratas no hace falta patente de corso.", "O conselho de {0} procura um capitão para caçar os wokou que atacam perto de {1}. Afunde-os ou force sua rendição e volte para receber {2} DB. Não é necessária carta de corso para combater piratas.", "{0}の評議会は、{1}付近を荒らす倭寇を討伐する船長を求めています。撃沈するか降伏させ、{2} DBを受け取りに戻ってください。海賊討伐に私掠免許状は不要です。", "Der Rat von {0} sucht einen Kapitän, der die nahe {1} plündernden Wokou jagt. Versenkt sie oder zwingt sie zur Aufgabe und kehrt dann für {2} DB zurück. Zur Jagd auf Piraten ist kein Kaperbrief nötig.", "Le conseil de {0} cherche un capitaine pour traquer les wokou qui pillent près de {1}. Coulez-les ou forcez-les à se rendre, puis revenez toucher {2} DB. La lutte contre les pirates ne nécessite pas de lettre de marque.", "Rada państwa {0} szuka kapitana do walki z wokou napadającymi w pobliżu {1}. Zatop ich lub zmusić do poddania się, a potem wróć po {2} DB. Do zwalczania piratów nie potrzeba listu kaperskiego.", "{0}的評議會正在招募船長，討伐侵擾{1}附近的倭寇。將其擊沉或迫使其投降，再回來領取{2} DB。討伐海盜無需私掠許可證。", "{0}의 평의회가 {1} 근처를 약탈하는 왜구를 토벌할 선장을 찾습니다. 침몰시키거나 항복시킨 뒤 {2} DB를 받으러 돌아오세요. 해적 토벌에는 사략 면허장이 필요 없습니다."]],
    ["{0}, cook", ["{0}，厨师", "{0}, повар", "{0}, cocinero", "{0}, cozinheiro", "{0}、料理人", "{0}, Koch", "{0}, cuisinier", "{0}, kucharz", "{0}，廚師", "{0}, 요리사"]],
    ["{0}, planter", ["{0}，种植园主", "{0}, плантатор", "{0}, plantador", "{0}, proprietário de plantação", "{0}、プランター農園主", "{0}, Plantagenbesitzer", "{0}, planteur", "{0}, plantator", "{0}，種植園主", "{0}, 농장주"]],
    ["{0}, adelantado", ["{0}，总督", "{0}, аделантадо", "{0}, adelantado", "{0}, adelantado", "{0}、アデランタード", "{0}, Adelantado", "{0}, adelantado", "{0}, adelantado", "{0}，總督", "{0}, 아델란타도"]],
    ["{0}, your family owes {1} doubloons, secured by the estate. At ten percent interest, time now works for me. {2}", ["{0}，你的家族以庄园作担保，欠我{1}枚达布隆。年息一成，拖得越久，我的收益越多。{2}", "{0}, ваша семья должна мне {1} дублонов под залог поместья. При десятипроцентном годовом проценте промедление играет мне на руку. {2}", "{0}, tu familia me debe {1} doblones, garantizados por la hacienda. Con un interés del diez por ciento anual, cuanto más pase el tiempo, más gano yo. {2}", "{0}, sua família me deve {1} dobrões, garantidos pela propriedade. Com juros anuais de dez por cento, quanto mais o tempo passa, mais ganho. {2}", "{0}、あなたの家族は農園を担保に{1}ダブロンを借りています。年利10%ですから、時間が経つほど私に有利です。{2}", "{0}, Eure Familie schuldet mir {1} Dublonen, abgesichert durch den Familienbesitz. Bei zehn Prozent Jahreszins spielt die Zeit nun mir in die Hände. {2}", "{0}, votre famille me doit {1} doublons, garantis par le domaine. Avec un intérêt annuel de dix pour cent, le temps joue désormais en ma faveur. {2}", "{0}, twoja rodzina jest mi winna {1} dublonów, pod zastaw majątku. Przy dziesięcioprocentowym oprocentowaniu każdy upływ czasu działa na moją korzyść. {2}", "{0}，你的家族以莊園作擔保，欠我{1}枚達布隆。年息一成，拖得越久，我的收益越多。{2}", "{0}님, 귀하의 가족은 재산을 담보로 제게 더블룬 {1}닢을 빚지고 있습니다. 연이율 10%이므로 시간이 흐를수록 제게 유리합니다. {2}"]],
    ["{0} WITHDRAWS THE PAPAL DECREE IN FAVOUR OF {1}", ["{0}撤回支持{1}的教宗诏令", "{0} ОТМЕНЯЕТ ПАПСКИЙ УКАЗ В ПОЛЬЗУ {1}", "{0} RETIRA EL DECRETO PAPAL A FAVOR DE {1}", "{0} REVOGA O DECRETO PAPAL A FAVOR DE {1}", "{0}が{1}を支持する教皇令を撤回", "{0} ZIEHT DAS PÄPSTLICHE DEKRET ZUGUNSTEN VON {1} ZURÜCK", "{0} RETIRE LE DÉCRET PONTIFICAL EN FAVEUR DE {1}", "{0} WYCOFUJE DEKRET PAPIESKI NA RZECZ {1}", "{0}撤回支持{1}的教宗詔令", "{0}이(가) {1}을(를) 지지하는 교황령을 철회합니다"]],
    ["{0} SECURED +{1} WHALE BLUBBER", ["{0}已取得 +{1} 鲸脂", "{0} ДОБЫТО: +{1} ЕД. КИТОВОГО ЖИРА", "{0} OBTENIDO: +{1} DE GRASA DE BALLENA", "{0} OBTIDO: +{1} DE ÓLEO DE BALEIA", "{0}確保：鯨脂+{1}", "{0} ERBEUTET: +{1} WALTRAN", "{0} RÉCUPÉRÉ : +{1} DE GRAISSE DE BALEINE", "{0} POZYSKANO: +{1} TRANU WIELORYBIEGO", "{0}已取得 +{1} 鯨脂", "{0} 확보: 고래기름 +{1}"]],
    ["CARGO HOLD FULL", ["货舱已满", "ТРЮМ ПОЛОН", "BODEGA LLENA", "PORÃO CHEIO", "貨物倉が満杯", "LADERAUM VOLL", "CALE PLEINE", "ŁADOWNIA PEŁNA", "貨艙已滿", "화물칸 가득 참"]],
    ["{0} CARGO HOLD FULL", ["{0}货舱已满", "{0}: ТРЮМ ПОЛОН", "BODEGA DE {0} LLENA", "PORÃO DE {0} CHEIO", "{0}の貨物倉が満杯", "LADERAUM VON {0} VOLL", "CALE DE {0} PLEINE", "ŁADOWNIA {0} PEŁNA", "{0}貨艙已滿", "{0} 화물칸 가득 참"]],
    ["CAUGHT {0} {1} CARGO HOLD FULL", ["捕获{0} {1}，货舱已满", "ПОЙМАН {0} {1}: ТРЮМ ПОЛОН", "CAPTURADO: {0} {1}. BODEGA LLENA", "CAPTURADO: {0} {1}. PORÃO CHEIO", "{0} {1}を捕獲。貨物倉が満杯", "{0} {1} GEFANGEN: LADERAUM VOLL", "{0} {1} CAPTURÉ : CALE PLEINE", "ZŁOWIONO {0} {1}: ŁADOWNIA PEŁNA", "捕獲{0} {1}，貨艙已滿", "{0} {1} 포획: 화물칸 가득 참"]],
    ["TRAPPED BEAVER CARGO HOLD FULL", ["捕获海狸，货舱已满", "ПОЙМАН БОБР: ТРЮМ ПОЛОН", "CASTOR ATRAPADO: BODEGA LLENA", "CASTOR PRESO: PORÃO CHEIO", "ビーバーを捕獲。貨物倉が満杯", "BIBER GEFANGEN: LADERAUM VOLL", "CASTOR CAPTURÉ : CALE PLEINE", "ZŁOWIONO BOBRA: ŁADOWNIA PEŁNA", "捕獲海狸，貨艙已滿", "비버 포획: 화물칸 가득 참"]],
    ["{0} TAKEN CARGO HOLD FULL", ["捕获{0}，货舱已满", "ДОБЫТО {0}: ТРЮМ ПОЛОН", "{0} OBTENIDO: BODEGA LLENA", "{0} OBTIDO: PORÃO CHEIO", "{0}を捕獲。貨物倉が満杯", "{0} ERBEUTET: LADERAUM VOLL", "{0} OBTENU : CALE PLEINE", "ZDOBYTO {0}: ŁADOWNIA PEŁNA", "捕獲{0}，貨艙已滿", "{0} 획득: 화물칸 가득 참"]],
    ["SPECIES EXTINCT: {species}  CARGO HOLD FULL", ["该物种已灭绝：{species}  货舱已满", "ВИД ИСТРЕБЛЁН: {species}  ТРЮМ ПОЛОН", "ESPECIE EXTINTA: {species}  BODEGA LLENA", "ESPÉCIE EXTINTA: {species}  PORÃO CHEIO", "種が絶滅：{species}  貨物倉が満杯", "ART AUSGEROTTET: {species}  LADERAUM VOLL", "ESPÈCE ÉTEINTE : {species}  CALE PLEINE", "GATUNEK WYGINĄŁ: {species}  ŁADOWNIA PEŁNA", "物種已滅絕：{species}  貨艙已滿", "종 멸종: {species}  화물칸 가득 참"]],
    ["{0} have banned merchandise from {1}", ["{0} 禁止销售来自 {1} 的商品", "{0} запретили торговлю товарами из {1}", "{0} ha prohibido comerciar con mercancías de {1}", "{0} proibiu o comércio de mercadorias de {1}", "{0} は {1} 産品の取引を禁止しました", "{0} hat den Handel mit Waren aus {1} verboten", "{0} a interdit le commerce des marchandises de {1}", "{0} zakazał handlu towarami z {1}", "{0} 禁止販售來自 {1} 的商品", "{0}은(는) {1}산 상품의 거래를 금지했습니다"]],
    ["{0} is ready to attend the ruler's court at {1}.", ["{0} 已准备好前往{1}的君主宫廷。", "{0} готовится ко двору правителя в {1}.", "{0} está listo para presentarse ante el soberano en {1}.", "{0} está pronto para comparecer à corte do soberano em {1}.", "{0} は{1}の君主の宮廷へ参内する準備ができています。", "{0} ist bereit, am Herrscherhof in {1} vorzusprechen.", "{0} est prêt à se présenter à la cour du souverain à {1}.", "{0} jest gotowy stawić się na dworze władcy w {1}.", "{0} 已準備好前往{1}的君主宮廷。", "{0}이(가) {1}의 군주 궁정에 출두할 준비가 되었습니다."]],
    ["{0} has taken power in {1}. The harbor watch waits to see whether port policy will change.", ["{0} 已在{1}掌权。港口守望者正留意港口政策是否会改变。", "{0} пришел к власти в {1}. Портовая стража следит, изменится ли политика порта.", "{0} ha tomado el poder en {1}. La guardia portuaria espera a ver si cambia la política del puerto.", "{0} assumiu o poder em {1}. A guarda portuária aguarda para ver se a política do porto mudará.", "{0} が{1}で権力を握りました。港の番人は港湾政策が変わるか見守っています。", "{0} hat in {1} die Macht übernommen. Die Hafenwache wartet ab, ob sich die Hafenpolitik ändert.", "{0} a pris le pouvoir à {1}. La garde du port attend de voir si la politique portuaire changera.", "{0} przejął władzę w {1}. Straż portowa czeka, czy zmieni się polityka portu.", "{0} 已在{1}掌權。港口守望者正留意港口政策是否會改變。", "{0}이(가) {1}에서 권력을 잡았습니다. 항만 경비대는 항만 정책이 바뀌는지 지켜봅니다."]],
    ["{0} is freed from {1}'s rule.", ["{0} 摆脱了 {1} 的统治。", "{0} освобожден от власти {1}.", "{0} queda libre del dominio de {1}.", "{0} se libertou do domínio de {1}.", "{0} は{1}の支配から解放されました。", "{0} ist von der Herrschaft {1}s befreit.", "{0} est libéré de la domination de {1}.", "{0} uwolnił się spod władzy {1}.", "{0} 擺脫了 {1} 的統治。", "{0}이(가) {1}의 지배에서 벗어났습니다."]],
    ["A stolen chest is waiting for us in {0}. Collect it from the waterfront between eight at night and five in the morning, then bring it here for {1} doubloons. Keep it quiet.", ["{0} 有一只赃箱等着我们。晚上八点至凌晨五点在海滨取货，再带到这里可领取{1}达布隆。此事务必保密。", "В {0} нас ждёт краденый сундук. Заберите его на набережной с восьми вечера до пяти утра и доставьте сюда за {1} дублонов. Соблюдайте тишину.", "En {0} nos espera un cofre robado. Recógelo en el muelle entre las ocho de la noche y las cinco de la mañana, y tráelo aquí por {1} doblones. No hagas ruido.", "Há um baú roubado à nossa espera em {0}. Pegue-o no cais entre as oito da noite e as cinco da manhã e traga-o aqui por {1} dobrões. Mantenha discrição.", "{0} に盗品の箱が届いています。夜8時から朝5時の間に波止場で受け取り、ここへ運べば{1}ダブロンを支払います。内密に。", "In {0} wartet eine gestohlene Truhe auf uns. Holt sie zwischen acht Uhr abends und fünf Uhr morgens am Kai ab und bringt sie für {1} Dublonen hierher. Haltet die Sache geheim.", "Un coffre volé nous attend à {0}. Récupérez-le sur le quai entre vingt heures et cinq heures du matin, puis rapportez-le ici contre {1} doublons. Restez discret.", "W {0} czeka na nas skradziona skrzynia. Odbierz ją na nabrzeżu między ósmą wieczorem a piątą rano i przynieś tutaj za {1} dublonów. Zachowaj dyskrecję.", "{0} 有一只贓箱等著我們。晚上八點至凌晨五點在海濱取貨，再帶到這裡可領取{1}達布隆。務必保密。", "{0}에 도난품 상자가 우리를 기다립니다. 밤 8시부터 새벽 5시 사이 부두에서 찾아 더블룬 {1}닢을 받고 여기로 가져오세요. 비밀을 지키세요."]],
...
function reviewedAdditionalMeaningOverrides() {
  const entries = [
    ["An expedition seeking the Sierra de la Plata needs a fort on the Paraguay. The Cario Guarani control these banks; survival requires their cooperation.", ["寻找拉普拉塔山的探险队需要在巴拉圭河畔建一座堡垒。卡里奥瓜拉尼人控制着这些河岸；要生存下去，就必须得到他们的合作。", "Экспедиции на поиски Сьерра-де-ла-Плата нужна крепость на реке Парагвай. Эти берега принадлежат карио-гуарани; без их помощи не выжить.", "La expedición que busca la Sierra de la Plata necesita un fuerte junto al río Paraguay. Los carios guaraníes controlan estas riberas; sobrevivir exige su cooperación.", "A expedição em busca da Serra da Prata precisa de um forte às margens do rio Paraguai. Os Cario Guarani controlam essas margens; sobreviver exige sua cooperação.", "シエラ・デ・ラ・プラタを探す遠征には、パラグアイ川沿いの砦が必要だ。この川岸を支配するカリオ・グアラニの協力なしに生き延びることはできない。", "Die Expedition auf der Suche nach der Sierra de la Plata braucht eine Festung am Paraguay. Die Cario-Guarani beherrschen diese Ufer; ohne ihre Hilfe ist ein Überleben unmöglich.", "L’expédition en quête de la Sierra de la Plata a besoin d’un fort sur les rives du Paraguay. Les Cario Guarani contrôlent ces rives ; leur coopération est indispensable à sa survie.", "Wyprawa w poszukiwaniu Sierra de la Plata potrzebuje fortu nad Paragwajem. Cario Guarani kontrolują te brzegi; ich współpraca jest niezbędna do przetrwania.", "尋找拉普拉塔山的探險隊需要在巴拉圭河畔建一座堡壘。卡里奧瓜拉尼人控制著這些河岸；要生存下去，就必須得到他們的合作。", "시에라 데 라 플라타를 찾는 원정대에는 파라과이강의 요새가 필요합니다. 카리오 과라니족이 이 강변을 지배하므로, 살아남으려면 그들의 협력이 필요합니다。"]],
    ["An attack would be lawful under your {0} embargo commission.", ["依据你的{0}禁运授权，发动攻击将属合法。", "По вашему разрешению на эмбарго «{0}» нападение будет законным.", "El ataque sería legal al amparo de tu patente de corso contra {0}.", "O ataque seria legal ao abrigo da sua comissão de embargo contra {0}.", "あなたの{0}向け通商停止許可状があれば、攻撃は合法となる。", "Ein Angriff wäre aufgrund Eures Kaperbriefs gegen {0} rechtmäßig.", "Votre commission d’embargo contre {0} rendrait cette attaque légale.", "Atak byłby zgodny z prawem na mocy Twojego listu kaperskiego przeciwko {0}.", "依據你的{0}禁運授權，發動攻擊將屬合法。", "{0}에 대한 금수 허가장이 있으면 공격은 합법입니다."]],
    ["admit our merchants under Joseon's licensed-port rules", ["按照朝鲜王朝的许可港规接纳我国商人", "Допустить наших купцов в соответствии с правилами лицензированных портов государства Чосон", "admitir a nuestros comerciantes conforme a las normas de puertos autorizados de Joseon", "admitir nossos comerciantes segundo as regras dos portos licenciados de Joseon", "朝鮮王朝の認可港規則に従い、我が国の商人を受け入れてください", "Unsere Händler gemäß den Regeln für lizenzierte Häfen Joseons zulassen", "admettre nos marchands conformément aux règles des ports autorisés de Joseon", "dopuścić naszych kupców zgodnie z zasadami licencjonowanych portów Joseon", "按照朝鮮王朝的許可港規接納我國商人", "조선 왕조의 허가항 규정에 따라 우리 상인을 받아들이다"]],
    ["A sperm whale stove in your hull.", ["抹香鲸撞破了你的船壳。", "Кашалот проломил борт вашего корабля.", "Un cachalote abrió un boquete en el casco de tu barco.", "Um cachalote abriu um rombo no casco do seu navio.", "マッコウクジラが船体に穴を開けました。", "Ein Pottwal hat Euren Schiffsrumpf eingedrückt.", "Un cachalot a défoncé la coque de votre navire.", "Kaszalot roztrzaskał burtę statku.", "抹香鯨撞破了你的船殼。", "향유고래가 배의 선체를 들이받아 부쉈습니다."]],
    ["A storm is working nearby. Check every line before departure.", ["附近风暴正在形成。启航前检查每根绳索。", "Поблизости бушует шторм. Перед отплытием проверьте все снасти.", "Se acerca una tormenta. Revisa todos los cabos antes de zarpar.", "Uma tempestade se aproxima. Confira todos os cabos antes de zarpar.", "近くで嵐が迫っています。出航前に索具を一つずつ確認してください。", "Ein Sturm zieht auf. Prüft vor der Abfahrt alle Leinen.", "Une tempête approche. Vérifiez tous les cordages avant le départ.", "W pobliżu nadciąga sztorm. Przed wypłynięciem sprawdź wszystkie liny.", "附近風暴正在形成。啟航前檢查每根繩索。", "근처에 폭풍이 다가옵니다. 출항 전에 모든 밧줄을 확인하세요."]],
    ["A storm makes equals of proud captains and cautious ones.", ["风暴面前，骄傲的船长和谨慎的船长并无分别。", "Перед штормом все равны — и гордые капитаны, и осторожные.", "La tormenta iguala a los capitanes orgullosos y a los prudentes.", "A tempestade iguala capitães orgulhosos e cautelosos.", "嵐の前では、誇り高い船長も慎重な船長も同じです。", "Ein Sturm macht stolze und vorsichtige Kapitäne gleich.", "La tempête met sur un pied d'égalité les capitaines fiers et les prudents.", "Burza zrównuje dumnych i ostrożnych kapitanów.", "風暴面前，驕傲的船長和謹慎的船長並無分別。", "폭풍 앞에서는 자만한 선장도 신중한 선장도 다를 바 없습니다."]],
    ["a stockade, storehouses, and storm repairs", ["栅栏、仓库和风暴后的修缮", "Частокол, склады и ремонт после шторма", "una empalizada, almacenes y reparaciones tras la tormenta", "uma paliçada, armazéns e reparos após a tempestade", "柵、倉庫、嵐の後の修繕", "Palisadenanlage, Lagerhäuser und Reparaturen nach dem Sturm", "une palissade, des entrepôts et des réparations après la tempête", "palisada, magazyny i naprawy po sztormie", "柵欄、倉庫和風暴後的修繕", "방책, 창고, 폭풍 후 수리"]],
    ["a sturdy coastal working boat whose handy lug sail and useful hold descend from the fishing craft that kept Europe's ports supplied", ["一艘坚固的沿海作业船，配有实用的斜桁帆和货舱，承袭自曾为欧洲港口供货的渔船。", "Прочное прибрежное рабочее судно с удобным рейковым парусом и вместительным трюмом, унаследованными от рыбацких лодок, снабжавших порты Европы.", "Un robusto barco de trabajo costero, con vela al tercio y bodega útil, descendiente de las embarcaciones pesqueras que abastecían los puertos europeos.", "Um robusto barco de trabalho costeiro, com vela de lug e porão útil, descendente das embarcações de pesca que abasteciam os portos europeus.", "ヨーロッパの港に物資を届けていた漁船を受け継ぐ、頑丈な沿岸作業船です。扱いやすいラグセイルと実用的な船倉を備えています。", "Ein robustes Küstenarbeitsboot mit praktischem Luggersegel und Laderaum, hervorgegangen aus den Fischerbooten, die Europas Häfen versorgten.", "Un robuste caboteur doté d'une voile au tiers pratique et d'une cale utile, issu des bateaux de pêche qui approvisionnaient les ports d'Europe.", "Solidna przybrzeżna łódź robocza z praktycznym żaglem rozprzowym i ładownią, wywodząca się z łodzi rybackich zaopatrujących europejskie porty.", "一艘堅固的沿海作業船，配有實用的斜桁帆和貨艙，承襲自曾為歐洲港口供貨的漁船。", "유럽 항구에 물자를 대던 어선에서 유래한 튼튼한 연안 작업선입니다. 다루기 쉬운 러그 돛과 실용적인 화물칸을 갖췄습니다."]],
    ["a towering island merchant, built with a deep cargo hull, canted sails, and twin quarter rudders for the long monsoon passages of Southeast Asia", ["一艘高大的岛屿商船，配有深载货船体、斜帆和双侧舵，适合东南亚漫长的季风航程。", "Высокий островной торговый корабль с глубоким грузовым корпусом, наклонными парусами и парой кормовых рулей, предназначенный для долгих муссонных переходов в Юго-Восточной Азии.", "Un imponente mercante insular, con casco de gran capacidad, velas inclinadas y dos timones laterales, hecho para las largas travesías monzónicas del Sudeste Asiático.", "Um imponente navio mercante insular, com casco de grande capacidade, velas inclinadas e dois lemes laterais, feito para as longas travessias de monção do Sudeste Asiático.", "東南アジアの長い季節風航路に適した大型の島嶼商船。深い船倉、傾斜した帆、左右一対の船尾舵を備えています。", "Ein hochbordiges Inselschiff für den Handel mit tiefem Frachtrumpf, schrägen Segeln und zwei Seitenrudern, gebaut für die langen Monsunfahrten Südostasiens.", "Un grand navire marchand insulaire doté d'une cale profonde, de voiles inclinées et de deux gouvernails latéraux, conçu pour les longues traversées de mousson en Asie du Sud-Est.", "Wysoki statek handlowy z wysp, z głębokim kadłubem ładunkowym, ukośnymi żaglami i dwoma sterami bocznymi, przeznaczony do długich rejsów monsunowych w Azji Południowo-Wschodniej.", "一艘高大的島嶼商船，配有深載貨船體、斜帆和雙側舵，適合東南亞漫長的季風航程。", "깊은 화물 선체와 기울어진 돛, 양쪽 선미에 단 쌍타를 갖춘 대형 도서 무역선입니다. 동남아시아의 긴 계절풍 항해에 적합합니다."]],
    ["A tireless pack hunter of African grasslands.", ["非洲草原上的不倦群猎者。", "Неутомимый стайный хищник африканских саванн.", "Un incansable cazador que vive y caza en manada en las praderas africanas.", "Um incansável predador que caça em bandos nas savanas africanas.", "アフリカの草原で群れをなして狩る、疲れ知らずの捕食者。", "Ein ausdauernder Rudeljäger in den afrikanischen Savannen.", "Un infatigable prédateur qui chasse en meute dans les prairies africaines.", "Niestrudzony drapieżnik polujący w stadzie na afrykańskich równinach.", "非洲草原上的不倦群獵者。", "아프리카 초원에서 무리 지어 사냥하는 지칠 줄 모르는 포식자입니다."]],
    ["a versatile Chinese junk, large enough for regional commerce yet handier in shoal water and river mouths than the great ocean carriers", ["一种多用途的中国帆船，足以承担区域贸易，在浅滩和河口也比大型远洋船灵活。", "Универсальная китайская джонка, достаточно большая для региональной торговли, но более манёвренная на мелководье и в устьях рек, чем крупные океанские суда.", "Un junco chino versátil, lo bastante grande para el comercio regional y más maniobrable en aguas someras y desembocaduras que los grandes buques oceánicos.", "Um junco chinês versátil, grande o bastante para o comércio regional e mais ágil em águas rasas e estuários que os grandes navios oceânicos.", "地域交易に十分な大きさがありながら、浅瀬や河口では大型外洋船より扱いやすい、多用途の中国式ジャンク船。", "Eine vielseitige chinesische Dschunke, groß genug für den regionalen Handel und in Untiefen und Flussmündungen wendiger als große Hochseeschiffe.", "Une jonque chinoise polyvalente, assez grande pour le commerce régional mais plus maniable que les grands navires océaniques dans les hauts-fonds et les estuaires.", "Wszechstronna chińska dżonka, dość duża do handlu regionalnego, a zarazem zwrotniejsza od wielkich statków oceanicznych na płyciznach i przy ujściach rzek.", "一種多用途的中國帆船，足以承擔區域貿易，在淺灘和河口也比大型遠洋船靈活。", "지역 무역에 충분히 크면서도 얕은 여울과 강어귀에서는 대형 원양선보다 다루기 쉬운 다목적 중국 정크선입니다."]],
    ["A tiny striped hoarder of North American woodlands.", ["一种北美林地的小型条纹囤粮动物。", "Маленький полосатый зверёк, запасливый обитатель лесов Северной Америки.", "Una pequeña ardilla listada de los bosques norteamericanos que almacena comida.", "Um pequeno esquilo listrado das florestas norte-americanas, que costuma guardar alimento.", "北米の森にすむ、小さくて縞模様の食べ物を蓄える動物。", "Ein kleines gestreiftes Tier aus nordamerikanischen Wäldern, das Nahrungsvorräte anlegt.", "Un petit rongeur rayé des forêts d'Amérique du Nord, qui fait des réserves.", "Mały pasiasty gryzoń z lasów Ameryki Północnej, który gromadzi zapasy.", "一種北美林地的小型條紋囤糧動物。", "북미 숲에 사는 작고 줄무늬가 있으며 먹이를 모아 두는 동물입니다."]],
    ["A warrant is only paper. I shall deny every word on it.", ["手令只是一张纸。我会否认上面写的一切。", "Ордер — всего лишь бумага. Я отрицаю каждое его слово.", "Una orden no es más que un papel. Negaré todo lo que ponga.", "Um mandado é só papel. Vou negar tudo o que estiver escrito nele.", "令状などただの紙だ。書かれたことはすべて否定してみせる。", "Ein Haftbefehl ist nur ein Stück Papier. Ich werde alles darin abstreiten.", "Un mandat n'est qu'un bout de papier. Je nierai tout ce qui y est écrit.", "Nakaz to tylko papier. Zaprzeczę wszystkiemu, co w nim napisano.", "手令只是一張紙。我會否認上面寫的一切。", "영장 따위는 종이일 뿐입니다. 거기에 적힌 내용은 모두 부인하겠습니다."]],
    ["A warrant to capture a port already awaits your answer. Ask about other commissions at the inn.", ["占领港口的军令已等候你答复。若想接其他任务，可去旅店打听。", "Приказ захватить порт уже ждёт вашего ответа. О других поручениях спросите на постоялом дворе.", "La orden para tomar un puerto ya espera tu respuesta. Pregunta en la posada por otras misiones.", "A ordem para tomar um porto já aguarda sua resposta. Pergunte na estalagem sobre outras missões.", "港を攻略する命令への返答を待っています。他の任務については宿屋で尋ねてください。", "Der Befehl zur Eroberung eines Hafens wartet bereits auf Eure Antwort. Erkundigt Euch im Gasthaus nach weiteren Aufträgen.", "L'ordre de prendre un port attend déjà votre réponse. Renseignez-vous sur les autres missions à l'auberge.", "Rozkaz zajęcia portu czeka już na twoją odpowiedź. O inne misje zapytaj w gospodzie.", "佔領港口的軍令已等候你答覆。若想接其他任務，可去旅店打聽。", "항구 점령 명령이 이미 답변을 기다리고 있습니다. 다른 임무는 여관에서 문의하세요."]],
    ["A white mountain ruling one of the world's deepest roads. Trace the gorge beneath it; mountain and passage explain one another.", ["一座白山俯临着世界上最深的峡谷道路之一。沿山下峡谷描绘路线；山与通道彼此映照。", "Белая гора возвышается над дорогой, проложенной по одному из глубочайших ущелий мира. Проследите ущелье у её подножия: гора и проход дополняют друг друга.", "Una montaña blanca domina una ruta que atraviesa uno de los desfiladeros más profundos del mundo. Traza el cañón a sus pies: la montaña y el paso se explican mutuamente.", "Uma montanha branca domina uma estrada por um dos desfiladeiros mais profundos do mundo. Trace o cânion abaixo; a montanha e a passagem se explicam mutuamente.", "世界有数の深い峡谷を通る道を見下ろす白い山です。その下の峡谷をたどってください。山と道は互いを物語っています。", "Ein weißer Berg über einer Straße, die durch eine der tiefsten Schluchten der Welt führt. Zeichnen Sie die Schlucht darunter nach; Berg und Weg gehören zusammen.", "Une montagne blanche domine une route qui traverse l'un des plus profonds canyons du monde. Suivez la gorge en contrebas : la montagne et le passage se répondent.", "Biała góra góruje nad drogą biegnącą przez jeden z najgłębszych wąwozów świata. Zaznacz wąwóz u jej stóp; góra i przełęcz uzupełniają się.", "一座白山俯臨著世界上最深的峽谷道路之一。沿山下峽谷描繪路線；山與通道彼此映照。", "세계에서 가장 깊은 협곡 중 하나를 지나는 길 위로 하얀 산이 솟아 있습니다. 산 아래 협곡을 그려 보세요. 산과 길은 서로를 설명합니다."]],
    ["A year ago they called this empire untouchable. Now Cuzco answers to the Crown, and even the royal accountants have surrendered. You kept faith with me, Captain. Here is the share I promised.", ["一年前，他们还称这个帝国不可撼动。如今库斯科已臣服王室，连王室会计也投降了。船长，你一直忠于我。这是我答应给你的那一份。", "Год назад эту империю считали непобедимой. Теперь Куско подчиняется Короне, и даже королевские счетоводы сдались. Капитан, вы не предали меня. Вот обещанная вам доля.", "Hace un año llamaban invencible a este imperio. Ahora Cuzco responde ante la Corona e incluso sus contadores reales se han rendido. Cumpliste tu palabra, capitán. Aquí tienes la parte que te prometí.", "Há um ano chamavam este império de invencível. Agora Cuzco responde à Coroa, e até os contadores reais se renderam. Você me foi leal, capitão. Aqui está a parte que prometi.", "一年前、この帝国は誰にも屈しないと言われていました。今やクスコは王室に従い、王室の会計方まで降伏しました。船長、あなたは私への義理を貫きました。約束の取り分です。", "Vor einem Jahr galt dieses Reich als unbezwingbar. Jetzt untersteht Cuzco der Krone, und selbst die königlichen Rechnungsführer haben kapituliert. Ihr seid mir treu geblieben, Kapitän. Hier ist der versprochene Anteil.", "Il y a un an, on disait cet empire invincible. À présent, Cuzco obéit à la Couronne, et même les comptables royaux se sont rendus. Vous m'êtes resté fidèle, capitaine. Voici la part promise.", "Rok temu nazywano to imperium niezwyciężonym. Teraz Cuzco podlega Koronie, a poddali się nawet królewscy rachmistrzowie. Dochowałeś mi wierności, kapitanie. Oto obiecana część.", "一年前，他們還稱這個帝國不可撼動。如今庫斯科已臣服王室，連王室會計也投降了。船長，你一直忠於我。這是我答應給你的那一份。", "1년 전만 해도 이 제국은 누구도 건드릴 수 없다고 했습니다. 이제 쿠스코는 왕실에 복종하고 왕실 회계관들마저 항복했습니다. 선장님은 제게 끝까지 충성을 지켰습니다. 약속한 몫을 드리겠습니다."]],
    ["Ah, {0}. I kept the account warm while you were away. Interest added {1} doubloons, bringing the balance to {2}. The sea may ignore calendars. I do not.", ["啊，{0}。你不在时，我一直替你看着账目。利息又添了{1}达布隆，余额现为{2}。海上或许不看日历，我可看。", "Ах, {0}. Пока вас не было, счёт не простаивал. Проценты добавили {1} дублонов, теперь долг составляет {2}. Море может не считаться с календарём, а я считаюсь.", "Ah, {0}. Tu cuenta siguió acumulando intereses mientras estabas fuera: {1} doblones más, para un saldo de {2}. El mar podrá ignorar el calendario; yo no.", "Ah, {0}. Sua dívida continuou rendendo juros enquanto você esteve fora: mais {1} dobrões, elevando o saldo a {2}. O mar pode ignorar o calendário; eu não.", "やあ、{0}。留守の間も勘定は止まりませんでした。利息が{1}ダブロン加わり、残高は{2}です。海は暦を気にしないでしょうが、私は気にします。", "Ah, {0}. Euer Konto lief weiter, während Ihr fort wart. Die Zinsen erhöhten den Saldo um {1} Dublonen auf {2}. Das Meer mag den Kalender ignorieren. Ich tue es nicht.", "Ah, {0}. Votre compte n'est pas resté inactif pendant votre absence : {1} doublons d'intérêts en plus, pour un solde de {2}. La mer ignore peut-être le calendrier. Moi, non.", "Ach, {0}. Podczas twojej nieobecności odsetki dopisały {1} dublonów, więc saldo wynosi teraz {2}. Morze może nie liczyć dni. Ja liczę.", "啊，{0}。你不在時，我一直替你看著帳目。利息又添了{1}達布隆，餘額現為{2}。海上或許不看日曆，我可看。", "아, {0}. 자리를 비운 동안에도 이자는 계속 붙었습니다. 더블룬 {1}닢이 더해져 잔액은 {2}입니다. 바다는 달력을 무시해도 저는 아닙니다."]],
    ["a working bank of oars", ["一排可用的船桨", "Рабочий ряд вёсел", "una bancada de remos en funcionamiento", "uma bancada de remos em funcionamento", "現役のオール一列", "eine einsatzbereite Ruderbank", "un banc de rameurs opérationnel", "sprawny rząd wioseł", "一排可用的船槳", "사용 가능한 노 한 줄"]],
    ["a workmanlike Ottoman coastal trader with a hooked bow, built to carry cargo between the Marmara, the Aegean, and the Black Sea", ["一艘实用的奥斯曼沿海商船，船首上翘，负责在马尔马拉海、爱琴海与黑海之间运货。", "Практичное османское прибрежное торговое судно с загнутым носом, предназначенное для перевозки грузов между Мраморным, Эгейским и Чёрным морями.", "Un práctico buque mercante otomano de cabotaje, con proa curvada, construido para transportar carga entre el Mármara, el Egeo y el mar Negro.", "Um prático navio mercante costeiro otomano, de proa curva, construído para transportar carga entre o mar de Mármara, o Egeu e o mar Negro.", "船首が反り上がった実用的なオスマン沿岸商船。マルマラ海、エーゲ海、黒海の間で貨物を運びます。", "Ein zweckmäßiges osmanisches Küstenhandelsschiff mit gebogenem Bug, gebaut für den Frachtverkehr zwischen Marmarameer, Ägäis und Schwarzem Meer.", "Un caboteur ottoman robuste à la proue recourbée, conçu pour transporter des marchandises entre la mer de Marmara, la mer Égée et la mer Noire.", "Praktyczny osmański statek handlowy o zakrzywionym dziobie, zbudowany do przewozu ładunków między Morzem Marmara, Egejskim i Czarnym.", "一艘實用的鄂圖曼沿海商船，船首上翹，負責在馬爾馬拉海、愛琴海與黑海之間運貨。", "갈고리처럼 휜 뱃머리를 지닌 실용적인 오스만 연안 무역선입니다. 마르마라해와 에게해, 흑해 사이로 화물을 운반합니다."]],
    ["A year ago they called this empire untouchable. Now Cuzco answers to the Crown, and even the royal accountants have surrendered. You kept faith with me, Captain. Here is the share I promised.", ["一年前，他们还称这个帝国不可撼动。如今库斯科已臣服王室，连王室会计也投降了。船长，你一直忠于我。这是我答应给你的那一份。", "Год назад эту империю считали непобедимой. Теперь Куско подчиняется Короне, и даже королевские счетоводы сдались. Капитан, вы не предали меня. Вот обещанная вам доля.", "Hace un año llamaban invencible a este imperio. Ahora Cuzco responde ante la Corona e incluso sus contadores reales se han rendido. Cumpliste tu palabra, capitán. Aquí tienes la parte que te prometí.", "Há um ano chamavam este império de invencível. Agora Cuzco responde à Coroa, e até os contadores reais se renderam. Você me foi leal, capitão. Aqui está a parte que prometi.", "一年前、この帝国は誰にも屈しないと言われていました。今やクスコは王室に従い、王室の会計方まで降伏しました。船長、あなたは私への義理を貫きました。約束の取り分です。", "Vor einem Jahr galt dieses Reich als unbezwingbar. Jetzt untersteht Cuzco der Krone, und selbst die königlichen Rechnungsführer haben kapituliert. Ihr seid mir treu geblieben, Kapitän. Hier ist der versprochene Anteil.", "Il y a un an, on disait cet empire invincible. À présent, Cuzco obéit à la Couronne, et même les comptables royaux se sont rendus. Vous m'êtes resté fidèle, capitaine. Voici la part promise.", "Rok temu nazywano to imperium niezwyciężonym. Teraz Cuzco podlega Koronie, a poddali się nawet królewscy rachmistrzowie. Dochowałeś mi wierności, kapitanie. Oto obiecana część.", "一年前，他們還稱這個帝國不可撼動。如今庫斯科已臣服王室，連王室會計也投降了。船長，你一直忠於我。這是我答應給你的那一份。", "1년 전만 해도 이 제국은 누구도 건드릴 수 없다고 했습니다. 이제 쿠스코는 왕실에 복종하고 왕실 회계관들마저 항복했습니다. 선장님은 제게 끝까지 충성을 지켰습니다. 약속한 몫을 드리겠습니다."]],
    ["Abandon this commission", ["放弃这项任务", "Отказаться от этого поручения", "Abandonar esta misión", "Abandonar esta missão", "この任務を放棄する", "Diesen Auftrag aufgeben", "Abandonner cette mission", "Porzuć tę misję", "放棄這項任務", "이 임무를 포기합니다"]],
    ["Abandon commission", ["放弃任务", "Отказаться от поручения", "Abandonar misión", "Abandonar missão", "任務を放棄する", "Auftrag aufgeben", "Abandonner la mission", "Porzuć misję", "放棄任務", "임무 포기"]],
    ["{0} Your share of {1} doubloons has been paid into your purse.", ["{0}你应得的{1}达布隆已存入你的钱袋。", "{0} Ваша доля — {1} дублонов — уже зачислена в кошелёк.", "{0} Tu parte de {1} doblones ya se ha ingresado en tu bolsa.", "{0} Sua parte de {1} dobrões já foi depositada em sua bolsa.", "{0}取り分の{1}ダブロンが財布に入金されました。", "{0} Euer Anteil von {1} Dublonen wurde in Euren Geldbeutel eingezahlt.", "{0} Votre part de {1} doublons a été versée dans votre bourse.", "{0} Twoje {1} dublonów zostało już wpłacone do sakiewki.", "{0}你應得的{1}達布隆已存入你的錢袋。", "{0} 몫인 더블룬 {1}닢이 주머니에 들어왔습니다."]],
    ["{0} Your share of {1} doubloons is already in your purse.", ["{0}你应得的{1}达布隆已经在钱袋里了。", "{0} Ваша доля — {1} дублонов — уже в кошельке.", "{0} Tu parte de {1} doblones ya está en tu bolsa.", "{0} Sua parte de {1} dobrões já está em sua bolsa.", "{0}取り分の{1}ダブロンは、すでに財布に入っています。", "{0} Euer Anteil von {1} Dublonen ist bereits in Eurem Geldbeutel.", "{0} Votre part de {1} doublons est déjà dans votre bourse.", "{0} Twoje {1} dublonów jest już w sakiewce.", "{0}你應得的{1}達布隆已經在錢袋裡了。", "{0} 몫인 더블룬 {1}닢은 이미 주머니에 있습니다."]],
    ["{0}; hold has {1}.", ["{0}；货舱内有{1}。", "{0}; в трюме: {1}.", "{0}; en la bodega hay {1}.", "{0}; no porão há {1}.", "{0}：貨物室には{1}あります。", "{0}; im Laderaum: {1}.", "{0} ; dans la cale : {1}.", "{0}; w ładowni: {1}.", "{0}；貨艙內有{1}。", "{0}; 화물칸에 {1}이 있습니다."]],
    ["Still need {0} {1}; hold has {2}.", ["还差{0}{1}；货舱内有{2}。", "Нужно ещё {0} {1}; в трюме: {2}.", "Aún hacen falta {0} {1}; en la bodega hay {2}.", "Ainda faltam {0} {1}; no porão há {2}.", "あと{0}{1}必要です。貨物室には{2}あります。", "Es fehlen noch {0} {1}; im Laderaum sind {2}.", "Il manque encore {0} {1} ; la cale en contient {2}.", "Brakuje jeszcze {0} {1}; w ładowni jest {2}.", "還差{0}{1}；貨艙內有{2}。", "아직 {0} {1}이(가) 더 필요합니다. 화물칸에는 {2}이(가) 있습니다."]],
    ["{0} The grain is weighed beneath the nuncio's seal and passed to local almoners.", ["{0}谷物在教廷使节的封印下称重，再交给当地的施赈官。", "{0} Зерно взвешивают под печатью нунция и передают местным раздатчикам милостыни.", "{0} El grano se pesa bajo el sello del nuncio y se entrega a los responsables locales de distribuir limosnas.", "{0} Os grãos são pesados sob o selo do núncio e entregues aos responsáveis locais pela distribuição de esmolas.", "{0}穀物は教皇使節の封印の下で量られ、地元の施療担当者に渡されます。", "{0} Das Getreide wird unter dem Siegel des Nuntius gewogen und örtlichen Armenpflegern übergeben.", "{0} Le grain est pesé sous le sceau du nonce et remis aux responsables locaux des aumônes.", "{0} Ziarno waży się pod pieczęcią nuncjusza i przekazuje miejscowym osobom odpowiedzialnym za jałmużnę.", "{0}穀物在教廷使節的封印下稱重，再交給當地的施賑官。", "{0} 교황대사의 인장 아래 곡물 무게를 잰 뒤 지역 구휼 담당자에게 전달합니다."]],
    ["{0} Those are the exact terms beneath the seal; the foreign court will answer them at our audience.", ["{0}这就是封印文书中的确切条款；外国朝廷将在觐见时答复。", "{0} Это точные условия, скреплённые печатью; иностранный двор ответит на них во время аудиенции.", "{0} Esas son las condiciones exactas del documento sellado; la corte extranjera responderá durante nuestra audiencia.", "{0} Estes são os termos exatos do documento selado; a corte estrangeira responderá durante nossa audiência.", "{0}封印された文書にはこれらの条件が記されています。外国の宮廷は謁見の場で回答するでしょう。", "{0} Das sind die genauen Bedingungen im versiegelten Schreiben; der ausländische Hof wird bei unserer Audienz darauf antworten.", "{0} Voici les conditions exactes du document scellé ; la cour étrangère y répondra lors de notre audience.", "{0} To dokładne warunki zapisane w zapieczętowanym dokumencie; zagraniczny dwór odpowie na nie podczas audiencji.", "{0}這就是封印文書中的確切條款；外國朝廷將在覲見時答覆。", "{0} 봉인된 문서에 적힌 정확한 조건입니다. 외국 궁정은 알현 자리에서 답할 것입니다."]],
    ["{0} was secured by allied forces. The commission is recalled, but the treasury will pay {1} doubloons for your preparations.", ["{0}已由盟军控制。任务已撤销，但王室金库仍会为你的准备工作支付{1}达布隆。", "{0} заняли союзные войска. Поручение отменено, но казна выплатит {1} дублонов за ваши приготовления.", "{0} quedó bajo control aliado. La misión se cancela, pero el tesoro pagará {1} doblones por tus preparativos.", "{0} ficou sob controle das forças aliadas. A missão foi cancelada, mas o tesouro pagará {1} dobrões pelos seus preparativos.", "{0}は同盟軍の支配下に入りました。任務は取り消されましたが、準備の報酬として財務局から{1}ダブロンが支払われます。", "{0} wurde von den verbündeten Truppen eingenommen. Der Auftrag wird zurückgezogen, doch die Staatskasse zahlt {1} Dublonen für Eure Vorbereitungen.", "{0} est passé sous le contrôle des forces alliées. La mission est annulée, mais le trésor versera {1} doublons pour vos préparatifs.", "{0} znalazł się pod kontrolą sił sojuszniczych. Misja zostaje odwołana, ale skarb państwa wypłaci {1} dublonów za przygotowania.", "{0}已由盟軍控制。任務已撤銷，但王室金庫仍會為你的準備工作支付{1}達布隆。", "{0}이(가) 연합군의 통제 아래 들어갔습니다. 임무는 취소되지만 재무부는 준비 비용으로 더블룬 {1}닢을 지급합니다."]],
    ["{0} would steal from the court, fail your mission, and lower your standing", ["{0}会偷窃宫廷财物、令任务失败，并损害你的声望。", "{0} обокрадёт двор, провалит ваше поручение и испортит вашу репутацию.", "{0} robaría en la corte, fracasaría en la misión y perjudicaría tu reputación.", "{0} roubaria na corte, fracassaria na missão e prejudicaria sua reputação.", "{0}は宮廷から盗み、任務に失敗し、あなたの評判を落とすでしょう。", "{0} würde den Hof bestehlen, Euren Auftrag scheitern lassen und Euer Ansehen mindern.", "{0} volerait la cour, ferait échouer votre mission et nuirait à votre réputation.", "{0} okradłby dwór, zawiódłby w misji i obniżyłby twoją reputację.", "{0}會偷竊宮廷財物、令任務失敗，並損害你的聲望。", "{0}은(는) 궁정의 물건을 훔쳐 임무를 망치고 평판을 떨어뜨릴 것입니다."]],
    ["{0}. Will you accept this commission?", ["{0}。你愿意接受这项任务吗？", "{0}. Вы примете это поручение?", "{0}. ¿Aceptarás este encargo?", "{0}. Você aceita esta missão?", "{0}。この依頼を引き受けてくださいますか？", "{0}. Nehmt Ihr diesen Auftrag an?", "{0}. Accepterez-vous cette mission ?", "{0}. Czy przyjmiesz to zlecenie?", "{0}。你願意接受這項任務嗎？", "{0}. 이 임무를 맡으시겠습니까?"]],
    ["{0} WOUNDED", ["受伤：{0}", "РАНЕНЫ: {0}", "HERIDOS: {0}", "FERIDOS: {0}", "負傷: {0}", "VERWUNDETE: {0}", "BLESSÉS : {0}", "RANNI: {0}", "受傷：{0}", "부상: {0}"]],
    ["{0}% victory • expect {1} dead / {2} wounded", ["胜率{0}% • 预计阵亡{1}人 / 受伤{2}人", "Вероятность победы: {0}% • ожидаемые потери: убитых — {1}, раненых — {2}", "Probabilidad de victoria: {0}% • bajas previstas: {1} muertos y {2} heridos", "Chance de vitória: {0}% • baixas previstas: {1} mortos e {2} feridos", "勝率{0}% • 予想損害: 死亡{1}人 / 負傷{2}人", "Siegchance: {0}% • erwartete Verluste: {1} Tote / {2} Verwundete", "Chances de victoire : {0} % • pertes prévues : {1} morts / {2} blessés", "Szansa na zwycięstwo: {0}% • przewidywane straty: {1} zabitych / {2} rannych", "勝率{0}% • 預計陣亡{1}人 / 受傷{2}人", "승리 확률 {0}% • 예상 사망 {1}명 / 부상 {2}명"]],
    ["{0}% victory • expect {1} dead / {2} wounded ({3}–{4} total)", ["胜率{0}% • 预计阵亡{1}人、受伤{2}人（总伤亡{3}–{4}人）", "Вероятность победы: {0}% • ожидаемые потери: убитых — {1}, раненых — {2} (всего: {3}–{4})", "Probabilidad de victoria: {0}% • bajas previstas: {1} muertos y {2} heridos ({3}–{4} en total)", "Chance de vitória: {0}% • baixas previstas: {1} mortos e {2} feridos ({3}–{4} no total)", "勝率{0}% • 予想損害: 死亡{1}人 / 負傷{2}人（合計{3}～{4}人）", "Siegchance: {0}% • erwartete Verluste: {1} Tote / {2} Verwundete (insgesamt {3}–{4})", "Chances de victoire : {0} % • pertes prévues : {1} morts / {2} blessés ({3}–{4} au total)", "Szansa na zwycięstwo: {0}% • przewidywane straty: {1} zabitych / {2} rannych (łącznie {3}–{4})", "勝率{0}% • 預計陣亡{1}人、受傷{2}人（總傷亡{3}–{4}人）", "승리 확률 {0}% • 예상 사망 {1}명 / 부상 {2}명 (총 {3}–{4}명)"]],
    ["{0}% victory • expect {1} dead /", ["胜率{0}% • 预计阵亡{1}人 /", "Вероятность победы: {0}% • погибших — {1} /", "Probabilidad de victoria: {0}% • muertos: {1} /", "Chance de vitória: {0}% • mortos: {1} /", "勝率{0}% • 予想死亡者数: {1}人 /", "Siegchance: {0}% • Tote: {1} /", "Chances de victoire : {0} % • morts : {1} /", "Szansa na zwycięstwo: {0}% • zabici: {1} /", "勝率{0}% • 預計陣亡{1}人 /", "승리 확률 {0}% • 사망 {1}명 /"]],
    ["A {0} doubloon cartaz licenses this vessel for {1} days under Estado da India patrols. Customs and spice levies still apply.", ["一份价值{0}达布隆的卡塔兹许可证，允许该船在葡属印度巡逻队的护航下航行{1}天。关税与香料税仍须缴纳。", "Лицензия-картас стоимостью {0} дублонов разрешает этому судну плавать {1} дней под патрулями Estado da Índia. Таможенные и пряные пошлины сохраняются.", "Un cartaz de {0} doblones autoriza a este buque a navegar durante {1} días bajo las patrullas del Estado da Índia. Siguen aplicándose los aranceles aduaneros y sobre las especias.", "Um cartaz de {0} dobrões autoriza este navio a navegar por {1} dias sob as patrulhas do Estado da Índia. Ainda se aplicam taxas alfandegárias e sobre especiarias.", "{0}ダブロンのカルタスにより、この船はEstado da Índiaの巡視下で{1}日間航行できます。関税と香辛料税は別途かかります。", "Ein Cartaz im Wert von {0} Dublonen berechtigt dieses Schiff für {1} Tage zur Fahrt unter den Patrouillen des Estado da Índia. Zoll- und Gewürzabgaben fallen weiterhin an.", "Un cartaz de {0} doublons autorise ce navire à naviguer pendant {1} jours sous les patrouilles de l'Estado da Índia. Les droits de douane et taxes sur les épices restent dus.", "Cartaz za {0} dublonów uprawnia ten statek do żeglugi przez {1} dni pod ochroną patroli Estado da Índia. Cła i opłaty od przypraw nadal obowiązują.", "一份價值{0}達布隆的卡塔兹許可證，允許該船在葡屬印度巡邏隊的護航下航行{1}天。關稅與香料稅仍須繳納。", "더블룬 {0}닢짜리 카르타스 허가증으로 이 선박은 Estado da Índia 순찰 아래 {1}일간 항해할 수 있습니다. 관세와 향신료 세금은 별도로 부과됩니다."]],
    ["A capital must rise quickly above the bay. Bring", ["首府必须尽快在海湾之上建成。带来", "Столица должна быстро вырасти над бухтой. Доставьте", "La capital debe alzarse pronto sobre la bahía. Trae", "A capital precisa erguer-se depressa acima da baía. Traga", "湾を見下ろす首都を早急に築かねばなりません。持ってきてください", "Die Hauptstadt muss sich rasch über der Bucht erheben. Bringt", "La capitale doit vite s'élever au-dessus de la baie. Apportez", "Stolica musi szybko wyrosnąć nad zatoką. Dostarcz", "首府必須盡快在海灣之上建成。帶來", "수도를 만 위에 서둘러 세워야 합니다. 가져오세요" ]],
    ["A captain outside Christendom would require singular trust in Rome: {0} standing or better.", ["基督教世界之外的船长需要赢得罗马的特别信任：声望至少达到{0}。", "Капитану за пределами христианского мира нужно особое доверие Рима: репутация не ниже «{0}». ", "Un capitán ajeno a la cristiandad debe gozar de una confianza especial en Roma: reputación de {0} o superior.", "Um capitão de fora da cristandade precisa inspirar confiança especial em Roma: reputação {0} ou superior.", "キリスト教世界の外にいる船長がローマの信頼を得るには、評判が{0}以上でなければなりません。", "Ein Kapitän außerhalb der Christenheit muss Roms besonderes Vertrauen genießen: Ansehen {0} oder höher.", "Un capitaine hors de la chrétienté doit jouir d'une confiance particulière à Rome : une réputation de {0} ou plus.", "Kapitan spoza chrześcijaństwa musi cieszyć się szczególnym zaufaniem Rzymu: reputacja co najmniej {0}.", "基督教世界之外的船長需要贏得羅馬的特別信任：聲望至少達到{0}。", "그리스도교 세계 밖의 선장은 로마의 특별한 신임을 얻어야 합니다. 평판 {0} 이상." ]],
    ["A compass, cross-staff, lead line, and tables sharpen shiphandling.", ["指南针、十字测杆、测深绳和航海表能提升操船本领。", "Компас, крестовый посох, лот и навигационные таблицы совершенствуют искусство судовождения.", "La brújula, la ballestilla, la sonda y las tablas náuticas afinan la navegación.", "A bússola, o bastão cruzado, o prumo e as tabelas náuticas aprimoram a navegação.", "羅針盤、クロススタッフ、測深鉛、航海表が操船技術を磨きます。", "Kompass, Jakobsstab, Lotleine und Navigationstabellen verbessern die Schiffsführung.", "La boussole, l'arbalestrille, la ligne de sonde et les tables nautiques affinent la conduite du navire.", "Kompas, laska Jakuba, sonda i tablice nawigacyjne doskonalą żeglugę.", "指南針、十字測桿、測深繩和航海表能提升操船本領。", "나침반, 크로스 스태프, 측심줄과 항해표가 항해술을 다듬어 줍니다."]],
    ["A conch sounds from the headland when your sail appears. The village knows which voyager has returned.", ["你的帆影一出现，海岬便响起海螺号。村民都知道是哪位航海者归来了。", "Когда появляется ваш парус, с мыса звучит раковина. В деревне знают, какой мореплаватель вернулся.", "Cuando aparece tu vela, suena una caracola desde el cabo. El pueblo sabe qué viajero ha regresado.", "Quando sua vela aparece, uma concha soa no promontório. A aldeia sabe qual viajante voltou.", "帆が見えると岬から法螺貝が鳴り、村人は誰が帰ってきたのか知ります。", "Wenn Euer Segel erscheint, ertönt vom Kap ein Muschelhorn. Das Dorf weiß, welcher Seefahrer zurückgekehrt ist.", "À l'apparition de votre voile, une conque retentit depuis le promontoire. Le village sait quel navigateur est de retour.", "Gdy pojawia się twój żagiel, z cypla rozlega się dźwięk muszli. Wieś wie, który żeglarz powrócił.", "你的帆影一出現，海岬便響起海螺號。村民都知道是哪位航海者歸來了。", "돛이 나타나면 곶에서 소라 나팔이 울립니다. 마을 사람들은 어떤 항해자가 돌아왔는지 압니다." ]],
    ["A crowded penguin rookery provided meat enough to replenish the ship's stores.", ["拥挤的企鹅繁殖地提供了足够的肉食，补充船上的储备。", "Многолюдное лежбище пингвинов дало достаточно мяса, чтобы пополнить корабельные запасы.", "Una colonia de pingüinos muy poblada proporcionó carne suficiente para reponer las provisiones del barco.", "Uma colônia de pinguins numerosa forneceu carne suficiente para reabastecer as provisões do navio.", "ペンギンが密集する繁殖地で、船の食料を補うのに十分な肉を得ました。", "Eine große Pinguinkolonie lieferte genug Fleisch, um die Vorräte des Schiffs aufzufüllen.", "Une colonie de manchots très peuplée a fourni assez de viande pour renouveler les vivres du navire.", "Liczna kolonia pingwinów dostarczyła dość mięsa, by uzupełnić zapasy statku.", "擁擠的企鵝繁殖地提供了足夠的肉食，補充船上的儲備。", "붐비는 펭귄 번식지에서 배의 식량을 보충할 만큼 충분한 고기를 얻었습니다."]],
    ["A landing at the Pasig cannot rely on steel alone. Supply", ["在巴石河口登陆，光有钢铁还不够。供应", "Для высадки на реке Пасиг мало одного железа. Доставьте", "Para desembarcar en el Pasig no basta con el acero. Abastece", "No desembarque no Pasig, não basta ter aço. Abasteça", "パシッグ川への上陸には鉄だけでは足りません。補給品を届けてください", "Für eine Landung am Pasig reicht Stahl allein nicht. Liefert", "Pour débarquer sur le Pasig, l'acier ne suffit pas. Approvisionnez", "Do desantu na rzece Pasig nie wystarczy sama stal. Dostarcz", "在巴石河口登陸，光有鋼鐵還不夠。供應", "파시그강에 상륙하려면 강철만으로는 부족합니다. 보급품을 보내세요"]],
    ["A king turned an isolated rock into both palace and proclamation. Sketch the gardens as well as the walls; power often reveals itself in what it chooses to make beautiful.", ["一位国王把孤岩建成宫殿，也借此向世人宣示王权。请把花园和城墙都画下来；权力也会显露在它选择装点之处。", "Король превратил одинокую скалу и в дворец, и в зримое заявление о своей власти. Зарисуйте не только стены, но и сады: выбор красоты тоже говорит о могуществе.", "Un rey convirtió una roca aislada en palacio y en una declaración de poder. Dibuja los jardines además de las murallas: el poder también se revela en aquello que decide embellecer.", "Um rei transformou uma rocha isolada em palácio e em declaração de poder. Esboce os jardins e também as muralhas: o poder se revela naquilo que escolhe embelezar.", "王は孤立した岩を宮殿に変え、権力を世に示しました。城壁だけでなく庭園も描き留めてください。何を美しく飾るかにも権力は表れます。", "Ein König machte aus einem einsamen Felsen einen Palast und ein weithin sichtbares Zeichen seiner Macht. Skizzieren Sie auch die Gärten, nicht nur die Mauern: Macht zeigt sich oft darin, was sie verschönern lässt.", "Un roi a fait d'un rocher isolé un palais et une affirmation de son pouvoir. Dessinez les jardins autant que les remparts : le pouvoir se révèle aussi dans ce qu'il choisit d'embellir.", "Król przemienił samotną skałę w pałac i widoczne świadectwo swej władzy. Naszkicuj ogrody i mury: o potędze świadczy także to, co postanawia upiększyć.", "一位國王把孤岩建成宮殿，也藉此向世人宣示王權。請把花園和城牆都畫下來；權力也會顯露在它選擇裝點之處。", "왕은 외딴 바위를 궁전으로 만들고 자신의 권력을 세상에 드러냈습니다. 성벽뿐 아니라 정원도 그리세요. 무엇을 아름답게 꾸미는지에도 권력이 드러납니다."]],
    ["A mode of travel and nurture unlike anything in our books. Draw the feet, tail, and pouch separately; readers will otherwise insist we joined three animals together.", ["这种移动方式和育幼习性前所未见。请分别画出脚、尾巴和育儿袋，不然读者会以为我们把三种动物拼在了一起。", "Такого способа передвижения и вынашивания детёнышей нет ни в одной нашей книге. Нарисуйте отдельно лапы, хвост и сумку, иначе читатели решат, что мы составили животное из трёх разных.", "Nunca habíamos documentado una forma de desplazarse y criar así. Dibuja por separado las patas, la cola y la bolsa; si no, los lectores creerán que hemos juntado tres animales.", "Nunca registramos uma forma de se locomover e criar os filhotes como esta. Desenhe separadamente as patas, a cauda e a bolsa; do contrário, os leitores pensarão que juntamos três animais.", "こんな移動の仕方や子育ては、どの本にも載っていません。脚、尾、育児嚢を別々に描いてください。そうしないと、三種の動物を合成したと思われます。", "Eine solche Fortbewegungs- und Aufzuchtweise findet sich in keinem unserer Bücher. Zeichnen Sie Füße, Schwanz und Beutel getrennt, sonst glauben die Leser, wir hätten drei Tiere zusammengesetzt.", "Nous n'avons jamais décrit pareil mode de déplacement et d'élevage des petits. Dessinez séparément les pattes, la queue et la poche, sinon les lecteurs croiront que nous avons assemblé trois animaux.", "Nie opisaliśmy dotąd takiego sposobu poruszania się i wychowywania młodych. Narysuj osobno łapy, ogon i torbę, bo czytelnicy uznają, że złożyliśmy zwierzę z trzech innych.", "這種移動方式和育幼習性前所未見。請分別畫出腳、尾巴和育兒袋，不然讀者會以為我們把三種動物拼在一起。", "이런 이동 방식과 새끼를 기르는 습성은 우리 책 어디에도 없습니다. 발과 꼬리, 육아낭을 따로 그리세요. 그렇지 않으면 독자들은 세 동물을 합쳤다고 생각할 겁니다."]],
    ["A mountain in a world almost emptied of everything else. Keep that page exactly as you drew it. The blankness around the massif is part of the discovery.", ["这座山耸立在一片几乎空无一物的世界里。请保留你画下的原貌；山体周围的空白也是发现的一部分。", "Гора в мире, где почти ничего больше не осталось. Сохраните страницу в точности такой, какой вы её нарисовали: пустое пространство вокруг горного массива — часть открытия.", "Una montaña en un mundo casi despojado de todo lo demás. Conserva la página tal como la dibujaste: el vacío alrededor del macizo también forma parte del descubrimiento.", "Uma montanha num mundo quase desprovido de todo o resto. Mantenha a página exatamente como a desenhou: o vazio em torno do maciço faz parte da descoberta.", "ほかのものがほとんど失われた世界にそびえる山です。描いたページをそのまま残してください。山塊を囲む空白も発見の一部です。", "Ein Berg in einer Welt, der fast alles andere fehlt. Lassen Sie die Seite genau so, wie Sie sie gezeichnet haben. Die Leere rund um das Massiv gehört zur Entdeckung.", "Une montagne dans un monde presque dépouillé de tout le reste. Gardez cette page exactement telle que vous l'avez dessinée : le vide autour du massif fait partie de la découverte.", "Góra w świecie, z którego niemal wszystko zniknęło. Zachowaj tę stronę dokładnie tak, jak ją narysowałeś. Pustka wokół masywu jest częścią odkrycia.", "這座山聳立在一片幾乎空無一物的世界裡。請保留你畫下的原貌；山體周圍的空白也是發現的一部分。", "다른 모든 것이 거의 사라진 세계에 우뚝 솟은 산입니다. 그 페이지는 그린 그대로 두세요. 산괴 주변의 공백도 발견의 일부입니다."]],
    ["a petition to Charles, King of Spain and Emperor, that Malta be granted as a new seat", ["一份呈给西班牙国王兼皇帝查理的请愿书，请求将马耳他赐作新的驻地。", "Прошение к Карлу, королю Испании и императору, о передаче Мальты под новую резиденцию ордена.", "Una petición a Carlos, rey de España y emperador, para que conceda Malta como nueva sede de la orden.", "Uma petição a Carlos, rei da Espanha e imperador, para que conceda Malta como nova sede da ordem.", "スペイン王兼皇帝カールに、マルタを新たな本拠地として認めるよう求める請願書。", "Eine Bittschrift an Karl, König von Spanien und Kaiser, Malta dem Orden als neuen Sitz zu überlassen.", "Une pétition adressée à Charles, roi d'Espagne et empereur, pour que Malte devienne le nouveau siège de l'ordre.", "Petycja do Karola, króla Hiszpanii i cesarza, z prośbą o przyznanie Malty jako nowej siedziby zakonu.", "一份呈給西班牙國王兼皇帝查理的請願書，請求將馬爾他賜作新的駐地。", "스페인의 왕이자 황제인 카를에게 몰타를 새 본거지로 허락해 달라는 청원서."]],
    ["a great broad-beamed galley enlarged into a floating gun platform, sacrificing the ordinary galley's speed for heavy artillery and a powerful fighting crew", ["一艘加宽的大型桨帆战船，改装成浮动炮台；它牺牲普通桨帆船的速度，换来重炮和强大的战斗船员。", "Большая ширококорпусная галера, превращённая в плавучую артиллерийскую платформу: ради тяжёлых пушек и сильной боевой команды она уступила в скорости обычной галере.", "Una gran galera de manga ancha convertida en plataforma artillera flotante; sacrifica la velocidad de una galera común a cambio de artillería pesada y una tripulación de combate poderosa.", "Uma grande galera de boca larga transformada em plataforma de artilharia flutuante, que sacrifica a velocidade de uma galera comum por canhões pesados e uma tripulação de combate poderosa.", "幅広の大型ガレー船を浮動砲台に改造したもの。通常のガレー船より速度を犠牲にする代わりに、重砲と強力な戦闘員を備えています。", "Eine große Galeere mit breitem Rumpf, zur schwimmenden Geschützplattform ausgebaut. Sie opfert die Geschwindigkeit einer gewöhnlichen Galeere zugunsten schwerer Artillerie und einer kampfstarken Besatzung.", "Une grande galère au large maître-bau transformée en plate-forme d'artillerie flottante ; elle sacrifie la vitesse d'une galère ordinaire au profit de canons lourds et d'un équipage de combat puissant.", "Duża galera o szerokim kadłubie, przebudowana na pływającą platformę artyleryjską. Zrezygnowano z szybkości zwykłej galery na rzecz ciężkich dział i silnej załogi bojowej.", "一艘加寬的大型槳帆戰船，改裝成浮動砲台；它犧牲普通槳帆船的速度，換來重砲和強大的戰鬥船員。", "선체가 넓은 대형 갤리선을 떠다니는 포대로 개조했습니다. 일반 갤리선의 속도를 희생한 대신 중포와 강한 전투 선원을 갖췄습니다."]],
    ["a light one-masted Mediterranean galley, built for speed under oars and quick coastal fighting rather than the cargo or artillery of larger warships", ["一艘轻型单桅地中海桨帆船，重在划桨速度和沿岸速战，不像大型战舰那样运货或装备重炮。", "Лёгкая одномачтовая средиземноморская галера, созданная для скорости на вёслах и быстрых прибрежных боёв, а не для грузов или тяжёлого вооружения крупных военных кораблей.", "Una galera mediterránea ligera de un solo mástil, diseñada para ganar velocidad a remo y combatir rápidamente cerca de la costa, no para cargar mercancías o artillería pesada.", "Uma galera mediterrânea leve de um mastro, feita para ganhar velocidade a remo e lutar depressa junto à costa, não para levar carga ou a artilharia de grandes navios de guerra.", "大型軍艦のように貨物や重砲を積むのではなく、櫂での速力と沿岸での素早い戦闘を重視した、地中海の軽量一檣ガレー船。", "Eine leichte, einmastige Mittelmeergaleere, gebaut für Rudergeschwindigkeit und schnelle Küstengefechte statt für Ladung oder die Artillerie größerer Kriegsschiffe.", "Une galère méditerranéenne légère à un mât, conçue pour filer à la rame et livrer de rapides combats côtiers plutôt que transporter des cargaisons ou l'artillerie des grands navires de guerre.", "Lekka, jednomasztowa galera śródziemnomorska, zbudowana z myślą o szybkości pod wiosłami i szybkich walkach przybrzeżnych, a nie o ładunku czy artylerii dużych okrętów.", "一艘輕型單桅地中海槳帆船，重在划槳速度和沿岸速戰，不像大型戰艦那樣運貨或裝備重砲。", "대형 전함처럼 화물이나 중포를 싣기보다 노를 저어 빠르게 움직이며 해안 전투를 벌이도록 만든 지중해의 경량 단돛대 갤리선입니다."]],
    ["a light lateen craft long at home on the Nile and eastern Mediterranean, fast to handle and able to trade from the smallest landing places", ["一种长期行驶于尼罗河和东地中海的轻型三角帆船，操纵灵活，连最小的渡口也能开展贸易。", "Лёгкое судно с латинским парусом, привычное на Ниле и в восточном Средиземноморье: простое в управлении и способное торговать даже у самых маленьких пристаней.", "Una ligera embarcación de vela latina, habitual en el Nilo y el Mediterráneo oriental, ágil de maniobra y capaz de comerciar desde los embarcaderos más pequeños.", "Uma embarcação leve de vela latina, comum no Nilo e no Mediterrâneo oriental, fácil de manobrar e capaz de negociar até nos menores ancoradouros.", "ナイル川や東地中海で長く使われてきた軽量のラテン帆船。操船しやすく、小さな船着き場からでも交易できます。", "Ein leichtes Schiff mit Lateinersegel, seit Langem auf dem Nil und im östlichen Mittelmeer zu Hause. Es ist wendig und kann selbst an den kleinsten Anlegestellen Handel treiben.", "Une embarcation légère à voile latine, familière du Nil et de la Méditerranée orientale, facile à manœuvrer et capable de commercer depuis les plus petits débarcadères.", "Lekka jednostka z ożaglowaniem łacińskim, od dawna pływająca po Nilu i wschodnim Morzu Śródziemnym; zwrotna i zdolna do handlu nawet przy najmniejszych przystaniach.", "一種長期行駛於尼羅河和東地中海的輕型三角帆船，操縱靈活，連最小的渡口也能進行貿易。", "나일강과 지중해 동부에서 오래 운항해 온 가벼운 라틴 돛배입니다. 조종이 쉽고 작은 선착장에서도 무역할 수 있습니다."]],
    ["A Fine Company", ["一群好船员", "Отличная команда", "Una gran tripulación", "Uma ótima tripulação", "頼もしい船員たち", "Eine gute Mannschaft", "Un équipage de choix", "Znakomita załoga", "一群好船員", "훌륭한 선원들"]],
    ["A Dominican's Testimony", ["多明我会修士的证词", "Показания монаха-доминиканца", "El testimonio de un fraile dominico", "O testemunho de um frade dominicano", "ドミニコ会士の証言", "Das Zeugnis eines Dominikaners", "Le témoignage d'un frère dominicain", "Świadectwo dominikanina", "多明我會修士的證詞", "도미니코회 수도사의 증언"]],
    ["a fixed allotment of lawful merchant calls under the court's customs officers", ["在朝廷海关官员监管下，给予一定数量的合法商船停靠名额", "Установленная квота разрешённых заходов торговых судов под надзором придворных таможенников", "Una cuota fija de escalas legales de buques mercantes bajo la supervisión aduanera de la corte", "Uma cota fixa de escalas legais de navios mercantes sob a fiscalização alfandegária da corte", "宮廷の税関官吏の監督下で認められる、商船の合法的な寄港枠", "Ein festes Kontingent rechtmäßiger Hafenanläufe von Handelsschiffen unter Aufsicht der Zollbeamten des Hofes", "Un quota fixe d'escales autorisées pour les navires marchands, sous la surveillance des douaniers de la cour", "Ustalona liczba legalnych zawinięć statków handlowych pod nadzorem dworskich celników", "在朝廷海關官員監管下，給予一定數量的合法商船停靠名額", "궁정 세관 관리의 감독 아래 허용되는 합법적인 상선 입항 횟수"]],
    ["A distant colony depends on ships, stores, accounts, and orders that actually arrive. These papers bind {0} to the court at {1}.", ["遥远的殖民地仰赖船只、补给、账目与订单真正送达。这些文书将{0}与{1}的朝廷约束在一起。", "Далёкая колония зависит от кораблей, припасов, счетов и приказов, которые действительно доходят до места. Эти бумаги связывают {0} с двором в {1}.", "Una colonia lejana depende de que lleguen los barcos, provisiones, cuentas y órdenes. Estos documentos vinculan a {0} con la corte de {1}.", "Uma colônia distante depende de navios, provisões, contas e ordens que de fato cheguem. Estes documentos vinculam {0} à corte de {1}.", "遠方の植民地は、船や物資、会計記録、命令が実際に届くかどうかにかかっています。この文書は{0}を{1}の宮廷に結び付けます。", "Eine entfernte Kolonie ist auf eintreffende Schiffe, Vorräte, Abrechnungen und Befehle angewiesen. Diese Papiere binden {0} an den Hof in {1}.", "Une colonie lointaine dépend de l'arrivée effective des navires, des provisions, des comptes et des ordres. Ces documents lient {0} à la cour de {1}.", "Odległa kolonia zależy od statków, zapasów, rachunków i rozkazów, które rzeczywiście do niej docierają. Dokumenty te wiążą {0} z dworem w {1}.", "遙遠的殖民地仰賴船隻、補給、帳目與命令確實送達。這些文書將{0}與{1}的朝廷聯繫起來。", "먼 식민지는 선박, 보급품, 회계, 명령이 실제로 도착해야 유지됩니다. 이 문서는 {0}을(를) {1}의 궁정에 묶어 둡니다."]],
    ["A hidden bundle beneath the Sō register bears unlisted names and copied seals. The evidence remains locked in the captain's cabin.", ["宗氏名册下藏着一捆文书，上面写着未登记的名字，印章也是伪造的。证据仍锁在船长室里。", "Под реестром рода Со спрятан свёрток с незарегистрированными именами и поддельными печатями. Улики по-прежнему заперты в каюте капитана.", "Un paquete oculto bajo el registro Sō contiene nombres no inscritos y sellos falsificados. Las pruebas siguen bajo llave en el camarote del capitán.", "Um pacote escondido sob o registro Sō contém nomes não registrados e selos falsificados. As provas continuam trancadas na cabine do capitão.", "宗氏の台帳の下に隠された包みには、記載のない名前と偽造された印がある。証拠は船長室にしまわれたままだ。", "Ein verstecktes Bündel unter dem Sō-Register enthält nicht verzeichnete Namen und gefälschte Siegel. Die Beweise bleiben in der Kapitänskajüte verschlossen.", "Un paquet caché sous le registre Sō porte des noms non répertoriés et des sceaux contrefaits. Les preuves restent enfermées dans la cabine du capitaine.", "W ukrytym pakunku pod rejestrem Sō są nazwiska spoza wykazu i podrobione pieczęcie. Dowody nadal są zamknięte w kajucie kapitana.", "宗氏名冊下藏著一捆文書，上面寫著未登記的名字，印章也是偽造的。證據仍鎖在船長室裡。", "소씨 장부 아래 숨겨진 꾸러미에는 명부에 없는 이름과 위조 인장이 있습니다. 증거는 여전히 선장실에 잠겨 있습니다."]],
    ["A formidable large feline of Africa and western India.", ["非洲和印度西部的一种大型猛猫。", "Крупный хищный представитель семейства кошачьих из Африки и западной Индии.", "Un gran felino imponente de África y el oeste de la India.", "Um grande felino imponente da África e do oeste da Índia.", "アフリカとインド西部に生息する、堂々たる大型ネコ科動物。", "Eine mächtige Großkatze aus Afrika und Westindien.", "Un grand félin imposant d'Afrique et de l'ouest de l'Inde.", "Potężny duży kot z Afryki i zachodnich Indii.", "非洲和印度西部的一種大型猛貓。", "아프리카와 서인도 지역에 사는 위풍당당한 대형 고양잇과 동물입니다."]],
    ["a compact junk in the old East Asian coastal tradition, with a shallow hull and easily managed battened sail suited to a modest crew", ["一艘沿袭东亚古老沿海传统的小型中国帆船，船体吃水浅，配有易于操纵的竹篾帆，适合小规模船员。", "Небольшая джонка в старой восточноазиатской прибрежной традиции: мелкая осадка, удобный в управлении реечный парус и небольшой экипаж.", "Un junco compacto de la antigua tradición costera de Asia oriental, con poco calado y una vela de batten fácil de manejar, apto para una tripulación reducida.", "Um junco compacto da antiga tradição costeira do Leste Asiático, com pouco calado e vela trincada fácil de manejar, adequado a uma tripulação pequena.", "東アジアの古い沿岸船の伝統を受け継ぐ小型ジャンク船。浅い船体と扱いやすい帆を備え、少人数の乗組員に適しています。", "Eine kompakte Dschunke aus der alten ostasiatischen Küstenschifffahrt mit flachem Rumpf und leicht zu handhabendem Segel, geeignet für eine kleine Besatzung.", "Une jonque compacte de l'ancienne tradition côtière d'Asie de l'Est, à faible tirant d'eau et dotée d'une voile à lattes facile à manœuvrer, adaptée à un petit équipage.", "Kompaktowa dżonka w dawnej tradycji przybrzeżnej Azji Wschodniej, o płytkim zanurzeniu i łatwym w obsłudze żaglu z listwami, dla niewielkiej załogi.", "一艘承襲東亞古老沿海傳統的小型中國帆船，船體吃水淺，配有易於操控的帆，適合小規模船員。", "얕은 선체와 다루기 쉬운 돛을 갖춘 동아시아 전통의 소형 정크선으로, 적은 선원으로 운항하기 좋습니다."]],
    ["A great Portuguese nau of the India run, built to survive the Cape route and return with a hold rich in Asian spices and wares", ["一艘用于葡萄牙印度航线的大型诺乌帆船，专为经受住绕行好望角的航程而造，返航时满载亚洲香料与商品。", "Большой португальский нау для рейсов в Индию, построенный для плаваний вокруг мыса и возвращения с трюмом, полным азиатских пряностей и товаров.", "Una gran nao portuguesa de la ruta de las Indias, construida para resistir la ruta del cabo y volver con la bodega llena de especias y mercancías asiáticas.", "Uma grande nau portuguesa da rota das Índias, construída para suportar a rota do Cabo e voltar com o porão cheio de especiarias e mercadorias asiáticas.", "インド航路に就く大型のポルトガル船ナウ。喜望峰回りの航海に耐え、アジアの香辛料や品物を船倉いっぱいに積んで帰るために造られました。", "Eine große portugiesische Nau für die Indienfahrt, gebaut für die Kaproute und die Rückkehr mit einem Laderaum voller asiatischer Gewürze und Waren.", "Un grand nau portugais de la route des Indes, conçu pour affronter la route du cap et revenir avec une cale chargée d'épices et de marchandises d'Asie.", "Duży portugalski statek typu nau na trasę do Indii, zbudowany tak, by przetrwać rejs wokół Przylądka i wrócić z ładownią pełną azjatyckich przypraw i towarów.", "一艘用於葡萄牙印度航線的大型諾烏帆船，專為經受住繞行好望角的航程而造，返航時滿載亞洲香料與商品。", "희망봉 항로를 견디고 아시아 향신료와 상품을 가득 실어 돌아오도록 만든 인도 항로용 대형 포르투갈 나우선입니다."]],
    ["{0}'s Grand Secretariat has settled upon {1}. Carry me under seal to {2}, then return with the answer. The court will pay {3} db.", ["{0}的内阁已选定{1}。请将我密封送往{2}，再带回答复。朝廷将支付{3} DB。", "Великая канцелярия державы {0} выбрала {1}. Доставьте меня с печатью в {2}, а затем вернитесь с ответом. Двор выплатит {3} DB.", "La Secretaría General de {0} se ha decidido por {1}. Llévame sellado a {2} y regresa con la respuesta. La Corona pagará {3} DB.", "A Secretaria-Geral de {0} escolheu {1}. Leve-me lacrado a {2} e volte com a resposta. A Coroa pagará {3} DB.", "{0}の大書記局は{1}を選びました。私を封印して{2}へ届け、返答を持ち帰ってください。朝廷から{3} DBが支払われます。", "Das Großsekretariat von {0} hat sich für {1} entschieden. Bringt mich versiegelt nach {2} und kehrt mit der Antwort zurück. Der Hof zahlt {3} DB.", "Le Grand Secrétariat de {0} a choisi {1}. Emportez-moi sous scellés à {2}, puis revenez avec la réponse. La cour versera {3} DB.", "Wielka Kancelaria państwa {0} wybrała {1}. Dostarcz mnie opieczętowanego do {2}, a potem wróć z odpowiedzią. Dwór zapłaci {3} DB.", "{0}的大書記局已選定{1}。請將我密封送往{2}，再帶回答覆。朝廷將支付{3} DB。", "{0}의 대서기관실이 {1}을(를) 선택했습니다. 저를 봉인해 {2}로 가져가고 답변을 받아 돌아오세요. 궁정에서 {3} DB를 지급합니다."]],
    ["{0}'s prohibition on furnishing {1} to {2}", ["{0}禁止向{2}提供{1}", "Запрет державы {0} на поставку {1} державе {2}", "Prohibición de {0} de suministrar {1} a {2}", "Proibição de {0} de fornecer {1} a {2}", "{0}が{2}に{1}を供給することの禁止", "{0}s Verbot, {2} mit {1} zu versorgen", "Interdiction faite par {0} de fournir {1} à {2}", "Zakaz państwa {0} dostarczania {1} państwu {2}", "{0}禁止向{2}提供{1}", "{0}의 {2}에 대한 {1} 공급 금지"]],
    ["{0}{1} is annexed and placed under the direct rule of {2}.", ["{0}{1}遭到吞并，置于{2}的直接统治之下。", "{0}{1} аннексировано и переходит под прямое управление державы {2}.", "{0}{1} es anexionada y queda bajo el gobierno directo de {2}.", "{0}{1} é anexada e fica sob o domínio direto de {2}.", "{0}{1}は併合され、{2}の直接統治下に置かれます。", "{0}{1} wird annektiert und unter die direkte Herrschaft von {2} gestellt.", "{0}{1} est annexé et placé sous la domination directe de {2}.", "{0}{1} zostaje zaanektowane i przechodzi pod bezpośrednie rządy państwa {2}.", "{0}{1}遭到吞併，置於{2}的直接統治之下。", "{0}{1}은(는) 합병되어 {2}의 직접 통치를 받게 됩니다."]],
    ["{0}{1} keeps its rulers and foreign policy, pays tribute to {2}, and receives its protection in defensive wars.", ["{0}{1}保留自己的统治者和外交政策，向{2}纳贡，并在防御战争中受其保护。", "{0}{1} сохраняет своих правителей и внешнюю политику, платит державе {2} дань и получает её защиту в оборонительных войнах.", "{0}{1} conserva a sus gobernantes y su política exterior, paga tributo a {2} y recibe su protección en guerras defensivas.", "{0}{1} mantém seus governantes e sua política externa, paga tributo a {2} e recebe sua proteção em guerras defensivas.", "{0}{1}は統治者と外交政策を保ち、{2}に貢納し、防衛戦争ではその保護を受けます。", "{0}{1} behält seine Herrscher und Außenpolitik, zahlt {2} Tribut und erhält in Verteidigungskriegen dessen Schutz.", "{0}{1} conserve ses dirigeants et sa politique étrangère, verse un tribut à {2} et reçoit sa protection dans les guerres défensives.", "{0}{1} zachowuje swoich władców i politykę zagraniczną, płaci daninę państwu {2} i otrzymuje jego ochronę w wojnach obronnych.", "{0}{1}保留自己的統治者和外交政策，向{2}納貢，並在防禦戰爭中受其保護。", "{0}{1}은(는) 통치자와 외교 정책을 유지하고 {2}에 조공을 바치며 방어 전쟁에서 보호를 받습니다."]],
    ["{0} You are a fellow Muslim. If you are ready, come with me as a pilgrim.", ["{0}你我同为穆斯林。若你准备好了，就与我同行朝觐。", "{0} Вы тоже мусульманин. Если готовы, отправляйтесь со мной в паломничество.", "{0} Tú también eres musulmán. Si estás listo, ven conmigo en peregrinación.", "{0} Você também é muçulmano. Se estiver pronto, venha comigo em peregrinação.", "{0}も同じイスラム教徒です。準備ができたら、私と巡礼に出かけましょう。", "{0} Ihr seid ebenfalls Muslim. Wenn Ihr bereit seid, kommt als Pilger mit mir.", "{0} Vous êtes musulman comme moi. Si vous êtes prêt, accompagnez-moi en pèlerinage.", "{0} Ty też jesteś muzułmaninem. Jeśli jesteś gotów, wyrusz ze mną na pielgrzymkę.", "{0}你我同為穆斯林。若你準備好了，就與我同行朝覲。", "{0} 당신도 무슬림입니다. 준비가 되었다면 저와 함께 순례를 떠나세요."]],
    ["{0} You have made the Hajj before, captain; pray that mine is accepted.", ["{0}船长，您以前朝觐过；请为我的朝觐能蒙接纳而祈祷。", "{0} Капитан, вы уже совершали хадж; молитесь, чтобы и мой был принят.", "{0} Capitán, ya hiciste el hach; reza para que el mío sea aceptado.", "{0} Capitão, você já fez o Hajj; reze para que o meu seja aceito.", "{0}船長は以前にハッジをなさいましたね。私の巡礼も受け入れられるよう祈ってください。", "{0} Ihr habt den Haddsch schon vollzogen, Kapitän; betet, dass auch meiner angenommen wird.", "{0} Vous avez déjà accompli le Hajj, capitaine ; priez pour que le mien soit accepté.", "{0} Kapitanie, odbyłeś już hadżdż; módl się, by mój został przyjęty.", "{0}船長，您以前朝覲過；請為我的朝覲能蒙接納而祈禱。", "{0} 선장님은 이미 하지(Hajj)를 다녀오셨지요. 제 순례도 받아들여지도록 기도해 주세요."]],
    ["{0} DEAD / {1} WOUNDED", ["阵亡：{0} / 受伤：{1}", "ПОГИБЛО: {0} / РАНЕНО: {1}", "MUERTOS: {0} / HERIDOS: {1}", "MORTOS: {0} / FERIDOS: {1}", "死亡: {0} / 負傷: {1}", "TOT: {0} / VERWUNDET: {1}", "MORTS : {0} / BLESSÉS : {1}", "ZABICI: {0} / RANNI: {1}", "陣亡：{0} / 受傷：{1}", "사망: {0} / 부상: {1}"]],
    ["{0} DEAD • {1} WOUNDED", ["阵亡：{0} • 受伤：{1}", "ПОГИБЛО: {0} • РАНЕНО: {1}", "MUERTOS: {0} • HERIDOS: {1}", "MORTOS: {0} • FERIDOS: {1}", "死亡: {0} • 負傷: {1}", "TOT: {0} • VERWUNDET: {1}", "MORTS : {0} • BLESSÉS : {1}", "ZABICI: {0} • RANNI: {1}", "陣亡：{0} • 受傷：{1}", "사망: {0} • 부상: {1}"]],
    ["{0} has forbidden {1} from {2}", ["{0}禁止{1}进行{2}。", "{0} запретил {1} заниматься делом: {2}.", "{0} ha prohibido a {1} realizar {2}.", "{0} proibiu {1} de realizar {2}.", "{0}は{1}に{2}を禁じました。", "{0} hat {1} verboten, {2} zu tun.", "{0} a interdit à {1} de faire {2}.", "{0} zabronił {1} wykonywania czynności: {2}.", "{0}禁止{1}進行{2}。", "{0}이(가) {1}에게 {2}을(를) 금지했습니다."]],
    ["{0} HELD", ["持有文书：{0}", "На руках документов: {0}", "Documentos en posesión: {0}", "Documentos em mãos: {0}", "所持書類: {0}", "Gehaltene Dokumente: {0}", "Documents détenus : {0}", "Posiadane dokumenty: {0}", "持有文書：{0}", "보유 문서: {0}"]],
    ["{0} has agreed to take our commission. His ship is reserved for us.", ["{0}已接受我们的委托。他的船已为我们留用。", "{0} согласился выполнить наше поручение. Его корабль закреплён за нами.", "{0} ha aceptado nuestro encargo. Su barco queda reservado para nosotros.", "{0} aceitou nosso encargo. Seu navio ficará reservado para nós.", "{0}が依頼を引き受けました。その船は当方のために確保されています。", "{0} hat unseren Auftrag angenommen. Sein Schiff ist für uns reserviert.", "{0} a accepté notre mission. Son navire nous est réservé.", "{0} przyjął nasze zlecenie. Jego statek jest dla nas zarezerwowany.", "{0}已接受我們的委託。他的船已供我們調用。", "{0} 선장이 의뢰를 수락했습니다. 그의 배는 우리를 위해 확보되어 있습니다."]],
    ["{0} now rules {1}. A new ruler always means new contracts.", ["{0}现已统治{1}。新统治者总会带来新契约。", "{0} теперь правит державой {1}. С новым правителем всегда приходят новые договоры.", "{0} ahora gobierna {1}. Un nuevo gobernante siempre trae nuevos contratos.", "{0} agora governa {1}. Um novo governante sempre traz novos contratos.", "{0}が{1}を統治するようになりました。新たな統治者は、いつも新たな契約をもたらします。", "{0} regiert nun {1}. Ein neuer Herrscher bedeutet immer neue Verträge.", "{0} règne désormais sur {1}. Un nouveau souverain apporte toujours de nouveaux contrats.", "{0} rządzi teraz państwem {1}. Nowy władca zawsze oznacza nowe kontrakty.", "{0}現已統治{1}。新統治者總會帶來新契約。", "{0}이(가) 이제 {1}을(를) 다스립니다. 새 통치자는 언제나 새 계약을 뜻합니다."]],
    ["{0} of Captain {1}'s old crew still block the harbor.", ["{1}船长的旧船员中仍有{0}人封锁着港口。", "{0} человек из старой команды капитана {1} по-прежнему блокируют гавань.", "{0} antiguos tripulantes del capitán {1} aún bloquean el puerto.", "{0} antigos tripulantes do capitão {1} ainda bloqueiam o porto.", "{1}船長の旧乗組員のうち{0}人が、今も港を封鎖しています。", "{0} Besatzungsmitglieder aus der alten Mannschaft von Kapitän {1} blockieren noch immer den Hafen.", "{0} membres de l'ancien équipage du capitaine {1} bloquent toujours le port.", "{0} członków dawnej załogi kapitana {1} wciąż blokuje port.", "{1}船長的舊船員中仍有{0}人封鎖港口。", "{1} 선장의 옛 선원 중 {0}명이 아직도 항구를 봉쇄하고 있습니다."]],
    ["{0} PROCLAIMS A CRUSADE AGAINST {1}", ["{0}宣布对{1}发动十字军东征", "{0} ОБЪЯВЛЯЕТ КРЕСТОВЫЙ ПОХОД ПРОТИВ {1}", "{0} PROCLAMA UNA CRUZADA CONTRA {1}", "{0} PROCLAMA UMA CRUZADA CONTRA {1}", "{0}が{1}に対する十字軍を宣言", "{0} RUFT ZUM KREUZZUG GEGEN {1} AUF", "{0} PROCLAME UNE CROISADE CONTRE {1}", "{0} OGŁASZA KRUCJATĘ PRZECIW {1}", "{0}宣布對{1}發動十字軍東征", "{0}이(가) {1}에 대한 십자군 원정을 선포합니다."]],
    ["{0} returned with the white whale's story. The chase became legend, but the captain finally learned to live beyond it. {1}{2}{3}", ["{0}带着白鲸的故事回来了。追逐已成传奇，但船长终于学会了放下执念，继续生活。{1}{2}{3}", "{0} вернулся с рассказом о Белом ките. Погоня стала легендой, но капитан наконец научился жить дальше. {1}{2}{3}", "{0} regresó con la historia de la ballena blanca. La persecución se volvió leyenda, pero el capitán por fin aprendió a seguir adelante. {1}{2}{3}", "{0} voltou com a história da baleia branca. A perseguição virou lenda, mas o capitão finalmente aprendeu a seguir em frente. {1}{2}{3}", "{0}は白鯨の物語を携えて帰還しました。追跡は伝説となりましたが、船長はついにそれを乗り越えて生きることを学びました。{1}{2}{3}", "{0} kehrte mit der Geschichte des weißen Wals zurück. Die Jagd wurde zur Legende, doch der Kapitän lernte schließlich, sein Leben weiterzuführen. {1}{2}{3}", "{0} est revenu avec l'histoire de la baleine blanche. La chasse est devenue légendaire, mais le capitaine a fini par apprendre à vivre sans elle. {1}{2}{3}", "{0} wrócił z opowieścią o białym wielorybie. Pościg stał się legendą, lecz kapitan w końcu nauczył się żyć dalej. {1}{2}{3}", "{0}帶著白鯨的故事回來了。追逐已成傳奇，但船長終於學會放下執念，繼續生活。{1}{2}{3}", "{0}이(가) 흰고래 이야기를 들고 돌아왔습니다. 추격은 전설이 되었지만, 선장은 마침내 그 일을 딛고 살아가는 법을 배웠습니다. {1}{2}{3}"]],
    ["{0} SETTLEMENT EXPELLED FROM {1}{2}", ["{0}人定居点遭驱逐，离开{1}{2}", "ПОСЕЛЕНИЕ {0} ИЗГНАНО ИЗ {1}{2}", "ASENTAMIENTO {0} EXPULSADO DE {1}{2}", "POVOADO {0} EXPULSO DE {1}{2}", "{1}{2}から{0}人入植地を追放", "SIEDLUNG VON {0} AUS {1}{2} VERTRIEBEN", "COLONIE {0} EXPULSÉE DE {1}{2}", "OSADNICY {0} WYPĘDZENI Z {1}{2}", "{0}人定居點遭驅逐，離開{1}{2}", "{1}{2}에서 {0} 정착민 추방"]],
    ["{0} repelled the landing. {1}", ["{0}击退了登陆部队。{1}", "{0} отбил высадку десанта. {1}", "{0} rechazó el desembarco. {1}", "{0} repeliu o desembarque. {1}", "{0}は上陸部隊を撃退しました。{1}", "{0} wehrte die Landung ab. {1}", "{0} a repoussé le débarquement. {1}", "{0} odparł desant. {1}", "{0}擊退了登陸部隊。{1}", "{0}이(가) 상륙 부대를 격퇴했습니다. {1}"]],
    ["{0} replacements have joined the expedition.", ["{0}名替补人员加入了远征队。", "К экспедиции присоединились {0} человек в качестве пополнения.", "Se han incorporado {0} reemplazos a la expedición.", "{0} substitutos se juntaram à expedição.", "交代要員{0}人が遠征隊に加わりました。", "{0} Ersatzleute sind zur Expedition gestoßen.", "{0} remplaçants ont rejoint l'expédition.", "Do wyprawy dołączyło {0} osób na zastępstwo.", "{0}名替補人員加入了遠征隊。", "대체 인원 {0}명이 원정대에 합류했습니다."]],
    ["{0} TAKEN BY {1} FORCES{2}", ["{0}被{1}军队占领{2}", "{0} захвачен войсками державы {1}{2}", "{0} fue tomado por las fuerzas de {1}{2}", "{0} foi tomado pelas forças de {1}{2}", "{0}は{1}の軍勢に占領されました{2}", "{0} wurde von den Streitkräften von {1} eingenommen{2}", "{0} pris par les forces de {1}{2}", "{0} przejęte przez siły państwa {1}{2}", "{0}被{1}軍隊佔領{2}", "{0}이(가) {1}의 군대에 점령되었습니다{2}"]],
    ["{0} The grain is counted into the granaries and the gunpowder into the magazines.", ["{0}谷物入仓，火药入火药库。", "{0} Зерно поступает в амбары, а порох — в пороховые склады.", "{0} El grano se almacena en los graneros y la pólvora en los polvorines.", "{0} Os grãos vão para os celeiros, e a pólvora, para os paióis.", "{0}穀物は穀倉へ、火薬は火薬庫へ運び込まれます。", "{0} Das Getreide kommt in die Kornspeicher, das Schießpulver in die Pulverkammern.", "{0} Le grain est entreposé dans les greniers et la poudre dans les poudrières.", "{0} Zboże trafia do spichlerzy, a proch do prochowni.", "{0}穀物入倉，火藥入火藥庫。", "{0} 곡물은 곡물 창고에, 화약은 화약고에 보관됩니다."]],
    ["{0} deliveries remain.", ["尚有{0}项交付待完成。", "Осталось выполнить доставок: {0}.", "Quedan {0} entregas.", "Ainda restam {0} entregas.", "残り{0}件の配達があります。", "Noch {0} Lieferungen ausstehend.", "Il reste {0} livraisons.", "Pozostało dostaw: {0}.", "尚有{0}項交付待完成。", "전달할 항목이 {0}건 남았습니다."]],
    ["{0} doubloons for completing the commission.", ["完成委托可获得{0}达布隆。", "{0} дублонов за выполнение поручения.", "{0} doblones por completar el encargo.", "{0} dobrões por concluir o encargo.", "任務完了の報酬: {0}ダブロン。", "{0} Dublonen für den Abschluss des Auftrags.", "{0} doublons pour avoir accompli la mission.", "{0} dublonów za wykonanie zlecenia.", "完成委託可獲得{0}達布隆。", "임무를 완료하면 더블룬 {0}닢을 받습니다."]],
    ["{0} DOUBLOONS - {1} FOR CURRENT SHIP = {2}", ["{0}达布隆 - 当前船只费用{1} = {2}", "{0} дублонов − {1} за текущий корабль = {2}", "{0} doblones − {1} por el barco actual = {2}", "{0} dobrões − {1} pelo navio atual = {2}", "{0}ダブロン − 現在の船の費用 {1} = {2}", "{0} Dublonen − {1} für das aktuelle Schiff = {2}", "{0} doublons − {1} pour le navire actuel = {2}", "{0} dublonów − {1} za obecny statek = {2}", "{0}達布隆 − 目前船隻費用{1} = {2}", "더블룬 {0} − 현재 함선 비용 {1} = {2}"]],
    ["{0} Doubloons {1}. Cargo space {2}/{3}.", ["{0}达布隆 {1}。货舱空间 {2}/{3}。", "{0} дублонов {1}. Место в трюме: {2}/{3}.", "{0} doblones {1}. Espacio de carga: {2}/{3}.", "{0} dobrões {1}. Espaço de carga: {2}/{3}.", "{0}ダブロン {1}。貨物スペース {2}/{3}。", "{0} Dublonen {1}. Laderaum {2}/{3}.", "{0} doublons {1}. Espace de cale : {2}/{3}.", "{0} dublonów {1}. Ładownia {2}/{3}.", "{0}達布隆 {1}。貨艙空間 {2}/{3}。", "더블룬 {0} {1}. 화물 공간 {2}/{3}."]],
    ["{0} Customs Assignment", ["{0}关税收入让渡", "Уступка таможенных доходов: {0}", "Cesión de los ingresos aduaneros de {0}", "Cessão das receitas alfandegárias de {0}", "{0}の関税収入譲渡証書", "{0} Abtretung der Zolleinnahmen", "Cession des recettes douanières de {0}", "Cesja wpływów celnych: {0}", "{0}關稅收入讓渡", "{0} 관세 수입 양도"]],
    ["{0} CONQUISTADORS / {1} DEAD / {2} WOUNDED", ["{0}名征服者 / {1}人阵亡 / {2}人受伤", "{0} КОНКИСТАДОРОВ / {1} ПОГИБЛО / {2} РАНЕНО", "{0} CONQUISTADORES / {1} MUERTOS / {2} HERIDOS", "{0} CONQUISTADORES / {1} MORTOS / {2} FERIDOS", "征服者{0}人 / 死亡{1}人 / 負傷{2}人", "{0} KONQUISTADOREN / {1} TOT / {2} VERWUNDET", "{0} CONQUISTADORES / {1} MORTS / {2} BLESSÉS", "KONKWISTADORZY: {0} / MARTWI: {1} / RANNI: {2}", "{0}名征服者 / {1}人陣亡 / {2}人受傷", "정복자 {0}명 / 사망 {1}명 / 부상 {2}명"]],
    ["{0} CREW LOST", ["{0}名船员阵亡", "ПОГИБЛО ЧЛЕНОВ ЭКИПАЖА: {0}", "TRIPULANTES PERDIDOS: {0}", "TRIPULANTES PERDIDOS: {0}", "乗組員死亡: {0}人", "BESATZUNGSVERLUSTE: {0}", "PERTES DANS L'ÉQUIPAGE : {0}", "STRATY W ZAŁODZE: {0}", "{0}名船員陣亡", "선원 사망: {0}명"]],
    ["{0} CREW LOST ASHORE", ["{0}名船员在岸上遇难", "ПОГИБЛО ЧЛЕНОВ ЭКИПАЖА НА БЕРЕГУ: {0}", "TRIPULANTES PERDIDOS EN TIERRA: {0}", "TRIPULANTES PERDIDOS EM TERRA: {0}", "上陸中に乗組員を{0}人失いました", "BESATZUNGSVERLUSTE AN LAND: {0}", "PERTES DE MEMBRES D'ÉQUIPAGE À TERRE : {0}", "STRATY W ZAŁODZE NA LĄDZIE: {0}", "{0}名船員在岸上遇難", "해안에서 선원 {0}명 사망"]],
    ["{0} can be delivered now", ["{0}现在可以交付", "{0} можно доставить сейчас", "{0} ya se puede entregar", "{0} pode ser entregue agora", "今すぐ{0}を届けられます", "{0} kann jetzt geliefert werden", "{0} peut être livré maintenant", "{0} można już dostarczyć", "{0}現在可以交付", "지금 {0}을(를) 전달할 수 있습니다"]],
    ["{0} cannons", ["{0}门大炮", "{0} пушек", "{0} cañones", "{0} canhões", "{0}門の大砲", "{0} Kanonen", "{0} canons", "{0} armat", "{0}門大砲", "대포 {0}문"]],
    ["{0} CASKS FULL", ["{0}桶已满", "БОЧКИ ПОЛНЫ: {0}", "{0} BARRILES LLENOS", "{0} BARRIS CHEIOS", "樽が{0}個満杯", "{0} FÄSSER VOLL", "{0} FÛTS PLEINS", "BECZKI {0} PEŁNE", "{0}桶已滿", "캐스크 {0}개 가득 참"]],
    ["{0} at last. I had nearly forgotten how a familiar harbor sounds.", ["终于到达{0}了。我几乎忘了熟悉港口的声音。", "Наконец-то мы в {0}. Я почти забыл, как звучит знакомая гавань.", "Por fin llegamos a {0}. Casi había olvidado el sonido de un puerto conocido.", "Finalmente chegamos a {0}. Eu quase tinha esquecido o som de um porto conhecido.", "ようやく{0}に着きました。聞き慣れた港の音を忘れかけていました。", "Endlich wieder in {0}. Ich hatte fast vergessen, wie ein vertrauter Hafen klingt.", "Enfin de retour à {0}. J'avais presque oublié le son d'un port familier.", "Nareszcie jesteśmy w {0}. Prawie nie pamiętam już, jak brzmi znajomy port.", "終於抵達{0}了。我幾乎忘了熟悉港口的聲音。", "드디어 {0}에 도착했습니다. 익숙한 항구의 소리를 거의 잊을 뻔했습니다."]],
    ["{0} at last. The treasury will settle our account.", ["终于到达{0}了。国库会替我们结清这笔账。", "Наконец-то {0}. Казна рассчитается с нами.", "Por fin, {0}. El tesoro saldará nuestra deuda.", "Finalmente, {0}. O tesouro acertará nossas contas.", "ようやく{0}です。国庫が借りを清算してくれます。", "Endlich {0}. Die Staatskasse wird unsere Forderung begleichen.", "Enfin, {0}. Le Trésor réglera notre compte.", "Nareszcie {0}. Skarb Państwa ureguluje naszą należność.", "終於抵達{0}了。國庫會替我們結清這筆帳。", "드디어 {0}에 도착했습니다. 국고에서 받을 돈을 정산해 줄 것입니다."]],
    ["{0} away.", ["{0}远。", "{0} отсюда.", "a {0} de distancia.", "a {0} de distância.", "{0}ほど離れています。", "{0} entfernt.", "à {0}.", "{0} dalej.", "{0}遠。", "{0} 떨어져 있습니다."]],
    ["{0} ADOPTED: +{1} DB", ["{0}已获收养：+{1} DB", "ПРИЮТИЛИ {0}: +{1} DB", "ADOPCIÓN DE {0}: +{1} DB", "ADOÇÃO DE {0}: +{1} DB", "{0}を引き取りました: +{1} DB", "{0} AUFGENOMMEN: +{1} DB", "ADOPTION DE {0} : +{1} DB", "ADOPTOWANO: {0} +{1} DB", "{0}已獲收養：+{1} DB", "{0} 입양: +{1} DB"]],
    ["{0} batteries will remain to refit after this one.", ["完成这座后，还需改装{0}座炮台。", "После этой останется переоборудовать ещё {0} артиллерийских батарей.", "Después de esta, quedarán {0} baterías por reacondicionar.", "Depois desta, ainda restarão {0} baterias para reequipar.", "この砲台の後、あと{0}か所の砲台を改装します。", "Nach dieser müssen noch {0} Geschützbatterien umgerüstet werden.", "Après celle-ci, il restera {0} batteries d'artillerie à rééquiper.", "Po tej pozostaną jeszcze {0} baterie artyleryjskie do przezbrojenia.", "完成這座後，還需改裝{0}座砲台。", "이 포대를 개조한 뒤에도 {0}개 포대를 더 개조해야 합니다."]],
    ["{0}'s artillery crews are waiting for the Portuguese gun patterns and test pieces. {1} batteries will remain to refit after this one.", ["{0}的炮兵正在等候葡萄牙火炮图样和试制炮。完成这座后，还需改装{1}座炮台。", "Артиллерийские расчёты {0} ждут чертежи португальских орудий и образцы для испытаний. После этой останется переоборудовать ещё {1} артиллерийских батарей.", "Las dotaciones de artillería de {0} esperan los planos de los cañones portugueses y las piezas de prueba. Después de esta, quedarán {1} baterías por reacondicionar.", "As guarnições de artilharia de {0} aguardam os projetos dos canhões portugueses e as peças de teste. Depois desta, ainda restarão {1} baterias para reequipar.", "{0}の砲兵はポルトガル砲の設計図と試験用の砲を待っています。この砲台の後、あと{1}か所を改装します。", "Die Artilleriebesatzungen von {0} warten auf die portugiesischen Geschützmuster und Versuchsstücke. Danach müssen noch {1} Geschützbatterien umgerüstet werden.", "Les artilleurs de {0} attendent les plans des canons portugais et les pièces d'essai. Après celle-ci, il restera {1} batteries d'artillerie à rééquiper.", "Obsługi artylerii w {0} czekają na portugalskie wzory dział i egzemplarze próbne. Po tej pozostaną jeszcze {1} baterie artyleryjskie do przezbrojenia.", "{0}的砲兵正在等候葡萄牙火砲圖樣和試製砲。完成這座後，還需改裝{1}座砲台。", "{0}의 포병대는 포르투갈 대포 설계도와 시험용 포를 기다리고 있습니다. 이 포대를 개조한 뒤에도 {1}개 포대를 더 개조해야 합니다."]],
    ["{0} BECOMES ROMAN EMPEROR", ["{0}成为罗马皇帝", "{0} СТАНОВИТСЯ РИМСКИМ ИМПЕРАТОРОМ", "{0} SE CONVIERTE EN EMPERADOR ROMANO", "{0} TORNA-SE IMPERADOR ROMANO", "{0}がローマ皇帝に即位", "{0} WIRD RÖMISCHER KAISER", "{0} DEVIENT EMPEREUR ROMAIN", "{0} ZOSTAJE CESARZEM RZYMSKIM", "{0}成為羅馬皇帝", "{0}이 로마 황제가 되었습니다"]],
    ["{0} asks to be released from {1}'s overlordship.", ["{0}请求解除对{1}的臣属关系。", "{0} просит освободиться от верховной власти {1}.", "{0} pide liberarse del señorío de {1}.", "{0} pede para se libertar da suserania de {1}.", "{0}は{1}の宗主権から解放されるよう求めています。", "{0} bittet darum, aus der Oberherrschaft von {1} entlassen zu werden.", "{0} demande à être libéré de la suzeraineté de {1}.", "{0} prosi o uwolnienie spod zwierzchnictwa {1}.", "{0}要求解除對{1}的臣屬關係。", "{0}은(는) {1}의 종주권에서 벗어나게 해 달라고 요청합니다."]],
    ["{0} and {1} married and had {2} children.", ["{0}和{1}结婚并育有{2}个孩子。", "{0} и {1} поженились, у них родилось {2} детей.", "{0} y {1} se casaron y tuvieron {2} hijos.", "{0} e {1} se casaram e tiveram {2} filhos.", "{0}と{1}は結婚し、{2}人の子どもをもうけました。", "{0} und {1} heirateten und hatten {2} Kinder.", "{0} et {1} se sont mariés et ont eu {2} enfants.", "{0} i {1} pobrali się i mieli {2} dzieci.", "{0}和{1}結婚並育有{2}名子女。", "{0}과 {1}은 결혼하여 자녀 {2}명을 두었습니다."]],
    ["{0} and {1} form an alliance.", ["{0}和{1}结成联盟。", "{0} и {1} образуют альянс.", "{0} y {1} forman una alianza.", "{0} e {1} formam uma aliança.", "{0}と{1}は同盟を結びました。", "{0} und {1} bilden eine Allianz.", "{0} et {1} forment une alliance.", "{0} i {1} tworzą sojusz.", "{0}和{1}結成聯盟。", "{0}과 {1}이 동맹을 맺습니다."]],
    ["{0} and {1} make peace.", ["{0}和{1}讲和。", "{0} и {1} заключают мир.", "{0} y {1} hacen las paces.", "{0} e {1} fazem as pazes.", "{0}と{1}は和解します。", "{0} und {1} schließen Frieden.", "{0} et {1} font la paix.", "{0} i {1} zawierają pokój.", "{0}和{1}講和。", "{0}과 {1}은 평화 협정을 맺습니다."]],
    ["- OVERFISHED", ["- 已过度捕捞", "- ПЕРЕЛОВЛЕНО", "- SOBREPESCADA", "- SOBREXPLOTADO", "- 乱獲された", "- ÜBERFISCHT", "- SUREXPLOITÉ", "- PRZEŁOWIONE", "- 已遭過度捕撈", "- 남획됨"]],
    ["(WIP)", ["（开发中）", "(В РАЗРАБОТКЕ)", "(EN DESARROLLO)", "(EM DESENVOLVIMENTO)", "(開発中)", "(IN ARBEIT)", "(EN COURS)", "(W TRAKCIE PRAC)", "（開發中）", "(개발 중)"]],
    ["LABOR (WIP)", ["劳工（开发中）", "ТРУД (В РАЗРАБОТКЕ)", "MANO DE OBRA (EN DESARROLLO)", "TRABALHO (EM DESENVOLVIMENTO)", "労働力（開発中）", "ARBEIT (IN ARBEIT)", "MAIN-D'ŒUVRE (EN COURS)", "PRACA (W TRAKCIE PRAC)", "勞工（開發中）", "노동(개발 중)"]],
    ["{0} A timely resupply earns {1} doubloons and gives {2} the stores it needs to become a permanent city.", ["{0}及时补给可赚取{1}达布隆，并为{2}提供建成永久城市所需的物资。", "{0}Своевременное пополнение запасов принесёт {1} дублонов и даст {2} необходимые припасы, чтобы стать постоянным городом.", "{0}El reabastecimiento a tiempo reporta {1} doblones y aporta a {2} los suministros necesarios para convertirse en ciudad permanente.", "{0}Um reabastecimento a tempo rende {1} dobrões e fornece a {2} os mantimentos necessários para se tornar uma cidade permanente.", "{0}期日どおりの補給で{1}ダブロンを得られ、{2}が恒久都市になるために必要な物資も届けられます。", "{0}Eine rechtzeitige Nachlieferung bringt {1} Dublonen ein und versorgt {2} mit den nötigen Vorräten für den Aufbau zu einer dauerhaften Stadt.", "{0}Un ravitaillement à temps rapporte {1} doublons et fournit à {2} les réserves nécessaires pour devenir une ville permanente.", "{0}Terminowe zaopatrzenie przynosi {1} dublonów i dostarcza {2} zapasów potrzebnych, by stało się ono stałym miastem.", "{0}及時補給可賺取{1}達布隆，並為{2}提供建成永久城市所需的物資。", "{0}제때 보급하면 더블룬 {1}닢을 얻고, {2}이 영구 도시가 되는 데 필요한 물자를 공급합니다."]],
    ["{0} A timely resupply earns {1} doubloons and", ["{0}及时补给可赚取{1}达布隆，并", "{0} За своевременное пополнение запасов можно получить {1} дублонов и", "{0} El reabastecimiento a tiempo reporta {1} doblones y", "{0} Um reabastecimento a tempo rende {1} dobrões e", "{0} 期日どおりの補給で{1}ダブロンを得られ、", "{0} Eine rechtzeitige Nachlieferung bringt {1} Dublonen ein und", "{0} Un ravitaillement à temps rapporte {1} doublons et", "{0} Terminowe zaopatrzenie przynosi {1} dublonów i", "{0}及時補給可賺取{1}達布隆，並", "{0} 제때 보급하면 더블룬 {1}닢을 얻고"]],
    ["Home waters. I have steered by strange stars for months, but I know this channel by heart.", ["故乡海域。我已凭借陌生的星辰航行数月，却对这条航道了如指掌。", "Родные воды. Месяцами я прокладывал курс по незнакомым звёздам, но этот пролив знаю наизусть.", "Aguas familiares. Durante meses he navegado guiándome por estrellas desconocidas, pero conozco este canal de memoria.", "Águas conhecidas. Naveguei por meses guiado por estrelas estranhas, mas conheço este canal de cor.", "故郷の海だ。何か月も見知らぬ星を頼りに航海してきたが、この水路は熟知している。", "Heimische Gewässer. Monatelang habe ich mich nach fremden Sternen gerichtet, doch diese Fahrrinne kenne ich auswendig.", "Eaux familières. J'ai navigué des mois en me guidant sur des étoiles inconnues, mais je connais ce chenal par cœur.", "Znajome wody. Przez miesiące żeglowałem według obcych gwiazd, ale ten kanał znam na pamięć.", "故鄉海域。我已憑藉陌生的星辰航行數月，卻對這條航道瞭如指掌。", "고향 바다다. 몇 달 동안 낯선 별을 길잡이 삼아 항해했지만, 이 물길은 눈감고도 안다."]],
    ["{0} ISSUES A PAPAL BULL FOR {1}", ["{0}颁布支持{1}的教宗诏书", "{0} ИЗДАЁТ ПАПСКУЮ БУЛЛУ В ПОДДЕРЖКУ {1}", "{0} EMITE UNA BULA PAPAL EN FAVOR DE {1}", "{0} EMITE UMA BULA PAPAL EM FAVOR DE {1}", "{0}が{1}を支持する教皇勅書を発布", "{0} ERLÄSST EINE PÄPSTLICHE BULLE FÜR {1}", "{0} PROMULGUE UNE BULLE PONTIFICALE EN FAVEUR DE {1}", "{0} WYDAJE BULLĘ PAPIESKĄ NA RZECZ {1}", "{0}頒布支持{1}的教宗詔書", "{0}이(가) {1}을(를) 지지하는 교황 교서를 반포"]],
    ["CREW MEMBER ADDED: {0}", ["新船员加入：{0}", "НОВЫЙ ЧЛЕН ЭКИПАЖА: {0}", "NUEVO TRIPULANTE: {0}", "NOVO TRIPULANTE: {0}", "乗組員が加入：{0}", "NEUES CREWMITGLIED: {0}", "NOUVEAU MEMBRE D'ÉQUIPAGE : {0}", "NOWY CZŁONEK ZAŁOGI: {0}", "新船員加入：{0}", "새 선원 합류: {0}"]],
    ["{0} joined the crew as ship's cook.", ["{0}加入船员，担任船上厨师。", "{0} поступил на корабль судовым поваром.", "{0} se incorporó a la tripulación como cocinero de a bordo.", "{0} entrou para a tripulação como cozinheiro de bordo.", "{0}が船乗りたちの料理人として加わりました。", "{0} kam als Schiffskoch an Bord.", "{0} a rejoint l'équipage comme cuisinier de bord.", "{0} dołączył do załogi jako okrętowy kucharz.", "{0}加入船員，擔任船上廚師。", "{0}이(가) 선상 요리사로 선원에 합류했습니다."]],
    ["{0} JOINS {1} IN WAR AGAINST {2}", ["{0}加入{1}一方，与{2}交战", "{0} ВСТУПАЕТ В ВОЙНУ НА СТОРОНЕ {1} ПРОТИВ {2}", "{0} SE UNE A {1} EN LA GUERRA CONTRA {2}", "{0} SE JUNTA A {1} NA GUERRA CONTRA {2}", "{0}が{1}に加勢し、{2}と交戦", "{0} TRITT AUF SEITEN VON {1} IN DEN KRIEG GEGEN {2} EIN", "{0} REJOINT {1} DANS LA GUERRE CONTRE {2}", "{0} DOŁĄCZA DO {1} W WOJNIE PRZECIW {2}", "{0}加入{1}一方，與{2}交戰", "{0}이(가) {1} 편에 서서 {2}와의 전쟁에 참전"]],
    ["{0} construction labor underway", ["{0}施工人工费", "{0}: СТРОИТЕЛЬНЫЕ РАБОТЫ", "{0}: MANO DE OBRA DE CONSTRUCCIÓN", "{0}: MÃO DE OBRA DA CONSTRUÇÃO", "{0}の建造作業費", "{0}: BAUARBEITEN", "{0} : MAIN-D'ŒUVRE DE CONSTRUCTION", "{0}: ROBOCIZNA PRZY BUDOWIE", "{0}施工人工費", "{0} 건조 인건비"]],
    ["{0} Let us sail to {1}.", ["{0}让我们驶往{1}。", "{0} Отправимся в плавание к {1}.", "{0} Naveguemos hacia {1}.", "{0} Vamos navegar até {1}.", "{0}、{1}へ航海しましょう。", "{0} Segeln wir nach {1}.", "{0} Mettons le cap sur {1}.", "{0} Płyńmy do {1}.", "{0}讓我們駛往{1}。", "{0} {1}(으)로 항해합시다."]],
    ["{0} ENDS ITS BAN ON {1} GOODS", ["{0}解除对{1}商品的禁令", "{0} ОТМЕНЯЕТ ЗАПРЕТ НА ТОВАРЫ ИЗ {1}", "{0} LEVANTA LA PROHIBICIÓN DE COMERCIAR CON PRODUCTOS DE {1}", "{0} ENCERRA O EMBARGO AOS PRODUTOS DE {1}", "{0}が{1}産品の禁輸を解除", "{0} HEBT DAS HANDELSVERBOT FÜR WAREN AUS {1} AUF", "{0} LÈVE L'INTERDICTION DES MARCHANDISES DE {1}", "{0} ZNOSI ZAKAZ HANDLU TOWARAMI Z {1}", "{0}解除對{1}商品的禁令", "{0}이(가) {1}산 상품에 대한 금수 조치를 해제"]],
    ["{0} ship supplies and armament restock", ["{0}船舶物资与武器补给", "Пополнение запасов и вооружения: {0}", "Reaprovisionamiento y armamento del buque: {0}", "Reabastecimento e armamento do navio: {0}", "{0}の船用品・武装補充", "Schiffsvorräte und Bewaffnung auffüllen: {0}", "Réapprovisionnement et armement du navire : {0}", "Uzupełnienie zapasów i uzbrojenia statku: {0}", "{0}船舶物資與武器補給", "{0} 선박 보급품 및 무장 재보충"]],
    ["{0} is aboard, waiting to sail to {1}.", ["{0} 已在船上等候，准备驶往{1}。", "{0} на борту и ждёт отплытия в {1}.", "{0} está a bordo, a la espera de zarpar hacia {1}.", "{0} está a bordo, aguardando para zarpar rumo a {1}.", "{0}は乗船し、{1}へ向けて出航するのを待っています。", "{0} ist an Bord und wartet auf die Abfahrt nach {1}.", "{0} est à bord et attend de mettre le cap sur {1}.", "{0} jest na pokładzie i czeka na wypłynięcie do {1}.", "{0} 已在船上等候，準備駛往{1}。", "{0}이(가) 승선해 {1}(으)로 출항하기를 기다리고 있습니다."]],
    ["{0} may receive a public mark of Papal favor.", ["教宗可能公开表示对{0}的嘉许。", "Папа может публично выразить благосклонность к державе {0}.", "El Papa podría mostrar públicamente su favor a {0}.", "O Papa pode demonstrar publicamente seu favor a {0}.", "教皇は{0}への支持を公に示すかもしれません。", "Der Papst könnte {0} öffentlich seine Gunst erweisen.", "Le pape pourrait témoigner publiquement sa faveur à {0}.", "Papież może publicznie okazać przychylność państwu {0}.", "教宗可能公開表達對{0}的嘉許。", "교황이 {0}에 대한 호의를 공개적으로 표할 수 있습니다."]],
    ["{0} may receive a public mark of Papal favor. His Holiness first wants a captain whose eyes are not those of a courtier.", ["教宗可能公开表示对{0}的嘉许。圣座首先需要一位不受宫廷视角局限的船长。", "Папа может публично выразить благосклонность к державе {0}. Его Святейшеству прежде всего нужен капитан с независимым взглядом на мир.", "El Papa podría mostrar públicamente su favor a {0}. Su Santidad busca primero a un capitán con una visión independiente del mundo.", "O Papa pode demonstrar publicamente seu favor a {0}. Sua Santidade primeiro procura um capitão com uma visão independente do mundo.", "教皇は{0}への支持を公に示すかもしれません。まずは世俗の宮廷にとらわれない視点を持つ船長が必要です。", "Der Papst könnte {0} öffentlich seine Gunst erweisen. Seine Heiligkeit sucht zunächst einen Kapitän mit unabhängigem Blick auf die Welt.", "Le pape pourrait témoigner publiquement sa faveur à {0}. Sa Sainteté cherche d'abord un capitaine au regard indépendant sur le monde.", "Papież może publicznie okazać przychylność państwu {0}. Jego Świątobliwość szuka przede wszystkim kapitana o niezależnym spojrzeniu na świat.", "教宗可能公開表達對{0}的嘉許。聖座首先需要一位不受宮廷視角局限的船長。", "교황이 {0}에 대한 호의를 공개적으로 표할 수 있습니다. 성하께서는 먼저 세상을 독립적인 시각으로 바라보는 선장을 찾으십니다."]],
    ["The Pope may publicly commend {0}.", ["教宗可能公开嘉奖{0}。", "Папа может публично отметить заслуги державы {0}.", "El Papa podría elogiar públicamente a {0}.", "O Papa pode elogiar publicamente {0}.", "教皇は{0}を公に称賛するかもしれません。", "Der Papst könnte {0} öffentlich loben.", "Le pape pourrait louer publiquement {0}.", "Papież może publicznie pochwalić państwo {0}.", "教宗可能公開嘉獎{0}。", "교황이 {0}을(를) 공개적으로 치하할 수 있습니다."]],
    ["The Pope may publicly commend {0}. His Holiness first seeks a captain with an independent view of the world.", ["教宗可能公开嘉奖{0}。圣座首先需要一位视野独立的船长。", "Папа может публично отметить заслуги державы {0}. Его Святейшество ищет капитана с независимым взглядом на мир.", "El Papa podría elogiar públicamente a {0}. Su Santidad busca primero a un capitán con una visión independiente del mundo.", "O Papa pode elogiar publicamente {0}. Sua Santidade primeiro procura um capitão com uma visão independente do mundo.", "教皇は{0}を公に称賛するかもしれません。まずは独立した視野を持つ船長をお求めです。", "Der Papst könnte {0} öffentlich loben. Seine Heiligkeit sucht zunächst einen Kapitän mit unabhängigem Blick auf die Welt.", "Le pape pourrait louer publiquement {0}. Sa Sainteté cherche d'abord un capitaine au regard indépendant sur le monde.", "Papież może publicznie pochwalić państwo {0}. Jego Świątobliwość szuka przede wszystkim kapitana o niezależnym spojrzeniu na świat.", "教宗可能公開嘉獎{0}。聖座首先需要一位視野獨立的船長。", "교황이 {0}을(를) 공개적으로 치하할 수 있습니다. 성하께서는 먼저 세상을 독립적인 시각으로 바라보는 선장을 찾으십니다."]],
    ["I still owe {0} about {1} doubloons.", ["我仍欠{0}约{1}达布隆。", "Я всё ещё должен державе {0} около {1} дублонов.", "Aún le debo unos {1} doblones a {0}.", "Ainda devo cerca de {1} dobrões a {0}.", "{0}にまだ約{1}ダブロンを返していません。", "Ich schulde {0} noch etwa {1} Dublonen.", "Je dois encore environ {1} doublons à {0}.", "Wciąż jestem winien {0} około {1} dublonów.", "我仍欠{0}約{1}達布隆。", "아직 {0}에게 더블룬 {1}닢가량을 빚지고 있습니다."]],
    ["I still owe {0} about {1} doubloons. Every profitable voyage brings the family estate closer to being debt-free.", ["我仍欠{0}约{1}达布隆。每次航行赚到钱，家族产业就离还清债务更近一步。", "Я всё ещё должен державе {0} около {1} дублонов. Каждый прибыльный рейс приближает семейное поместье к полному расчёту с долгами.", "Aún le debo unos {1} doblones a {0}. Cada viaje rentable acerca a la familia a saldar su deuda.", "Ainda devo cerca de {1} dobrões a {0}. Cada viagem lucrativa aproxima a família de quitar a dívida.", "{0}にまだ約{1}ダブロンを返していません。航海で利益を上げるたび、家の借金を完済する日が近づきます。", "Ich schulde {0} noch etwa {1} Dublonen. Jede gewinnbringende Reise bringt die Familie der Schuldenfreiheit näher.", "Je dois encore environ {1} doublons à {0}. Chaque voyage rentable rapproche la famille du remboursement intégral.", "Wciąż jestem winien {0} około {1} dublonów. Każdy zyskowny rejs przybliża rodzinę do spłaty długu.", "我仍欠{0}約{1}達布隆。每次航行賺到錢，家族產業就離還清債務更近一步。", "아직 {0}에게 더블룬 {1}닢가량을 빚지고 있습니다. 수익성 있는 항해를 할 때마다 집안의 빚을 갚는 날이 가까워집니다."]],
    ["{0} Thank you, Captain. Our guests have eaten well. Now I long for adventure beyond this shore. Take me aboard, and I will make your provisions last longer.", ["{0}多谢船长。客人们吃得尽兴。如今我渴望去远方冒险。带我上船，我会让你的补给更耐用。", "{0} Благодарю, капитан. Наши гости сыты. Теперь я жажду приключений за этим берегом. Возьмите меня на борт, и ваши припасы будут расходоваться экономнее.", "{0} Gracias, capitán. Nuestros invitados han comido bien. Ahora anhelo aventuras más allá de esta costa. Llévame a bordo y haré que tus provisiones duren más.", "{0} Obrigado, capitão. Nossos convidados comeram bem. Agora quero viver aventuras além desta costa. Leve-me a bordo e farei seus mantimentos durarem mais.", "{0}船長、ありがとうございます。客人たちは満足したようです。今度はこの海岸の向こうへ冒険に出たい。船に乗せてくだされば、食料を長持ちさせます。", "{0} Danke, Kapitän. Unsere Gäste sind satt geworden. Nun zieht es mich zu Abenteuern jenseits dieser Küste. Nehmt mich an Bord, dann reichen Eure Vorräte länger.", "{0} Merci, capitaine. Nos invités ont bien mangé. J'aspire maintenant à l'aventure au-delà de ce rivage. Emmenez-moi à bord et je ferai durer vos provisions.", "{0} Dziękuję, kapitanie. Nasi goście dobrze jedli. Teraz marzę o przygodach za tym brzegiem. Zabierz mnie na pokład, a twoje zapasy wystarczą na dłużej.", "{0}多謝船長。客人們吃得盡興。如今我渴望去遠方冒險。帶我上船，我會讓你的補給更耐用。", "{0} 감사합니다, 선장님. 손님들이 잘 먹었습니다. 이제 이 해안 너머의 모험을 떠나고 싶습니다. 저를 승선시키면 식량을 더 오래 쓰도록 돕겠습니다."]],
    ["{0} new harbors have their first homes and storehouses because of your voyages. Few captains leave such a mark on the map.", ["你的航行让{0}座新港有了最初的民居与仓库。很少有船长能在地图上留下这样的印记。", "Благодаря вашим плаваниям в {0} новых гаванях появились первые дома и склады. Мало кто из капитанов оставляет такой след на карте.", "Gracias a tus viajes, {0} nuevos puertos ya tienen sus primeras casas y almacenes. Pocos capitanes dejan una huella así en el mapa.", "Graças às suas viagens, {0} novos portos já têm suas primeiras casas e armazéns. Poucos capitães deixam uma marca assim no mapa.", "あなたの航海のおかげで、{0}か所の新しい港に最初の住居と倉庫が建ちました。地図にこれほどの足跡を残す船長は稀です。", "Dank Eurer Reisen entstanden in {0} neuen Häfen die ersten Wohnhäuser und Lager. Nur wenige Kapitäne hinterlassen solche Spuren auf der Karte.", "Grâce à vos voyages, {0} nouveaux ports ont désormais leurs premières maisons et leurs premiers entrepôts. Peu de capitaines laissent une telle empreinte sur la carte.", "Dzięki twoim podróżom w {0} nowych portach powstały pierwsze domy i magazyny. Niewielu kapitanów zostawia taki ślad na mapie.", "你的航行讓{0}座新港有了最初的民居與倉庫。很少有船長能在地圖上留下這樣的印記。", "당신의 항해 덕분에 새 항구 {0}곳에 첫 주택과 창고가 들어섰습니다. 지도에 이런 흔적을 남기는 선장은 드뭅니다."]],
    ["My book now records {0} of {1} creatures. Stay alert whenever you go ashore.", ["我的图鉴已记录{1}种生物中的{0}种。每次上岸都请留意新发现。", "В моей книге описаны {0} из {1} существ. Будьте внимательны всякий раз, выходя на берег.", "Ya he registrado {0} de las {1} criaturas en mi libro. Mantente alerta cada vez que desembarques.", "Meu livro já registra {0} das {1} criaturas. Fique atento sempre que desembarcar.", "図鑑には{1}種中{0}種を記録しました。上陸したら新たな生き物に目を配ってください。", "Mein Buch verzeichnet nun {0} von {1} Tierarten. Haltet bei jeder Landung Ausschau nach weiteren.", "Mon livre recense désormais {0} créatures sur {1}. Restez à l'affût à chaque débarquement.", "Moja księga opisuje już {0} z {1} gatunków. Wypatruj kolejnych za każdym razem, gdy schodzisz na ląd.", "我的圖鑑已記錄{1}種生物中的{0}種。每次上岸都請留意新發現。", "내 도감에 {1}종 가운데 {0}종을 기록했습니다. 상륙할 때마다 새로운 생물을 살펴보세요."]],
    ["My book now records {0} of {1} creatures in these seas. Stay alert whenever you go ashore.", ["我的图鉴已记录这些海域{1}种生物中的{0}种。每次上岸都请留意新发现。", "В моей книге описаны {0} из {1} существ этих морей. Будьте внимательны всякий раз, выходя на берег.", "Ya he registrado {0} de las {1} criaturas de estos mares en mi libro. Mantente alerta cada vez que desembarques.", "Meu livro já registra {0} das {1} criaturas destes mares. Fique atento sempre que desembarcar.", "この海域の{1}種中{0}種を図鑑に記録しました。上陸したら新たな生き物に目を配ってください。", "Mein Buch verzeichnet nun {0} von {1} Tierarten dieser Meere. Haltet bei jeder Landung Ausschau nach weiteren.", "Mon livre recense désormais {0} des {1} créatures de ces mers. Restez à l'affût à chaque débarquement.", "Moja księga opisuje już {0} z {1} gatunków tych mórz. Wypatruj kolejnych za każdym razem, gdy schodzisz na ląd.", "我的圖鑑已記錄這些海域{1}種生物中的{0}種。每次上岸都請留意新發現。", "이 바다의 {1}종 가운데 {0}종을 내 도감에 기록했습니다. 상륙할 때마다 새로운 생물을 살펴보세요."]],
    ["The treasure is aboard, but {0} former crew members of Captain {1} still block the way home to {2}.", ["宝藏已在船上，但船长{1}的{0}名前船员仍挡着我们回{2}的路。", "Сокровище на борту, но {0} бывших моряков капитана {1} всё ещё преграждают путь домой, в {2}.", "El tesoro está a bordo, pero {0} antiguos tripulantes del capitán {1} aún bloquean el regreso a {2}.", "O tesouro está a bordo, mas {0} antigos tripulantes do capitão {1} ainda bloqueiam o caminho de volta para {2}.", "宝は船に積みましたが、船長{1}の元乗組員{0}人が、まだ{2}への帰路を塞いでいます。", "Der Schatz ist an Bord, doch {0} ehemalige Besatzungsmitglieder von Kapitän {1} versperren noch den Heimweg nach {2}.", "Le trésor est à bord, mais {0} anciens marins du capitaine {1} bloquent encore le retour vers {2}.", "Skarb jest na pokładzie, lecz {0} byłych członków załogi kapitana {1} wciąż blokuje drogę powrotną do {2}.", "寶藏已在船上，但船長{1}的{0}名前船員仍擋著我們回{2}的路。", "보물은 배에 실었지만, {0}명의 {1} 선장 옛 선원들이 아직 {2}(으)로 돌아가는 길을 막고 있습니다."]],
    ["The flag of {1} now flies over {0}.", ["{0}上空如今飘扬着{1}的旗帜。", "Над {0} теперь развевается флаг державы {1}.", "La bandera de {1} ya ondea sobre {0}.", "A bandeira de {1} agora tremula sobre {0}.", "{0}には今、{1}の旗が掲げられています。", "Über {0} weht nun die Flagge von {1}.", "Le drapeau de {1} flotte désormais sur {0}.", "Nad {0} powiewa teraz flaga państwa {1}.", "{0}上空如今飄揚著{1}的旗幟。", "이제 {0} 상공에 {1}의 깃발이 휘날립니다."]],
    ["{0} SAFE PASSAGE {1} DAYS", ["{0}安全通行 {1}天", "БЕЗОПАСНЫЙ ПРОХОД ДЕРЖАВЫ {0}: {1} ДН.", "PASO SEGURO DE {0}: {1} DÍAS", "PASSAGEM SEGURA DE {0}: {1} DIAS", "{0}の安全通行：{1}日間", "SICHERE DURCHFAHRT FÜR {0}: {1} TAGE", "PASSAGE SÛR POUR {0} : {1} JOURS", "BEZPIECZNE PRZEJŚCIE DLA {0}: {1} DNI", "{0}安全通行 {1}天", "{0} 안전 통행: {1}일"]],
    ["{0} DIPLOMATIC SAFE PASSAGE {1} DAYS", ["{0}外交安全通行 {1}天", "ДИПЛОМАТИЧЕСКИЙ ПРОХОД ДЕРЖАВЫ {0}: {1} ДН.", "PASO DIPLOMÁTICO SEGURO DE {0}: {1} DÍAS", "PASSAGEM DIPLOMÁTICA SEGURA DE {0}: {1} DIAS", "{0}の外交安全通行：{1}日間", "DIPLOMATISCHE SICHERE DURCHFAHRT FÜR {0}: {1} TAGE", "PASSAGE DIPLOMATIQUE SÛR POUR {0} : {1} JOURS", "BEZPIECZNE PRZEJŚCIE DYPLOMATYCZNE DLA {0}: {1} DNI", "{0}外交安全通行 {1}天", "{0} 외교 안전 통행: {1}일"]],
    ["{0} safe-passage toll", ["{0}安全通行费", "ПЛАТА ЗА БЕЗОПАСНЫЙ ПРОХОД: {0}", "PEAJE POR PASO SEGURO: {0}", "PEDÁGIO POR PASSAGEM SEGURA: {0}", "{0}の安全通行料", "ZOLL FÜR SICHERE DURCHFAHRT: {0}", "PÉAGE POUR PASSAGE SÛR : {0}", "OPŁATA ZA BEZPIECZNE PRZEJŚCIE: {0}", "{0}安全通行費", "{0} 안전 통행료"]],
    ["{0} LOOTED +{1} DB", ["{0}被洗劫 +{1} DB", "{0} РАЗГРАБЛЕН: +{1} ДБ", "{0} SAQUEADO: +{1} DB", "{0} SAQUEADO: +{1} DB", "{0}を略奪：+{1}ダブロン", "{0} GEPLÜNDERT: +{1} DB", "{0} PILLÉ : +{1} DB", "{0} ZŁUPIONO: +{1} DB", "{0}被洗劫 +{1} DB", "{0} 약탈: +{1} DB"]],
    ["{0} PREPARES AN OFFICIAL MESSAGE FOR {1}", ["{0}为{1}准备官方文书", "{0} ГОТОВИТ ОФИЦИАЛЬНОЕ ПОСЛАНИЕ ДЛЯ {1}", "{0} PREPARA UN MENSAJE OFICIAL PARA {1}", "{0} PREPARA UMA MENSAGEM OFICIAL PARA {1}", "{0}が{1}宛ての公文書を準備", "{0} BEREITET EINE AMTLICHE BOTSCHAFT FÜR {1} VOR", "{0} PRÉPARE UN MESSAGE OFFICIEL POUR {1}", "{0} PRZYGOTOWUJE OFICJALNĄ WIADOMOŚĆ DLA {1}", "{0}為{1}準備官方文書", "{0}이(가) {1}에게 보낼 공식 서신을 준비합니다"]],
    ["{0} proclaims a crusade against {1}", ["{0}宣布对{1}发动十字军", "{0} объявляет крестовый поход против {1}", "{0} proclama una cruzada contra {1}", "{0} proclama uma cruzada contra {1}", "{0}が{1}に対する十字軍を宣言", "{0} ruft zum Kreuzzug gegen {1} auf", "{0} proclame une croisade contre {1}", "{0} ogłasza krucjatę przeciwko {1}", "{0}宣告對{1}發動十字軍", "{0}이(가) {1}을(를) 상대로 십자군을 선포합니다"]],
    ["{0} raises the blockade of {1}", ["{0}解除了对{1}的封锁", "{0} снимает блокаду {1}", "{0} levanta el bloqueo de {1}", "{0} suspende o bloqueio a {1}", "{0}が{1}の封鎖を解く", "{0} hebt die Blockade von {1} auf", "{0} lève le blocus de {1}", "{0} znosi blokadę {1}", "{0}解除了對{1}的封鎖", "{0}이(가) {1}의 봉쇄를 해제합니다"]],
    ["{0} Rare gear like this earns its berth on a working ship.", ["{0} 这样的稀有装备，值得配备在常年航行的船上。", "{0} Для такой редкой оснастки найдётся место на ходовом корабле.", "{0} Un equipo tan poco común merece un lugar en un barco en servicio.", "{0} Um equipamento tão raro merece lugar a bordo de um navio em serviço.", "{0} これほど珍しい装備なら、現役の船に載せる価値があります。", "{0} So seltene Ausrüstung verdient einen Platz an Bord eines seetüchtigen Schiffs.", "{0} Un équipement aussi rare mérite sa place à bord d'un navire en service.", "{0} Tak rzadki sprzęt zasługuje na miejsce na sprawnym statku.", "{0} 這樣稀有的裝備，值得配備在常年航行的船上。", "{0} 이런 희귀한 장비는 실제 운항하는 선박에 실을 만합니다."]],
    ["{0} offers protection to {1} in exchange for tribute payments and allegiance.", ["{0}为{1}提供保护，以换取贡金和效忠。", "{0} защищает державу {1} в обмен на дань и верность.", "{0} ofrece protección a {1} a cambio del pago de tributos y su lealtad.", "{0} oferece proteção a {1} em troca do pagamento de tributos e de sua lealdade.", "{0}は{1}に保護を与える代わりに、貢納と忠誠を求めます。", "{0} gewährt {1} Schutz gegen Tributzahlungen und Treue.", "{0} protège {1} en échange du versement d'un tribut et de son allégeance.", "{0} zapewnia {1} ochronę w zamian za daninę i lojalność.", "{0}為{1}提供保護，以換取貢金和效忠。", "{0}은(는) {1}에게 보호를 제공하고 조공과 충성을 받습니다."]],
    ["{0} offers to pay tribute to and swear allegiance to {1} in exchange for recognition and protection.", ["{0}提出向{1}缴纳贡金并宣誓效忠，以换取承认和保护。", "{0} предлагает платить державе {1} дань и присягнуть ей на верность в обмен на признание и защиту.", "{0} ofrece pagar tributo y jurar lealtad a {1} a cambio de reconocimiento y protección.", "{0} oferece pagar tributos e jurar lealdade a {1} em troca de reconhecimento e proteção.", "{0}は、承認と保護を得るため、{1}への貢納と忠誠を申し出ます。", "{0} bietet an, {1} Tribut zu zahlen und Treue zu schwören, um dafür Anerkennung und Schutz zu erhalten.", "{0} propose de payer un tribut à {1} et de lui prêter allégeance en échange de sa reconnaissance et de sa protection.", "{0} oferuje płacenie daniny i przysięgę wierności państwu {1} w zamian za uznanie i ochronę.", "{0}提出向{1}繳納貢金並宣誓效忠，以換取承認和保護。", "{0}은(는) 승인을 받고 보호받는 대가로 {1}에게 조공을 바치고 충성을 맹세하겠다고 제안합니다."]],
    ["The nuncio presents his sealed brief at {0}. Under diplomatic safe-conduct, {1} officials receive it.", ["教廷使节在{0}递交密封公文。按照外交通行保护，{1}的官员接收了公文。", "Нунций вручает запечатанное послание в державе {0}. Державные лица {1} принимают его под защитой дипломатического иммунитета.", "El nuncio presenta su escrito sellado en {0}. Los funcionarios de {1} lo reciben bajo salvoconducto diplomático.", "O núncio apresenta seu documento selado em {0}. As autoridades de {1} o recebem sob salvo-conduto diplomático.", "教皇使節は{0}で封印された書状を差し出します。外交上の安全通行のもと、{1}の官吏が受け取ります。", "Der Nuntius überreicht sein versiegeltes Schreiben in {0}. Die Amtsträger von {1} nehmen es unter diplomatischem Geleit entgegen.", "Le nonce présente son pli scellé à {0}. Les représentants de {1} le reçoivent sous sauf-conduit diplomatique.", "Nuncjusz przedstawia zapieczętowane pismo w {0}. Urzędnicy państwa {1} przyjmują je na mocy glejtu dyplomatycznego.", "教廷使節在{0}遞交密封公文。按照外交通行保護，{1}的官員接收了公文。", "교황대사가 {0}에서 봉인된 서한을 제시합니다. 외교상 안전 통행의 보호 아래 {1}의 관리들이 이를 받습니다."]],
    ["We enjoy safe-conduct only while we respect our hosts; break it, and we lose that protection.", ["只要尊重接待我们的势力，我们就享有安全通行保护；一旦违背约定，保护便会失效。", "Нас защищает дипломатический иммунитет, пока мы уважаем хозяев. Нарушим договорённость — лишимся этой защиты.", "Tenemos salvoconducto mientras respetemos a quienes nos reciben; si lo quebrantamos, perderemos esa protección.", "Temos salvo-conduto enquanto respeitarmos quem nos recebe; se o violarmos, perderemos essa proteção.", "受け入れてくれた相手を尊重する限り、安全通行が認められます。約束を破れば、その保護を失います。", "Wir genießen diplomatisches Geleit, solange wir unsere Gastgeber achten. Brechen wir die Vereinbarung, verlieren wir diesen Schutz.", "Nous bénéficions d'un sauf-conduit tant que nous respectons nos hôtes ; si nous le violons, nous perdons cette protection.", "Korzystamy z glejtu, dopóki szanujemy naszych gospodarzy. Jeśli go złamiemy, stracimy tę ochronę.", "只要尊重接待我們的勢力，我們就享有安全通行保護；一旦違背約定，保護便會失效。", "우리를 받아들인 이들을 존중하는 동안에는 안전 통행이 보장됩니다. 약속을 어기면 그 보호를 잃습니다."]],
    ["The flag of {0} now flies over {1}.", ["{1}如今升起了{0}的旗帜。", "Над {1} теперь развевается флаг державы {0}.", "La bandera de {0} ya ondea sobre {1}.", "A bandeira de {0} agora tremula sobre {1}.", "{1}には今、{0}の旗が掲げられています。", "Über {1} weht nun die Flagge von {0}.", "Le drapeau de {0} flotte désormais sur {1}.", "Nad {1} powiewa teraz flaga państwa {0}.", "{1}如今升起了{0}的旗幟。", "이제 {1}에 {0}의 깃발이 휘날립니다."]],
    ["Every profitable voyage brings the family estate closer to being debt-free.", ["每次航行赚到钱，家族产业就离还清债务更近一步。", "Каждый прибыльный рейс приближает семью к погашению долга.", "Cada viaje rentable acerca a la familia a saldar su deuda.", "Cada viagem lucrativa aproxima a família de quitar a dívida.", "航海で利益を上げるたび、家の借金を完済する日が近づきます。", "Jede gewinnbringende Reise bringt die Familie der Schuldenfreiheit näher.", "Chaque voyage rentable rapproche la famille du remboursement intégral.", "Każdy zyskowny rejs przybliża rodzinę do spłaty długu.", "每次航行賺到錢，家族產業就離還清債務更近一步。", "수익성 있는 항해를 할 때마다 집안의 빚을 갚는 날이 가까워집니다."]],
    ["His Holiness first seeks a captain with an independent view of the world.", ["圣座首先需要一位视野独立的船长。", "Его Святейшество прежде всего ищет капитана с независимым взглядом на мир.", "Su Santidad busca primero a un capitán con una visión independiente del mundo.", "Sua Santidade primeiro procura um capitão com uma visão independente do mundo.", "まずは独立した視野を持つ船長をお求めです。", "Seine Heiligkeit sucht zunächst einen Kapitän mit unabhängigem Blick auf die Welt.", "Sa Sainteté cherche d'abord un capitaine au regard indépendant sur le monde.", "Jego Świątobliwość szuka przede wszystkim kapitana o niezależnym spojrzeniu na świat.", "聖座首先需要一位視野獨立的船長。", "성하께서는 먼저 세상을 독립적인 시각으로 바라보는 선장을 찾으십니다."]],
    ["You have taken {0}. Carry the victory dispatches back to {1}; the crown's debt must be settled there.", ["你已攻下{0}。把胜利捷报送回{1}，王室欠你的报酬须在那里结清。", "Вы взяли {0}. Доставьте донесение о победе в {1}, где корона должна расплатиться с вами.", "Has tomado {0}. Lleva el parte de victoria a {1}; allí la Corona saldará su deuda contigo.", "Você tomou {0}. Leve o despacho da vitória a {1}; lá a Coroa quitará sua dívida com você.", "{0}を攻略しました。勝利の報告書を{1}へ届け、王室からの報酬を受け取ってください。", "Ihr habt {0} eingenommen. Bringt die Siegesmeldung nach {1}; dort wird die Krone ihre Schuld begleichen.", "Vous avez pris {0}. Rapportez le bulletin de victoire à {1} ; la Couronne y règlera sa dette envers vous.", "Zajęto {0}. Dostarcz meldunek o zwycięstwie do {1}; tam Korona spłaci swój dług wobec ciebie.", "你已攻下{0}。把勝利捷報送回{1}，王室欠你的報酬須在那裡結清。", "{0}을(를) 점령했습니다. 승전 보고서를 {1}로 가져가면 왕실이 그곳에서 빚을 갚을 것입니다."]],
    ["Those {0} are sealed tribute, not yours to sell. Selling {1} would steal from the court, fail your mission, and lower your standing by {2} with {3}{4}.", ["这些{0}是封存的贡品，不是你可以出售的货物。出售{1}就是盗取朝廷财物，会导致任务失败，并使你在{3}的声望降低{2}{4}。", "Этот груз ({0}) — запечатанная дань, продавать его нельзя. Продав {1}, вы обокрадёте двор, провалите поручение и потеряете {2} репутации у державы {3}{4}.", "Esos {0} son tributo sellado, no mercancía tuya. Vender {1} sería robar a la corte, haría fracasar tu misión y reduciría tu reputación en {2} con {3}{4}.", "Esses {0} são tributo lacrado, não carga sua. Vender {1} seria roubar a corte, faria sua missão fracassar e reduziria sua reputação em {2} com {3}{4}.", "その{0}は封印された貢納品で、あなたの貨物ではありません。{1}を売れば宮廷への窃盗となり、任務は失敗し、{3}での評判が{2}{4}低下します。", "Diese {0} sind versiegelte Tribute und nicht zum Verkauf bestimmt. Der Verkauf von {1} wäre Diebstahl am Hof, ließe Euren Auftrag scheitern und senkte Euer Ansehen bei {3} um {2}{4}.", "Ces {0} sont un tribut scellé, pas votre cargaison. Vendre {1} reviendrait à voler la cour, ferait échouer votre mission et réduirait votre réputation de {2} auprès de {3}{4}.", "Te {0} to zapieczętowany trybut, nie twój towar. Sprzedaż {1} byłaby kradzieżą na szkodę dworu, zakończyłaby misję niepowodzeniem i obniżyła twoją reputację o {2} u {3}{4}.", "這些{0}是封存的貢品，不是你可以出售的貨物。出售{1}就是竊取朝廷財物，會導致任務失敗，並使你在{3}的聲望降低{2}{4}。", "이 {0}은(는) 봉인된 조공품이지 당신이 팔 수 있는 화물이 아닙니다. {1}을(를) 팔면 조정의 재물을 훔치는 셈이며 임무가 실패하고 {3}에서의 평판이 {2}{4}만큼 낮아집니다."]],
    [", together with command of Tripoli", [
      "，并取得的黎波里的指挥权", ", а также командование Триполи", "y el mando de Trípoli", "e o comando de Trípoli", "そしてトリポリの指揮権", "sowie das Kommando über Tripolis", "et le commandement de Tripoli", "oraz dowództwo nad Trypolisem", "，並取得的黎波里的指揮權", "그리고 트리폴리의 지휘권"
    ]],
    ["{0} BANS {1} MERCHANDISE", [
      "{0} 禁止销售 {1} 的货物", "{0} ЗАПРЕЩАЕТ ТОРГОВАТЬ ТОВАРАМИ {1}", "{0} PROHÍBE COMERCIAR CON MERCANCÍAS DE {1}", "{0} PROÍBE O COMÉRCIO DE MERCADORIAS DE {1}", "{0}は{1}の商品の取引を禁止", "{0} VERBIETET DEN HANDEL MIT WAREN AUS {1}", "{0} INTERDIT LE COMMERCE DES MARCHANDISES DE {1}", "{0} ZAKAZUJE HANDLU TOWARAMI Z {1}", "{0} 禁止販售 {1} 的貨物", "{0}, {1} 상품 거래 금지"
    ]],
    ["{0} CASKS FULL", [
      "{0}桶已满", "{0} БОЧКИ ПОЛНЫ", "{0} BARRILES LLENOS", "{0} BARRIS CHEIOS", "{0}の樽は満杯", "{0} FÄSSER VOLL", "FÛTS DE {0} PLEINS", "BECZKI {0} PEŁNE", "{0}桶已滿", "{0} 캐스크 가득 참"
    ]],
    ["{0} BATTERY DISABLED ({1} DAYS)", [
      "{0} 海岸炮台已失效（{1}天）", "{0} БЕРЕГОВАЯ БАТАРЕЯ ВЫВЕДЕНА ИЗ СТРОЯ ({1} ДН.)", "{0} BATERÍA COSTERA NEUTRALIZADA ({1} DÍAS)", "{0} BATERIA COSTEIRA DESATIVADA ({1} DIAS)", "{0}の沿岸砲台を無力化（{1}日間）", "{0} KÜSTENBATTERIE AUSSER GEFECHT ({1} TAGE)", "BATTERIE CÔTIÈRE DE {0} NEUTRALISÉE ({1} JOURS)", "{0} BATERIA NADBRZEŻNA UNIESZKODLIONA ({1} DNI)", "{0} 海岸砲台已失效（{1}天）", "{0} 해안 포대 무력화({1}일)"
    ]],
    ["Purchased {0} and brought it aboard for {1} db.", [
      "购买了{0}并带上船，花费{1}达布隆。", "{0} куплено и доставлено на борт за {1} дублонов.", "Has comprado {0} y lo has subido a bordo por {1} doblones.", "Você comprou {0} e o trouxe a bordo por {1} dobrões.", "{0}を購入して積み込みました。代金は{1}ダブロンです。", "{0} gekauft und für {1} Dublonen an Bord gebracht.", "{0} acheté et embarqué pour {1} doublons.", "Kupiono {0} i wniesiono na pokład za {1} dublonów.", "購買了{0}並帶上船，花費{1}達布隆。", "{0}을(를) 구매해 배에 실었습니다. 가격은 더블룬 {1}닢입니다."
    ]],
    ["{0} stole my share. My silver cup was last seen aboard {1} near {2}. Bring it here; I'll pay {3} doubloons.", [
      "{0}抢走了我的那份。我的银杯最后一次出现在{2}附近的{1}船上。把它带来，我付你{3}达布隆。", "{0} украл мою долю. Мой серебряный кубок в последний раз видели на борту {1} у {2}. Принесите его сюда, и я заплачу {3} дублонов.", "{0} me robó mi parte. Mi copa de plata fue vista por última vez a bordo de {1}, cerca de {2}. Tráela y te pagaré {3} doblones.", "{0} roubou a minha parte. Minha taça de prata foi vista pela última vez a bordo de {1}, perto de {2}. Traga-a e pagarei {3} dobrões.", "{0}に取り分を奪われた。銀の杯は{2}付近を航行する{1}の船上で目撃されたのが最後だ。持って来てくれれば{3}ダブロン払おう。", "{0} hat mich um meinen Anteil betrogen. Mein Silberbecher wurde zuletzt an Bord der {1} nahe {2} gesehen. Bringt ihn her; ich zahle {3} Dublonen.", "{0} m'a volé ma part. Ma coupe en argent a été vue pour la dernière fois à bord du {1}, près de {2}. Rapportez-la-moi ; je vous paierai {3} doublons.", "{0} ukradł moją część. Mój srebrny puchar widziano ostatnio na pokładzie {1} w pobliżu {2}. Przynieś go, a zapłacę {3} dublonów.", "{0}搶走了我的那份。我的銀杯最後一次出現在{2}附近的{1}船上。把它帶來，我付你{3}達布隆。", "{0}이 내 몫을 훔쳤습니다. 내 은잔은 {2} 근처에서 {1}호 선상에 있는 모습이 마지막으로 목격됐습니다. 가져오면 더블룬 {3}닢을 드리겠습니다."
    ]],
    ["{0} BATTERY DISABLED ({1} DAYS)", [
      "{0} 海岸炮台已失效（{1}天）", "{0} БЕРЕГОВАЯ БАТАРЕЯ ВЫВЕДЕНА ИЗ СТРОЯ ({1} ДН.)", "{0} BATERÍA COSTERA NEUTRALIZADA ({1} DÍAS)", "{0} BATERIA COSTEIRA DESATIVADA ({1} DIAS)", "{0}の沿岸砲台を無力化（{1}日間）", "{0} KÜSTENBATTERIE AUSSER GEFECHT ({1} TAGE)", "BATTERIE CÔTIÈRE DE {0} NEUTRALISÉE ({1} JOURS)", "{0} BATERIA NADBRZEŻNA UNIESZKODLIWIONA ({1} DNI)", "{0} 海岸砲台已失效（{1}天）", "{0} 해안 포대 무력화({1}일)"
    ]],
    ["{0} BLOCKADES {1}", [
      "{0} 封锁 {1}", "{0} БЛОКИРУЕТ {1}", "{0} BLOQUEA {1}", "{0} BLOQUEIA {1}", "{0}は{1}を封鎖", "{0} BLOCKIERT {1}", "{0} BLOQUE {1}", "{0} BLOKUJE {1}", "{0} 封鎖 {1}", "{0}이 {1}을 봉쇄"
    ]],
    ["{0} EXCOMMUNICATED BY {1}", [
      "{0}遭{1}绝罚", "ЦЕРКОВНОЕ ОТЛУЧЕНИЕ: {0} ({1})", "{0} EXCOMULGADO POR {1}", "{0} EXCOMUNGADO POR {1}", "{0}は{1}に破門された", "{0} VON {1} EXKOMMUNIZIERT", "{0} EXCOMMUNIÉ PAR {1}", "{0} EKSKOMUNIKOWANY PRZEZ {1}", "{0}遭{1}絕罰", "{0}, {1}에 의해 파문됨"
    ]],
    ["{0} EXPEDITION OFFICE MOVED FROM {1} TO {2} AFTER THE PORT CHANGED HANDS", [
      "{0}的远征办事处随港口易主，从{1}迁至{2}。", "Экспедиционное управление {0} перенесено из {1} в {2} после смены власти в порту.", "La oficina de expedición de {0} se trasladó de {1} a {2} tras el cambio de soberanía del puerto.", "O escritório de expedição de {0} foi transferido de {1} para {2} após a mudança de controle do porto.", "港の支配者交代に伴い、{0}の遠征事務所を{1}から{2}へ移転。", "Das Expeditionsbüro von {0} wurde nach dem Wechsel der Hafenherrschaft von {1} nach {2} verlegt.", "Le bureau d'expédition de {0} a été déplacé de {1} à {2} après le changement de souveraineté du port.", "Biuro wypraw {0} przeniesiono z {1} do {2} po zmianie władzy nad portem.", "{0}的遠征辦事處隨港口易主，從{1}遷至{2}。", "항구의 지배권이 바뀌어 {0} 원정 사무소를 {1}에서 {2}로 옮겼습니다."
    ]],
    ["Seek permission in {0} first, then sail to {1}.", [
      "先在{0}取得许可，再驶往{1}。", "Сначала получите разрешение в {0}, затем отправляйтесь в {1}.", "Pide permiso primero en {0} y luego navega a {1}.", "Peça autorização primeiro em {0}, depois siga para {1}.", "まず{0}で許可を得てから、{1}へ向かえ。", "Holt zuerst in {0} die Erlaubnis ein und segelt dann nach {1}.", "Demandez d'abord l'autorisation à {0}, puis mettez le cap sur {1}.", "Najpierw uzyskaj zgodę w {0}, a potem płyń do {1}.", "先在{0}取得許可，再駛往{1}。", "먼저 {0}에서 허가를 받은 뒤 {1}로 항해하십시오."
    ]],
    ["{0} ATTACK DEFLECTED", [
      "{0}的攻击被弹开", "АТАКА {0} ОТРАЖЕНА", "ATAQUE DE {0} DESVIADO", "ATAQUE DE {0} DESVIADO", "{0}の攻撃を弾いた", "ANGRIFF VON {0} ABGEWEHRT", "ATTAQUE DE {0} DÉVIÉE", "ATAK {0} ODBITY", "{0}的攻擊被彈開", "{0}의 공격을 막아냈습니다"
    ]],
    ["{0} authorizes you to take ships belonging to enemies of {1} as prizes.", [
      "{0}授权你捕获{1}敌方的船只作为战利品。", "{0} разрешает вам захватывать корабли врагов державы {1} в качестве призов.", "{0} te autoriza a capturar como botín los barcos de los enemigos de {1}.", "{0} autoriza você a capturar como presa os navios inimigos de {1}.", "{0}は{1}の敵船を拿捕船として捕らえることを許可します。", "{0} berechtigt Euch, Schiffe der Feinde von {1} als Prisen zu nehmen.", "{0} vous autorise à prendre comme prises les navires ennemis de {1}.", "{0} upoważnia cię do zdobywania jako łupów statków należących do wrogów {1}.", "{0}授權你捕獲{1}敵方的船隻作為戰利品。", "{0}은 {1}의 적선을 나포해 전리품으로 삼도록 허가합니다."
    ]],
    ["You already hold {0}'s commission to take enemy ships of {1} as prizes.", [
      "你已持有{0}的委任，可捕获{1}的敌船作为战利品。", "У вас уже есть поручение {0} захватывать корабли врагов державы {1} в качестве призов.", "Ya tienes la comisión de {0} para capturar como botín los barcos enemigos de {1}.", "Você já tem a comissão de {0} para capturar como presa os navios inimigos de {1}.", "{0}から{1}の敵船を拿捕船として捕らえる委任をすでに受けています。", "Ihr habt bereits den Auftrag von {0}, Schiffe der Feinde von {1} als Prisen zu nehmen.", "Vous avez déjà reçu de {0} la commission de prendre comme prises les navires ennemis de {1}.", "Masz już zlecenie od {0}, by zdobywać jako łupy statki wrogów {1}.", "你已持有{0}的委任，可捕獲{1}的敵船作為戰利品。", "이미 {0}에게서 {1}의 적선을 나포해 전리품으로 삼으라는 위임을 받았습니다."
    ]],
    ["{0} prohibit the sale of this cargo here, captain.", [
      "船长，{0}禁止在此出售这批货物。", "Капитан, {0} запрещают продавать здесь этот груз.", "Capitán, {0} prohíben vender esta mercancía aquí.", "Capitão, {0} proíbem a venda desta carga aqui.", "船長、{0}はここでこの貨物を売ることを禁じている。", "Kapitän, {0} verbieten den Verkauf dieser Fracht hier.", "Capitaine, {0} interdisent la vente de cette cargaison ici.", "Kapitanie, {0} zakazują tutaj sprzedaży tego towaru.", "船長，{0}禁止在此出售這批貨物。", "선장님, {0}은 이곳에서 이 화물을 판매하지 못하게 합니다."
    ]],
    ["{0} prohibit the sale of this cargo here, captain. The customs books will bear your name, and their agents will learn of the bargain.", [
      "船长，{0}禁止在此出售这批货物。海关簿上会记下你的名字，他们的代理人也会得知这笔交易。", "Капитан, {0} запрещают продавать здесь этот груз. Ваше имя попадёт в таможенные книги, а их агенты узнают о сделке.", "Capitán, {0} prohíben vender esta mercancía aquí. Tu nombre quedará en los registros aduaneros y sus agentes se enterarán del trato.", "Capitão, {0} proíbem a venda desta carga aqui. Seu nome ficará nos registros alfandegários, e os agentes deles saberão do negócio.", "船長、{0}はここでこの貨物を売ることを禁じている。税関の帳簿にそなたの名が載り、役人にも取引を知られるだろう。", "Kapitän, {0} verbieten den Verkauf dieser Fracht hier. Euer Name wird in den Zollbüchern stehen, und ihre Agenten erfahren von dem Handel.", "Capitaine, {0} interdisent la vente de cette cargaison ici. Votre nom figurera dans les registres douaniers et leurs agents apprendront l'affaire.", "Kapitanie, {0} zakazują tutaj sprzedaży tego towaru. Twoje nazwisko trafi do ksiąg celnych, a ich agenci dowiedzą się o transakcji.", "船長，{0}禁止在此出售這批貨物。海關簿上會記下你的名字，他們的代理人也會得知這筆交易。", "선장님, {0}은 이곳에서 이 화물을 판매하지 못하게 합니다. 관세 장부에 이름이 기록되고 그들의 관리들도 거래를 알게 될 겁니다."
    ]],
    ["The sale of this cargo is forbidden here by {0}, captain.", [
      "船长，{0}禁止在此出售这批货物。", "Капитан, {0} запрещает продажу этого груза здесь.", "Capitán, {0} prohíbe vender esta mercancía aquí.", "Capitão, {0} proíbe a venda desta carga aqui.", "船長、{0}はここでこの貨物を売ることを禁じている。", "Kapitän, {0} verbietet den Verkauf dieser Fracht hier.", "Capitaine, {0} interdit la vente de cette cargaison ici.", "Kapitanie, {0} zakazuje tutaj sprzedaży tego towaru.", "船長，{0}禁止在此出售這批貨物。", "선장님, {0}은 이곳에서 이 화물을 판매하지 못하게 합니다."
    ]],
    ["The customs books will record your name, and their agents will hear of the bargain.", [
      "海关簿将记下你的名字，他们的代理人也会听闻这笔交易。", "Ваше имя внесут в таможенные книги, и их агенты узнают о сделке.", "Tu nombre quedará en los registros aduaneros y sus agentes se enterarán del trato.", "Seu nome ficará nos registros alfandegários, e os agentes deles saberão do negócio.", "税関の帳簿にそなたの名が載り、役人にも取引を知られるだろう。", "Euer Name wird in die Zollbücher eingetragen, und ihre Agenten erfahren von dem Handel.", "Votre nom figurera dans les registres douaniers et leurs agents apprendront l'affaire.", "Twoje nazwisko trafi do ksiąg celnych, a ich agenci dowiedzą się o transakcji.", "海關簿將記下你的名字，他們的代理人也會聽聞這筆交易。", "관세 장부에 이름이 기록되고 그들의 관리들도 거래를 알게 될 겁니다."
    ]],
    ["The sale of this cargo is forbidden here by {0}, captain. The customs books will record your name, and their agents will hear of the bargain.", [
      "船长，{0}禁止在此出售这批货物。海关簿上会记下你的名字，他们的代理人也会得知这笔交易。", "Капитан, {0} запрещает продажу этого груза здесь. Ваше имя внесут в таможенные книги, и их агенты узнают о сделке.", "Capitán, {0} prohíbe vender esta mercancía aquí. Tu nombre quedará en los registros aduaneros y sus agentes se enterarán del trato.", "Capitão, {0} proíbe a venda desta carga aqui. Seu nome ficará nos registros alfandegários, e os agentes deles saberão do negócio.", "船長、{0}はここでこの貨物を売ることを禁じている。税関の帳簿にそなたの名が載り、役人にも取引を知られるだろう。", "Kapitän, {0} verbietet den Verkauf dieser Fracht hier. Euer Name wird in die Zollbücher eingetragen, und die Agenten erfahren von dem Handel.", "Capitaine, {0} interdit la vente de cette cargaison ici. Votre nom figurera dans les registres douaniers et leurs agents apprendront l'affaire.", "Kapitanie, {0} zakazuje tutaj sprzedaży tego towaru. Twoje nazwisko trafi do ksiąg celnych, a agenci dowiedzą się o transakcji.", "船長，{0}禁止在此出售這批貨物。海關簿上會記下你的名字，他們的代理人也會得知這筆交易。", "선장님, {0}은 이곳에서 이 화물을 판매하지 못하게 합니다. 관세 장부에 이름이 기록되고 그들의 관리들도 거래를 알게 될 겁니다."
    ]],
    ["The sale of this cargo is forbidden here by {0}, captain. The customs books will record your name, and their agents will hear of the bargain. Will you still sell the {1}?", [
      "船长，{0}禁止在此出售这批货物。海关簿上会记下你的名字，他们的代理人也会得知这笔交易。你还要出售{1}吗？", "Капитан, {0} запрещает продажу этого груза здесь. Ваше имя внесут в таможенные книги, и их агенты узнают о сделке. Вы всё же продадите {1}?", "Capitán, {0} prohíbe vender esta mercancía aquí. Tu nombre quedará en los registros aduaneros y sus agentes se enterarán del trato. ¿Aun así venderás {1}?", "Capitão, {0} proíbe a venda desta carga aqui. Seu nome ficará nos registros alfandegários, e os agentes deles saberão do negócio. Ainda quer vender {1}?", "船長、{0}はここでこの貨物を売ることを禁じている。税関の帳簿にそなたの名が載り、役人にも取引を知られるだろう。それでも{1}を売るのか？", "Kapitän, {0} verbietet den Verkauf dieser Fracht hier. Euer Name wird in die Zollbücher eingetragen, und die Agenten erfahren von dem Handel. Wollt Ihr {1} trotzdem verkaufen?", "Capitaine, {0} interdit la vente de cette cargaison ici. Votre nom figurera dans les registres douaniers et leurs agents apprendront l'affaire. Voulez-vous tout de même vendre {1} ?", "Kapitanie, {0} zakazuje tutaj sprzedaży tego towaru. Twoje nazwisko trafi do ksiąg celnych, a agenci dowiedzą się o transakcji. Czy mimo to sprzedasz {1}?", "船長，{0}禁止在此出售這批貨物。海關簿上會記下你的名字，他們的代理人也會得知這筆交易。你還要出售{1}嗎？", "선장님, {0}은 이곳에서 이 화물을 판매하지 못하게 합니다. 관세 장부에 이름이 기록되고 그들의 관리들도 거래를 알게 될 겁니다. 그래도 {1}을(를) 판매하시겠습니까?"
    ]],
    ["{0} prohibit the sale of this cargo here, captain. The customs books will bear your name, and their agents will learn of the bargain. Will you still sell the {1}?", [
      "船长，{0}禁止在此出售这批货物。海关簿上会记下你的名字，他们的代理人也会得知这笔交易。你还要出售{1}吗？", "Капитан, {0} запрещают продавать здесь этот груз. Ваше имя попадёт в таможенные книги, а их агенты узнают о сделке. Вы всё же продадите товар: {1}?", "Capitán, {0} prohíben vender esta mercancía aquí. Tu nombre quedará en los registros aduaneros y sus agentes se enterarán del trato. ¿Aun así venderás {1}?", "Capitão, {0} proíbem a venda desta carga aqui. Seu nome ficará nos registros alfandegários, e os agentes deles saberão do negócio. Ainda quer vender {1}?", "船長、{0}はここでこの貨物を売ることを禁じている。税関の帳簿にそなたの名が載り、役人にも取引を知られるだろう。それでも{1}を売るのか？", "Kapitän, {0} verbieten den Verkauf dieser Fracht hier. Euer Name wird in den Zollbüchern stehen, und ihre Agenten erfahren von dem Handel. Wollt Ihr {1} trotzdem verkaufen?", "Capitaine, {0} interdisent la vente de cette cargaison ici. Votre nom figurera dans les registres douaniers et leurs agents apprendront l'affaire. Voulez-vous tout de même vendre {1} ?", "Kapitanie, {0} zakazują tutaj sprzedaży tego towaru. Twoje nazwisko trafi do ksiąg celnych, a ich agenci dowiedzą się o transakcji. Czy mimo to sprzedasz {1}?", "船長，{0}禁止在此出售這批貨物。海關簿上會記下你的名字，他們的代理人也會得知這筆交易。你還要出售{1}嗎？", "선장님, {0}은 이곳에서 이 화물을 판매하지 못하게 합니다. 관세 장부에 이름이 기록되고 그들의 관리들도 거래를 알게 될 겁니다. 그래도 {1}을(를) 판매하시겠습니까?"
    ]],
    ["{0} FLEET DEFEATED", [
      "{0}舰队被击败", "ФЛОТ {0} РАЗГРОМЛЕН", "FLOTA DE {0} DERROTADA", "FROTA DE {0} DERROTADA", "{0}艦隊を撃破", "FLOTTE VON {0} BESIEGT", "FLOTTE DE {0} VAINCUE", "FLOTA {0} POKONANA", "{0}艦隊被擊敗", "{0} 함대 격파"
    ]],
    ["{0} FLEET ENGAGED", [
      "与{0}舰队交战", "БОЙ С ФЛОТОМ {0}", "FLOTA DE {0} EN COMBATE", "FROTA DE {0} EM COMBATE", "{0}艦隊と交戦", "FLOTTE VON {0} IM GEFECHT", "COMBAT CONTRE LA FLOTTE DE {0}", "WALKA Z FLOTĄ {0}", "與{0}艦隊交戰", "{0} 함대와 교전"
    ]],
    ["RIVAL FLEET DEFEATED - RETURN TO NINGBO", [
      "击败敌方舰队——返回宁波", "ФЛОТ ПРОТИВНИКА РАЗГРОМЛЕН — ВОЗВРАЩАЙТЕСЬ В НИНБО", "FLOTA RIVAL DERROTADA: REGRESA A NINGBO", "FROTA RIVAL DERROTADA — VOLTE A NINGBO", "敵艦隊を撃破——寧波へ戻れ", "Gegnerische Flotte besiegt – kehrt nach Ningbo zurück", "Flotte rivale vaincue — retournez à Ningbo", "Pokonano wrogą flotę — wróć do Ningbo", "擊敗敵方艦隊——返回寧波", "적 함대 격파 — 닝보로 돌아가십시오"
    ]],
    ["YOUR FLEET WAS DEFEATED - NINGBO MISSION FAILED", [
      "你的舰队被击败——宁波任务失败", "ВАШ ФЛОТ РАЗГРОМЛЕН — МИССИЯ В НИНБО ПРОВАЛЕНА", "TU FLOTA HA SIDO DERROTADA: MISIÓN DE NINGBO FALLIDA", "SUA FROTA FOI DERROTADA — MISSÃO DE NINGBO FRACASSADA", "自艦隊が敗北——寧波の任務は失敗", "Eure Flotte wurde besiegt – die Ningbo-Mission ist gescheitert", "Votre flotte a été vaincue — mission de Ningbo échouée", "Twoja flota została pokonana — misja w Ningbo nieudana", "你的艦隊被擊敗——寧波任務失敗", "아군 함대 패배 — 닝보 임무 실패"
    ]],
    ["{0} courier", [
      "{0}信使", "{0} курьер", "{0} mensajero", "{0} mensageiro", "{0}の使者", "{0} Kurier", "{0} coursier", "Kurier {0}", "{0}信使", "{0} 사절"
    ]],
    ["{0} crew muster", [
      "{0}船员点名", "Перекличка экипажа: {0}", "Revista de la tripulación: {0}", "Chamada da tripulação: {0}", "{0}乗組員の点呼", "Musterung der Besatzung: {0}", "Appel de l'équipage : {0}", "Zbiórka załogi: {0}", "{0}船員點名", "{0} 선원 점호"
    ]],
    ["{0} DAYS LEFT", [
      "剩余{0}天", "ОСТАЛОСЬ {0} ДНЕЙ", "QUEDAN {0} DÍAS", "RESTAM {0} DIAS", "残り{0}日", "NOCH {0} TAGE", "ENCORE {0} JOURS", "POZOSTAŁO {0} DNI", "剩餘{0}天", "남은 기간 {0}일"
    ]],
    ["{0} DAYS TO LAUNCH", [
      "距下水还有{0}天", "ДО СПУСКА НА ВОДУ: {0} ДН.", "FALTAN {0} DÍAS PARA BOTARLO", "FALTAM {0} DIAS PARA O LANÇAMENTO", "進水まであと{0}日", "NOCH {0} TAGE BIS ZUM STAPELLAUF", "MISE À L'EAU DANS {0} JOURS", "DO WODOWANIA: {0} DNI", "距下水還有{0}天", "진수까지 {0}일 남음"
    ]],
    ["{0} customs have gathered {1} of {2} doubloons.", [
      "{0}的关税收入已累计{1}达布隆，目标为{2}。", "Таможенные сборы в {0} составили {1} из {2} дублонов.", "Las aduanas de {0} han recaudado {1} de los {2} doblones previstos.", "A alfândega de {0} arrecadou {1} dos {2} dobrões previstos.", "{0}の関税収入は{1}ダブロンに達しました。目標額は{2}ダブロンです。", "Die Zölle von {0} haben {1} von {2} Dublonen eingebracht.", "Les douanes de {0} ont perçu {1} doublons sur les {2} prévus.", "Cła w {0} przyniosły {1} z wymaganych {2} dublonów.", "{0}的關稅收入已累計{1}達布隆，目標為{2}。", "{0}의 관세 수입은 목표액 {2}더블룬 중 {1}더블룬에 이르렀습니다."
    ]],
    ["{0} CREW LOST", [
      "{0}名船员伤亡", "ПОТЕРИ ЭКИПАЖА: {0}", "BAJAS EN LA TRIPULACIÓN: {0}", "BAIXAS NA TRIPULAÇÃO: {0}", "乗組員の損失：{0}人", "BESATZUNGSVERLUSTE: {0}", "PERTES DANS L'ÉQUIPAGE : {0}", "STRATY W ZAŁODZE: {0}", "{0}名船員傷亡", "선원 피해: {0}명"
    ]],
    ["{0} CREW LOST ASHORE", [
      "{0}名船员在岸上遇难", "ПОТЕРИ ЭКИПАЖА НА БЕРЕГУ: {0}", "BAJAS EN TIERRA: {0} TRIPULANTES", "BAIXAS EM TERRA: {0} TRIPULANTES", "上陸中に乗組員を{0}人失いました", "BESATZUNGSVERLUSTE AN LAND: {0}", "{0} MEMBRES D'ÉQUIPAGE PERDUS À TERRE", "STRATY W ZAŁODZE NA LĄDZIE: {0}", "{0}名船員在岸上遇難", "해안에서 선원 {0}명 피해"
    ]],
    ["{0} demands tribute from {1}.", [
      "{0}要求{1}进贡。", "{0} требует дань с {1}.", "{0} exige tributo a {1}.", "{0} exige tributo de {1}.", "{0}は{1}に貢納を要求します。", "{0} fordert von {1} Tribut.", "{0} exige un tribut de {1}.", "{0} żąda daniny od {1}.", "{0}要求{1}進貢。", "{0}은 {1}에게 조공을 요구합니다."
    ]],
    ["{0} demands {1} doubloons for safe passage through {2} for {3}.", [
      "{0}要求支付{1}达布隆，以换取在{2}安全通行{3}。", "{0} требует {1} дублонов за безопасный проход через {2} сроком на {3}.", "{0} exige {1} doblones a cambio de paso seguro por {2} durante {3}.", "{0} exige {1} dobrões em troca de passagem segura por {2} durante {3}.", "{0}は{2}を{3}の間安全に通行する代金として{1}ダブロンを要求します。", "{0} verlangt {1} Dublonen für sicheres Geleit durch {2} für die Dauer von {3}.", "{0} exige {1} doublons en échange d'un passage sûr à travers {2} pendant {3}.", "{0} żąda {1} dublonów za bezpieczne przejście przez {2} na okres {3}.", "{0}要求支付{1}達布隆，以換取在{2}安全通行{3}。", "{0}은 {2}을 {3} 동안 안전하게 통과하는 대가로 더블룬 {1}닢을 요구합니다."
    ]],
    ["{0} Doubloons {1}. Cargo space {2}/{3}.", [
      "{0}达布隆：{1}。货舱：{2}/{3}。", "Дублоны: {1} ({0}). Место в трюме: {2}/{3}.", "Doblonas: {1} ({0}). Espacio de carga: {2}/{3}.", "Dobras: {1} ({0}). Espaço de carga: {2}/{3}.", "所持ダブロン：{1}（{0}）。貨物スペース：{2}/{3}。", "Dublonen: {1} ({0}). Laderaum: {2}/{3}.", "Doublons : {1} ({0}). Espace de cale : {2}/{3}.", "Dublony: {1} ({0}). Miejsce w ładowni: {2}/{3}.", "達布隆：{1}（{0}）。貨艙：{2}/{3}。", "더블룬: {1} ({0}). 화물 공간: {2}/{3}."
    ]],
    ["{0} doubloons for the completed commission.", [
      "完成委托可得{0}达布隆。", "{0} дублонов за выполненное поручение.", "{0} doblones por completar la comisión.", "{0} dobrões por concluir a comissão.", "委任任務の完了報酬：{0}ダブロン。", "{0} Dublonen für den abgeschlossenen Auftrag.", "{0} doublons pour la commission accomplie.", "{0} dublonów za ukończenie zlecenia.", "完成委託可得{0}達布隆。", "임무 완료 보상: 더블룬 {0}닢."
    ]],
    ["{0}. The Pope's treasury pays {1} doubloons for completing the commission.", [
      "{0}。教宗的国库支付{1}达布隆，作为完成委托的报酬。", "{0}. Казна папы выплачивает {1} дублонов за выполнение поручения.", "{0}. El tesoro pontificio paga {1} doblones por completar la comisión.", "{0}. O tesouro papal paga {1} dobrões pela conclusão da comissão.", "{0}。教皇庁の金庫から、委任任務の完了報酬として{1}ダブロンが支払われます。", "{0}. Die päpstliche Schatzkammer zahlt {1} Dublonen für den abgeschlossenen Auftrag.", "{0}. Le trésor pontifical verse {1} doublons pour la commission accomplie.", "{0}. Skarbiec papieski wypłaca {1} dublonów za wykonanie zlecenia.", "{0}。教宗的國庫支付{1}達布隆，作為完成委託的報酬。", "{0}. 교황청 금고에서 임무 완료 보상으로 더블룬 {1}닢을 지급합니다."
    ]],
    ["{0}. The Pope's treasury pays", [
      "{0}。教宗的国库支付", "{0}. Казна папы выплачивает", "{0}. El tesoro pontificio paga", "{0}. O tesouro papal paga", "{0}。教皇庁の金庫から支払われます", "{0}. Die päpstliche Schatzkammer zahlt", "{0}. Le trésor pontifical verse", "{0}. Skarbiec papieski wypłaca", "{0}。教宗的國庫支付", "{0}. 교황청 금고에서 지급합니다"
    ]],
    ["{0} has already been stripped of its valuables. Damaged harbor defenses remain under military guard until they recover.", [
      "{0} 已被洗劫一空。受损的港口防御工事在修复前仍由军队把守。", "{0} уже лишился ценностей. Повреждённые портовые укрепления остаются под военной охраной до восстановления.", "{0} ya ha sido despojado de sus objetos de valor. Las defensas portuarias dañadas permanecen bajo vigilancia militar hasta su recuperación.", "{0} já foi saqueado de seus bens valiosos. As defesas danificadas do porto permanecem sob guarda militar até serem reparadas.", "{0} はすでに略奪され、価値ある品は残っていません。港の損傷した防備は、修復されるまで軍の警備下にあります。", "{0} wurde bereits seiner Wertgegenstände beraubt. Die beschädigten Hafenbefestigungen bleiben bis zu ihrer Instandsetzung unter militärischer Bewachung.", "{0} a déjà été dépouillé de ses objets de valeur. Les défenses endommagées du port restent sous garde militaire jusqu'à leur réparation.", "{0} został już ograbiony z kosztowności. Uszkodzone umocnienia portowe pozostają pod strażą wojskową do czasu naprawy.", "{0} 已被洗劫一空。受損的港口防禦工事在修復前仍由軍隊把守。", "{0}은(는) 이미 귀중품을 모두 빼앗겼습니다. 손상된 항구 방어 시설은 복구될 때까지 군대가 지킵니다."
    ]],
    ["{0} seeks terms before resorting to war. Carry me to {1} with a proposal setting out tribute and allegiance, then return for {2} doubloons.", [
      "{0} 希望先谈妥条件，避免开战。请带我前往{1}，递交一份列明贡金与效忠条款的提案，再返回领取{2}达布隆。", "{0} хочет договориться об условиях, прежде чем прибегнуть к войне. Отвезите меня в {1} с предложением о дани и верности, затем возвращайтесь за {2} дублонами.", "{0} busca llegar a un acuerdo antes de recurrir a la guerra. Llévame a {1} con una propuesta que establezca el tributo y la lealtad, y luego regresa por {2} doblones.", "{0} quer chegar a um acordo antes de recorrer à guerra. Leve-me a {1} com uma proposta que estabeleça o tributo e a lealdade, depois volte para receber {2} dobrões.", "{0} は戦争に踏み切る前に条件をまとめようとしています。貢納と臣従の条件を記した提案書を持って{1}へ連れて行き、その後{2}ダブロンを受け取りに戻ってください。", "{0} will sich vor einem Krieg auf Bedingungen einigen. Bringt mich mit einem Vorschlag zu Tribut und Treue nach {1} und kehrt danach für {2} Dublonen zurück.", "{0} cherche à s'entendre sur les conditions avant de recourir à la guerre. Emmenez-moi à {1} avec une proposition précisant le tribut et l'allégeance, puis revenez toucher {2} doublons.", "{0} chce uzgodnić warunki, zanim ucieknie się do wojny. Zanieś do {1} propozycję określającą daninę i podległość, a potem wróć po {2} dublonów.", "{0} 希望先談妥條件，避免開戰。請帶我前往{1}，遞交一份列明貢金與效忠條款的提案，再返回領取{2}達布隆。", "{0}은(는) 전쟁에 나서기 전에 조건을 협상하려 합니다. 조공과 충성 의무를 명시한 제안을 가지고 {1}로 데려다준 뒤 더블룬 {2}닢을 받으러 돌아오세요."
    ]],
    ["{0} has received the answer. The treasury pays you {1} doubloons.", [
      "{0} 已收到答复。金库将向你支付{1}达布隆。", "{0} получил ответ. Казна выплатит вам {1} дублонов.", "{0} ha recibido la respuesta. El tesoro te pagará {1} doblones.", "{0} recebeu a resposta. O tesouro pagará a você {1} dobrões.", "{0} は返答を受け取りました。財務局からあなたに{1}ダブロンが支払われます。", "{0} hat die Antwort erhalten. Die Schatzkammer zahlt Euch {1} Dublonen.", "{0} a reçu la réponse. Le trésor vous versera {1} doublons.", "{0} otrzymał odpowiedź. Skarbiec wypłaci ci {1} dublonów.", "{0} 已收到答覆。金庫將向你支付{1}達布隆。", "{0}이(가) 답변을 받았습니다. 재무부에서 더블룬 {1}닢을 지급합니다."
    ]],
    ["{0} has fallen. The commissioners negotiated terms with its rulers, and the princes and envoys made peace. The treasury will pay the reward for {1}'s extraordinary commission.", [
      "{0} 已陷落。全权代表与当地统治者谈妥条件，诸侯与使节缔结了和平。金库将支付{1}这项非凡使命的报酬。", "{0} пал. Комиссары согласовали условия с его правителями, а князья и послы заключили мир. Казна выплатит награду за особое поручение {1}.", "{0} ha caído. Los comisionados negociaron las condiciones con sus gobernantes, y príncipes y enviados hicieron la paz. El tesoro pagará la recompensa por la extraordinaria misión de {1}.", "{0} caiu. Os comissários negociaram os termos com seus governantes, e príncipes e enviados fizeram a paz. O tesouro pagará a recompensa pela missão extraordinária de {1}.", "{0} は陥落しました。全権委員が統治者と条件を交渉し、諸侯と使節が和平を結びました。財務局は{1}の特別任務の報奨金を支払います。", "{0} ist gefallen. Die Bevollmächtigten verhandelten mit seinen Herrschern, und Fürsten und Gesandte schlossen Frieden. Die Schatzkammer zahlt die Belohnung für {1}s außerordentlichen Auftrag.", "{0} est tombé. Les commissaires ont négocié les conditions avec ses dirigeants, et princes et envoyés ont conclu la paix. Le trésor versera la récompense due à {1} pour cette mission exceptionnelle.", "{0} upadł. Komisarze uzgodnili warunki z jego władcami, a książęta i posłowie zawarli pokój. Skarbiec wypłaci nagrodę za nadzwyczajną misję {1}.", "{0} 已陷落。全權代表與當地統治者談妥條件，諸侯與使節締結了和平。金庫將支付{1}這項非凡使命的報酬。", "{0}이(가) 함락되었습니다. 전권위원들이 통치자들과 조건을 협상했고, 제후와 사절들이 평화 조약을 맺었습니다. 재무부는 {1}의 특별 임무에 대한 보상을 지급합니다."
    ]],
    ["{0} has agreed to the commissioners' terms, and the rulers have made peace. Carry the final peace dispatches to {1}.", [
      "{0} 已接受全权代表提出的条件，统治者们也已缔结和平。请将最终和约文书送往{1}。", "{0} согласился на условия комиссаров, и правители заключили мир. Доставьте окончательные мирные депеши в {1}.", "{0} ha aceptado las condiciones de los comisionados y los gobernantes han firmado la paz. Lleva los despachos finales de paz a {1}.", "{0} aceitou os termos dos comissários, e os governantes fizeram a paz. Leve os despachos finais do tratado a {1}.", "{0} は全権委員の条件を受け入れ、統治者たちは和平を結びました。最終的な和平文書を{1}へ届けてください。", "{0} hat den Bedingungen der Bevollmächtigten zugestimmt, und die Herrscher haben Frieden geschlossen. Bringt die abschließenden Friedensdepeschen nach {1}.", "{0} a accepté les conditions des commissaires, et les dirigeants ont conclu la paix. Portez les dernières dépêches de paix à {1}.", "{0} zgodził się na warunki komisarzy, a władcy zawarli pokój. Dostarcz końcowe depesze pokojowe do {1}.", "{0} 已接受全權代表提出的條件，統治者們也已締結和平。請將最終和約文書送往{1}。", "{0}이(가) 전권위원들의 조건을 받아들였고 통치자들은 평화 조약을 맺었습니다. 최종 평화 문서를 {1}로 전달하세요."
    ]],
    ["{0} has surrendered. You seize {1} doubloons from its treasury.{2}{3}", [
      "{0} 已投降。你从其金库中缴获了{1}达布隆。{2}{3}", "{0} сдался. Вы захватили в его казне {1} дублонов.{2}{3}", "{0} se ha rendido. Has obtenido {1} doblones de su tesoro.{2}{3}", "{0} se rendeu. Você tomou {1} dobrões de seu tesouro.{2}{3}", "{0} は降伏しました。国庫から{1}ダブロンを押収しました。{2}{3}", "{0} hat kapituliert. Ihr erbeutet {1} Dublonen aus seiner Schatzkammer.{2}{3}", "{0} s'est rendu. Vous avez saisi {1} doublons dans son trésor.{2}{3}", "{0} skapitulował. Zdobywasz {1} dublonów z jego skarbca.{2}{3}", "{0} 已投降。你從其金庫中繳獲了{1}達布隆。{2}{3}", "{0}이(가) 항복했습니다. 국고에서 더블룬 {1}닢을 빼앗았습니다.{2}{3}"
    ]],
    [". The Pope's treasury pays", [
      "。教宗的国库支付", ". Казна папы выплачивает", ". El tesoro pontificio paga", ". O tesouro papal paga", "。教皇庁の金庫から支払われます", ". Die päpstliche Schatzkammer zahlt", ". Le trésor pontifical verse", ". Skarbiec papieski wypłaca", "。教宗的國庫支付", ". 교황청 금고에서 지급합니다"
    ]],
    ["{0} doubloons. Enough to delay my plans, not enough to settle your debt. You keep {1}; {2} remains due.", [
      "{0}达布隆。足以让我推迟计划，却不足以还清你的债务。你留下{1}；尚欠{2}。", "{0} дублонов. Хватит, чтобы отложить мои планы, но не для погашения вашего долга. У вас остаётся {1}; к уплате ещё {2}.", "{0} doblones. Bastan para retrasar mis planes, pero no para saldar tu deuda. Conservas {1}; aún debes {2}.", "{0} dobrões. Dá para adiar meus planos, mas não para quitar sua dívida. Você fica com {1}; ainda deve {2}.", "{0}ダブロンか。計画を先延ばしにはできるが、借金を完済するには足りない。手元に{1}を残し、残額{2}を返すのだ。", "{0} Dublonen. Genug, um meine Pläne aufzuschieben, aber nicht, um Eure Schuld zu begleichen. {1} behaltet Ihr; {2} bleibt noch offen.", "{0} doublons. De quoi retarder mes projets, pas de quoi régler votre dette. Gardez {1} ; il reste {2} à payer.", "{0} dublonów. Wystarczy, by odłożyć moje plany, ale nie by spłacić twój dług. Zatrzymujesz {1}; do spłaty pozostaje {2}.", "{0}達布隆。足以讓我推遲計畫，卻不足以還清你的債務。你留下{1}；尚欠{2}。", "더블룬 {0}닢. 내 계획을 미룰 수는 있어도 당신의 빚을 갚기엔 부족하군요. {1}은 남겨 두세요. 아직 {2}이 남았습니다."
    ]],
    ["Hostile canoes still attacking: {0}.", [
      "仍在进攻的敌方独木舟：{0}艘。", "Вражеские каноэ продолжают атаковать: {0}.", "Canoas enemigas que siguen atacando: {0}.", "Canoas inimigas ainda atacando: {0}.", "攻撃を続ける敵のカヌー：{0}隻。", "Noch angreifende feindliche Kanus: {0}.", "Canoës ennemis qui attaquent encore : {0}.", "Wrogie kanu nadal atakujące: {0}.", "仍在進攻的敵方獨木舟：{0}艘。", "아직 공격 중인 적 카누: {0}척."
    ]],
    ["At last, {0}—the sea gate to Mecca. Pilgrims take the inland road from here. You have brought me to the threshold of the Hajj.", [
      "终于到了{0}——通往麦加的海上门户。朝圣者从这里踏上内陆之路。你已送我抵达朝觐的门槛。", "Наконец-то {0} — морские ворота в Мекку. Отсюда паломники идут вглубь страны. Вы довезли меня до порога хаджа.", "Por fin, {0}: la puerta marítima de La Meca. Desde aquí los peregrinos siguen tierra adentro. Me has llevado hasta el umbral del Hajj.", "Enfim, {0} — a porta marítima de Meca. Daqui, os peregrinos seguem pela estrada em direção ao interior. Você me trouxe até o limiar do Hajj.", "ついに{0}に着きました。ここはメッカへの海の玄関口です。巡礼者はここから内陸へ向かいます。あなたのおかげでハッジの入り口まで来られました。", "Endlich {0} – das Seetor nach Mekka. Von hier ziehen die Pilger ins Landesinnere. Ihr habt mich bis an die Schwelle des Haddsch gebracht.", "Enfin, {0} : la porte maritime de La Mecque. Les pèlerins prennent ici la route de l'intérieur. Vous m'avez conduit jusqu'au seuil du Hajj.", "Nareszcie {0} — morska brama do Mekki. Stąd pielgrzymi ruszają w głąb lądu. Doprowadziłeś mnie do progu hadżdżu.", "終於到了{0}——通往麥加的海上門戶。朝聖者從這裡踏上內陸之路。你已送我抵達朝覲的門檻。", "드디어 {0}에 도착했군요. 메카로 향하는 바닷길의 관문입니다. 순례자들은 여기서 내륙길로 갑니다. 당신 덕분에 하지를 위한 문턱까지 왔습니다."
    ]],
    ["{0} at last. I left home as a pilgrim and now return from the Hajj. Thank you.", [
      "终于回到{0}。我以朝圣者的身份离家，如今朝觐归来。谢谢你。", "Наконец-то {0}. Я покинул дом паломником, а теперь возвращаюсь после хаджа. Благодарю вас.", "Por fin, {0}. Salí de casa como peregrino y ahora regreso del Hajj. Gracias.", "Finalmente, {0}. Saí de casa como peregrino e agora volto do Hajj. Obrigado.", "ようやく{0}に帰ってきました。巡礼者として故郷を発ち、ハッジを終えて戻りました。ありがとう。", "Endlich {0}. Ich verließ meine Heimat als Pilger und kehre nun vom Haddsch zurück. Habt Dank.", "Enfin, {0}. J'ai quitté mon foyer en pèlerin et reviens du Hajj. Merci à vous.", "Nareszcie {0}. Wyruszyłem z domu jako pielgrzym i wracam z hadżdżu. Dziękuję.", "終於回到{0}。我以朝聖者的身分離家，如今朝覲歸來。謝謝你。", "드디어 {0}에 돌아왔습니다. 순례자로 고향을 떠났다가 이제 하지를 마치고 돌아옵니다. 고맙습니다."
    ]],
    ["{0} at last. I went looking for stories from the past and came back with enough to fill a tavern.", [
      "终于回到{0}。我出门寻访往事，归来时带回的故事足以坐满一家酒馆。", "Наконец-то {0}. Я отправился искать истории прошлого и вернулся с таким запасом рассказов, что хватит на весь трактир.", "Por fin, {0}. Salí en busca de historias del pasado y volví con tantas que llenarían una taberna.", "Finalmente, {0}. Saí em busca de histórias do passado e voltei com tantas que encheriam uma taverna.", "ようやく{0}に着いた。昔の話を探しに出たが、酒場が満員になるほど話の種を持ち帰ったよ。", "Endlich {0}. Ich zog los, um Geschichten aus der Vergangenheit zu suchen, und kehrte mit genug zurück, um eine ganze Schenke zu füllen.", "Enfin, {0}. Je suis parti chercher des récits du passé et j'en rapporte assez pour remplir une taverne.", "Nareszcie {0}. Wyruszyłem szukać opowieści z przeszłości i wróciłem z tyloma, że zapełniłyby całą gospodę.", "終於回到{0}。我出門尋訪往事，歸來時帶回的故事足以坐滿一家酒館。", "드디어 {0}에 도착했군요. 옛이야기를 찾아 떠났다가 선술집을 가득 채울 만큼 많은 이야기를 가져왔습니다."
    ]],
    ["{0} at last. My family will remember your kindness. Here are the {1} db I owe.", [
      "终于回到{0}。我的家人会记得你的恩情。这是我欠你的{1}达布隆。", "Наконец-то {0}. Моя семья будет помнить вашу доброту. Вот {1} дублонов, которые я вам должен.", "Por fin, {0}. Mi familia recordará tu bondad. Aquí tienes los {1} doblones que te debo.", "Finalmente, {0}. Minha família se lembrará da sua bondade. Aqui estão os {1} dobrões que lhe devo.", "ようやく{0}に着いた。家族には君の親切を伝えておこう。借りていた{1}ダブロンを受け取ってくれ。", "Endlich {0}. Meine Familie wird sich an Eure Güte erinnern. Hier sind die {1} Dublonen, die ich Euch schulde.", "Enfin, {0}. Ma famille se souviendra de votre bonté. Voici les {1} doublons que je vous dois.", "Nareszcie {0}. Moja rodzina zapamięta twoją życzliwość. Oto {1} dublonów, które ci jestem winien.", "終於回到{0}。我的家人會記得你的恩情。這是我欠你的{1}達布隆。", "드디어 {0}에 도착했군요. 가족에게 당신의 친절을 전하겠습니다. 빚진 더블룬 {1}닢을 받으세요."
    ]],
    ["{0}. I know that smell of water and smoke. You have brought me home; here is the payment I promised.", [
      "{0}。我认得这水汽与烟火的气息。你送我回了家；这是我答应付给你的钱。", "{0}. Я узнаю этот запах воды и дыма. Вы доставили меня домой; вот обещанная плата.", "{0}. Reconozco ese olor a agua y humo. Me has traído a casa; aquí tienes el pago que te prometí.", "{0}. Conheço esse cheiro de água e fumaça. Você me trouxe para casa; aqui está o pagamento que prometi.", "{0}。水と煙の匂いで、ここだと分かる。家まで送ってくれてありがとう。約束の礼金を受け取ってくれ。", "{0}. Ich kenne diesen Geruch nach Wasser und Rauch. Ihr habt mich nach Hause gebracht; hier ist die versprochene Bezahlung.", "{0}. Je reconnais cette odeur d'eau et de fumée. Vous m'avez ramené chez moi ; voici le paiement promis.", "{0}. Znam ten zapach wody i dymu. Odwiozłeś mnie do domu; oto obiecana zapłata.", "{0}。我認得這水氣與煙火的氣息。你送我回了家；這是我答應付給你的錢。", "{0}. 물과 연기 냄새가 익숙하네요. 집까지 데려다주셨군요. 약속한 사례금을 드립니다."
    ]],
    ["{0} at last. Here is the payment I promised.", [
      "终于到了{0}。这是我答应付给你的钱。", "Наконец-то {0}. Вот обещанная плата.", "Por fin, {0}. Aquí tienes el pago que te prometí.", "Finalmente, {0}. Aqui está o pagamento que prometi.", "ようやく{0}に着きました。約束した謝礼を受け取ってください。", "Endlich {0}. Hier ist die versprochene Bezahlung.", "Enfin, {0}. Voici le paiement promis.", "Nareszcie {0}. Oto obiecana zapłata.", "終於到了{0}。這是我答應付給你的錢。", "드디어 {0}에 도착했습니다. 약속한 사례금을 드립니다."
    ]],
    ["{0} bombarded {1} and silenced its guns. The quays remain closed for {2}; you must leave port.", [
      "{0}炮击了{1}，使其炮台哑火。码头仍将关闭{2}；你必须离港。", "{0} обстрелял {1} и подавил его орудия. Причалы будут закрыты ещё {2}; вам придётся покинуть порт.", "{0} bombardeó {1} y silenció sus cañones. Los muelles seguirán cerrados durante {2}; debes salir del puerto.", "{0} bombardeou {1} e silenciou seus canhões. Os cais continuarão fechados por {2}; você terá de deixar o porto.", "{0}は{1}を砲撃し、砲台を沈黙させた。埠頭はあと{2}閉鎖される。出港せよ。", "{0} hat {1} beschossen und dessen Geschütze zum Schweigen gebracht. Die Kais bleiben noch {2} gesperrt; Ihr müsst den Hafen verlassen.", "{0} a bombardé {1} et réduit ses canons au silence. Les quais resteront fermés pendant {2} ; vous devez quitter le port.", "{0} ostrzelał {1} i uciszył jego działa. Nabrzeża pozostaną zamknięte przez {2}; musisz opuścić port.", "{0}砲擊了{1}，使其砲台啞火。碼頭仍將關閉{2}；你必須離港。", "{0}이 {1}을 포격해 포대를 침묵시켰습니다. 부두는 {2} 동안 폐쇄됩니다. 항구를 떠나야 합니다."
    ]],
    ["Both rulers' courts have answered. Rome will act on the counsel you bring back.", [
      "两位统治者的宫廷都已答复。罗马将依照你带回的意见行事。", "Оба правительственных двора ответили. Рим поступит согласно совету, который вы привезёте.", "Las cortes de ambos gobernantes han respondido. Roma actuará según el consejo que traigas.", "As cortes de ambos governantes responderam. Roma agirá conforme ao parecer que você trouxer.", "両君主の宮廷から返答が届いた。ローマはそなたが持ち帰る進言に従って動く。", "Die Höfe beider Herrscher haben geantwortet. Rom wird nach dem Rat handeln, den Ihr zurückbringt.", "Les cours des deux souverains ont répondu. Rome agira selon l'avis que vous rapporterez.", "Oba dwory udzieliły odpowiedzi. Rzym postąpi zgodnie z radą, którą przywieziesz.", "兩位統治者的宮廷都已答覆。羅馬將依照你帶回的意見行事。", "두 통치자의 궁정이 모두 답했습니다. 로마는 당신이 가져올 의견에 따라 움직일 것입니다."
    ]],
    ["{0} agrees to pay tribute to {1}.", [
      "{0}同意向{1}缴纳贡礼。", "{0} соглашается платить дань {1}.", "{0} acepta pagar tributo a {1}.", "{0} concorda em pagar tributo a {1}.", "{0}は{1}に貢納することに同意しました。", "{0} erklärt sich bereit, {1} Tribut zu entrichten.", "{0} accepte de verser un tribut à {1}.", "{0} zgadza się płacić daninę na rzecz {1}.", "{0}同意向{1}繳納貢禮。", "{0}은 {1}에게 조공을 바치기로 합니다."
    ]],
    ["{0}{1} remains independent but agrees to pay tribute to {2}.", [
      "{0}{1}保持独立，但同意向{2}缴纳贡礼。", "{0}{1} сохраняет независимость, но соглашается платить дань {2}.", "{0}{1} sigue siendo independiente, pero acepta pagar tributo a {2}.", "{0}{1} permanece independente, mas concorda em pagar tributo a {2}.", "{0}{1}は独立を保つ一方、{2}への貢納に同意しました。", "{0}{1} bleibt unabhängig, erklärt sich jedoch bereit, {2} Tribut zu entrichten.", "{0}{1} reste indépendant, mais accepte de verser un tribut à {2}.", "{0}{1} pozostaje niezależny, ale zgadza się płacić daninę na rzecz {2}.", "{0}{1}保持獨立，但同意向{2}繳納貢禮。", "{0}{1}은 독립을 유지하면서 {2}에게 조공을 바치기로 합니다."
    ]],
    ["{0} agrees to pay tribute to {1}.", [
      "{0}同意向{1}缴纳贡礼。", "{0} соглашается платить дань {1}.", "{0} acepta pagar tributo a {1}.", "{0} concorda em pagar tributo a {1}.", "{0}は{1}に貢納することに同意しました。", "{0} erklärt sich bereit, {1} Tribut zu entrichten.", "{0} accepte de verser un tribut à {1}.", "{0} zgadza się płacić daninę na rzecz {1}.", "{0}同意向{1}繳納貢禮。", "{0}은 {1}에게 조공을 바치기로 합니다."
    ]],
    ...
    [". Each year, on All Saints' Day, one falcon shall be rendered to the Viceroy of Sicily.", [
      "。每年諸聖日，須向西西里副王進獻一隻獵鷹。", ". Каждый год в День всех святых вице-королю Сицилии надлежит преподнести сокола.", ". Cada año, el día de Todos los Santos, se entregará un halcón al virrey de Sicilia.", ". Todos os anos, no Dia de Todos os Santos, um falcão será entregue ao vice-rei da Sicília.", "。毎年、諸聖人の日にシチリア副王へ鷹を一羽献上するものとする。", ". Alljährlich ist dem Vizekönig von Sizilien an Allerheiligen ein Falke zu übergeben.", ". Chaque année, à la Toussaint, un faucon sera remis au vice-roi de Sicile.", ". Co roku w Dzień Wszystkich Świętych należy przekazać sokoła wicekrólowi Sycylii.", "。每年諸聖日，須向西西里副王進獻一隻獵鷹。", ". 매년 모든 성인의 날에 시칠리아 부왕에게 매 한 마리를 바쳐야 합니다."
    ]],
    ["{0}% ABOVE WORLD", [
      "高于世界价格{0}%", "{0}% ВЫШЕ МИРОВОЙ ЦЕНЫ", "{0}% POR ENCIMA DEL PRECIO MUNDIAL", "{0}% ACIMA DO PREÇO MUNDIAL", "世界価格より{0}%高い", "{0}% ÜBER DEM WELTPREIS", "{0} % AU-DESSUS DU PRIX MONDIAL", "{0}% POWYŻEJ CENY ŚWIATOWEJ", "高於世界價格{0}%", "세계 시세보다 {0}% 높음"
    ]],
    ["{0}% BELOW WORLD", [
      "低于世界价格{0}%", "{0}% НИЖЕ МИРОВОЙ ЦЕНЫ", "{0}% POR DEBAJO DEL PRECIO MUNDIAL", "{0}% ABAIXO DO PREÇO MUNDIAL", "世界価格より{0}%安い", "{0}% UNTER DEM WELTPREIS", "{0} % EN DESSOUS DU PRIX MONDIAL", "{0}% PONIŻEJ CENY ŚWIATOWEJ", "低於世界價格{0}%", "세계 시세보다 {0}% 낮음"
    ]],
    ["{0}% BUILT", [
      "已建成{0}%", "ПОСТРОЕНО НА {0}%", "CONSTRUIDO AL {0}%", "CONSTRUÍDO: {0}%", "建設率{0}%", "{0}% FERTIGGESTELLT", "CONSTRUIT À {0} %", "ZBUDOWANO W {0}%", "已建成{0}%", "{0}% 건설 완료"
    ]],
    ["{0}% casualty resistance", [
      "避免船员伤亡的概率：{0}%", "{0}% — шанс предотвратить потери экипажа", "{0}% de probabilidad de evitar bajas en la tripulación", "{0}% de chance de evitar baixas na tripulação", "乗組員の死傷を防ぐ確率：{0}%", "{0}% Chance, Verluste unter der Besatzung zu verhindern", "{0} % de chances d'éviter des pertes parmi l'équipage", "{0}% szans na uniknięcie strat wśród załogi", "避免船員傷亡的機率：{0}%", "선원 피해 방지 확률 {0}%"
    ]],
    ["{0} at last. I left to chase history and return with enough of it to empty a tavern.", [
      "终于回到{0}。我出门寻访往事，归来时带回的故事足以让一家酒馆座无虚席。", "Наконец-то {0}. Я отправился искать следы прошлого и вернулся с таким запасом историй, что их хватит на весь трактир.", "Por fin, {0}. Salí en busca de historias del pasado y volví con tantas que llenarían una taberna.", "Finalmente, {0}. Saí em busca de histórias do passado e voltei com tantas que encheriam uma taverna.", "ようやく{0}に着いた。歴史を探しに出たが、酒場が満員になるほど話の種を持ち帰ったよ。", "Endlich {0}. Ich zog aus, um Geschichten aus der Vergangenheit zu suchen, und kehrte mit genug davon für eine ganze Schenke zurück.", "Enfin {0}. Je suis parti chercher des récits du passé et j'en rapporte assez pour remplir une taverne.", "Nareszcie {0}. Wyruszyłem szukać opowieści z przeszłości i wróciłem z tyloma, że zapełniłyby całą gospodę.", "終於回到{0}。我出門尋訪往事，歸來時帶回的故事足以讓一家酒館座無虛席。", "드디어 {0}에 도착했군요. 옛이야기를 찾아 떠났다가 선술집을 가득 채울 만큼 많은 이야기를 가져왔습니다."
    ]],
    ["{0} at last. My family will hear your name kindly. Here is the {1} db I owe.", [
      "终于回到{0}。我的家人会记得你的恩情。这是我欠你的{1}达布隆。", "Наконец-то {0}. Моя семья будет вспоминать вас с благодарностью. Вот мои {1} дублонов.", "Por fin, {0}. Mi familia te recordará con gratitud. Aquí tienes los {1} doblones que te debo.", "Finalmente, {0}. Minha família se lembrará de você com gratidão. Aqui estão os {1} dobrões que lhe devo.", "ようやく{0}に着いた。家族には君のことを感謝とともに話そう。借りていた{1}ダブロンを受け取ってくれ。", "Endlich {0}. Meine Familie wird Euch in guter Erinnerung behalten. Hier sind die {1} Dublonen, die ich Euch schulde.", "Enfin {0}. Ma famille se souviendra de vous avec gratitude. Voici les {1} doublons que je vous dois.", "Nareszcie {0}. Moja rodzina będzie ci wdzięczna. Oto {1} dublonów, które jestem ci winien.", "終於回到{0}。我的家人會記得你的恩情。這是我欠你的{1}達布隆。", "드디어 {0}에 도착했군요. 가족에게 당신의 은혜를 전하겠습니다. 빚진 더블룬 {1}닢을 받으세요."
    ]],
    ["{0} and {1} are spilling one another's Christian blood.", [
      "{0}和{1}正在彼此杀戮基督徒。", "{0} и {1} проливают кровь христиан, сражаясь друг с другом.", "{0} y {1} se enfrentan derramando sangre cristiana.", "{0} e {1} se enfrentam, derramando sangue cristão.", "{0}と{1}は争い、キリスト教徒同士で血を流している。", "{0} und {1} bekämpfen einander und vergießen dabei christliches Blut.", "{0} et {1} s'affrontent et font couler le sang chrétien.", "{0} i {1} walczą ze sobą, przelewając chrześcijańską krew.", "{0}和{1}正在彼此殺戮基督徒。", "{0}과 {1}은 서로 싸우며 기독교인의 피를 흘리고 있습니다."
    ]],
    ["Carry a Papal nuncio from one ruler's court to the other, and bring back both replies.", [
      "请护送教宗使节从一位统治者的宫廷前往另一位的宫廷，并带回双方的答复。", "Доставьте папского нунция из двора одного правителя ко двору другого и привезите ответы обоих.", "Lleva a un nuncio papal de la corte de un gobernante a la del otro y trae las respuestas de ambos.", "Leve um núncio papal da corte de um governante à do outro e traga as respostas de ambos.", "教皇特使を一方の君主の宮廷からもう一方の宮廷へ送り届け、双方の返答を持ち帰れ。", "Bringt einen päpstlichen Nuntius vom Hof des einen Herrschers zum Hof des anderen und kehrt mit beiden Antworten zurück.", "Conduisez un nonce pontifical de la cour de l'un des souverains à celle de l'autre, puis rapportez leurs deux réponses.", "Przewieź nuncjusza papieskiego z dworu jednego władcy na dwór drugiego i przywieź odpowiedzi obu.", "請護送教宗使節從一位統治者的宮廷前往另一位的宮廷，並帶回雙方的答覆。", "교황 사절을 한 통치자의 궁정에서 다른 통치자의 궁정으로 모시고 가 양측의 답변을 받아 오십시오."
    ]],
    ["{0} and {1} are spilling one another's Christian blood. Carry a Papal nuncio from one ruler's court to the other, and bring back both replies.", [
      "{0}和{1}正在彼此杀戮基督徒。请护送教宗使节从一位统治者的宫廷前往另一位的宫廷，并带回双方的答复。", "{0} и {1} проливают кровь христиан, сражаясь друг с другом. Доставьте папского нунция из двора одного правителя ко двору другого и привезите ответы обоих.", "{0} y {1} se enfrentan derramando sangre cristiana. Lleva a un nuncio papal de la corte de un gobernante a la del otro y trae las respuestas de ambos.", "{0} e {1} se enfrentam, derramando sangue cristão. Leve um núncio papal da corte de um governante à do outro e traga as respostas de ambos.", "{0}と{1}は争い、キリスト教徒同士で血を流している。教皇特使を一方の君主の宮廷からもう一方の宮廷へ送り届け、双方の返答を持ち帰れ。", "{0} und {1} bekämpfen einander und vergießen dabei christliches Blut. Bringt einen päpstlichen Nuntius vom Hof des einen Herrschers zum Hof des anderen und kehrt mit beiden Antworten zurück.", "{0} et {1} s'affrontent et font couler le sang chrétien. Conduisez un nonce pontifical de la cour de l'un des souverains à celle de l'autre, puis rapportez leurs deux réponses.", "{0} i {1} walczą ze sobą, przelewając chrześcijańską krew. Przewieź nuncjusza papieskiego z dworu jednego władcy na dwór drugiego i przywieź odpowiedzi obu.", "{0}和{1}正在彼此殺戮基督徒。請護送教宗使節從一位統治者的宮廷前往另一位的宮廷，並帶回雙方的答覆。", "{0}과 {1}은 서로 싸우며 기독교인의 피를 흘리고 있습니다. 교황 사절을 한 통치자의 궁정에서 다른 통치자의 궁정으로 모시고 가 양측의 답변을 받아 오십시오."
    ]],
    ["{0} Both rulers' courts have answered. Rome will act on the counsel you bring back.", [
      "{0} 两位统治者的宫廷都已答复。罗马将依照你带回的意见行事。", "{0} Оба правительственных двора ответили. Рим поступит согласно совету, который вы привезёте.", "{0} Las cortes de ambos gobernantes han respondido. Roma actuará según el consejo que traigas.", "{0} As cortes de ambos governantes responderam. Roma agirá conforme ao parecer que você trouxer.", "{0} 両君主の宮廷から返答が届いた。ローマはそなたが持ち帰る進言に従って動く。", "{0} Die Höfe beider Herrscher haben geantwortet. Rom wird nach dem Rat handeln, den Ihr zurückbringt.", "{0} Les cours des deux souverains ont répondu. Rome agira selon l'avis que vous rapporterez.", "{0} Oba dwory udzieliły odpowiedzi. Rzym postąpi zgodnie z radą, którą przywieziesz.", "{0} 兩位統治者的宮廷都已答覆。羅馬將依照你帶回的意見行事。", "{0} 두 통치자의 궁정이 모두 답했습니다. 로마는 당신이 가져올 의견에 따라 움직일 것입니다."
    ]],
    ["{0} is ruled by its own sovereign. Turn back; you will find no provisions for sale here.", [
      "{0}由自己的君主统治。请掉头离开；这里不出售补给。", "{0} подчиняется собственному государю. Поворачивайте назад: здесь вам не продадут припасы.", "{0} tiene su propio soberano. Da media vuelta; aquí no se venden provisiones.", "{0} tem seu próprio soberano. Volte; aqui não se vendem mantimentos.", "{0}は独自の君主に治められている。引き返せ。ここでは補給品を売らぬ。", "{0} hat einen eigenen Herrscher. Kehrt um; hier werden keine Vorräte verkauft.", "{0} a son propre souverain. Faites demi-tour ; aucun ravitaillement n'est vendu ici.", "{0} ma własnego władcę. Zawróć; tutaj nie sprzedaje się zaopatrzenia.", "{0}由自己的君主統治。請掉頭離開；這裡不出售補給。", "{0}은 자체 군주가 다스립니다. 돌아가십시오. 이곳에서는 보급품을 팔지 않습니다."
    ]],
  ...
  Object.assign(overrides, {
    "God's peace attend you, captain. It is good to meet another subject of the English Church.": reviewedLocaleOverrides("God's peace attend you, captain. It is good to meet another subject of the English Church.", ["愿上帝赐平安给你，船长。很高兴遇见另一位英国国教会的信徒。", "Да пребудет с вами мир Божий, капитан. Рад встретить ещё одного последователя англиканской церкви.", "Que la paz de Dios te acompañe, capitán. Me alegra encontrar a otro fiel de la Iglesia de Inglaterra.", "Que a paz de Deus esteja com você, capitão. É bom encontrar outro fiel da Igreja da Inglaterra.", "神の平安があなたと共にありますように、船長。英国国教会の信徒に会えてうれしいです。", "Gottes Friede sei mit Euch, Kapitän. Es ist schön, einem weiteren Gläubigen der anglikanischen Kirche zu begegnen.", "Que la paix de Dieu vous accompagne, capitaine. C'est un plaisir de rencontrer un autre fidèle de l'Église d'Angleterre.", "Pokój Boży niech będzie z tobą, kapitanie. Dobrze spotkać innego wiernego Kościoła anglikańskiego.", "願上帝賜平安給你，船長。很高興遇見另一位英國國教會的信徒。", "선장님, 하나님의 평화가 함께하기를 바랍니다. 영국 국교회 신자를 또 만나 반갑습니다."]),
    "Gold has come north from Peru. I mean to follow it south. The Crown licenses me to conquer at my own cost. Provision my company and break Chan Chan's batteries. God and His Majesty may judge the rest.": reviewedLocaleOverrides("Gold has come north from Peru. I mean to follow it south. The Crown licenses me to conquer at my own cost. Provision my company and break Chan Chan's batteries. God and His Majesty may judge the rest.", ["黄金已从秘鲁北上，我打算循着它南下。王室准许我自费征服。请为我的连队补给，并摧毁昌昌的炮台。其余的事交由上帝和陛下评断。", "Золото пришло с юга, из Перу. Я намерен последовать за ним. Корона разрешила мне вести завоевание за свой счёт. Снабдите мою роту и уничтожьте орудия Чан-Чана. Остальное рассудят Бог и Его Величество.", "El oro ha llegado al norte desde Perú; pienso seguir su rastro hacia el sur. La Corona me autoriza a conquistar por mi cuenta. Abastece a mi compañía y destruye las baterías de Chan Chan. Dios y Su Majestad juzgarán el resto.", "O ouro veio do Peru para o norte; pretendo seguir seu rastro para o sul. A Coroa me autorizou a conquistar por minha conta. Abasteça minha companhia e destrua as baterias de Chan Chan. Deus e Sua Majestade julgarão o resto.", "ペルーから黄金が北へ運ばれてきた。今度は南へ追うつもりだ。王室から自費での征服を許されている。兵を補給し、チャン・チャンの砲台を破壊してくれ。あとは神と陛下の裁きに任せよう。", "Das Gold kam aus Peru nach Norden. Ich will seiner Spur nach Süden folgen. Die Krone hat mir erlaubt, auf eigene Kosten Eroberungen zu führen. Versorgt meine Kompanie und zerstört Chan Chans Geschützbatterien. Über alles Weitere mögen Gott und Seine Majestät richten.", "L'or est remonté du Pérou vers le nord ; je compte le suivre vers le sud. La Couronne m'autorise à conquérir à mes frais. Ravitaillez ma compagnie et détruisez les batteries de Chan Chan. Dieu et Sa Majesté jugeront du reste.", "Złoto przybyło z Peru na północ; zamierzam ruszyć jego śladem na południe. Korona zezwala mi podbijać na własny koszt. Zaopatrz moją kompanię i zniszcz baterie dział Chan Chan. Resztę osądzą Bóg i Jego Wysokość.", "黃金已從秘魯北上，我打算循著它南下。王室准許我自費征服。請為我的連隊補給，並摧毀昌昌的砲台。其餘的事交由上帝和陛下評斷。", "페루에서 금이 북쪽으로 올라왔습니다. 그 흔적을 따라 남쪽으로 갈 생각입니다. 왕실은 제 비용으로 정복하는 것을 허가했습니다. 우리 중대에 보급품을 대고 찬찬의 포대를 파괴하세요. 나머지는 하나님과 폐하께서 판단하실 것입니다."]),
    "Great figures scored into the desert. Who were they meant to see?": reviewedLocaleOverrides("Great figures scored into the desert. Who were they meant to see?", ["沙漠中刻画着巨大的图形。它们是给谁看的？", "На поверхности пустыни начертаны огромные фигуры. Кто должен был их увидеть?", "En el desierto hay figuras enormes trazadas en el suelo. ¿Quién debía verlas?", "Há figuras enormes traçadas no deserto. Quem deveria vê-las?", "砂漠に刻まれた巨大な地上絵。誰に見せるためのものだったのだろう？", "Riesige Figuren sind in den Wüstenboden gezeichnet. Wer sollte sie sehen?", "D'immenses figures sont tracées dans le désert. À qui étaient-elles destinées ?", "Na pustyni wyryto ogromne figury. Kto miał je zobaczyć?", "沙漠中刻畫著巨大的圖形。它們是給誰看的？", "사막에 거대한 형상들이 새겨져 있습니다. 누구에게 보여 주려던 걸까요?"]),
    "Great Zimbabwe": reviewedLocaleOverrides("Great Zimbabwe", ["大津巴布韦", "Великое Зимбабве", "Gran Zimbabue", "Grande Zimbábue", "グレート・ジンバブエ", "Groß-Simbabwe", "Grand Zimbabwe", "Wielkie Zimbabwe", "大辛巴威", "그레이트 짐바브웨"]),
    "Good news: I have come to settle accounts. Better news: the floor has stopped listing to port.": reviewedLocaleOverrides("Good news: I have come to settle accounts. Better news: the floor has stopped listing to port.", ["好消息：我来结账了。更好的消息：地板终于不再向左舷倾斜了。", "Хорошая новость: я пришёл свести счета. Ещё лучше — пол больше не кренится на левый борт.", "Buenas noticias: he venido a saldar cuentas. Mejor aún: el suelo ha dejado de escorarse a babor.", "Boa notícia: vim acertar as contas. Melhor ainda: o piso parou de adernar para bombordo.", "いい知らせだ。勘定を清算しに来た。もっといい知らせは、床が左舷に傾かなくなったことだ。", "Gute Nachrichten: Ich bin gekommen, um abzurechnen. Noch bessere: Der Boden neigt sich nicht mehr nach Backbord.", "Bonne nouvelle : je viens régler les comptes. Mieux encore : le plancher ne penche plus sur bâbord.", "Dobra wiadomość: przyszedłem rozliczyć rachunki. Lepsza: podłoga przestała przechylać się na lewą burtę.", "好消息：我來結帳了。更好的消息：地板終於不再向左舷傾斜了。", "좋은 소식입니다. 결산하러 왔습니다. 더 좋은 소식은 바닥이 더는 좌현 쪽으로 기울지 않는다는 겁니다."]),
  });
  Object.assign(overrides, {
    "God and the King may bless an expedition, Captain, but neither fills its holds. Bring {0} {1} for {2}. I will pay {3} doubloons when the order is complete, weighed before my notary.": reviewedLocaleOverrides("God and the King may bless an expedition, Captain, but neither fills its holds. Bring {0} {1} for {2}. I will pay {3} doubloons when the order is complete, weighed before my notary.", ["船长，上帝与国王或许会保佑远征，却不会替船舱装货。请为{2}送去{0}{1}。货物交齐并由我的公证人过秤后，我会付你{3}达布隆。", "Капитан, Бог и король могут благословить экспедицию, но трюмы они не наполнят. Доставьте для {2}: {0} {1}. Когда заказ будет выполнен и взвешен у моего нотариуса, я заплачу {3} дублонов.", "Capitán, Dios y el rey podrán bendecir la expedición, pero no llenarán sus bodegas. Lleva {0} {1} para {2}. Cuando completes el pedido y mi notario pese la mercancía, te pagaré {3} doblones.", "Capitão, Deus e o rei podem abençoar a expedição, mas não enchem os porões. Leve {0} {1} para {2}. Pagarei {3} dobrões quando o pedido estiver completo e meu tabelião pesar a carga.", "船長、神と王は遠征を祝福してくれるかもしれないが、船倉を満たしてはくれない。{2}へ{0}{1}を届けてくれ。注文分がそろい、私の公証人が荷を量ったら、{3}ダブロンを払おう。", "Kapitän, Gott und der König mögen eine Expedition segnen, aber ihre Laderäume füllen sie nicht. Liefert {0} {1} für {2}. Sobald der Auftrag vollständig ist und mein Notar die Ware gewogen hat, zahle ich {3} Dublonen.", "Capitaine, Dieu et le roi peuvent bénir une expédition, mais ils ne rempliront pas ses cales. Livrez {0} {1} pour {2}. Je vous paierai {3} doublons une fois la commande complète, après pesée devant mon notaire.", "Kapitanie, Bóg i król mogą błogosławić wyprawie, ale nie zapełnią jej ładowni. Dostarcz {0} {1} dla {2}. Gdy zamówienie będzie kompletne i mój notariusz zważy towar, zapłacę {3} dublonów.", "船長，上帝與國王或許會保佑遠征，卻不會替船艙裝貨。請為{2}送去{0}{1}。貨物交齊並由我的公證人過秤後，我會付你{3}達布隆。", "선장님, 신과 왕께서 원정을 축복하실 수는 있어도 화물창을 채워 주시진 않습니다. {2}에 {0}{1}을 가져다주세요. 주문품이 모두 모이고 제 공증인이 무게를 재면 {3} 더블룬을 지급하겠습니다."]),
    "God and the King may bless an expedition, Captain, but neither fills its holds. Bring {0} {1} for {2}. I will pay {3} doubloons when the order is complete, weighed before my notary.{4}": reviewedLocaleOverrides("God and the King may bless an expedition, Captain, but neither fills its holds. Bring {0} {1} for {2}. I will pay {3} doubloons when the order is complete, weighed before my notary.{4}", ["船长，上帝与国王或许会保佑远征，却不会替船舱装货。请为{2}送去{0}{1}。货物交齐并由我的公证人过秤后，我会付你{3}达布隆。{4}", "Капитан, Бог и король могут благословить экспедицию, но трюмы они не наполнят. Доставьте для {2}: {0} {1}. Когда заказ будет выполнен и взвешен у моего нотариуса, я заплачу {3} дублонов.{4}", "Capitán, Dios y el rey podrán bendecir la expedición, pero no llenarán sus bodegas. Lleva {0} {1} para {2}. Cuando completes el pedido y mi notario pese la mercancía, te pagaré {3} doblones.{4}", "Capitão, Deus e o rei podem abençoar a expedição, mas não enchem os porões. Leve {0} {1} para {2}. Pagarei {3} dobrões quando o pedido estiver completo e meu tabelião pesar a carga.{4}", "船長、神と王は遠征を祝福してくれるかもしれないが、船倉を満たしてはくれない。{2}へ{0}{1}を届けてくれ。注文分がそろい、私の公証人が荷を量ったら、{3}ダブロンを払おう。{4}", "Kapitän, Gott und der König mögen eine Expedition segnen, aber ihre Laderäume füllen sie nicht. Liefert {0} {1} für {2}. Sobald der Auftrag vollständig ist und mein Notar die Ware gewogen hat, zahle ich {3} Dublonen.{4}", "Capitaine, Dieu et le roi peuvent bénir une expédition, mais ils ne rempliront pas ses cales. Livrez {0} {1} pour {2}. Je vous paierai {3} doublons une fois la commande complète, après pesée devant mon notaire.{4}", "Kapitanie, Bóg i król mogą błogosławić wyprawie, ale nie zapełnią jej ładowni. Dostarcz {0} {1} dla {2}. Gdy zamówienie będzie kompletne i mój notariusz zważy towar, zapłacę {3} dublonów.{4}", "船長，上帝與國王或許會保佑遠征，卻不會替船艙裝貨。請為{2}送去{0}{1}。貨物交齊並由我的公證人過秤後，我會付你{3}達布隆。{4}", "선장님, 신과 왕께서 원정을 축복하실 수는 있어도 화물창을 채워 주시진 않습니다. {2}에 {0}{1}을 가져다주세요. 주문품이 모두 모이고 제 공증인이 무게를 재면 {3} 더블룬을 지급하겠습니다.{4}"]),
    "Genoa may change masters again. This deed will not.": reviewedLocaleOverrides("Genoa may change masters again. This deed will not.", ["热那亚或许还会易主，但这份契约不会改变。", "Генуя может снова сменить правителя, но условия этого документа останутся прежними.", "Génova puede volver a cambiar de manos; este documento seguirá en vigor.", "Gênova pode mudar de mãos outra vez; este documento continuará valendo.", "ジェノヴァはまた支配者が変わるかもしれない。だが、この証書の効力は変わらない。", "Genua mag erneut den Herrscher wechseln. Diese Urkunde bleibt davon unberührt.", "Gênes peut changer de maître encore une fois ; cet acte restera valable.", "Genua może znów zmienić władcę, ale ten dokument pozostanie w mocy.", "熱那亞或許還會易主，但這份契約不會改變。", "제노바의 지배자는 다시 바뀔 수 있지만, 이 증서의 효력은 그대로입니다."]),
    "Gentlemen searching for treasure will still need to cut wood and plant. Bring": reviewedLocaleOverrides("Gentlemen searching for treasure will still need to cut wood and plant. Bring", ["寻宝的先生们仍得伐木耕种。带上", "Даже джентльменам в поисках сокровищ придётся рубить лес и сажать семена. Возьмите", "Quienes busquen tesoros también tendrán que talar árboles y sembrar. Lleva", "Mesmo quem busca tesouros ainda terá de cortar madeira e plantar. Leve", "宝探しをする紳士たちも、木を伐り、種をまかねばならない。持っていくのは", "Auch Schatzsucher müssen Holz schlagen und säen. Bringt", "Même les chercheurs de trésors devront couper du bois et planter. Apportez", "Nawet poszukiwacze skarbów muszą ścinać drzewa i sadzić. Zabierz", "尋寶的先生們仍得伐木耕種。帶上", "보물을 찾는 사람들도 나무를 베고 씨를 뿌려야 합니다. 다음을 준비하세요"]),
    "Give me the treasure account after breakfast. For now, try not to bury yourself.": reviewedLocaleOverrides("Give me the treasure account after breakfast. For now, try not to bury yourself.", ["早餐后把宝藏账目交给我。现在嘛，尽量别把自己埋了。", "После завтрака принесите мне отчёт о сокровищах. А пока постарайтесь не закопать себя.", "Después del desayuno, dame las cuentas del tesoro. Por ahora, procura no enterrarte.", "Depois do café da manhã, traga o balanço do tesouro. Por enquanto, tente não se enterrar.", "宝の収支報告は朝食の後でいい。今は自分が埋まらないよう気をつけてくれ。", "Gib mir nach dem Frühstück die Schatzabrechnung. Versuch bis dahin, dich nicht selbst zu verschütten.", "Donnez-moi les comptes du trésor après le petit-déjeuner. D'ici là, tâchez de ne pas vous ensevelir.", "Po śniadaniu przynieś mi rozliczenie skarbu. Na razie postaraj się nie zakopać.", "早餐後把寶藏帳目交給我。現在嘛，儘量別把自己埋了。", "아침 식사 후 보물 장부를 가져오세요. 그전까지는 스스로를 파묻지 않도록 하세요."]),
    "Full gun ports and fighting crew": reviewedLocaleOverrides("Full gun ports and fighting crew", ["炮门全开，战斗船员就位", "Все орудийные порты открыты, экипаж готов к бою", "Artillería lista y tripulación preparada para el combate", "Canhões prontos e tripulação preparada para o combate", "砲門を開き、乗組員は戦闘態勢", "Geschütze bemannt und Mannschaft kampfbereit", "Canons aux sabords et équipage prêt au combat", "Działa gotowe do strzału, załoga do walki", "砲門全開，戰鬥船員就位", "포문을 열고 선원들은 전투 태세를 갖추세요"]),
    "Furl your colors beyond the headland. Inside this cove, no captain asks where a cargo came from.": reviewedLocaleOverrides("Furl your colors beyond the headland. Inside this cove, no captain asks where a cargo came from.", ["绕过岬角便收起旗帜。在这处海湾里，没有船长会追问货物的来历。", "За мысом уберите флаг. В этой бухте ни один капитан не спросит, откуда груз.", "Arría tus colores al otro lado del cabo. En esta cala, ningún capitán pregunta de dónde viene la carga.", "Recolha a bandeira depois do cabo. Nesta enseada, nenhum capitão pergunta de onde veio a carga.", "岬を越えたら旗を降ろせ。この入り江では、貨物の出所を尋ねる船長はいない。", "Holt hinter der Landzunge die Flagge ein. In dieser Bucht fragt kein Kapitän, woher die Ladung stammt.", "Amenez vos couleurs après le cap. Dans cette crique, aucun capitaine ne demande d'où vient la cargaison.", "Za cyplem zwiń banderę. W tej zatoce żaden kapitan nie pyta, skąd pochodzi ładunek.", "繞過岬角便收起旗幟。在這處海灣裡，沒有船長會追問貨物的來歷。", "곶을 돌아가면 깃발을 내리세요. 이 만에서는 화물의 출처를 묻는 선장이 없습니다."]),
    "Galleys, coasters, and deep-water merchants crowd the harbor, each carrying news from another shore.": reviewedLocaleOverrides("Galleys, coasters, and deep-water merchants crowd the harbor, each carrying news from another shore.", ["桨帆船、沿岸船只和远洋商船挤满港口，每艘都带来另一处海岸的消息。", "Галеры, каботажные суда и океанские торговые корабли заполняют гавань, принося вести с других берегов.", "Galera, barcos de cabotaje y mercantes de altura llenan el puerto; cada uno trae noticias de otras costas.", "Galeras, navios de cabotagem e mercantes de alto-mar lotam o porto, cada um trazendo notícias de outras costas.", "ガレー船、沿岸航路船、外洋商船が港にひしめき、それぞれ別の岸からの知らせを運んでくる。", "Galeeren, Küstenschiffe und Hochseefrachter füllen den Hafen; jedes bringt Nachrichten von einer anderen Küste.", "Galères, caboteurs et navires de commerce hauturiers encombrent le port, chacun apportant des nouvelles d'une autre rive.", "Galery, kabotażowce i pełnomorskie statki handlowe tłoczą się w porcie, każdy z wieściami z innego wybrzeża.", "槳帆船、沿岸船隻和遠洋商船擠滿港口，每艘都帶來另一處海岸的消息。", "갤리선과 연안선, 원양 상선이 항구를 가득 메우고, 저마다 다른 해안의 소식을 전합니다."])
  });
  Object.assign(overrides, {
    "Free Imperial City of Worms": reviewedLocaleOverrides("Free Imperial City of Worms", ["沃尔姆斯自由帝国城市", "Вольный имперский город Вормс", "Ciudad Imperial Libre de Worms", "Cidade Imperial Livre de Worms", "ヴォルムス自由帝国都市", "Freie Reichsstadt Worms", "Ville libre d'Empire de Worms", "Wolne Miasto Rzeszy Worms", "沃爾姆斯自由帝國城市", "보름스 자유 제국 도시"]),
    "French Montreal mission settlement": reviewedLocaleOverrides("French Montreal mission settlement", ["法国蒙特利尔传教据点", "Поселение французской миссии в Монреале", "Asentamiento de la misión francesa de Montreal", "Assentamento da missão francesa em Montreal", "フランスのモントリオール伝道拠点", "Französische Missionssiedlung in Montreal", "Établissement missionnaire français à Montréal", "Francuska osada misyjna w Montrealu", "法國蒙特婁傳教據點", "프랑스 몬트리올 선교 거점"]),
  });
  Object.assign(overrides, {
    "FOUND A SEEP": reviewedLocaleOverrides("FOUND A SEEP", ["发现渗水处", "НАЙДЕН ИСТОЧНИК ПРОСАЧИВАНИЯ ВОДЫ", "SE HA ENCONTRADO UNA FILTRACIÓN DE AGUA", "FOI ENCONTRADO UM PONTO DE INFILTRAÇÃO", "水の染み出しを発見", "SICKERSTELLE GEFUNDEN", "SUINTEMENT DÉCOUVERT", "ZNALEZIONO WYCIEK", "發現滲水處", "물이 스며 나오는 곳을 발견했습니다"]),
    "FOUND A SPRING": reviewedLocaleOverrides("FOUND A SPRING", ["发现一处泉眼", "НАЙДЕН ИСТОЧНИК", "SE HA ENCONTRADO UN MANANTIAL", "FOI ENCONTRADA UMA NASCENTE", "泉を発見", "QUELLE GEFUNDEN", "SOURCE DÉCOUVERTE", "ZNALEZIONO ŹRÓDŁO", "發現一處泉眼", "샘을 발견했습니다"]),
    "FOUND COASTAL FOOD": reviewedLocaleOverrides("FOUND COASTAL FOOD", ["发现沿海食物", "НАЙДЕНА ПРИБРЕЖНАЯ ПИЩА", "ALIMENTO COSTERO ENCONTRADO", "ALIMENTO COSTEIRO ENCONTRADO", "沿岸の食料を発見", "Nahrung an der Küste gefunden", "NOURRITURE CÔTIÈRE TROUVÉE", "ZNALEZIONO ŻYWNOŚĆ NA WYBRZEŻU", "發現沿海食物", "해안에서 식량을 발견했습니다"])
  });
  Object.assign(overrides, {
    "Floodwater and distance will punish a careless camp. Bring": reviewedLocaleOverrides("Floodwater and distance will punish a careless camp. Bring", ["营地稍有疏忽，就会遭洪水和路途之苦。带上", "Неосторожный лагерь пострадает от разливов и удалённости. Возьмите с собой", "Una acampada descuidada sufrirá las crecidas y la distancia. Lleva", "Um acampamento descuidado sofrerá com as cheias e a distância. Leve", "洪水や遠路は、備えのない野営地を苦しめる。持っていくのは", "Hochwasser und die abgelegene Lage machen einem unvorsichtigen Lager zu schaffen. Bringt", "Les crues et l'éloignement mettront un camp imprudent à rude épreuve. Apportez", "Powódź i odległość dadzą się we znaki nieostrożnemu obozowi. Zabierz", "營地稍有疏忽，就會遭洪水和路途之苦。帶上", "홍수와 먼 거리는 부주의한 야영지를 힘들게 합니다. 다음을 준비하세요"]),
    "Florida's storms and rival fleets demand defenses before comfort. Bring": reviewedLocaleOverrides("Florida's storms and rival fleets demand defenses before comfort. Bring", ["佛罗里达风暴频仍，敌对舰队虎视眈眈，应先筑防御，再顾舒适。带上", "Штормы и вражеские флоты у берегов Флориды требуют сперва укрепить оборону, а уж потом думать об удобствах. Возьмите", "Las tormentas de Florida y las flotas rivales exigen priorizar las defensas antes que las comodidades. Lleva", "As tempestades da Flórida e as frotas rivais exigem defesas antes do conforto. Leve", "フロリダの嵐と敵対艦隊に備え、快適さより防備を優先せよ。持っていくのは", "Floridas Stürme und rivalisierende Flotten erfordern erst Verteidigungsanlagen, dann Komfort. Bringt", "Face aux tempêtes de Floride et aux flottes rivales, les défenses passent avant le confort. Apportez", "Burze na Florydzie i wrogie floty wymagają najpierw obrony, a dopiero potem wygód. Zabierz", "佛羅里達風暴頻仍，敵對艦隊虎視眈眈，應先築防禦，再顧舒適。帶上", "플로리다의 폭풍과 적대 함대에 대비해 편의보다 방어 시설을 먼저 갖추세요. 다음을 준비하세요"]),
    "Fishing rafts line the shore, and word of your arrival is already moving toward inland settlements.": reviewedLocaleOverrides("Fishing rafts line the shore, and word of your arrival is already moving toward inland settlements.", ["渔筏沿岸排列，你抵达的消息已经传往内陆聚落。", "У берега выстроились рыбацкие плоты, а весть о вашем прибытии уже разносится по поселениям в глубине страны.", "Las balsas de pesca se alinean en la orilla, y la noticia de tu llegada ya se extiende hacia los asentamientos del interior.", "As jangadas de pesca se alinham à beira d'água, e a notícia de sua chegada já se espalha pelos povoados do interior.", "岸辺に漁筏が並び、到着の知らせはすでに内陸の集落へ伝わっています。", "Fischerflöße säumen das Ufer, und die Nachricht von Eurer Ankunft verbreitet sich bereits im Landesinneren.", "Des radeaux de pêche bordent le rivage, et la nouvelle de votre arrivée gagne déjà les villages de l'intérieur.", "Tratwy rybackie ciągną się wzdłuż brzegu, a wieść o twoim przybyciu dociera już do osad w głębi lądu.", "漁筏沿岸排列，你抵達的消息已傳往內陸聚落。", "해안에는 고기잡이 뗏목이 늘어서 있고, 도착 소식은 이미 내륙 마을로 퍼지고 있습니다."])
  });
  Object.assign(overrides, {
    "Destroy pirate haven": reviewedLocaleOverrides("Destroy pirate haven", ["摧毁海盗巢穴", "Уничтожить пиратское логово", "Destruye el escondite pirata", "Destrua o esconderijo pirata", "海賊の隠れ家を破壊する", "Zerstöre das Piratenversteck", "Détruisez le repaire des pirates", "Zniszcz kryjówkę piratów", "摧毀海盜巢穴", "해적 은신처를 파괴하세요"]),
    "Dust from the caravan road settles on the landing, where merchants weigh news from inland against news from the sea.": reviewedLocaleOverrides("Dust from the caravan road settles on the landing, where merchants weigh news from inland against news from the sea.", ["商队道路上的尘土落在码头上，商人在那里权衡来自内陆和海上的消息。", "Пыль с караванной дороги оседает на пристани, где купцы сопоставляют вести из глубины страны и с моря.", "El polvo del camino de las caravanas se posa en el muelle, donde los comerciantes comparan las noticias del interior con las del mar.", "A poeira da estrada das caravanas se deposita no cais, onde os mercadores comparam as notícias do interior com as do mar.", "キャラバンの道から舞い上がった砂埃が船着き場に積もる。商人たちは内陸と海から届いた知らせを比べている。", "Staub von der Karawanenstraße legt sich auf dem Anleger nieder, wo Händler Nachrichten aus dem Landesinneren mit denen vom Meer vergleichen.", "La poussière de la route des caravanes se dépose sur le quai, où les marchands comparent les nouvelles de l'intérieur à celles venues de la mer.", "Pył z karawanowego szlaku osiada na przystani, gdzie kupcy porównują wieści z głębi lądu z tymi znad morza.", "商隊道路上的塵土落在碼頭上，商人在那裡權衡來自內陸和海上的消息。", "대상로의 먼지가 부두에 내려앉고, 상인들은 내륙과 바다에서 온 소식을 견주어 봅니다."]),
    "Each day brings us nearer to {0} and the road to Mecca. I have waited years for the Hajj; I pray our passage remains safe.": reviewedLocaleOverrides("Each day brings us nearer to {0} and the road to Mecca. I have waited years for the Hajj; I pray our passage remains safe.", ["我们一天天接近{0}，也逐渐踏上通往麦加的路。我盼望朝觐多年，祈愿此行平安。", "С каждым днём мы приближаемся к {0} и дороге в Мекку. Я годами ждал хаджа и молюсь, чтобы путь оставался безопасным.", "Cada día nos acercamos más a {0} y al camino hacia La Meca. Llevo años esperando el hach; rezo para que el viaje sea seguro.", "A cada dia, nos aproximamos de {0} e do caminho para Meca. Espero há anos pela peregrinação do hajj; rezo para que a viagem seja segura.", "日ごとに{0}とメッカへ続く道に近づいている。何年も待ち望んだハッジだ。旅路の安全を祈ろう。", "Jeder Tag bringt uns {0} und dem Weg nach Mekka näher. Ich habe jahrelang auf den Haddsch gewartet und bete, dass unsere Reise sicher bleibt.", "Chaque jour nous rapproche de {0} et de la route de La Mecque. J'attends le pèlerinage du hajj depuis des années ; je prie pour que notre voyage se déroule sans danger.", "Z każdym dniem jesteśmy bliżej {0} i drogi do Mekki. Od lat czekam na hadżdż; modlę się, by nasza podróż była bezpieczna.", "我們一天天接近{0}，也逐漸踏上通往麥加的路。我盼望朝覲多年，祈願此行平安。", "하루하루 {0}과 메카로 가는 길에 가까워집니다. 수년간 하지 순례를 기다렸으니, 여정이 안전하기를 기도합니다."])
    ,"Earlier Spanish footholds in Caracas failed. Losada proposes a new city, though Caracas and allied peoples have shown that a charter cannot secure the valley.": reviewedLocaleOverrides("Earlier Spanish footholds in Caracas failed. Losada proposes a new city, though Caracas and allied peoples have shown that a charter cannot secure the valley.", ["西班牙先前在加拉加斯建立據點的嘗試已告失敗。洛薩達提議另建一座城市，但加拉加斯及其盟友已證明，單憑特許狀無法控制這片山谷。", "Прежние испанские поселения в Каракасе потерпели неудачу. Лосада предлагает основать новый город, хотя Каракас и его союзники уже доказали: одной хартии недостаточно, чтобы удержать долину.", "Los primeros asentamientos españoles en Caracas fracasaron. Losada propone fundar una nueva ciudad, aunque Caracas y sus aliados ya han demostrado que una carta no basta para controlar el valle.", "As primeiras tentativas espanholas de se estabelecer em Caracas fracassaram. Losada propõe fundar uma nova cidade, embora Caracas e seus aliados já tenham mostrado que uma carta não basta para controlar o vale.", "カラカスでのスペインの初期拠点は失敗に終わった。ロサダは新たな都市の建設を提案するが、カラカスとその同盟勢力は、特許状だけでは谷を支配できないと示している。", "Frühere spanische Niederlassungen in Caracas scheiterten. Losada schlägt eine neue Stadt vor, doch Caracas und seine Verbündeten haben gezeigt, dass eine Urkunde allein das Tal nicht sichern kann.", "Les premières implantations espagnoles à Caracas ont échoué. Losada propose de fonder une nouvelle ville, même si Caracas et ses alliés ont montré qu'une charte ne suffisait pas à contrôler la vallée.", "Wcześniejsze hiszpańskie osady w Caracas upadły. Losada proponuje założyć nowe miasto, choć Caracas i sprzymierzone ludy pokazały, że sam przywilej nie wystarczy, by opanować dolinę.", "西班牙先前在加拉加斯建立據點的嘗試已告失敗。洛薩達提議另建一座城市，但加拉加斯及其盟友已證明，單憑特許狀無法控制這片山谷。", "카라카스의 초기 스페인 거점은 실패했습니다. 로사다는 새 도시를 세우자고 제안하지만, 카라카스와 동맹 세력은 헌장만으로 계곡을 장악할 수 없음을 이미 보여 주었습니다."]),
    "Easy, captain. You found me out. Put the {0} away.": reviewedLocaleOverrides("Easy, captain. You found me out. Put the {0} away.", ["别激动，船长。你识破我了。把{0}收起来吧。", "Спокойно, капитан. Вы меня раскусили. Уберите {0}.", "Tranquilo, capitán. Me has descubierto. Guarda el {0}.", "Calma, capitão. Você me desmascarou. Guarde o {0}.", "落ち着いて、船長。見破られてしまったね。{0}はしまってくれ。", "Ruhig, Kapitän. Du hast mich durchschaut. Steck den {0} weg.", "Du calme, capitaine. Vous m'avez démasqué. Rangez le {0}.", "Spokojnie, kapitanie. Przejrzałeś mnie. Schowaj {0}.", "別激動，船長。你識破我了。把{0}收起來吧。", "진정하세요, 선장님. 들켰군요. {0}을 치우세요."])
    ,"Endow the language lessons": reviewedLocaleOverrides("Endow the language lessons", ["为语言课程提供经费", "Оплатите языковые занятия", "Financia las clases de idiomas", "Financie as aulas de idiomas", "語学講座に資金を提供する", "Finanzieren Sie den Sprachunterricht", "Financez les cours de langue", "Sfinansuj lekcje języka", "為語言課程提供經費", "언어 수업에 기금을 지원하세요"]),
    "ENGLAND BREAKS WITH ROME": reviewedLocaleOverrides("ENGLAND BREAKS WITH ROME", ["英格兰与罗马决裂", "АНГЛИЯ РАЗРЫВАЕТ СВЯЗИ С РИМОМ", "INGLATERRA ROMPE CON ROMA", "INGLATERRA ROMPE COM ROMA", "イングランド、ローマと決別", "ENGLAND BRICHT MIT ROM", "L'ANGLETERRE ROMPT AVEC ROME", "ANGLIA ZRYWA ZWIĄZKI Z RZYMEM", "英格蘭與羅馬決裂", "잉글랜드, 로마와 결별"]),
    "Enjoy the insult. It earns you no interest, and I will remember it when the debt is gone.": reviewedLocaleOverrides("Enjoy the insult. It earns you no interest, and I will remember it when the debt is gone.", ["尽管挖苦我吧。这不会给你带来任何利息；等债务还清后，我也会记住这笔账。", "Оскорбляйте на здоровье. Это не принесёт вам процентов, а когда долг будет погашен, я припомню это.", "Insúltame si quieres. Eso no te dará intereses, y lo recordaré cuando saldes la deuda.", "Pode me insultar à vontade. Isso não rende juros, e vou me lembrar quando a dívida for paga.", "好きなだけ侮辱すればいい。利息はつかないが、借金を返し終えた後も覚えておく。", "Beleidigt mich nur. Das bringt Euch keine Zinsen ein, und ich werde es Euch nicht vergessen, wenn die Schuld beglichen ist.", "Allez-y, insultez-moi. Cela ne vous rapportera aucun intérêt, et je m'en souviendrai une fois la dette réglée.", "Obrażaj mnie, jeśli chcesz. Nie przyniesie ci to odsetek, a gdy spłacisz dług, będę o tym pamiętać.", "儘管挖苦我吧。這不會給你帶來任何利息；等債務還清後，我也會記住這筆帳。", "마음껏 모욕하십시오. 그렇다고 이자가 붙는 건 아니며, 빚을 다 갚은 뒤에도 이 일을 기억하겠습니다."])
    ,"Even the sea feels baked along this coast. Shade the water casks.": reviewedLocaleOverrides("Even the sea feels baked along this coast. Shade the water casks.", ["这片海岸热得连海水都像被晒烫了。把水桶放到阴凉处。", "На этом побережье даже море кажется раскалённым. Уберите бочки с водой в тень.", "Hasta el mar parece abrasador junto a esta costa. Pon las barricas de agua a la sombra.", "Até o mar parece escaldante nesta costa. Deixe os barris de água à sombra.", "この海岸は海まで焼けつくように暑い。水樽を日陰に置け。", "An dieser Küste wirkt selbst das Meer aufgeheizt. Stellt die Wasserfässer in den Schatten.", "Sur cette côte, même la mer semble brûlante. Mettez les tonneaux d'eau à l'ombre.", "U tego wybrzeża nawet morze zdaje się rozpalone. Ustaw beczki z wodą w cieniu.", "這片海岸熱得連海水都像被曬燙了。把水桶放到陰涼處。", "이 해안은 바다마저 뜨겁게 달아오른 듯합니다. 물통을 그늘에 두세요."]),
    "Every old sailor on the quay predicts a storm, each by a different knee.": reviewedLocaleOverrides("Every old sailor on the quay predicts a storm, each by a different knee.", ["码头上的老水手个个都说要有暴风雨，只不过各自看的是不同的膝盖。", "Каждый старый моряк на пристани предсказывает шторм по своему больному колену.", "Todos los viejos marineros del muelle pronostican una tormenta, cada uno según le duele la rodilla.", "Todos os velhos marinheiros no cais preveem uma tempestade, cada qual pela própria dor no joelho.", "波止場の老水夫は皆、膝の具合を頼りに嵐を予言する。", "Jeder alte Seemann am Kai sagt einen Sturm voraus – jeder anhand seines eigenen Knies.", "Tous les vieux marins du quai prédisent une tempête, chacun en se fiant à son genou.", "Każdy stary marynarz na nabrzeżu przepowiada sztorm, każdy po swojemu — z bólu kolana.", "碼頭上的老水手個個都說要有暴風雨，只不過各自看的是不同的膝蓋。", "부두의 늙은 선원들은 저마다 자기 무릎을 근거로 폭풍이 올 거라고 예측합니다."]),
    "Every piece is aboard a pirate ship. Ask in ports. Hail ships. Mark reliable bearings until the old crew shows its sails.": reviewedLocaleOverrides("Every piece is aboard a pirate ship. Ask in ports. Hail ships. Mark reliable bearings until the old crew shows its sails.", ["每件遗物都在海盗船上。到各港口打听，并向过往船只喊话。记下可靠的方位，直到那支老船员队伍扬帆现身。", "Все предметы находятся на пиратском корабле. Спрашивайте в портах и окликайте встречные суда. Записывайте надёжные пеленги, пока прежний экипаж не появится под парусами.", "Cada pieza está a bordo de un barco pirata. Pregunta en los puertos y llama a los barcos que encuentres. Anota las marcaciones fiables hasta que la vieja tripulación aparezca bajo sus velas.", "Cada peça está a bordo de um navio pirata. Pergunte nos portos e chame os navios que encontrar. Anote as marcações confiáveis até a velha tripulação surgir sob as velas.", "品々はすべて海賊船にある。港で尋ね、行き交う船に呼びかけろ。古参の乗組員が帆を掲げて現れるまで、確かな方位を記録するんだ。", "Jedes Stück befindet sich an Bord eines Piratenschiffs. Fragt in den Häfen nach und ruft anderen Schiffen zu. Notiert verlässliche Peilungen, bis die alte Mannschaft unter Segeln auftaucht.", "Chaque pièce se trouve à bord d'un navire pirate. Renseignez-vous dans les ports et hélez les navires croisés. Notez les relèvements fiables jusqu'à ce que l'ancien équipage apparaisse sous voiles.", "Każdy przedmiot znajduje się na pirackim statku. Pytaj w portach i nawołuj napotkane statki. Zapisuj wiarygodne namiary, aż dawna załoga ukaże się pod żaglami.", "每件遺物都在海盜船上。到各港口打聽，並向過往船隻喊話。記下可靠的方位，直到那支老船員隊伍揚帆現身。", "모든 조각은 해적선에 있습니다. 항구에서 물어보고 지나가는 배를 불러 세우세요. 옛 선원들이 돛을 달고 나타날 때까지 믿을 만한 방위를 기록하세요."])
    ,"Exactly {0} doubloons. You have preserved your purse and wasted my afternoon. The remaining {1} continues to grow.": reviewedLocaleOverrides("Exactly {0} doubloons. You have preserved your purse and wasted my afternoon. The remaining {1} continues to grow.", ["正好{0}达布隆。你保住了钱袋，却浪费了我的一下午。剩下的{1}还在继续增加。", "Ровно {0} дублонов. Вы сохранили свои деньги и зря потратили моё время. Оставшийся долг в размере {1} продолжает расти.", "Exactamente {0} doblones. Has conservado tu dinero y me has hecho perder la tarde. La deuda restante de {1} sigue aumentando.", "Exatamente {0} dobrões. Você ficou com o seu dinheiro e desperdiçou a minha tarde. O restante da dívida, {1}, continua aumentando.", "ちょうど{0}ダブロンです。あなたは財布を守り、私の午後を無駄にしました。残る{1}の借金は増え続けています。", "Genau {0} Dublonen. Du hast dein Geld behalten und meinen Nachmittag verschwendet. Die restlichen {1} Schulden wachsen weiter.", "Exactement {0} doublons. Vous avez gardé votre argent et gâché mon après-midi. Le solde restant de {1} continue d'augmenter.", "Dokładnie {0} dublonów. Zachowałeś pieniądze, a mnie zmarnowałeś popołudnie. Pozostały dług w wysokości {1} wciąż rośnie.", "正好{0}達布隆。你保住了錢袋，卻浪費了我的一下午。剩下的{1}還在繼續增加。", "정확히 {0} 더블룬입니다. 돈은 지켰지만 제 오후를 낭비하게 했군요. 남은 빚 {1}은 계속 늘고 있습니다."]),
    "Expensive. Take them off before the merchant charges us for wearing the cargo.": reviewedLocaleOverrides("Expensive. Take them off before the merchant charges us for wearing the cargo.", ["真贵。趁商人还没按穿戴费收钱，赶紧脱下来。", "Дорогие. Снимите их, пока торговец не взял с нас плату за то, что мы их носим.", "Qué caros. Quítatelos antes de que el mercader nos cobre por llevarlos puestos.", "Que caro. Tire-os antes que o mercador cobre pelo tempo que ficarmos usando a carga.", "高いな。商人に身に着けている間の料金を請求される前に脱いでおこう。", "Ganz schön teuer. Zieh sie aus, bevor der Händler uns noch fürs Tragen der Ware zur Kasse bittet.", "C'est cher. Enlevez-les avant que le marchand ne nous facture le fait de les porter.", "Ale drogie. Zdejmij je, zanim kupiec zacznie nam naliczać opłatę za noszenie towaru.", "真貴。趁商人還沒按穿戴費收錢，趕緊脫下來。", "비싸군요. 상인이 착용료까지 청구하기 전에 벗으세요."])
  });
  Object.assign(overrides, {
    "Finish your delivery from {0} to {1}; then I can talk work.": reviewedLocaleOverrides("Finish your delivery from {0} to {1}; then I can talk work.", ["先完成从{0}到{1}的货运，再来谈工作。", "Завершите доставку груза из {0} в {1}, и тогда поговорим о работе.", "Termina la entrega de {0} a {1}; después podremos hablar de trabajo.", "Conclua a entrega de {0} para {1}; depois conversamos sobre trabalho.", "{0}から{1}への配達を終えてください。仕事の話はそれからです。", "Schließt erst die Lieferung von {0} nach {1} ab; dann können wir über Arbeit sprechen.", "Terminez la livraison de {0} à {1} ; ensuite, nous parlerons travail.", "Dokończ dostawę z {0} do {1}; wtedy porozmawiamy o pracy.", "先完成從{0}到{1}的貨運，再來談工作。", "{0}에서 {1}까지 화물 운송을 마치세요. 그다음에 일 이야기를 하죠."]),
    "Fishing boats and coastal traders share the harbor; every crew pauses long enough to inspect a new arrival.": reviewedLocaleOverrides("Fishing boats and coastal traders share the harbor; every crew pauses long enough to inspect a new arrival.", ["渔船和沿岸商船共用这座港口；每支船队都会停下手头的事，打量新到的船只。", "Рыбацкие лодки и каботажные суда делят гавань; каждая команда ненадолго прерывает дела, чтобы осмотреть новое судно.", "Los barcos pesqueros y los mercantes costeros comparten el puerto; cada tripulación se detiene un momento para observar a los recién llegados.", "Barcos pesqueiros e comerciantes costeiros dividem o porto; cada tripulação interrompe o trabalho por um instante para examinar o navio recém-chegado.", "漁船と沿岸交易船が港を分け合い、どの乗組員も新たな船の到着に手を止めて見入る。", "Fischerboote und Küstenhändler teilen sich den Hafen; jede Mannschaft hält kurz inne, um ein neu angekommenes Schiff zu begutachten.", "Les bateaux de pêche et les caboteurs se partagent le port ; chaque équipage s'arrête un instant pour observer le navire qui vient d'arriver.", "Łodzie rybackie i statki kabotażowe dzielą port; każda załoga przerywa na chwilę pracę, by przyjrzeć się nowo przybyłemu statkowi.", "漁船和沿岸商船共用這座港口；每支船隊都會停下手邊的事，打量新到的船隻。", "어선과 연안 무역선이 항구를 함께 씁니다. 선원들은 새로 들어온 배를 살펴보느라 잠시 일을 멈춥니다."])
  });
  Object.assign(overrides, {
    "By royal and imperial grace, Malta is granted to the Order in perpetual fief{0}. Each year, on All Saints' Day, one falcon shall be rendered to the Viceroy of Sicily.": Object.freeze({
      "zh-Hans": "奉王室与帝国恩准，马耳他永久封赐骑士团为采邑{0}。每年诸圣日，须向西西里副王进献一只猎鹰。",
      "zh-Hant": "奉王室與帝國恩准，馬爾他永久封賜騎士團為采邑{0}。每年諸聖日，須向西西里副王進獻一隻獵鷹。"
    })
  });
  Object.assign(overrides, {
    "God and the King may bless an expedition, Captain, but neither fills its holds. Bring {0} {1} for {2}. I will pay {3} doubloons when the order is complete, weighed before my notary.": reviewedLocaleOverrides("God and the King may bless an expedition, Captain, but neither fills its holds. Bring {0} {1} for {2}. I will pay {3} doubloons when the order is complete, weighed before my notary.", ["船长，上帝与国王或许会保佑远征，却不会替船舱装货。请为{2}送去{0}{1}。货物交齐并由我的公证人过秤后，我会付你{3}达布隆。", "Капитан, Бог и король могут благословить экспедицию, но трюмы они не наполнят. Доставьте для {2}: {0} {1}. Когда заказ будет выполнен и взвешен у моего нотариуса, я заплачу {3} дублонов.", "Capitán, Dios y el rey podrán bendecir la expedición, pero no llenarán sus bodegas. Lleva {0} {1} para {2}. Cuando completes el pedido y mi notario pese la mercancía, te pagaré {3} doblones.", "Capitão, Deus e o rei podem abençoar a expedição, mas não enchem os porões. Leve {0} {1} para {2}. Pagarei {3} dobrões quando o pedido estiver completo e meu tabelião pesar a carga.", "船長、神と王は遠征を祝福してくれるかもしれないが、船倉を満たしてはくれない。{2}へ{0}{1}を届けてくれ。注文分がそろい、私の公証人が荷を量ったら、{3}ダブロンを払おう。", "Kapitän, Gott und der König mögen eine Expedition segnen, aber ihre Laderäume füllen sie nicht. Liefert {0} {1} für {2}. Sobald der Auftrag vollständig ist und mein Notar die Ware gewogen hat, zahle ich {3} Dublonen.", "Capitaine, Dieu et le roi peuvent bénir une expédition, mais ils ne rempliront pas ses cales. Livrez {0} {1} pour {2}. Je vous paierai {3} doublons une fois la commande complète, après pesée devant mon notaire.", "Kapitanie, Bóg i król mogą błogosławić wyprawie, ale nie zapełnią jej ładowni. Dostarcz {0} {1} dla {2}. Gdy zamówienie będzie kompletne i mój notariusz zważy towar, zapłacę {3} dublonów.", "船長，上帝與國王或許會保佑遠征，卻不會替船艙裝貨。請為{2}送去{0}{1}。貨物交齊並由我的公證人過秤後，我會付你{3}達布隆。", "선장님, 신과 왕께서 원정을 축복하실 수는 있어도 화물창을 채워 주시진 않습니다. {2}에 {0}{1}을 가져다주세요. 주문품이 모두 모이고 제 공증인이 무게를 재면 {3} 더블룬을 지급하겠습니다."]),
  ...
  Object.assign(overrides, {
    "Genoese": reviewedLocaleOverrides("Genoese", ["热那亚人", "генуэзский", "genovés", "genovês", "ジェノヴァ人", "Genueser", "génois", "genueński", "熱那亞人", "제노바인"]),
    "Good harbour master! Your harbor has two quays today, and I have docked at both of them.": reviewedLocaleOverrides("Good harbour master! Your harbor has two quays today, and I have docked at both of them.", ["港务长，幸会！今天贵港有两个泊位，我都停靠过了。", "Приветствую, начальник порта! Сегодня в вашей гавани два причала, и я пришвартовался у обоих.", "¡Saludos, capitán del puerto! Hoy hay dos muelles en tu puerto y he atracado en ambos.", "Saudações, capitão do porto! Hoje há dois cais no seu porto, e atraquei nos dois.", "港務長殿、こんにちは！今日は港に埠頭が二つありますね。どちらにも船を着けましたよ。", "Guten Tag, Hafenmeister! Euer Hafen hat heute zwei Kais, und ich habe an beiden angelegt.", "Bonjour, maître du port ! Votre port compte deux quais aujourd'hui, et j'ai accosté aux deux.", "Witaj, kapitanie portu! Dziś w twoim porcie są dwa nabrzeża i przy obu zacumowałem.", "港務長，幸會！今天貴港有兩個泊位，我都停靠過了。", "항만장님, 반갑습니다! 오늘 이 항구에 부두가 두 곳이라 둘 다 정박해 봤습니다."]),
    "HARPOON AWAY": reviewedLocaleOverrides("HARPOON AWAY", ["发射鱼叉！", "ГАРПУН — ПУСК!", "¡Arpón lanzado!", "Arpão lançado!", "銛を放て！", "HARPUNE LOS!", "HARPOON LÂCHÉ !", "HARPUN WYPUSZCZONY!", "發射魚叉！", "작살 발사!"]),
    "HARDTACK": reviewedLocaleOverrides("HARDTACK", ["船用硬饼干", "МОРСКОЙ СУХАРЬ", "GALLETAS MARINAS", "BISCOITO DE MARINHEIRO", "堅パン", "SCHIFFSZWIEBACK", "BISCUIT DE MER", "SUCHARY OKRĘTOWE", "船用硬餅乾", "건빵"]),
    "Harbor boats weave among galleys and merchantmen while clerks bargain over berths, cargo, and the next convoy.": reviewedLocaleOverrides("Harbor boats weave among galleys and merchantmen while clerks bargain over berths, cargo, and the next convoy.", ["港内小艇穿梭于桨帆船和商船之间，办事人员则忙着商谈泊位、货物与下一支船队。", "Портовые лодки лавируют между галерами и торговыми судами, а служащие договариваются о стоянках, грузе и следующем конвое.", "Las lanchas del puerto se abren paso entre galeras y mercantes, mientras los empleados negocian atraques, carga y el próximo convoy.", "As lanchas do porto passam entre galeras e navios mercantes, enquanto os funcionários negociam atracações, cargas e o próximo comboio.", "港内の小舟がガレー船や商船の間を縫って進み、事務方は停泊場所や荷、次の船団について交渉する。", "Hafenboote schlängeln sich zwischen Galeeren und Handelsschiffen hindurch, während die Angestellten über Liegeplätze, Fracht und den nächsten Konvoi verhandeln.", "Les barques du port se faufilent entre galères et navires marchands, tandis que les commis négocient les postes d'amarrage, les cargaisons et le prochain convoi.", "Łodzie portowe lawirują między galerami a statkami handlowymi, a urzędnicy negocjują miejsca postojowe, ładunki i kolejny konwój.", "港內小艇穿梭於槳帆船和商船之間，辦事人員則忙著商談泊位、貨物與下一支船隊。", "항구의 작은 배들이 갤리선과 상선 사이를 오가고, 직원들은 정박지와 화물, 다음 호송대를 두고 협상합니다."])
  });
  Object.assign(overrides, {
    "Heave to and keep your hands where I can see them.": reviewedLocaleOverrides("Heave to and keep your hands where I can see them.", ["停下船来，把手举到我看得见的地方。", "Стоп! Держите руки так, чтобы я их видел.", "Detén el barco y mantén las manos donde pueda verlas.", "Pare o navio e mantenha as mãos onde eu possa vê-las.", "船を止めろ。手は見えるところに置け。", "Bringt das Schiff zum Stehen und haltet die Hände sichtbar.", "Stoppez le navire et gardez les mains bien en vue.", "Zatrzymać statek! Trzymaj ręce tak, żebym je widział.", "停下船來，把手舉到我看得見的地方。", "배를 멈추고 손을 내가 볼 수 있는 곳에 두세요."]),
    "Heave to. We found Luther's forbidden Testaments. Surrender the books, or answer to our guns.": reviewedLocaleOverrides("Heave to. We found Luther's forbidden Testaments. Surrender the books, or answer to our guns.", ["停船！我们发现了路德的禁书。交出这些书，否则就用炮火说话。", "Стоп! Мы нашли запрещённые переводы Библии Лютера. Сдайте книги или отвечайте перед нашими пушками.", "¡Detén el barco! Hemos encontrado los Testamentos prohibidos de Lutero. Entrega los libros o responderás ante nuestros cañones.", "Pare o navio! Encontramos os Testamentos proibidos de Lutero. Entregue os livros ou responderá aos nossos canhões.", "停船せよ！ルターの禁書を見つけた。本を渡せ。さもなくば砲撃する。", "Bringt das Schiff zum Stehen! Wir haben Luthers verbotene Bibelausgaben gefunden. Gebt die Bücher heraus, oder unsere Geschütze sprechen.", "Stoppez le navire ! Nous avons trouvé les Testaments interdits de Luther. Rendez les livres, ou nos canons parleront.", "Zatrzymać statek! Znaleźliśmy zakazane przekłady Biblii Lutra. Oddajcie księgi albo odpowiemy ogniem z dział.", "停船！我們發現了路德的禁書。交出這些書，否則就用砲火說話。", "정선하라! 루터의 금서 성경을 찾아냈다. 책을 넘겨라. 거부하면 포격하겠다."]),
    "Heave to. We will take the hoard and leave your crew their lives.": reviewedLocaleOverrides("Heave to. We will take the hoard and leave your crew their lives.", ["停船！我们要拿走财宝，饶你船员一命。", "Стоп! Мы заберём сокровища, а вашу команду оставим в живых.", "¡Detén el barco! Nos llevaremos el tesoro y perdonaremos la vida a tu tripulación.", "Pare o navio! Ficaremos com o tesouro e pouparemos a vida da sua tripulação.", "停船せよ！財宝はいただくが、乗組員の命は助けてやる。", "Bringt das Schiff zum Stehen! Wir nehmen den Schatz und verschonen Eure Mannschaft.", "Stoppez le navire ! Nous prendrons le trésor et épargnerons votre équipage.", "Zatrzymać statek! Zabierzemy skarb, a twoją załogę zostawimy przy życiu.", "停船！我們要拿走財寶，饒你船員一命。", "정선하라! 보물은 가져가되 선원들의 목숨은 살려 주겠다."]),
    "Heave to. Your cargo or your life.": reviewedLocaleOverrides("Heave to. Your cargo or your life.", ["停船！交出货物，或者交出性命。", "Стоп! Груз или жизнь.", "¡Detén el barco! La carga o la vida.", "Pare o navio! A carga ou a vida.", "停船！交出貨物，或者交出性命。", "Bringt das Schiff zum Stehen! Ladung oder Leben.", "Stoppez le navire ! La cargaison ou la vie.", "Zatrzymać statek! Ładunek albo życie.", "停船！交出貨物，或者交出性命。", "정선하라! 화물이냐 목숨이냐."]),
    "Here was the last pale spout. Somewhere beyond this empty water, the white whale still rolls on.": reviewedLocaleOverrides("Here was the last pale spout. Somewhere beyond this empty water, the white whale still rolls on.", ["最后一道淡淡的喷水痕迹就在这里。白鲸仍在这片空旷海域之外的某处继续游弋。", "Здесь в последний раз показался слабый фонтан белого кита. Где-то за этими пустынными водами он всё ещё плывёт.", "Aquí vimos por última vez el tenue chorro de la ballena. En algún lugar más allá de estas aguas vacías, sigue nadando.", "Foi aqui que vimos pela última vez o esguicho pálido. Em algum lugar além dessas águas vazias, a baleia-branca continua nadando.", "最後に見たかすかな潮吹きはここだった。この空白の海の向こうで、白鯨は今も泳ぎ続けている。", "Hier sahen wir zuletzt den blassen Blas des Wals. Irgendwo jenseits dieses leeren Meeres schwimmt er noch immer weiter.", "C'est ici que nous avons aperçu son dernier souffle pâle. Quelque part au-delà de ces eaux désertes, la baleine blanche poursuit sa route.", "Tutaj po raz ostatni widzieliśmy bladą fontannę. Gdzieś za tymi pustymi wodami biały wieloryb wciąż płynie.", "最後一道淡淡的噴水痕跡就在這裡。白鯨仍在這片空曠海域之外的某處繼續游弋。", "마지막으로 희미한 물기둥을 본 곳이 바로 여기였습니다. 흰고래는 이 텅 빈 바다 너머 어딘가에서 여전히 헤엄치고 있습니다."])
  });
  Object.assign(overrides, {
    "hold has {0}.": reviewedLocaleOverrides("hold has {0}.", ["货舱内有{0}。", "В трюме находится {0}.", "La bodega contiene {0}.", "O porão contém {0}.", "船倉には{0}がある。", "Im Laderaum befinden sich {0}.", "La cale contient {0}.", "W ładowni znajduje się {0}.", "貨艙內有{0}。", "화물창에 {0}이(가) 있습니다."]),
    "hold the enemy court for our commissioners. They—not your company—will present the terms.": reviewedLocaleOverrides("hold the enemy court for our commissioners. They—not your company—will present the terms.", ["为我方特使夺取并控制敌方宫廷。和平条件将由他们提出，而非贵公司。", "Займите двор противника и удерживайте его до прибытия наших переговорщиков. Условия будут представлять они, а не ваша компания.", "Asegura la corte enemiga para nuestros comisionados. Ellos, no tu compañía, presentarán las condiciones.", "Garanta o controle da corte inimiga para nossos comissários. Eles, e não sua companhia, apresentarão os termos.", "敵方の宮廷を占領し、我々の使節団が来るまで確保せよ。条件を提示するのは貴社ではなく、彼らだ。", "Sichert den feindlichen Hof für unsere Beauftragten. Sie – nicht Eure Kompanie – werden die Bedingungen vorlegen.", "Prenez le contrôle de la cour ennemie pour nos commissaires. Ce sont eux, et non votre compagnie, qui présenteront les conditions.", "Zajmij dwór wroga i utrzymaj go dla naszych komisarzy. To oni, nie twoja kompania, przedstawią warunki.", "為我方特使奪取並控制敵方宮廷。和平條件將由他們提出，而非貴公司。", "적의 궁정을 점령해 우리 협상단이 도착할 때까지 지키세요. 조건은 당신의 회사가 아니라 그들이 제시할 것입니다."]),
    "This is the final stroke. Break {0}'s batteries, land your marines, and hold the enemy court for our commissioners. They—not your company—will present the terms.": reviewedLocaleOverrides("This is the final stroke. Break {0}'s batteries, land your marines, and hold the enemy court for our commissioners. They—not your company—will present the terms.", ["这是最后一击。摧毁{0}的炮台，让海军陆战队登陆，并为我方特使夺取、控制敌方宫廷。和平条件由他们提出，而非贵公司。", "Это последний удар. Уничтожьте орудия {0}, высадите морскую пехоту и удерживайте двор противника до прибытия наших переговорщиков. Условия будут представлять они, а не ваша компания.", "Este es el golpe final. Destruye las baterías de {0}, desembarca a tus infantes de marina y asegura la corte enemiga para nuestros comisionados. Ellos, no tu compañía, presentarán las condiciones.", "Este é o golpe final. Destrua as baterias de {0}, desembarque seus fuzileiros navais e garanta o controle da corte inimiga para nossos comissários. Eles, e não sua companhia, apresentarão os termos.", "これが最後の一撃だ。{0}の砲台を破壊し、海兵隊を上陸させ、我々の使節団のために敵方の宮廷を確保せよ。条件を提示するのは貴社ではなく彼らだ。", "Das ist der letzte Schlag. Zerstört die Geschützbatterien von {0}, landet Eure Marineinfanterie und sichert den feindlichen Hof für unsere Beauftragten. Sie – nicht Eure Kompanie – werden die Bedingungen vorlegen.", "C'est le coup de grâce. Détruisez les batteries de {0}, débarquez vos fusiliers marins et prenez la cour ennemie pour nos commissaires. Ce sont eux, et non votre compagnie, qui présenteront les conditions.", "To ostatnie uderzenie. Zniszcz baterie dział {0}, wysadź piechotę morską i zajmij dwór wroga dla naszych komisarzy. To oni, nie twoja kompania, przedstawią warunki.", "這是最後一擊。摧毀{0}的砲台，讓海軍陸戰隊登陸，並為我方特使奪取、控制敵方宮廷。和平條件由他們提出，而非貴公司。", "마지막 일격입니다. {0}의 포대를 파괴하고 해병대를 상륙시킨 뒤, 적의 궁정을 점령해 우리 협상단을 위해 지키세요. 조건은 당신의 회사가 아니라 그들이 제시할 것입니다."]),
    "Hold this course a moment. I want the bearings checked against the log.": reviewedLocaleOverrides("Hold this course a moment. I want the bearings checked against the log.", ["保持航向一会儿。我想对照航海日志核对方位。", "Держите этот курс. Нужно сверить пеленги с судовым журналом.", "Mantén el rumbo un momento. Quiero cotejar las marcaciones con el diario de navegación.", "Mantenha este rumo por um instante. Quero conferir as marcações com o diário de bordo.", "少しこの針路を保ってくれ。方位を航海日誌と照合したい。", "Haltet kurz diesen Kurs. Ich möchte die Peilungen mit dem Logbuch abgleichen.", "Gardez ce cap un instant. Je veux comparer les relèvements au journal de bord.", "Trzymajcie chwilę ten kurs. Chcę porównać namiary z dziennikiem pokładowym.", "保持航向一會兒。我想對照航海日誌核對方位。", "잠시 이 항로를 유지하세요. 방위를 항해일지와 대조하고 싶습니다."]),
    "Hold your fire! I am an elector's accredited envoy carrying sealed instructions to the electoral college.": reviewedLocaleOverrides("Hold your fire! I am an elector's accredited envoy carrying sealed instructions to the electoral college.", ["别开火！我是选帝侯正式派遣的使节，正要把密封指令送往选帝会议。", "Не стрелять! Я аккредитованный посланник курфюрста и везу запечатанные инструкции коллегии выборщиков.", "¡No disparen! Soy un enviado acreditado de un elector y llevo instrucciones selladas al colegio electoral.", "Não atirem! Sou um enviado credenciado por um príncipe-eleitor e levo instruções seladas ao colégio eleitoral.", "撃つな！私は選帝侯の正式な使節だ。選帝侯会議へ封印された指示書を届けるところだ。", "Nicht schießen! Ich bin ein bevollmächtigter Gesandter eines Kurfürsten und bringe versiegelte Anweisungen zum Kurfürstenkollegium.", "Ne tirez pas ! Je suis un envoyé accrédité d'un électeur et je porte des instructions scellées au collège électoral.", "Nie strzelać! Jestem akredytowanym wysłannikiem elektora i wiozę zapieczętowane instrukcje do kolegium elektorskiego.", "別開火！我是選帝侯正式派遣的使節，正要把密封指令送往選帝會議。", "발포하지 마시오! 나는 선제후가 공식 파견한 사절이며 선제후 회의에 봉인된 지시서를 전달하러 가는 길이오."]),
    "Hold your fire! This vessel carries an accredited trade embassy between our nations.": reviewedLocaleOverrides("Hold your fire! This vessel carries an accredited trade embassy between our nations.", ["别开火！本船载有经两国认可、往来于两国之间的贸易使团。", "Не стрелять! На этом судне находится официально признанная торговая миссия между нашими странами.", "¡No disparen! Este navío transporta una misión comercial acreditada entre nuestras naciones.", "Não atirem! Este navio transporta uma missão comercial credenciada por nossas nações.", "撃つな！この船には、両国公認の通商使節団が乗っている。", "Nicht schießen! Dieses Schiff befördert eine zwischen unseren Nationen akkreditierte Handelsdelegation.", "Ne tirez pas ! Ce navire transporte une délégation commerciale accréditée par nos deux nations.", "Nie strzelać! Ten statek przewozi akredytowaną misję handlową między naszymi narodami.", "別開火！本船載有經兩國認可、往來於兩國之間的貿易使團。", "발포하지 마시오! 이 배에는 양국이 공식 인정한 통상 사절단이 타고 있소."])
  });
  Object.assign(overrides, {
    "Hold! Our colors are struck. We have surrendered and are making for a safe port. This fight is over.": reviewedLocaleOverrides("Hold! Our colors are struck. We have surrendered and are making for a safe port. This fight is over.", ["等一下！我们已降旗投降，正驶往安全港口。这场战斗结束了。", "Стойте! Мы спустили флаг и сдались. Теперь держим курс к безопасному порту. Бой окончен.", "¡Alto! Hemos arriado la bandera y nos rendimos. Ponemos rumbo a un puerto seguro. El combate ha terminado.", "Parem! Arriamos a bandeira e nos rendemos. Estamos indo para um porto seguro. O combate terminou.", "待ってくれ！我々は降旗して降伏した。安全な港へ向かっている。戦いは終わりだ。", "Halt! Wir haben die Flagge gestrichen und uns ergeben. Wir steuern einen sicheren Hafen an. Der Kampf ist vorbei.", "Halte ! Nous avons amené notre pavillon et nous nous rendons. Nous faisons route vers un port sûr. Le combat est terminé.", "Stójcie! Opuściliśmy banderę i poddaliśmy się. Płyniemy do bezpiecznego portu. Walka dobiegła końca.", "等一下！我們已降旗投降，正駛往安全港口。這場戰鬥結束了。", "멈춰요! 우리는 깃발을 내리고 항복했습니다. 안전한 항구로 향하고 있습니다. 전투는 끝났습니다."]),
    "Hold your fire! This vessel carries tribute under the seals of both courts.": reviewedLocaleOverrides("Hold your fire! This vessel carries tribute under the seals of both courts.", ["别开火！本船运载着两国宫廷盖印认可的贡品。", "Не стрелять! Это судно везёт дань, скреплённую печатями обоих дворов.", "¡No disparen! Este navío transporta tributos autorizados por los sellos de ambas cortes.", "Não atirem! Este navio transporta tributos autorizados pelos selos de ambas as cortes.", "撃つな！この船は両国の宮廷が印を押した貢納品を運んでいる。", "Nicht schießen! Dieses Schiff transportiert Tribute, die mit den Siegeln beider Höfe bestätigt wurden.", "Ne tirez pas ! Ce navire transporte un tribut autorisé par les sceaux des deux cours.", "Nie strzelać! Statek przewozi daninę opatrzoną pieczęciami obu dworów.", "別開火！本船運載著兩國宮廷蓋印認可的貢品。", "발포하지 마시오! 이 배는 양국 궁정의 인장이 찍힌 조공품을 운반하고 있소."]),
    "Home waters, captain. Even the gulls sound as though they are insulting me personally.": reviewedLocaleOverrides("Home waters, captain. Even the gulls sound as though they are insulting me personally.", ["回到熟悉的海域了，船长。连海鸥叫起来都像是在骂我。", "Родные воды, капитан. Даже крики чаек звучат так, будто они лично меня оскорбляют.", "Aguas conocidas, capitán. Hasta las gaviotas parecen insultarme a propósito.", "Estamos em águas conhecidas, capitão. Até o grito das gaivotas parece um insulto pessoal.", "故郷の海だ、船長。カモメの鳴き声まで、私を名指しで罵っているように聞こえる。", "Heimatgewässer, Kapitän. Sogar die Möwen klingen, als würden sie mich persönlich beleidigen.", "Nous sommes en eaux familières, capitaine. Même les mouettes semblent m'insulter personnellement.", "Znajome wody, kapitanie. Nawet mewy brzmią, jakby obrażały mnie osobiście.", "回到熟悉的海域了，船長。連海鷗叫起來都像是在罵我。", "익숙한 바다에 들어왔습니다, 선장님. 갈매기 울음마저 저를 콕 집어 모욕하는 듯하군요."]),
    "Home waters, captain. They will not believe half our voyage, so I shall begin with the least impossible parts.": reviewedLocaleOverrides("Home waters, captain. They will not believe half our voyage, so I shall begin with the least impossible parts.", ["回到熟悉的海域了，船长。他们不会相信我们一半的航程，所以我先从最不离奇的部分讲起。", "Родные воды, капитан. Они не поверят и половине наших приключений, так что начну с наименее невероятных.", "Aguas conocidas, capitán. No creerán ni la mitad de nuestro viaje, así que empezaré por lo menos increíble.", "Estamos em águas conhecidas, capitão. Eles não acreditarão nem na metade da nossa viagem, então começarei pelas partes menos inacreditáveis.", "故郷の海だ、船長。航海の半分も信じてもらえまい。まずは一番ありそうな話から始めよう。", "Heimatgewässer, Kapitän. Sie werden uns die Hälfte der Reise nicht glauben. Also fange ich mit den am wenigsten unglaublichen Erlebnissen an.", "Nous sommes en eaux familières, capitaine. Ils ne croiront pas la moitié de notre voyage ; je commencerai donc par les épisodes les plus plausibles.", "Znajome wody, kapitanie. Nie uwierzą w połowę naszej podróży, więc zacznę od najmniej nieprawdopodobnych historii.", "回到熟悉的海域了，船長。他們不會相信我們一半的航程，所以我先從最不離奇的部分講起。", "익숙한 바다에 들어왔습니다, 선장님. 우리 항해의 절반도 믿지 않을 테니 가장 덜 믿기 어려운 이야기부터 시작하겠습니다."]),
    "He advanced silver upon the Emperor's seal. Great lords kept their promises to one another; our house kept the debt.": reviewedLocaleOverrides("He advanced silver upon the Emperor's seal. Great lords kept their promises to one another; our house kept the debt.", ["他凭皇帝的印信借出白银。大领主们彼此信守承诺；这笔债却留在了我们家名下。", "Он выдал серебро под гарантию императорской печати. Великие вельможи сдержали обещания друг другу, а долг остался за нашим домом.", "Prestó plata respaldado por el sello del Emperador. Los grandes señores cumplieron sus promesas entre sí; la deuda quedó en manos de nuestra casa.", "Ele emprestou prata com a garantia do selo do Imperador. Os grandes senhores cumpriram suas promessas entre si; a dívida ficou com nossa família.", "彼は皇帝の印信を担保に銀を貸し出した。大領主たちは互いの約束を守ったが、借金は我が家に残った。", "Er verlieh Silber gegen das Siegel des Kaisers als Bürgschaft. Die großen Herren hielten ihre Versprechen; die Schuld blieb bei unserem Haus.", "Il prêta de l'argent sous la garantie du sceau impérial. Les grands seigneurs tinrent leurs promesses entre eux ; la dette, elle, resta à notre charge.", "Pożyczył srebro pod gwarancję cesarskiej pieczęci. Wielcy panowie dotrzymali sobie obietnic, a dług pozostał na naszym domu.", "他憑皇帝的印信借出白銀。大領主們彼此信守承諾；這筆債卻留在了我們家名下。", "그는 황제의 인장을 담보로 은화를 빌려주었습니다. 대영주들은 서로의 약속을 지켰지만 빚은 우리 가문에 남았습니다."]),
    "His name appeared among the Prince of Ning's papers. Proving his innocence cost the family nearly everything.": reviewedLocaleOverrides("His name appeared among the Prince of Ning's papers. Proving his innocence cost the family nearly everything.", ["他的名字出现在宁王的文书里。为了证明他清白，家里几乎倾尽所有。", "Его имя обнаружилось среди бумаг князя Нина. Доказать его невиновность стоило семье почти всего.", "Su nombre apareció entre los documentos del príncipe de Ning. Demostrar su inocencia le costó a la familia casi todo.", "Seu nome apareceu entre os documentos do príncipe de Ning. Provar sua inocência custou quase tudo à família.", "彼の名は寧王の文書に記されていた。無実を証明するため、家族はほとんどすべてを犠牲にした。", "Sein Name stand in den Unterlagen des Prinzen von Ning. Seine Unschuld zu beweisen, kostete die Familie beinahe alles.", "Son nom figurait dans les documents du prince de Ning. Prouver son innocence a presque tout coûté à sa famille.", "Jego nazwisko znalazło się w dokumentach księcia Ning. Udowodnienie jego niewinności kosztowało rodzinę niemal wszystko.", "他的名字出現在寧王的文書裡。為了證明他清白，家裡幾乎傾盡所有。", "그의 이름은 영왕의 문서에 있었습니다. 그의 결백을 입증하느라 가문은 거의 모든 것을 희생했습니다."])
  });
  Object.assign(overrides, {
    "Hospitaller": reviewedLocaleOverrides("Hospitaller", ["医院骑士", "госпитальер", "caballero hospitalario", "cavaleiro hospitalário", "ホスピタル騎士", "Hospitaliter", "hospitalier", "joannita", "醫院騎士", "구호기사단원"]),
    "Hostile-port disguise +{0}%": reviewedLocaleOverrides("Hostile-port disguise +{0}%", ["敌对港口伪装 +{0}%", "Маскировка в неприятельском порту +{0}%", "Disimulo en puerto enemigo +{0}%", "Disfarce em porto inimigo +{0}%", "敵対港での偽装 +{0}%", "Tarnung im feindlichen Hafen +{0}%", "Dissimulation dans un port hostile +{0} %", "Maskowanie w porcie wroga +{0}%", "敵對港口偽裝 +{0}%", "적대 항구 위장 +{0}%"]),
    "Havana": reviewedLocaleOverrides("Havana", ["哈瓦那", "Гавана", "La Habana", "Havana", "ハバナ", "Havanna", "La Havane", "Hawana", "哈瓦那", "아바나"]),
    "Honk!": reviewedLocaleOverrides("Honk!", ["鸣笛！", "Гудок!", "¡Haz sonar la bocina!", "Buzine!", "警笛を鳴らせ！", "Hupen!", "Faites retentir la corne !", "Zatrąb!", "鳴笛！", "뱃고동을 울려라!"]),
    "HONK!": reviewedLocaleOverrides("HONK!", ["鸣笛！", "ГУДОК!", "¡BOCINA!", "BUZINA!", "警笛を鳴らせ！", "HUPEN!", "FAITES RETENTIR LA CORNE !", "TRĄBIĆ!", "鳴笛！", "뱃고동을 울려라!"]),
    "Honk.": reviewedLocaleOverrides("Honk.", ["鸣笛。", "Подайте гудок.", "Haz sonar la bocina.", "Buzine.", "警笛を鳴らす。", "Hupe.", "Faites retentir la corne.", "Zatrąb.", "鳴笛。", "뱃고동을 울리세요."])
  });
  Object.assign(overrides, {
    "HULL {0} ARMOR {1}% COVER {2}% CREW {3}": reviewedLocaleOverrides("HULL {0} ARMOR {1}% COVER {2}% CREW {3}", ["船体 {0} 装甲 {1}% 船员防护 {2}% 船员 {3}", "КОРПУС {0} БРОНЯ {1}% ЗАЩИТА ЭКИПАЖА {2}% ЭКИПАЖ {3}", "CASCO {0} BLINDAJE {1}% PROTECCIÓN DE LA TRIPULACIÓN {2}% TRIPULACIÓN {3}", "CASCO {0} BLINDAGEM {1}% PROTEÇÃO DA TRIPULAÇÃO {2}% TRIPULAÇÃO {3}", "船体 {0} 装甲 {1}% 乗組員の防護 {2}% 乗組員 {3}", "RUMPF {0} PANZERUNG {1}% BESATZUNGSSCHUTZ {2}% MANNSCHAFT {3}", "COQUE {0} BLINDAGE {1}% PROTECTION DE L'ÉQUIPAGE {2}% ÉQUIPAGE {3}", "KADŁUB {0} PANCERZ {1}% OCHRONA ZAŁOGI {2}% ZAŁOGA {3}", "船體 {0} 裝甲 {1}% 船員防護 {2}% 船員 {3}", "선체 {0} 장갑 {1}% 승무원 보호 {2}% 승무원 {3}"]),
    "Home again. The world is wider than I imagined, captain, and {0} dearer than I remembered.": reviewedLocaleOverrides("Home again. The world is wider than I imagined, captain, and {0} dearer than I remembered.", ["又回家了，船长。世界比我想象的更辽阔，而{0}也比记忆中更加亲切。", "Снова дома. Мир оказался шире, чем я представлял, капитан, а {0} стал мне дороже, чем я помнил.", "De vuelta en casa. El mundo es más grande de lo que imaginaba, capitán, y {0} me importa más de lo que recordaba.", "De volta ao lar. O mundo é mais amplo do que eu imaginava, capitão, e {0} me é mais querido do que lembrava.", "また帰ってこられた。世界は想像より広かったよ、船長。そして{0}は記憶よりもずっと大切な場所だった。", "Wieder zu Hause. Die Welt ist größer, als ich dachte, Kapitän, und {0} liegt mir mehr am Herzen, als ich in Erinnerung hatte.", "De retour au bercail. Le monde est plus vaste que je ne l'imaginais, capitaine, et {0} m'est plus cher encore que dans mon souvenir.", "Znowu w domu. Świat jest większy, niż sobie wyobrażałem, kapitanie, a {0} jest mi bliższe sercu, niż pamiętałem.", "又回家了，船長。世界比我想像的更遼闊，而{0}也比記憶中更加親切。", "다시 집으로 돌아왔습니다. 세상은 생각보다 넓었고, {0}은 기억보다 더 소중한 곳이군요, 선장님."]),
    "Hunters followed broad tracks across the snow and brought down a polar bear for the stores.": reviewedLocaleOverrides("Hunters followed broad tracks across the snow and brought down a polar bear for the stores.", ["猎人沿着雪地上的宽大足迹追踪，猎到一头北极熊，为船上补充储备。", "Охотники пошли по широким следам на снегу, добыли белого медведя и пополнили запасы.", "Los cazadores siguieron unas huellas anchas por la nieve y abatieron un oso polar para reponer las provisiones.", "Os caçadores seguiram pegadas largas na neve e abateram um urso-polar para reabastecer as provisões.", "猟師たちは雪上の大きな足跡を追い、ホッキョクグマを仕留めて船の食料を補充した。", "Die Jäger folgten breiten Spuren durch den Schnee und erlegten einen Eisbären, um die Vorräte aufzustocken.", "Les chasseurs ont suivi de larges traces dans la neige et abattu un ours polaire pour renouveler les provisions.", "Myśliwi ruszyli szerokim tropem przez śnieg i upolowali niedźwiedzia polarnego, by uzupełnić zapasy.", "獵人沿著雪地上的寬大足跡追蹤，獵到一頭北極熊，為船上補充儲備。", "사냥꾼들은 눈 위의 넓은 발자국을 따라가 북극곰을 잡아 식량을 보충했습니다."]),
    "Hunted the white whale across the world and returned home alive.": reviewedLocaleOverrides("Hunted the white whale across the world and returned home alive.", ["追踪白鲸遍历世界，最终活着回到家乡。", "Охотился на белого кита по всему миру и вернулся домой живым.", "Persiguió a la ballena blanca por todo el mundo y regresó vivo a casa.", "Caçou a baleia-branca pelo mundo e voltou para casa vivo.", "白鯨を追って世界を巡り、生きて故郷へ戻った。", "Jagte den weißen Wal rund um die Welt und kehrte lebend nach Hause zurück.", "A pourchassé la baleine blanche à travers le monde et est rentré vivant.", "Ścigał białego wieloryba po całym świecie i wrócił żywy do domu.", "追蹤白鯨遍歷世界，最終活著回到家鄉。", "흰고래를 쫓아 세계를 누비고 살아서 귀향했습니다."]),
    "I am bound for {0}.": reviewedLocaleOverrides("I am bound for {0}.", ["我要前往{0}。", "Я держу курс на {0}.", "Voy rumbo a {0}.", "Estou a caminho de {0}.", "{0}へ向かっている。", "Ich bin auf dem Weg nach {0}.", "Je fais route vers {0}.", "Płynę do {0}.", "我要前往{0}。", "저는 {0}(으)로 향하고 있습니다."]),
    "His name appeared among the Prince of Ning's papers. Proving his innocence cost the family nearly everything.": reviewedLocaleOverrides("His name appeared among the Prince of Ning's papers. Proving his innocence cost the family nearly everything.", ["他的名字出现在宁王的文书里。为了证明他清白，家里几乎倾尽所有。", "Его имя обнаружилось среди бумаг князя Нина. Доказать его невиновность стоило семье почти всего.", "Su nombre apareció entre los documentos del príncipe de Ning. Demostrar su inocencia le costó a la familia casi todo.", "Seu nome apareceu entre os documentos do príncipe de Ning. Provar sua inocência custou quase tudo à família.", "彼の名は寧王の文書に記されていた。無実を証明するため、家族はほとんどすべてを犠牲にした。", "Sein Name stand in den Unterlagen des Prinzen von Ning. Seine Unschuld zu beweisen, kostete die Familie beinahe alles.", "Son nom figurait dans les documents du prince de Ning. Prouver son innocence a presque tout coûté à sa famille.", "Jego nazwisko znalazło się w dokumentach księcia Ning. Udowodnienie jego niewinności kosztowało rodzinę niemal wszystko.", "他的名字出現在寧王的文書裡。為了證明他清白，家裡幾乎傾盡所有。", "그의 이름은 닝왕의 문서에 있었습니다. 결백을 입증하느라 가문은 거의 모든 것을 희생했습니다."])
  });
  Object.assign(overrides, {
    "I carry papers for a patron in {0}, and the roads are closed to me. Passage by sea is safer. Take me there for {1} db.": reviewedLocaleOverrides("I carry papers for a patron in {0}, and the roads are closed to me. Passage by sea is safer. Take me there for {1} db.", ["我替{0}的一位委托人送文件，但陆路不通。走海路更安全。请送我去那里，报酬是{1}达布隆。", "Я везу документы для покровителя в {0}, но сухопутные дороги закрыты. По морю безопаснее. Доставьте меня туда за {1} дублонов.", "Llevo documentos para un cliente en {0}, pero las rutas terrestres están cerradas. Es más seguro ir por mar. Llévame allí por {1} doblones.", "Levo documentos para um cliente em {0}, mas as estradas estão fechadas. Por mar é mais seguro. Leve-me até lá por {1} dobrões.", "{0}の依頼人に書類を届けるところだが、陸路は封鎖されている。海路の方が安全だ。{1}ダブロンでそこまで乗せてくれ。", "Ich bringe Unterlagen zu einem Auftraggeber in {0}, aber die Straßen sind gesperrt. Der Seeweg ist sicherer. Bring mich für {1} Dublonen dorthin.", "Je transporte des documents pour un client à {0}, mais les routes sont fermées. La mer est plus sûre. Emmenez-moi là-bas pour {1} doublons.", "Wiozę dokumenty dla zleceniodawcy w {0}, ale drogi są zamknięte. Bezpieczniej będzie morzem. Zabierz mnie tam za {1} dublonów.", "我替{0}的一位委託人送文件，但陸路不通。走海路更安全。請送我去那裡，報酬是{1}達布隆。", "{0}의 의뢰인에게 서류를 전하러 가야 하는데 육로가 막혔습니다. 바닷길이 더 안전하니 {1} 더블룬을 드리고 그곳까지 가고 싶습니다."]),
    "I carry papers for a patron in {0}, but no ship here sails there. Take me across the sea for {1} db.": reviewedLocaleOverrides("I carry papers for a patron in {0}, but no ship here sails there. Take me across the sea for {1} db.", ["我替{0}的一位委托人送文件，但这里没有船去那里。请载我渡海，报酬是{1}达布隆。", "Я везу документы для покровителя в {0}, но отсюда туда нет кораблей. Переправьте меня морем за {1} дублонов.", "Llevo documentos para un cliente en {0}, pero desde aquí no sale ningún barco hacia allí. Llévame por mar por {1} doblones.", "Levo documentos para um cliente em {0}, mas não há navio daqui para lá. Leve-me por mar por {1} dobrões.", "{0}の依頼人に書類を届けるところだが、ここからそこへ行く船がない。{1}ダブロンで海を渡らせてくれ。", "Ich bringe Unterlagen zu einem Auftraggeber in {0}, aber von hier fährt kein Schiff dorthin. Bring mich für {1} Dublonen übers Meer.", "Je transporte des documents pour un client à {0}, mais aucun navire ne part d'ici dans cette direction. Faites-moi traverser pour {1} doublons.", "Wiozę dokumenty dla zleceniodawcy w {0}, ale stąd nie odpływa tam żaden statek. Przewieź mnie morzem za {1} dublonów.", "我替{0}的一位委託人送文件，但這裡沒有船去那裡。請載我渡海，報酬是{1}達布隆。", "{0}의 의뢰인에게 서류를 전하러 가야 하는데 이곳에서 그곳으로 가는 배가 없습니다. {1} 더블룬을 드릴 테니 바다를 건너 데려다주세요."]),
    "I command {0} fighting men. The watches are full, with a reserve ready at the alarm.": reviewedLocaleOverrides("I command {0} fighting men. The watches are full, with a reserve ready at the alarm.", ["我麾下有{0}名战士。各班岗哨人手充足，另有预备队随时待命。", "Под моим началом {0} бойцов. На всех вахтах достаточно людей, а резерв готов выступить по тревоге.", "Tengo {0} hombres armados a mi mando. Todos los puestos de guardia están cubiertos y hay una reserva lista si suena la alarma.", "Tenho {0} homens de armas sob meu comando. Todos os turnos de vigia estão completos, e há uma reserva pronta para o alarme.", "私の指揮下には{0}人の兵がいる。各哨戒に人員を配置し、警報に備えて予備隊も待機させている。", "Ich befehlige {0} Kämpfer. Alle Wachposten sind besetzt, und bei Alarm steht eine Reserve bereit.", "Je commande {0} combattants. Toutes les gardes sont assurées et une réserve est prête à intervenir en cas d'alerte.", "Dowodzę {0} zbrojnymi. Wszystkie warty są obsadzone, a odwód czeka w gotowości na alarm.", "我麾下有{0}名戰士。各班崗哨人手充足，另有預備隊隨時待命。", "제 지휘 아래 전투원 {0}명이 있습니다. 모든 경계 근무가 배치되었고 비상시 투입할 예비대도 대기 중입니다."]),
    "I command {0} fighting men. We can man every approach and keep a seasoned reserve.": reviewedLocaleOverrides("I command {0} fighting men. We can man every approach and keep a seasoned reserve.", ["我麾下有{0}名战士，足以守住各处入口，并留下一支经验丰富的预备队。", "Под моим началом {0} бойцов. Мы можем выставить охрану на всех подступах и сохранить опытный резерв.", "Tengo {0} hombres armados a mi mando. Podemos cubrir todos los accesos y mantener una reserva veterana.", "Tenho {0} homens de armas sob meu comando. Podemos guarnecer todos os acessos e manter uma reserva experiente.", "私の指揮下には{0}人の兵がいる。あらゆる進入路を守り、熟練の予備隊も確保できる。", "Ich befehlige {0} Kämpfer. Wir können alle Zugänge bemannen und eine erfahrene Reserve zurückhalten.", "Je commande {0} combattants. Nous pouvons tenir tous les accès et garder une réserve aguerrie.", "Dowodzę {0} zbrojnymi. Możemy obsadzić wszystkie podejścia i zachować doświadczony odwód.", "我麾下有{0}名戰士，足以守住各處入口，並留下一支經驗豐富的預備隊。", "제 지휘 아래 전투원 {0}명이 있습니다. 모든 진입로를 지키면서 숙련된 예비대도 남겨 둘 수 있습니다."]),
    "I deliver the sovereign's commission. Assemble the officers of {0} and enter it in the port register.": reviewedLocaleOverrides("I deliver the sovereign's commission. Assemble the officers of {0} and enter it in the port register.", ["我奉主君之命送来委任状。请召集{0}的官员，并将此事登记在港口簿册上。", "Я доставил поручение государя. Созовите офицеров {0} и внесите его в портовый реестр.", "Traigo la comisión del soberano. Reúne a los oficiales de {0} y registra el nombramiento en el libro del puerto.", "Trago a comissão do soberano. Reúna os oficiais de {0} e registre o ato no livro do porto.", "君主の委任状を届けに来た。{0}の役人を集め、この任命を港の記録簿に記せ。", "Ich überbringe den Auftrag des Souveräns. Versammelt die Offiziere von {0} und tragt ihn ins Hafenregister ein.", "Je remets la commission du souverain. Réunissez les officiers de {0} et inscrivez-la au registre du port.", "Przynoszę nominację władcy. Zbierz urzędników {0} i wpisz ją do portowego rejestru.", "我奉主君之命送來委任狀。請召集{0}的官員，並將此事登記在港口簿冊上。", "군주의 임명장을 가져왔습니다. {0}의 관리들을 모아 항구 기록부에 등록하세요."]),
    "I found the white whale. Or a white whale. Or an extremely judgmental wave.": reviewedLocaleOverrides("I found the white whale. Or a white whale. Or an extremely judgmental wave.", ["我找到白鲸了。或者说，一头白鲸。也可能只是一个特别爱评判人的浪头。", "Я нашёл того самого белого кита. Или просто белого кита. Или волну, осуждающую всех вокруг.", "Encontré a la ballena blanca. O a una ballena blanca. O a una ola sumamente juzgona.", "Encontrei a baleia-branca. Ou uma baleia branca qualquer. Ou uma onda extremamente julgadora.", "白鯨を見つけた。いや、白い鯨か。あるいは、やけに人を値踏みする波か。", "Ich habe den weißen Wal gefunden. Oder einen weißen Wal. Oder eine äußerst urteilende Welle.", "J'ai trouvé la baleine blanche. Ou une baleine blanche. Ou une vague particulièrement jugeante.", "Znalazłem białego wieloryba. A może po prostu białego wieloryba. Albo falę, która wyjątkowo ocenia innych.", "我找到白鯨了。或者說，一頭白鯨。也可能只是一個特別愛評判人的浪頭。", "흰고래를 찾았어요. 아니, 그냥 흰 고래였을지도요. 아니면 유난히 남을 재단하는 파도였거나요."])
  });
  Object.assign(overrides, {
    "I have been entrusted with {0}, and ordinary fare will not do.": reviewedLocaleOverrides("I have been entrusted with {0}, and ordinary fare will not do.", ["我受托筹办{0}，寻常饭菜可配不上这场宴席。", "Мне поручили устроить {0}, и обычными блюдами тут не обойтись.", "Me han confiado la organización de {0}, y una comida corriente no bastará.", "Confiaram-me a organização de {0}, e uma refeição comum não será suficiente.", "{0}の宴を任されたが、ありきたりな料理ではいけない。", "Mir wurde {0} anvertraut, und gewöhnliche Speisen reichen dafür nicht aus.", "On m'a confié l'organisation de {0}, et un repas ordinaire ne suffira pas.", "Powierzono mi przygotowanie {0}, a zwykły posiłek nie wystarczy.", "我受託籌辦{0}，尋常飯菜可配不上這場宴席。", "{0} 행사를 맡았는데 평범한 음식으로는 부족합니다."]),
    "I have been entrusted with {0}, and ordinary fare will not do. I need one each of {1}. Bring them as you find them and I can make a table worthy": reviewedLocaleOverrides("I have been entrusted with {0}, and ordinary fare will not do. I need one each of {1}. Bring them as you find them and I can make a table worthy", ["我受托筹办{0}，寻常饭菜可配不上这场宴席。我需要{1}各一份。找到后就带来，我好备出一桌体面的宴席", "Мне поручили устроить {0}, и обычными блюдами тут не обойтись. Нужно по одному каждого из этих продуктов: {1}. Приносите их по мере находки, и я накрою достойный стол", "Me han confiado la organización de {0}, y una comida corriente no bastará. Necesito una unidad de cada ingrediente: {1}. Tráelos conforme los encuentres y prepararé un banquete digno", "Confiaram-me a organização de {0}, e uma refeição comum não será suficiente. Preciso de um de cada ingrediente: {1}. Traga-os conforme os encontrar, e prepararei um banquete à altura", "{0}の宴を任されたが、ありきたりな料理ではいけない。{1}を一つずつ用意してくれ。見つけたものから届けてくれれば、立派な宴席を整えよう", "Mir wurde {0} anvertraut, und gewöhnliche Speisen reichen nicht aus. Ich brauche je eines von {1}. Bringt sie nach und nach, dann kann ich ein Festmahl bereiten", "On m'a confié l'organisation de {0}, et un repas ordinaire ne suffira pas. Il me faut un exemplaire de chaque ingrédient : {1}. Apportez-les au fur et à mesure pour que je prépare un banquet à la hauteur", "Powierzono mi przygotowanie {0}, a zwykły posiłek nie wystarczy. Potrzebuję po jednym składniku z każdego rodzaju: {1}. Przynoś je, gdy je znajdziesz, a przygotuję ucztę godną okazji", "我受託籌辦{0}，尋常飯菜可配不上這場宴席。我需要{1}各一份。找到後就帶來，我好備出一桌體面的宴席", "{0} 행사를 맡았는데 평범한 음식으로는 부족합니다. 다음 재료를 하나씩 준비해야 합니다: {1}. 찾는 대로 가져오시면 성대한 잔칫상을 차릴 수 있습니다"]),
    "I have been entrusted with {0}, and ordinary fare will not do. I need one each of {1}. Bring them as you find them and I can make a table worthy of the occasion.{2}": reviewedLocaleOverrides("I have been entrusted with {0}, and ordinary fare will not do. I need one each of {1}. Bring them as you find them and I can make a table worthy of the occasion.{2}", ["我受托筹办{0}，寻常饭菜可配不上这场宴席。我需要{1}各一份。找到后就带来，我好备出一桌配得上这场宴席的佳肴。{2}", "Мне поручили устроить {0}, и обычными блюдами тут не обойтись. Нужно по одному каждого продукта: {1}. Приносите их по мере находки, и я накрою стол, достойный этого события.{2}", "Me han confiado la organización de {0}, y una comida corriente no bastará. Necesito una unidad de cada ingrediente: {1}. Tráelos conforme los encuentres y prepararé un banquete digno de la ocasión.{2}", "Confiaram-me a organização de {0}, e uma refeição comum não será suficiente. Preciso de um de cada ingrediente: {1}. Traga-os conforme os encontrar, e prepararei um banquete à altura da ocasião.{2}", "{0}の宴を任されたが、ありきたりな料理ではいけない。{1}を一つずつ用意してくれ。見つけたものから届けてくれれば、この機会にふさわしい宴席を整えよう。{2}", "Mir wurde {0} anvertraut, und gewöhnliche Speisen reichen nicht aus. Ich brauche je eines von {1}. Bringt sie nach und nach, dann kann ich ein Festmahl bereiten, das diesem Anlass gerecht wird.{2}", "On m'a confié l'organisation de {0}, et un repas ordinaire ne suffira pas. Il me faut un exemplaire de chaque ingrédient : {1}. Apportez-les au fur et à mesure pour que je prépare un banquet digne de l'occasion.{2}", "Powierzono mi przygotowanie {0}, a zwykły posiłek nie wystarczy. Potrzebuję po jednym składniku z każdego rodzaju: {1}. Przynoś je, gdy je znajdziesz, a przygotuję ucztę godną tej okazji.{2}", "我受託籌辦{0}，尋常飯菜可配不上這場宴席。我需要{1}各一份。找到後就帶來，我好備出一桌配得上這場宴席的佳餚。{2}", "{0} 행사를 맡았는데 평범한 음식으로는 부족합니다. 다음 재료를 하나씩 준비해야 합니다: {1}. 찾는 대로 가져오시면 이 행사에 걸맞은 잔칫상을 차릴 수 있습니다.{2}"]),
    "I need one each of {0}. Bring them as you find them and I can make a table worthy": reviewedLocaleOverrides("I need one each of {0}. Bring them as you find them and I can make a table worthy", ["{0}을(를) 하나씩 가져와 주세요. 찾는 대로 가져오시면 훌륭한 잔칫상을 차릴 수 있습니다", "Нужно по одному каждого продукта: {0}. Приносите их по мере находки, и я накрою достойный стол", "Necesito una unidad de cada ingrediente: {0}. Tráelos conforme los encuentres y prepararé un banquete digno", "Preciso de um de cada ingrediente: {0}. Traga-os conforme os encontrar, e prepararei um banquete à altura", "{0}を一つずつ用意してくれ。見つけたものから届けてくれれば、立派な宴席を整えよう", "Ich brauche je eines von {0}. Bringt sie nach und nach, dann kann ich ein Festmahl bereiten", "Il me faut un exemplaire de chaque ingrédient : {0}. Apportez-les au fur et à mesure pour que je prépare un banquet digne", "Potrzebuję po jednym składniku z każdego rodzaju: {0}. Przynoś je, gdy je znajdziesz, a przygotuję ucztę godną", "{0}各一份。找到後就帶來，我好備出一桌體面的宴席", "다음 재료를 하나씩 준비해야 합니다: {0}. 찾는 대로 가져오시면 훌륭한 잔칫상을 차릴 수 있습니다"]),
    "I have returned with discoveries. Some of them are currently moving, but I wrote them down while they were still.": reviewedLocaleOverrides("I have returned with discoveries. Some of them are currently moving, but I wrote them down while they were still.", ["我带着新发现回来了。有些东西现在还在移动，但我趁它们静止时把位置记了下来。", "Я вернулся с открытиями. Некоторые из них уже движутся, но я успел записать, где они были, пока они ещё стояли на месте.", "He vuelto con mis descubrimientos. Algunos ya se están moviendo, pero alcancé a anotar dónde estaban mientras seguían quietos.", "Voltei com minhas descobertas. Algumas já estão se movendo, mas anotei onde estavam enquanto ainda estavam paradas.", "発見を持ち帰ったよ。もう動いているものもあるが、まだじっとしている間に場所を書き留めておいた。", "Ich bin mit Entdeckungen zurückgekehrt. Einige bewegen sich inzwischen, aber ich habe ihren Standort notiert, solange sie noch stillstanden.", "Je suis revenu avec mes découvertes. Certaines bougent déjà, mais j'ai noté leur emplacement quand elles étaient encore immobiles.", "Wróciłem z odkryciami. Niektóre już się przemieszczają, ale zdążyłem zanotować ich położenie, gdy jeszcze stały w miejscu.", "我帶著新發現回來了。有些東西現在還在移動，但我趁它們靜止時把位置記了下來。", "발견물을 가지고 돌아왔습니다. 일부는 벌써 움직이고 있지만, 가만히 있을 때 위치를 적어 두었지요."]),
    "I must earn enough to settle with {0} in {1}.": reviewedLocaleOverrides("I must earn enough to settle with {0} in {1}.", ["我得赚够钱，才能在{1}向{0}偿清债务。", "Мне нужно заработать достаточно, чтобы расплатиться с {0} в {1}.", "Tengo que ganar lo suficiente para saldar mi deuda con {0} en {1}.", "Preciso ganhar o suficiente para quitar minha dívida com {0} em {1}.", "{1}で{0}への借金を返すため、十分な金を稼がなくては。", "Ich muss genug verdienen, um meine Schulden bei {0} in {1} zu begleichen.", "Je dois gagner assez pour rembourser ma dette à {0} à {1}.", "Muszę zarobić dość, by spłacić dług u {0} w {1}.", "我得賺夠錢，才能在{1}向{0}還清債務。", "{1}에서 {0}에게 진 빚을 갚을 만큼 충분히 벌어야 합니다."]),
    "The family debt stands at about {0} doubloons. I must earn enough to settle with {1} in {2}.": reviewedLocaleOverrides("The family debt stands at about {0} doubloons. I must earn enough to settle with {1} in {2}.", ["家族债务约为{0}达布隆。我得赚够钱，才能在{2}向{1}还清债务。", "Семейный долг составляет около {0} дублонов. Мне нужно заработать достаточно, чтобы расплатиться с {1} в {2}.", "La deuda familiar asciende a unos {0} doblones. Tengo que ganar lo suficiente para saldarla con {1} en {2}.", "A dívida da família é de cerca de {0} dobrões. Preciso ganhar o bastante para quitá-la com {1} em {2}.", "家族の借金は約{0}ダブロン。{2}で{1}への借金を返すため、十分な金を稼がなくては。", "Die Familienschulden belaufen sich auf etwa {0} Dublonen. Ich muss genug verdienen, um sie bei {1} in {2} zu begleichen.", "La dette familiale s'élève à environ {0} doublons. Je dois gagner assez pour la rembourser à {1} à {2}.", "Dług rodzinny wynosi około {0} dublonów. Muszę zarobić dość, by spłacić go u {1} w {2}.", "家族債務約為{0}達布隆。我得賺夠錢，才能在{2}向{1}還清債務。", "가족의 빚은 약 {0}더블룬입니다. {2}에서 {1}에게 진 빚을 갚을 만큼 충분히 벌어야 합니다."]),
    "I have no business for you today.": reviewedLocaleOverrides("I have no business for you today.", ["我今天没事要你办。", "На сегодня у меня нет для вас поручений.", "Hoy no tengo ningún encargo para ti.", "Hoje não tenho nenhum serviço para você.", "今日は頼みたい仕事はない。", "Heute habe ich keinen Auftrag für dich.", "Je n'ai aucune mission à vous confier aujourd'hui.", "Nie mam dziś dla ciebie żadnego zlecenia.", "我今天沒事要你辦。", "오늘은 부탁할 일이 없습니다."]),
    "I come under {0}'s seal to present our terms before this court.": reviewedLocaleOverrides("I come under {0}'s seal to present our terms before this court.", ["我奉{0}之命，前来此庭陈述我方条件。", "Я прибыл с полномочиями от {0}, чтобы представить наши условия этому суду.", "Comparezco con plenos poderes de {0} para presentar nuestras condiciones ante este tribunal.", "Venho com plenos poderes de {0} para apresentar nossos termos perante este tribunal.", "{0}の委任を受け、この法廷で我々の条件を提示しに参った。", "Im Auftrag von {0} bin ich hier, um diesem Gericht unsere Bedingungen vorzulegen.", "Je viens mandaté par {0} pour présenter nos conditions devant cette cour.", "Przybywam z pełnomocnictwem od {0}, by przedstawić nasze warunki przed tym sądem.", "我奉{0}之命，前來此庭陳述我方條件。", "{0}의 위임을 받아 이 법정에 우리의 조건을 제시하러 왔습니다."]),
    "I hold {0} of {1} pieces of Captain": reviewedLocaleOverrides("I hold {0} of {1} pieces of Captain", ["船长碎片：{0}/{1}", "У меня {0} из {1} фрагментов капитана", "Tengo {0} de {1} fragmentos del capitán", "Tenho {0} de {1} fragmentos do capitão", "船長の欠片：{0}/{1}", "Ich habe {0} von {1} Captain-Teilen", "Je possède {0} fragments du capitaine sur {1}", "Mam {0} z {1} fragmentów kapitana", "船長碎片：{0}/{1}", "캡틴 조각 {1}개 중 {0}개 보유"]),
    "I hold {0} of {1} pieces of Captain {2}'s map. {3}": reviewedLocaleOverrides("I hold {0} of {1} pieces of Captain {2}'s map. {3}", ["我收集了{2}船长地图的{0}/{1}块碎片。{3}", "У меня {0} из {1} фрагментов карты капитана {2}. {3}", "Tengo {0} de los {1} fragmentos del mapa del capitán {2}. {3}", "Tenho {0} dos {1} fragmentos do mapa do capitão {2}. {3}", "{2}船長の地図の欠片：{0}/{1}。{3}", "Ich habe {0} von {1} Teilen der Karte von Captain {2}. {3}", "Je possède {0} des {1} fragments de la carte du capitaine {2}. {3}", "Mam {0} z {1} fragmentów mapy kapitana {2}. {3}", "我收集了{2}船長地圖的{0}/{1}塊碎片。{3}", "{2} 선장의 지도 조각 {1}개 중 {0}개를 보유 중입니다. {3}"])
  });
  Object.assign(overrides, {
    "I must keep searching, then return to {0} in {1}.": reviewedLocaleOverrides("I must keep searching, then return to {0} in {1}.", ["我还得继续搜寻，然后回到{1}去见{0}。", "Нужно продолжать поиски, а затем вернуться к {0} в {1}.", "Debo seguir buscando y luego volver con {0} en {1}.", "Preciso continuar procurando e depois voltar para junto de {0} em {1}.", "まだ探し続けてから、{1}に戻って{0}のもとへ行かなくては。", "Ich muss weiter suchen und dann zu {0} nach {1} zurückkehren.", "Je dois poursuivre mes recherches, puis retrouver {0} à {1}.", "Muszę szukać dalej, a potem wrócić do {0} w {1}.", "我還得繼續搜尋，然後回到{1}去見{0}。", "계속 찾은 뒤 {1}로 돌아가 {0}을 만나야 합니다."]),
    "I must seek {0} and bring a true account back to {1} in {2}.": reviewedLocaleOverrides("I must seek {0} and bring a true account back to {1} in {2}.", ["我必须寻找{0}，然后回到{2}向{1}如实报告。", "Я должен найти {0}, а затем вернуться в {2} и рассказать {1}, что удалось выяснить.", "Debo encontrar {0} y regresar a {2} para contarle a {1} lo que descubrí.", "Preciso encontrar {0} e voltar a {2} para relatar a {1} o que descobri.", "{0}を探し出し、{2}へ戻って{1}にありのままを報告しなくては。", "Ich muss {0} finden und {1} in {2} wahrheitsgetreu davon berichten.", "Je dois trouver {0}, puis retourner à {2} pour en faire un compte rendu fidèle à {1}.", "Muszę odnaleźć {0}, a potem wrócić do {2} i zdać {1} rzetelną relację.", "我必須尋找{0}，然後回到{2}向{1}如實報告。", "{0}을 찾아 {2}로 돌아가 {1}에게 사실대로 보고해야 합니다."]),
    "I present {0}'s memorial in friendship and await the court's answer.": reviewedLocaleOverrides("I present {0}'s memorial in friendship and await the court's answer.", ["我代表{0}友好呈递请愿书，静候朝廷答复。", "В знак дружбы я представляю петицию от имени {0} и жду ответа двора.", "Presento en señal de amistad la petición de {0} y espero la respuesta de la corte.", "Apresento, em sinal de amizade, a petição de {0} e aguardo a resposta da corte.", "友好の証として{0}の上申書を提出し、朝廷の返答を待つ。", "Im Zeichen der Freundschaft überreiche ich die Bittschrift von {0} und warte auf die Antwort des Hofes.", "Je présente la requête de {0} en signe d'amitié et attends la réponse de la cour.", "W geście przyjaźni składam petycję w imieniu {0} i czekam na odpowiedź dworu.", "我代表{0}友好呈遞請願書，靜候朝廷答覆。", "우정의 표시로 {0}의 청원서를 제출하고 조정의 답변을 기다리겠습니다."]),
    "I present {0}'s tribute and ask that it be entered faithfully in the register.": reviewedLocaleOverrides("I present {0}'s tribute and ask that it be entered faithfully in the register.", ["我呈上{0}的贡品，请如实登记在册。", "Я представляю дань от имени {0} и прошу точно внести её в реестр.", "Presento el tributo de {0} y pido que se anote fielmente en el registro.", "Apresento o tributo de {0} e peço que seja registrado com exatidão.", "{0}からの貢納品を差し出す。正確に台帳へ記録してほしい。", "Ich überreiche den Tribut von {0} und bitte darum, ihn genau ins Register einzutragen.", "Je présente le tribut de {0} et demande qu'il soit fidèlement consigné au registre.", "Przedstawiam daninę od {0} i proszę o jej rzetelne odnotowanie w rejestrze.", "我呈上{0}的貢品，請如實登記在冊。", "{0}의 조공품을 바치니 장부에 정확히 기록해 주십시오."]),
    "I still owe {0} about {1} doubloons.": reviewedLocaleOverrides("I still owe {0} about {1} doubloons.", ["我还欠{0}约{1}达布隆。", "Я всё ещё должен {0} примерно {1} дублонов.", "Todavía debo a {0} unos {1} doblones.", "Ainda devo cerca de {1} dobrões a {0}.", "{0}にまだ約{1}ダブロンの借金がある。", "Ich schulde {0} noch etwa {1} Dublonen.", "Je dois encore environ {1} doublons à {0}.", "Wciąż jestem winien {0} około {1} dublonów.", "我還欠{0}約{1}達布隆。", "아직 {0}에게 약 {1}더블룬을 빚지고 있습니다."]),
    "I still owe {0} about {1} doubloons. Every profitable voyage brings the family estate closer to being debt-free.": reviewedLocaleOverrides("I still owe {0} about {1} doubloons. Every profitable voyage brings the family estate closer to being debt-free.", ["我还欠{0}约{1}达布隆。每趟航行赚到的钱，都让家族产业离还清债务更近一步。", "Я всё ещё должен {0} примерно {1} дублонов. Каждый прибыльный рейс приближает нашу семью к полной выплате долга.", "Todavía debo a {0} unos {1} doblones. Cada viaje rentable acerca a mi familia a saldar toda la deuda.", "Ainda devo cerca de {1} dobrões a {0}. Cada viagem lucrativa aproxima a família de quitar a dívida.", "{0}にまだ約{1}ダブロンの借金がある。航海で利益を上げるたび、家の借金完済が近づく。", "Ich schulde {0} noch etwa {1} Dublonen. Jede gewinnbringende Reise bringt unser Familienvermögen der Schuldenfreiheit näher.", "Je dois encore environ {1} doublons à {0}. Chaque voyage rentable rapproche ma famille du remboursement intégral.", "Wciąż jestem winien {0} około {1} dublonów. Każdy zyskowny rejs przybliża rodzinę do spłaty całego długu.", "我還欠{0}約{1}達布隆。每趟航行賺到的錢，都讓家族產業離還清債務更近一步。", "아직 {0}에게 약 {1}더블룬을 빚지고 있습니다. 수익을 내는 항해를 할 때마다 가문의 빚을 갚는 날이 가까워집니다."])
  });
  Object.assign(overrides, {
    "I wanted a quiet shore. I should have tried honesty before the rope.": reviewedLocaleOverrides("I wanted a quiet shore. I should have tried honesty before the rope.", ["我只想找个安静的海岸。早知如此，当初在上绞索之前就该说实话。", "Мне хотелось тихого берега. Надо было сказать правду, пока дело не дошло до петли.", "Quería una costa tranquila. Debí decir la verdad antes de que me pusieran la soga al cuello.", "Eu queria um litoral tranquilo. Devia ter dito a verdade antes de me porem a corda no pescoço.", "静かな岸辺が欲しかった。縄をかけられる前に、正直に話すべきだった。", "Ich wollte ein ruhiges Ufer. Ich hätte ehrlich sein sollen, bevor man mir den Strick um den Hals legte.", "Je voulais une côte tranquille. J'aurais dû dire la vérité avant qu'on me passe la corde au cou.", "Chciałem spokojnego brzegu. Trzeba było powiedzieć prawdę, zanim założono mi stryczek.", "我只想找個安靜的海岸。早知如此，當初在上絞索之前就該說實話。", "조용한 해안을 원했어요. 밧줄에 목이 매이기 전에 솔직하게 말했어야 했는데."]),
    "I was a pirate, captain. I lied because I want out. Take me home to {0}, and I will trouble no ship again.": reviewedLocaleOverrides("I was a pirate, captain. I lied because I want out. Take me home to {0}, and I will trouble no ship again.", ["船长，我以前是海盗。我撒谎是因为想脱离海盗生涯。送我回{0}吧，我再也不骚扰任何船只。", "Я был пиратом, капитан. Я солгал, потому что хочу завязать. Отвезите меня домой, в {0}, и я больше не трону ни одного корабля.", "Fui pirata, capitán. Mentí porque quiero dejar esa vida. Llévame a casa, a {0}, y no volveré a molestar a ningún barco.", "Eu era pirata, capitão. Menti porque quero abandonar essa vida. Leve-me para casa, em {0}, e nunca mais incomodarei navio algum.", "船長、私は海賊だった。足を洗いたくて嘘をついた。{0}へ送り届けてくれ。もう二度と船には手を出さない。", "Ich war Pirat, Kapitän. Ich habe gelogen, weil ich aussteigen will. Bring mich nach {0} nach Hause, und ich lasse künftig jedes Schiff in Ruhe.", "J'étais pirate, capitaine. J'ai menti parce que je veux tourner la page. Ramenez-moi chez moi, à {0}, et je ne m'en prendrai plus à aucun navire.", "Byłem piratem, kapitanie. Skłamałem, bo chcę skończyć z tym życiem. Odwieź mnie do domu, do {0}, a już nie napadnę na żaden statek.", "船長，我以前是海盜。我撒謊是因為想脫離海盜生涯。送我回{0}吧，我再也不騷擾任何船隻。", "해적이었지만 선장님, 이제 그만두고 싶어서 거짓말을 했습니다. {0}으로 데려다주시면 다시는 어떤 배도 괴롭히지 않겠습니다."]),
    "I will carry the legation and answer for its safety.": reviewedLocaleOverrides("I will carry the legation and answer for its safety.", ["我会护送使团，并对其安全负责。", "Я сопровожу посольство и буду отвечать за его безопасность.", "Escoltaré a la legación y responderé por su seguridad.", "Escoltarei a legação e responderei por sua segurança.", "使節団を護衛し、その安全に責任を持とう。", "Ich werde die Gesandtschaft begleiten und für ihre Sicherheit sorgen.", "J'escorterai la délégation et répondrai de sa sécurité.", "Będę eskortować poselstwo i odpowiadać za jego bezpieczeństwo.", "我會護送使團，並對其安全負責。", "사절단을 호위하고 안전을 책임지겠습니다."]),
    "I will keep your watch when I can. May the day bring you the peace you seek.": reviewedLocaleOverrides("I will keep your watch when I can. May the day bring you the peace you seek.", ["有机会我会替你值守。愿你终能迎来所寻求的平静。", "Когда смогу, подменю вас на вахте. Пусть этот день принесёт вам желанный покой.", "Cuando pueda, haré tu guardia. Que hoy encuentres la paz que buscas.", "Quando puder, fico de vigia no seu lugar. Que este dia lhe traga a paz que procura.", "できる時は君の当直を代わろう。今日が、求める安らぎをもたらしますように。", "Wenn ich kann, übernehme ich Deine Wache. Möge dieser Tag Dir den ersehnten Frieden bringen.", "Je prendrai votre quart quand je le pourrai. Puisse ce jour vous apporter la paix que vous cherchez.", "Gdy będę mógł, przejmę twoją wachtę. Niech ten dzień przyniesie ci upragniony spokój.", "有機會我會替你值守。願你終能迎來所尋求的平靜。", "가능하면 제가 당신의 당직을 대신 서겠습니다. 오늘 하루가 바라던 평안을 가져다주기를 바랍니다."]),
    "I will mark {0} on your chart: {1} kilometres by sea. Silence its shore guns and storm the camp. Return for {2} doubloons.": reviewedLocaleOverrides("I will mark {0} on your chart: {1} kilometres by sea. Silence its shore guns and storm the camp. Return for {2} doubloons.", ["我会在海图上标出{0}，距此海路{1}公里。摧毁岸炮并攻下营地。回来领取{2}达布隆。", "Я отмечу {0} на вашей карте: {1} км морем. Подавите береговые орудия и возьмите лагерь штурмом. Возвращайтесь за наградой в {2} дублонов.", "Marcaré {0} en tu carta: está a {1} kilómetros por mar. Silencia sus cañones costeros y toma el campamento. Regresa para cobrar {2} doblones.", "Marcarei {0} na sua carta: fica a {1} quilômetros por mar. Silencie os canhões costeiros e tome o acampamento. Volte para receber {2} dobrões.", "{0}は海路{1}キロ先だ。海図に印を付けておこう。岸の砲台を黙らせ、陣地を攻め落とせ。戻れば報酬の{2}ダブロンを払おう。", "Ich markiere {0} auf Eurer Karte: {1} Kilometer über See. Setzt die Küstengeschütze außer Gefecht und stürmt das Lager. Kehrt zurück, um {2} Dublonen abzuholen.", "Je marquerai {0} sur votre carte, à {1} kilomètres par mer. Réduisez ses canons côtiers au silence et prenez le camp d'assaut. Revenez toucher les {2} doublons.", "Zaznaczę {0} na twojej mapie: {1} km drogą morską. Ucisz działa nadbrzeżne i zdobądź obóz. Wróć po nagrodę w wysokości {2} dublonów.", "我會在海圖上標出{0}，距此海路{1}公里。摧毀岸砲並攻下營地。回來領取{2}達布隆。", "해도에 {0}을 표시하겠습니다. 해로로 {1}킬로미터 거리입니다. 해안 포대를 무력화하고 야영지를 공격하세요. 돌아오면 {2}더블룬을 드리겠습니다."]),
    "I will sell you the {0}, captain, but {1}. Their patrols may search your hold, seize the cargo, and levy a fine. Shall I have it loaded?": reviewedLocaleOverrides("I will sell you the {0}, captain, but {1}. Their patrols may search your hold, seize the cargo, and levy a fine. Shall I have it loaded?", ["船长，我可以把{0}卖给你，不过{1}。他们的巡逻队可能会搜查货舱、没收货物并罚款。要我装船吗？", "Я продам вам {0}, капитан, но {1}. Их патрули могут обыскать ваш трюм, конфисковать груз и наложить штраф. Загрузить его?", "Te venderé {0}, capitán, pero {1}. Sus patrullas pueden registrar tu bodega, confiscar la carga y multarte. ¿Lo cargo?", "Vou vender o {0} para você, capitão, mas {1}. As patrulhas podem revistar seu porão, apreender a carga e aplicar uma multa. Quer que eu carregue?", "船長、{0}を売ろう。ただし{1}。巡視船に船倉を調べられ、荷を没収されたうえ罰金を科される恐れがある。積み込もうか？", "Ich verkaufe Euch {0}, Kapitän, aber {1}. Ihre Patrouillen können Euren Laderaum durchsuchen, die Fracht beschlagnahmen und eine Geldstrafe verhängen. Soll ich die Ware laden?", "Je vous vendrai {0}, capitaine, mais {1}. Leurs patrouilles peuvent fouiller votre cale, saisir la cargaison et vous infliger une amende. Dois-je le charger ?", "Sprzedam ci {0}, kapitanie, ale {1}. Ich patrole mogą przeszukać ładownię, skonfiskować towar i nałożyć grzywnę. Załadować go?", "船長，我可以把{0}賣給你，不過{1}。他們的巡邏隊可能會搜查貨艙、沒收貨物並罰款。要我裝船嗎？", "선장님, {0}을 팔겠습니다. 다만 {1}. 순찰대가 화물창을 수색하고 화물을 압수하거나 벌금을 부과할 수 있습니다. 실어 드릴까요?"]),
    "I will take the pieces from Captain {0}'s old crew, read the map whole, and come home with the gold.": reviewedLocaleOverrides("I will take the pieces from Captain {0}'s old crew, read the map whole, and come home with the gold.", ["我会从{0}船长的老船员手中收齐碎片，拼出完整地图，带着黄金回家。", "Я соберу фрагменты карты у бывшей команды капитана {0}, сложу её целиком и вернусь домой с золотом.", "Reuniré las piezas del mapa que guarda la antigua tripulación del capitán {0}, lo completaré y volveré a casa con el oro.", "Vou reunir as peças do mapa com a antiga tripulação do capitão {0}, montá-lo por inteiro e voltar para casa com o ouro.", "{0}船長の元乗組員から地図の断片を集め、地図を完成させて、黄金と共に帰ろう。", "Ich sammle die Kartenstücke von Kapitän {0}s alter Mannschaft, setze die Karte zusammen und kehre mit dem Gold nach Hause zurück.", "Je récupérerai les fragments de carte auprès de l'ancien équipage du capitaine {0}, reconstituerai la carte et rentrerai avec l'or.", "Zbiorę fragmenty mapy od dawnej załogi kapitana {0}, odtworzę całą mapę i wrócę do domu ze złotem.", "我會從{0}船長的老船員手中收齊碎片，拼出完整地圖，帶著黃金回家。", "{0} 선장의 옛 선원들에게서 지도 조각을 모아 전체 지도를 맞춘 뒤 금을 가지고 돌아오겠습니다."])
  });
  Object.assign(overrides, {
    "Ibrahim forgot many of Jalal's friends. Your kinsman's guarantee was not among them.": reviewedLocaleOverrides("Ibrahim forgot many of Jalal's friends. Your kinsman's guarantee was not among them.", ["易卜拉欣忘了贾拉勒的许多旧友，却没有忘记你亲族的担保。", "Ибрагим забыл многих друзей Джалала, но не забыл о поручительстве вашего родственника.", "Ibrahim olvidó a muchos amigos de Jalal, pero no la garantía de tu pariente.", "Ibrahim esqueceu muitos amigos de Jalal, mas não a garantia dada por seu parente.", "イブラヒムはジャラールの友人を大勢忘れたが、君の親族の保証は忘れなかった。", "Ibrahim vergaß viele von Jalals Freunden, doch die Bürgschaft Eures Verwandten nicht.", "Ibrahim a oublié bien des amis de Jalal, mais pas la garantie de votre parent.", "Ibrahim zapomniał o wielu przyjaciołach Jalala, ale nie o poręczeniu twojego krewnego.", "易卜拉欣忘了賈拉勒的許多舊友，卻沒有忘記你親族的擔保。", "이브라힘은 잘랄의 많은 친구를 잊었지만, 당신 친척의 보증은 잊지 않았습니다."]),
    "Ice to every quarter, and not a chimney in the world. Keep a sharp watch.": reviewedLocaleOverrides("Ice to every quarter, and not a chimney in the world. Keep a sharp watch.", ["四下全是冰，望不到一缕炊烟。提高警惕，仔细瞭望。", "Кругом лёд, и ни одного дымохода на всём свете. Будьте начеку.", "Hielo en todas direcciones y ni una chimenea en el horizonte. Mantente alerta.", "Gelo por todos os lados, sem uma única chaminé à vista. Mantenha a vigilância.", "四方は氷に閉ざされ、煙突は世界のどこにも見当たらない。目を光らせろ。", "Ringsum Eis und weit und breit kein Schornstein. Haltet sorgfältig Wache.", "De la glace à perte de vue et pas une cheminée à l'horizon. Restez aux aguets.", "Lód ze wszystkich stron, ani jednego komina w zasięgu wzroku. Zachowaj czujność.", "四下全是冰，望不到一縷炊煙。提高警覺，仔細瞭望。", "사방이 얼음뿐이고 굴뚝 하나 보이지 않는군요. 경계를 늦추지 마세요."]),
    "If I breathe in, someone else has to breathe out. This vessel is all elbows.": reviewedLocaleOverrides("If I breathe in, someone else has to breathe out. This vessel is all elbows.", ["我一吸气，就得有人呼气。这船上挤得连转身都难。", "Стоит мне вдохнуть — кому-то уже приходится выдыхать. На этом судне локоть от локтя не протолкнуться.", "Si yo inspiro, alguien tiene que espirar. En este barco no cabe un alfiler.", "Se eu inspirar, alguém terá de expirar. Este navio está apertado até não caber mais ninguém.", "私が息を吸えば、誰かが吐かなきゃならない。この船は肘がぶつかるほどぎゅうぎゅうだ。", "Wenn ich einatme, muss jemand anderes ausatmen. Auf diesem Schiff ist es so eng, dass überall Ellbogen sind.", "Si je respire, quelqu'un doit expirer. On est serrés comme des sardines sur ce navire.", "Gdy ja wciągam powietrze, ktoś inny musi je wypuścić. Na tym statku nie ma miejsca na łokieć.", "我一吸氣，就得有人呼氣。這船上擠得連轉身都難。", "내가 숨을 들이쉬면 누군가는 내쉬어야 해요. 배 안이 너무 비좁아 팔꿈치가 사방에 부딪힙니다."]),
    "If the wind holds, {0} is close enough to hope for. I will not forget this passage.": reviewedLocaleOverrides("If the wind holds, {0} is close enough to hope for. I will not forget this passage.", ["只要风势不变，{0}就近在眼前，值得期待。这段航程我不会忘记。", "Если ветер не переменится, до {0} уже рукой подать. Этот переход я не забуду.", "Si el viento se mantiene, {0} está lo bastante cerca como para alcanzarlo. No olvidaré esta travesía.", "Se o vento continuar, {0} está perto o bastante para chegarmos. Não esquecerei esta travessia.", "風がこのまま続けば、{0}はもうすぐだ。この航海は忘れない。", "Wenn der Wind anhält, ist {0} nah genug, um es zu erreichen. Diese Überfahrt werde ich nicht vergessen.", "Si le vent tient, {0} est assez proche pour qu'on l'atteigne. Je n'oublierai pas cette traversée.", "Jeśli wiatr się utrzyma, {0} jest już w zasięgu. Nie zapomnę tego rejsu.", "只要風勢不變，{0}就近在眼前，值得期待。這段航程我不會忘記。", "바람만 계속 불어 준다면 {0}도 곧 닿을 거리입니다. 이 항해를 잊지 않겠습니다."]),
    "If they alter course, wake me before they promote themselves.": reviewedLocaleOverrides("If they alter course, wake me before they promote themselves.", ["要是它们改了航向，在它们自封头领之前叫醒我。", "Если они изменят курс, разбудите меня, пока они сами себя не назначили.", "Si cambian de rumbo, despiértame antes de que se nombren al mando.", "Se mudarem de rumo, acorde-me antes que se autoproclamem líderes.", "あいつらが進路を変えたら、自分たちを昇進させる前に起こしてくれ。", "Wenn sie den Kurs ändern, weckt mich, bevor sie sich selbst befördern.", "S'ils changent de cap, réveillez-moi avant qu'ils ne s'autoproclament chefs.", "Jeśli zmienią kurs, obudź mnie, zanim same mianują się dowódcami.", "要是牠們改了航向，在牠們自封頭領之前叫醒我。", "녀석들이 항로를 바꾸면 스스로를 승진시키기 전에 깨워 주세요."]),
    "I will follow those rumors to the edge of every chart. When I return, you will know these places as more than names, and I will finally have seen the world I imagined.": reviewedLocaleOverrides("I will follow those rumors to the edge of every chart. When I return, you will know these places as more than names, and I will finally have seen the world I imagined.", ["我会循着那些传闻，驶到每张海图的尽头。等我回来，你会知道这些地方不只是名字，而我也终于亲眼看到了心中的世界。", "Я пойду за этими слухами до самого края всех морских карт. Когда вернусь, вы будете знать эти места не только по названиям, а я наконец увижу мир, о котором мечтал.", "Seguiré esos rumores hasta los confines de cada carta náutica. Cuando vuelva, conocerás esos lugares más allá de sus nombres, y yo por fin habré visto el mundo que imaginaba.", "Seguirei esses rumores até o limite de cada carta náutica. Quando voltar, você conhecerá esses lugares além dos nomes, e eu finalmente terei visto o mundo que imaginei.", "あらゆる海図の果てまで噂を追おう。戻る頃には、君も地名だけでなくその土地を知るはずだ。そして私も、夢見た世界をこの目で見てくる。", "Ich werde den Gerüchten bis an den Rand jeder Seekarte folgen. Wenn ich zurückkehre, kennst du diese Orte nicht mehr nur dem Namen nach, und ich habe endlich die Welt gesehen, die ich mir vorgestellt habe.", "Je suivrai ces rumeurs jusqu'aux confins de chaque carte marine. À mon retour, vous connaîtrez ces lieux autrement que par leur nom, et j'aurai enfin vu le monde dont je rêvais.", "Podążę za tymi pogłoskami aż po kres każdej mapy morskiej. Gdy wrócę, poznasz te miejsca nie tylko z nazwy, a ja wreszcie zobaczę świat, który sobie wyobraziłem.", "我會循著那些傳聞，駛到每張海圖的盡頭。等我回來，你會知道這些地方不只是名字，而我也終於親眼看到了心中的世界。", "모든 해도의 끝까지 소문을 따라가겠습니다. 돌아오면 이곳들을 이름만이 아닌 실제 장소로 알게 될 것이고, 저도 마침내 꿈꾸던 세상을 보게 될 겁니다."])
  });
  return overrides;
}
...
function reviewedCatalogRange1700Overrides() {
  const entries = [
    ["Imperial bonds are excellent promises, provided one does not need payment.", ["帝国债券上的承诺十分可靠，前提是你不急着拿到钱。", "Имперские долговые обязательства — прекрасное обещание, если вам не нужны деньги.", "Los bonos imperiales prometen mucho, siempre que uno no necesite cobrar.", "Os títulos imperiais são excelentes promessas, desde que ninguém precise receber.", "帝国の債券は、すぐに支払いを受ける必要がなければ頼もしい約束だ。", "Kaiserliche Anleihen versprechen viel – solange man nicht auf Auszahlung angewiesen ist.", "Les obligations impériales promettent beaucoup, tant qu'on n'a pas besoin d'être payé.", "Cesarskie obligacje wiele obiecują, o ile nie trzeba ich spieniężyć.", "帝國債券上的承諾十分可靠，前提是你不急著拿到錢。", "제국 채권은 당장 돈을 받을 필요가 없다면 훌륭한 약속입니다."]],
    ["Jamestown has survived disease, hunger, and war long enough to become permanent. The Company's pamphlets boast of the fort; its graveyard keeps the truer account.", ["詹姆斯敦熬过了疾病、饥荒与战乱，终于站稳脚跟。公司宣传册吹嘘堡垒的功绩，墓园却记录着更真实的代价。", "Джеймстаун пережил болезни, голод и войну и наконец стал постоянным поселением. Компания хвалится своим фортом в брошюрах, а кладбище хранит куда более правдивый отчёт.", "Jamestown sobrevivió a las enfermedades, el hambre y la guerra hasta consolidarse. Los folletos de la Compañía presumen del fuerte; el cementerio cuenta la historia más veraz.", "Jamestown sobreviveu a doenças, fome e guerra até se firmar como povoado permanente. Os panfletos da Companhia exaltam o forte; o cemitério registra o custo real.", "ジェームズタウンは疫病、飢え、戦争を乗り越えて定着しました。会社のパンフレットは砦を誇りますが、墓地にはより真実の記録が残っています。", "Jamestown überstand Krankheit, Hunger und Krieg und wurde schließlich dauerhaft besiedelt. Die Kompanie rühmt in ihren Flugblättern das Fort; der Friedhof erzählt die wahrere Geschichte.", "Jamestown a survécu aux maladies, à la faim et à la guerre, jusqu'à s'enraciner durablement. Les brochures de la Compagnie vantent le fort ; le cimetière raconte la vérité.", "Jamestown przetrwało choroby, głód i wojnę, aż w końcu stało się stałą osadą. Kompania chwali się fortem w broszurach, lecz cmentarz opowiada prawdziwszą historię.", "詹姆斯敦熬過了疾病、饑荒與戰亂，終於站穩腳跟。公司宣傳冊吹噓堡壘的功績，墓園卻記錄著更真實的代價。", "제임스타운은 질병과 굶주림, 전쟁을 견뎌내고 마침내 정착지로 자리 잡았습니다. 회사는 팸플릿에서 요새를 자랑하지만, 묘지는 더 진실한 대가를 기록합니다."]],
    ["Joseon grants Tsushima limited trade, but its councillors call the Sō envoys frauds. These credentials are genuine. Carry me and the Sō register to Hanseong before they revoke our privilege.", ["朝鲜只准对马有限通商，但朝鲜大臣称宗氏使节是骗子。这些凭证确为真品。请在通商特权被撤销前，带我和宗氏名册前往汉城。", "Чосон разрешает Цусиме ограниченную торговлю, но его сановники называют посланников рода Со мошенниками. Эти грамоты подлинные. Доставьте меня и реестр Со в Хансон, пока нашу привилегию не отозвали.", "Joseon concede a Tsushima un comercio limitado, pero sus consejeros llaman impostores a los enviados del clan Sō. Estas credenciales son auténticas. Llévame con el registro Sō a Hanseong antes de que revoquen nuestro privilegio.", "Joseon concede a Tsushima comércio limitado, mas seus conselheiros chamam de impostores os enviados do clã Sō. Estas credenciais são autênticas. Leve-me e ao registro Sō a Hanseong antes que revoguem nosso privilégio.", "朝鮮は対馬に限られた交易を認めているが、重臣たちは宗氏の使節を詐欺師呼ばわりする。この通行証は本物だ。特権を取り消される前に、私と宗氏の台帳を漢城まで運んでほしい。", "Joseon gewährt Tsushima begrenzten Handel, doch seine Räte nennen die Gesandten des Sō-Klans Betrüger. Diese Beglaubigung ist echt. Bringt mich und das Sō-Register nach Hanseong, bevor man uns das Privileg entzieht.", "Joseon accorde à Tsushima un commerce limité, mais ses conseillers traitent les envoyés du clan Sō d'imposteurs. Ces lettres de créance sont authentiques. Conduisez-moi avec le registre Sō à Hanseong avant la révocation de notre privilège.", "Joseon przyznaje Cuszimie ograniczone prawo handlu, lecz jego radni nazywają wysłanników rodu Sō oszustami. Te dokumenty uwierzytelniające są prawdziwe. Zawieź mnie i rejestr Sō do Hanseong, nim odbiorą nam przywilej.", "朝鮮只准對馬有限通商，但朝鮮大臣稱宗氏使節是騙子。這些憑證確為真品。請在通商特權被撤銷前，帶我和宗氏名冊前往漢城。", "조선은 쓰시마에 제한적 무역을 허용하지만, 대신들은 소씨 사절을 사기꾼이라 부릅니다. 이 신임장은 진짜입니다. 특권이 철회되기 전에 나와 소씨 장부를 한성으로 데려가 주십시오."]],
    ["Keep clear, {0} hireling. The {1} tally will reach Ningbo first. Yet a prudent captain need not lose with {2}: stand with us if the hearing turns to battle, and {3} db is yours.", ["退开，{0}的雇佣兵。{1}的账册会先送到宁波。不过，谨慎的船长不必跟着{2}输掉：若听证会演变成战斗，就站在我们这边，你将得到{3}达布隆。", "Держись подальше, наёмник {0}. Ведомость {1} первой достигнет Нинбо. Но благоразумному капитану не обязательно проигрывать вместе с {2}: если слушание перерастёт в бой, встаньте на нашу сторону и получите {3} дублонов.", "Aléjate, mercenario de {0}. El registro de {1} llegará primero a Ningbo. Pero un capitán prudente no tiene por qué perder junto a {2}: ponte de nuestro lado si la audiencia acaba en batalla y recibirás {3} doblones.", "Afaste-se, mercenário de {0}. O registro de {1} chegará primeiro a Ningbo. Mas um capitão prudente não precisa perder junto com {2}: fique do nosso lado se a audiência virar combate e receberá {3} dobrões.", "下がれ、{0}の雇われ船長。{1}の記録が先に寧波へ届く。だが賢い船長なら{2}と共倒れする必要はない。審理が戦になれば我らに付け。{3}ダブロンを払おう。", "Haltet Euch fern, Söldner von {0}. Die Abrechnung von {1} erreicht Ningbo zuerst. Doch ein kluger Kapitän muss nicht mit {2} verlieren: Steht auf unserer Seite, wenn die Anhörung zum Kampf wird, und Ihr erhaltet {3} Dublonen.", "Éloignez-vous, mercenaire de {0}. Le registre de {1} arrivera d'abord à Ningbo. Mais un capitaine avisé n'est pas obligé de perdre avec {2} : ralliez-nous si l'audience tourne au combat, et vous recevrez {3} doublons.", "Trzymaj się z dala, najemniku {0}. Rejestr {1} dotrze do Ningbo jako pierwszy. Rozważny kapitan nie musi jednak przegrać razem z {2}: stań po naszej stronie, jeśli rozprawa przerodzi się w bitwę, a dostaniesz {3} dublonów.", "退開，{0}的傭兵。{1}的帳冊會先送到寧波。不過，謹慎的船長不必跟著{2}輸掉：若聽證會演變成戰鬥，就站在我們這邊，你將得到{3}達布隆。", "{0}의 용병, 물러서시오. {1}의 장부가 닝보에 먼저 도착할 것입니다. 하지만 현명한 선장은 {2}와 함께 패할 필요가 없습니다. 심리가 전투로 번지면 우리 편에 서시오. 그러면 {3}더블룬을 드리겠습니다."]]
  ];
  return Object.fromEntries(entries.map(([source, translations]) => [source, reviewedLocaleOverrides(source, translations)]));
}

function reviewedCatalogRange1750Overrides() {
  const entries = [
    ["Korean", ["朝鲜人", "кореец", "coreano", "coreano", "韓国人", "Koreaner", "Coréen", "Koreańczyk", "韓國人", "한국인"]],
    ["Kosciuszko is no lonely spire. It is the highest rise in a broad, windswept country of rounded ridges, pale grass, and winter snow.", ["科修斯科峰并非孤立的尖塔，而是广阔多风的高地上最高的一处隆起。圆缓的山脊、浅色草地与冬雪铺展四周。", "Костюшко — не одинокий пик, а высшая точка обширного продуваемого ветрами края с округлыми хребтами, бледной травой и зимним снегом.", "Kosciuszko no es una aguja solitaria, sino la mayor elevación de una extensa región azotada por el viento, con crestas redondeadas, hierba pálida y nieve invernal.", "Kosciuszko não é uma agulha solitária, mas a maior elevação de uma vasta região varrida pelo vento, com cristas arredondadas, capim claro e neve no inverno.", "コジオスコは孤立した尖峰ではありません。丸い尾根と淡い草地、冬の雪が広がる風の強い高原で、最も高く盛り上がった場所です。", "Der Kosciuszko ist keine einsame Spitze, sondern die höchste Erhebung in einer weiten, windumtosten Landschaft mit sanften Rücken, hellem Gras und Winterschnee.", "Le Kosciuszko n'est pas un pic isolé, mais le point culminant d'une vaste région balayée par les vents, aux crêtes arrondies, à l'herbe pâle et aux neiges hivernales.", "Kościuszko nie jest samotną iglicą, lecz najwyższym wzniesieniem rozległej, smaganej wiatrem krainy o zaokrąglonych grzbietach, bladej trawie i zimowym śniegu.", "科修斯科峰並非孤立的尖塔，而是廣闊多風的高地上最高的一處隆起。圓緩的山脊、淺色草地與冬雪鋪展四周。", "코지우스코산은 외로운 첨탑이 아닙니다. 둥근 능선과 옅은 풀밭, 겨울 눈이 펼쳐진 바람 센 넓은 고원에서 가장 높이 솟은 곳입니다."]],
    ["Luther's Bible is forbidden. Fortunately, I have read it. Close the chest, captain; my eyesight has failed.", ["路德译本的《圣经》是禁书。幸好我已经读过了。船长，把箱子关上吧；我的眼睛不太好使了。", "Библия в переводе Лютера запрещена. К счастью, я уже прочитал её. Закройте сундук, капитан: зрение меня подводит.", "La Biblia de Lutero está prohibida. Por suerte, ya la he leído. Cierra el cofre, capitán; la vista me falla.", "A Bíblia de Lutero é proibida. Ainda bem que já a li. Feche o baú, capitão; minha vista está falhando.", "ルター訳聖書は禁止されています。幸い、もう読んであります。船長、箱を閉めてください。目がかすんできました。", "Luthers Bibel ist verboten. Zum Glück habe ich sie schon gelesen. Schließt die Truhe, Kapitän; meine Augen lassen nach.", "La Bible de Luther est interdite. Heureusement, je l'ai déjà lue. Fermez le coffre, capitaine ; ma vue baisse.", "Biblia Lutra jest zakazana. Na szczęście już ją przeczytałem. Zamknij skrzynię, kapitanie; wzrok już nie ten.", "路德譯本的《聖經》是禁書。幸好我已經讀過了。船長，把箱子關上吧；我的眼睛不太好使了。", "루터 성경은 금서요. 다행히 이미 읽어 두었소. 선장, 상자를 닫으시오. 눈이 침침해졌으니."]]
  ];
  return Object.fromEntries(entries.map(([source, translations]) => [source, reviewedLocaleOverrides(source, translations)]));
}

function reviewedCatalogRange1800Overrides() {
  const entries = [
    ["Malacca lost a warehouse. I acquired excellent collateral.", ["马六甲失去了一座仓库，我却拿到了上好的抵押品。", "Малакка потеряла склад, а я получил прекрасный залог.", "Malaca perdió un almacén; yo conseguí una excelente garantía.", "Malaca perdeu um armazém; eu fiquei com uma ótima garantia.", "マラッカは倉庫を失い、私は上等な担保を手に入れた。", "Malakka verlor ein Lagerhaus; ich erhielt dafür eine ausgezeichnete Sicherheit.", "Malacca a perdu un entrepôt ; j'ai obtenu une excellente garantie.", "Malakka straciła magazyn, a ja zyskałem doskonałe zabezpieczenie długu.", "馬六甲失去了一座倉庫，我卻拿到了上好的抵押品。", "말라카는 창고를 잃었고, 나는 훌륭한 담보를 얻었지."]],
    ["Manually assigned crew, guns, and supplies", ["手动分配的船员、火炮与补给", "Экипаж, пушки и припасы назначаются вручную", "Tripulación, cañones y provisiones asignados manualmente", "Tripulação, canhões e suprimentos atribuídos manualmente", "乗組員・大砲・物資を手動で割り当て", "Manuell zugewiesene Besatzung, Geschütze und Vorräte", "Équipage, canons et provisions attribués manuellement", "Ręcznie przydzielona załoga, działa i zapasy", "手動分配的船員、火炮與補給", "선원, 대포, 보급품을 수동으로 배정"]],
    ["Marignano made the king glorious. It left your family in my debt.", ["马里尼亚诺之战成就了国王的威名，也让你家欠下了我的债。", "Мариньяно прославило короля и оставило вашу семью в долгу передо мной.", "Marignano dio gloria al rey y dejó a tu familia endeudada conmigo.", "Marignano glorificou o rei e deixou sua família em dívida comigo.", "マリニャーノの戦いは王の名声を高め、あなたの一族には私への借りを残した。", "Marignano brachte dem König Ruhm ein und ließ Eure Familie bei mir in der Schuld stehen.", "Marignan a glorifié le roi et laissé votre famille endettée envers moi.", "Marignano przyniosło królowi chwałę, a twoją rodzinę wpędziło w dług wobec mnie.", "馬里尼亞諾之戰成就了國王的威名，也讓你家欠下了我的債。", "마리냐노 전투는 왕의 명성을 높였고, 당신 가문은 내게 빚을 지게 되었지."]],
    ["Mauna Kea rises from the ocean as a broad, gentle island slope, then climbs to a cold, bare summit. Snow lay above warm Pacific water and black volcanic stone.", ["莫納克亞山从海中隆起，宽阔平缓的山坡渐渐抬升，直至寒冷光秃的山顶。温暖的太平洋海水与黑色火山岩之上，竟覆着积雪。", "Мауна-Кеа поднимается из океана широким пологим склоном острова, который постепенно ведёт к холодной голой вершине. Снег лежит над тёплой водой Тихого океана и чёрной вулканической породой.", "El Mauna Kea emerge del océano como una amplia y suave ladera insular que asciende hasta una cumbre fría y desnuda. La nieve cubre las aguas cálidas del Pacífico y la roca volcánica negra.", "O Mauna Kea emerge do oceano como uma encosta insular ampla e suave, que sobe até um cume frio e despojado. A neve repousava acima das águas quentes do Pacífico e da rocha vulcânica negra.", "マウナ・ケアは島の幅広くなだらかな斜面となって海から立ち上がり、やがて冷たく木々のない山頂へと続きます。暖かな太平洋の海と黒い火山岩の上に、雪が積もっていました。", "Der Mauna Kea steigt als breiter, sanfter Inselhang aus dem Meer auf und führt hinauf zu einem kalten, kahlen Gipfel. Schnee lag über dem warmen Pazifik und schwarzem Vulkangestein.", "Le Mauna Kea émerge de l'océan par un vaste versant insulaire en pente douce, qui s'élève jusqu'à un sommet froid et dénudé. La neige recouvrait les eaux chaudes du Pacifique et la roche volcanique noire.", "Mauna Kea wyrasta z oceanu jako rozległy, łagodny stok wyspy, który wznosi się ku zimnemu, nagiemu szczytowi. Śnieg leżał nad ciepłymi wodami Pacyfiku i czarną skałą wulkaniczną.", "莫納克亞山從海中隆起，寬闊平緩的山坡漸漸抬升，直至寒冷光禿的山頂。溫暖的太平洋海水與黑色火山岩之上，竟覆著積雪。", "마우나케아는 넓고 완만한 섬 비탈로 바다에서 솟아올라 차갑고 민둥한 정상까지 이어집니다. 따뜻한 태평양 바다와 검은 화산암 위로 눈이 쌓여 있었습니다."]],
    ["Maynila is already a fortified Tagalog and Muslim port beside Tondo. Legazpi intends to conquer it and rebuild it as his capital, not claim to have discovered it.", ["梅尼拉已是通多旁一座由他加禄人与穆斯林建成的设防港口。黎牙实比打算征服并重建此城，将其作为自己的首府，而非声称发现了它。", "Майнила уже является укреплённым тагальским и мусульманским портом рядом с Тондо. Легаспи намерен завоевать город и отстроить его заново как свою столицу, а не объявлять, будто он его открыл.", "Maynila ya es un puerto fortificado tagalo y musulmán junto a Tondo. Legazpi pretende conquistarlo y reconstruirlo como capital, no atribuirse su descubrimiento.", "Maynila já é um porto fortificado tagalo e muçulmano junto a Tondo. Legazpi pretende conquistá-la e reconstruí-la como sua capital, não alegar que a descobriu.", "マイニラはすでにトンドに隣接する、タガログ人とイスラム教徒の要塞港です。レガスピが目指すのは征服して首都として再建することであり、発見したと称することではありません。", "Maynila ist bereits ein befestigter, von Tagalen und Muslimen bewohnter Hafen neben Tondo. Legazpi will die Stadt erobern und als seine Hauptstadt wiederaufbauen, nicht ihre Entdeckung für sich beanspruchen.", "Maynila est déjà un port fortifié tagalog et musulman, voisin de Tondo. Legazpi entend le conquérir et le reconstruire pour en faire sa capitale, sans prétendre l'avoir découvert.", "Maynila jest już ufortyfikowanym portem Tagalów i muzułmanów, położonym obok Tondo. Legazpi zamierza go podbić i odbudować jako swoją stolicę, a nie przypisywać sobie jego odkrycie.", "梅尼拉已是通多旁一座由他加祿人與穆斯林建成的設防港口。黎牙實比打算征服並重建此城，將其作為自己的首府，而非聲稱發現了它。", "마닐라는 이미 톤도 옆에 타갈로그인과 무슬림이 세운 요새 항구입니다. 레가스피는 이곳을 정복해 수도로 재건하려는 것이지, 발견했다고 주장하려는 게 아닙니다."]],
    ["Many merchants are arriving. Berths and dock labor are limited.", ["商船纷纷抵达，但泊位和码头人手有限。", "Прибывает много купцов, а причалов и портовых рабочих не хватает.", "Llegan muchos mercaderes, pero escasean los atraques y la mano de obra portuaria.", "Muitos mercadores estão chegando, mas há poucos berços e trabalhadores no porto.", "商人が次々と到着していますが、停泊場所も荷役人足も足りません。", "Viele Händler treffen ein, doch Liegeplätze und Hafenarbeiter sind knapp.", "De nombreux marchands arrivent, mais les postes d'amarrage et les dockers manquent.", "Przybywa wielu kupców, lecz brakuje miejsc do cumowania i robotników portowych.", "商船紛紛抵達，但泊位和碼頭人手有限。", "상인들이 많이 도착하고 있지만, 정박지와 부두 인력이 부족합니다."]],
    ["Masterwork seine", ["精制围网", "Мастерской невод", "Red de cerco magistral", "Rede de cerco primorosa", "名匠作の地引網", "Meisterhaftes Zugnetz", "Senne d'exception", "Mistrzowski niewód", "精製圍網", "명품 후릿그물"]]
  ];
  return Object.fromEntries(entries.map(([source, translations]) => [source, reviewedLocaleOverrides(source, translations)]));
}

function reviewedCatalogRange1850Overrides() {
  const entries = [
    ["Nagasaki is a Japanese port reshaped by the annual arrival of a Portuguese ship. Its six streets are shared by local officials, Jesuits, and foreign trading factors.", ["长崎是一座日本港口，每年都有葡萄牙船只到来，令其面貌焕然一新。当地官员、耶稣会士和外国商行的代理人共处于六条街道之间。", "Нагасаки — японский порт, который преобразило ежегодное прибытие португальского корабля. На его шести улицах встречаются местные чиновники, иезуиты и иностранные торговые факторы.", "Nagasaki es un puerto japonés transformado por la llegada anual de un navío portugués. Sus seis calles reúnen a funcionarios locales, jesuitas y agentes comerciales extranjeros.", "Nagasaki é um porto japonês transformado pela chegada anual de um navio português. Suas seis ruas reúnem autoridades locais, jesuítas e agentes comerciais estrangeiros.", "長崎はポルトガル船が毎年訪れ、姿を変えた日本の港です。六つの通りには地元役人、イエズス会士、外国商館の商人が行き交います。", "Nagasaki ist ein japanischer Hafen, den die jährliche Ankunft eines portugiesischen Schiffs geprägt hat. Auf seinen sechs Straßen begegnen sich örtliche Beamte, Jesuiten und ausländische Handelsfaktoren.", "Nagasaki est un port japonais transformé par l'arrivée annuelle d'un navire portugais. Ses six rues sont fréquentées par les autorités locales, les jésuites et les facteurs étrangers.", "Nagasaki to japoński port, który odmieniły coroczne przybycia portugalskiego statku. Na jego sześciu ulicach spotykają się miejscowi urzędnicy, jezuici i zagraniczni faktorzy.", "長崎是一座日本港口，每年都有葡萄牙船隻到來，令其面貌煥然一新。當地官員、耶穌會士和外國商行的代理人共處於六條街道之間。", "나가사키는 포르투갈 선박이 해마다 도착하며 달라진 일본 항구입니다. 여섯 거리에는 지방 관리와 예수회, 외국 무역 상관의 상인들이 함께 모여듭니다."]],
    ["Natural philosophers too often deny beasts any action beyond bare necessity. I intend to study the otter's observable habits firsthand.", ["自然哲学家常常认为，野兽除求生所需外别无行动。我打算亲自观察水獭的种种习性。", "Натурфилософы слишком часто считают, что животные действуют лишь по крайней необходимости. Я намерен лично изучить повадки выдры.", "Los filósofos naturales suelen negar que los animales actúen por algo más que pura necesidad. Me propongo observar de primera mano los hábitos de la nutria.", "Os filósofos naturais muitas vezes negam que os animais ajam por algo além da necessidade. Pretendo observar de perto os hábitos da lontra.", "自然哲学者は、獣は生きるためだけに行動すると考えがちです。私はカワウソの習性を自分の目で観察するつもりです。", "Naturphilosophen gestehen Tieren oft nur Handlungen aus reiner Notwendigkeit zu. Ich will das Verhalten des Otters selbst beobachten.", "Les philosophes naturels n'accordent souvent aux bêtes que les gestes dictés par la nécessité. Je compte observer les habitudes de la loutre moi-même.", "Filozofowie przyrody zbyt często przypisują zwierzętom wyłącznie działania konieczne do przeżycia. Zamierzam osobiście zbadać zwyczaje wydry.", "自然哲學家常常認為，野獸除求生所需外別無行動。我打算親自觀察水獺的種種習性。", "자연철학자들은 짐승이 생존에 필요한 행동만 한다고 여기는 경우가 많습니다. 수달의 습성을 직접 관찰해 보려 합니다."]],
    ["No rival ship has reached the Thames. Your chests carry the first tea delivery of the year to London.", ["没有竞争对手的船驶抵泰晤士河。你运来的茶箱将成为今年首批送达伦敦的茶叶。", "Ни один корабль соперников не дошёл до Темзы. Ваши сундуки везут в Лондон первую в этом году партию чая.", "Ningún barco rival ha llegado al Támesis. Tus cofres llevan a Londres el primer cargamento de té del año.", "Nenhum navio rival chegou ao Tâmisa. Seus baús levam a Londres a primeira carga de chá do ano.", "競争相手の船はまだテムズ川に着いていません。あなたの箱が、今年初めてロンドンに届く茶葉を運んでいます。", "Kein Schiff der Konkurrenz hat die Themse erreicht. Eure Kisten bringen die erste Teelieferung des Jahres nach London.", "Aucun navire concurrent n'a atteint la Tamise. Vos coffres acheminent à Londres la première cargaison de thé de l'année.", "Żaden konkurencyjny statek nie dotarł do Tamizy. Twoje skrzynie wiozą do Londynu pierwszą w tym roku dostawę herbaty.", "沒有競爭對手的船駛抵泰晤士河。你運來的茶箱將成為今年首批送達倫敦的茶葉。", "경쟁 선박은 아직 템스강에 도착하지 않았습니다. 당신의 상자에 실린 차가 올해 처음 런던에 도착할 물량입니다."]],
    ["New Haven now stands at Quinnipiac as a rigorously planned Puritan merchant colony. Its nine-square grid is clearer than its commercial future.", ["纽黑文如今在昆尼皮亚克建成，是一座规划严谨的清教徒商贸殖民地。九宫格般的街区布局已清晰可见，商业前景却仍未明朗。", "Нью-Хейвен возник в Квиннипиаке как тщательно спланированная пуританская торговая колония. Её кварталы образуют ясную сетку из девяти квадратов, а торговые перспективы остаются туманными.", "New Haven se alza en Quinnipiac como una colonia mercantil puritana, trazada con rigor. Su cuadrícula de nueve manzanas está más clara que su porvenir comercial.", "New Haven surge em Quinnipiac como uma colônia mercantil puritana rigorosamente planejada. Sua grade de nove quarteirões está mais definida que seu futuro comercial.", "ニューヘイブンはクイニピアックに築かれた、整然と計画されたピューリタンの商業植民地です。九つの区画からなる街並みは明瞭ですが、商業の先行きは見通せません。", "New Haven entstand in Quinnipiac als streng geplante puritanische Handelskolonie. Ihr Raster aus neun Stadtblöcken ist klarer als ihre wirtschaftliche Zukunft.", "New Haven s'établit à Quinnipiac comme une colonie marchande puritaine au plan rigoureux. Sa grille de neuf pâtés de maisons est plus nette que son avenir commercial.", "New Haven powstało w Quinnipiac jako starannie zaplanowana purytańska kolonia kupiecka. Siatka dziewięciu kwartałów jest wyraźniejsza niż jej perspektywy handlowe.", "紐黑文如今在昆尼皮亞克建成，是一座規劃嚴謹的清教徒商貿殖民地。九宮格般的街區布局已清晰可見，商業前景卻仍未明朗。", "뉴헤이븐은 퀴니피악에 엄격히 계획된 청교도 상업 식민지로 자리 잡았습니다. 아홉 구획의 격자형 도시는 뚜렷하지만, 상업적 전망은 불투명합니다."]],
    ["Boats on the Niger, salt caravans, and court messengers crowd Gao's river landing; news of every arrival moves quickly through the market.", ["尼日尔河上的船只、盐商队和宫廷使者挤满了加奥的河埠头；每有来客，消息很快便传遍市场。", "Лодки на Нигере, караваны с солью и придворные гонцы заполняют речную пристань Гао; вести о каждом прибытии быстро расходятся по рынку.", "Barcos del Níger, caravanas de sal y mensajeros de la corte llenan el embarcadero fluvial de Gao; las noticias de cada llegada corren por el mercado.", "Barcos do Níger, caravanas de sal e mensageiros da corte lotam o cais fluvial de Gao; as notícias de cada chegada logo correm pelo mercado.", "ニジェール川の船、塩の隊商、宮廷の使者がガオの河岸に集まります。到着の知らせはすぐに市場へ広がります。", "Boote auf dem Niger, Salzkarawanen und Hofboten drängen sich am Flusshafen von Gao. Jede Ankunft spricht sich rasch auf dem Markt herum.", "Les bateaux du Niger, les caravanes de sel et les messagers de la cour se pressent au débarcadère fluvial de Gao ; chaque arrivée est vite connue au marché.", "Łodzie na Nigrze, karawany solne i posłańcy dworscy tłoczą się przy nadrzecznym nabrzeżu Gao. Wieści o każdym przybyciu szybko obiegają targ.", "尼日爾河上的船隻、鹽商隊和宮廷使者擠滿了加奧的河埠頭；每有來客，消息很快便傳遍市場。", "니제르강의 배와 소금 대상, 궁정 사절들이 가오의 강변 선착장에 모여듭니다. 도착 소식은 시장에 빠르게 퍼집니다."]],
    ["Nanga Parbat rises in one overwhelming sweep above the Indus country, its bare lower slopes giving way to hanging ice. Its immense face seemed to contain several climates.", ["南迦帕尔巴特峰以磅礴之势凌驾印度河流域，裸露的山麓渐渐过渡为悬冰。那面巨大的山壁仿佛囊括了数种气候。", "Нанга-Парбат вздымается над долиной Инда единым исполинским склоном: голые нижние скалы сменяются нависающими льдами. Казалось, на его огромном склоне уживались разные климатические пояса.", "El Nanga Parbat se alza de golpe sobre la región del Indo; sus laderas bajas y desnudas dan paso a hielos colgantes. Su inmensa pared parece abarcar varios climas.", "O Nanga Parbat ergue-se imponente sobre a região do Indo; as encostas baixas e nuas dão lugar a geleiras suspensas. Sua imensa face parece reunir vários climas.", "ナンガ・パルバットはインダス地方の上に圧倒的な姿でそびえ、むき出しの山麓から懸垂氷河へと続きます。その巨大な山肌には、いくつもの気候があるようでした。", "Der Nanga Parbat erhebt sich in einem gewaltigen Zug über dem Indusgebiet. Auf die kahlen unteren Hänge folgen hängende Eismassen; seine gewaltige Flanke schien mehrere Klimazonen zu umfassen.", "Le Nanga Parbat s'élève d'un seul élan au-dessus du pays de l'Indus. Ses pentes inférieures dénudées cèdent la place aux glaces suspendues ; son immense paroi semble réunir plusieurs climats.", "Nanga Parbat wznosi się nad krainą Indusu potężnym, nieprzerwanym stokiem. Nagie dolne zbocza przechodzą w wiszące lodowce, a ogromna ściana zdaje się obejmować kilka stref klimatycznych.", "南迦帕爾巴特峰以磅礴之勢凌駕印度河流域，裸露的山麓漸漸過渡為懸冰。那面巨大的山壁彷彿囊括了數種氣候。", "낭가파르바트는 인더스 지역 위로 거대한 산세를 드러냅니다. 아래쪽의 민둥한 비탈은 매달린 얼음으로 이어지고, 거대한 산벽에는 여러 기후대가 깃든 듯합니다."]],
    ["No bodies or sign of a hurried flight. The houses were dismantled; CROATOAN was carved into a post, perhaps naming their destination.", ["没有发现尸体，也看不出有人仓促逃离。房屋已被拆除；一根柱子上刻着“CROATOAN”，或许指明了他们去往何处。", "Ни тел, ни следов поспешного бегства. Дома разобрали, а на столбе вырезали слово CROATOAN — возможно, указав место, куда они ушли.", "No había cuerpos ni señales de una huida apresurada. Las casas fueron desmontadas; en un poste tallaron CROATOAN, quizá para indicar su destino.", "Não havia corpos nem sinais de fuga apressada. As casas foram desmontadas; em um poste, gravaram CROATOAN, talvez indicando o destino.", "遺体も、慌てて逃げた形跡もありません。家々は解体され、柱には行き先を示すのか「CROATOAN」と刻まれていました。", "Keine Leichen und keine Anzeichen einer überstürzten Flucht. Die Häuser wurden abgebaut; in einen Pfosten ritzte man CROATOAN, vielleicht als Hinweis auf das Ziel.", "Aucun corps ni signe de fuite précipitée. Les maisons ont été démontées ; CROATOAN était gravé sur un poteau, peut-être pour indiquer leur destination.", "Nie znaleziono ciał ani śladów pospiesznej ucieczki. Domy rozebrano; na słupie wyryto CROATOAN, być może wskazując miejsce, do którego wyruszyli.", "沒有發現屍體，也看不出有人倉促逃離。房屋已被拆除；一根柱子上刻著「CROATOAN」，或許指明了他們去往何處。", "시신도 급히 달아난 흔적도 없었습니다. 집은 해체되었고, 기둥에는 목적지를 가리키듯 CROATOAN이라는 글자가 새겨져 있었습니다."]]
  ];
  return Object.fromEntries(entries.map(([source, translations]) => [source, reviewedLocaleOverrides(source, translations)]));
}

function reviewedCatalogRange1900Overrides() {
  const entries = [
    ["Olinda has poor anchorage. Beyond the reef, fishers and merchants gather at Arrecife dos Navios. Pernambuco needs a harbor for sugar and mill equipment.", ["奥林达锚地欠佳。礁石外的阿雷西费-杜斯-纳维乌斯聚集着渔民和商人。伯南布哥需要一座能装运蔗糖和制糖设备的港口。", "У Олинды плохая якорная стоянка. За рифом, в Арресифе-дус-Навиус, собираются рыбаки и торговцы. Пернамбуку нужен порт для сахара и оборудования сахарных мельниц.", "Olinda tiene un fondeadero deficiente. Al otro lado del arrecife, pescadores y comerciantes se reúnen en Arrecife dos Navios. Pernambuco necesita un puerto para el azúcar y los equipos de los ingenios.", "Olinda tem um ancoradouro ruim. Além do recife, pescadores e comerciantes se reúnem em Arrecife dos Navios. Pernambuco precisa de um porto para açúcar e equipamentos de engenho.", "オリンダは停泊に適しません。礁の向こうにあるアレシフェ・ドス・ナヴィオスには漁師や商人が集まっています。ペルナンブーコには砂糖と製糖設備を扱う港が必要です。", "Olinda bietet keinen guten Ankerplatz. Jenseits des Riffs versammeln sich Fischer und Händler in Arrecife dos Navios. Pernambuco braucht einen Hafen für Zucker und Mühlenausrüstung.", "Olinda offre un mauvais mouillage. Au-delà du récif, pêcheurs et marchands se retrouvent à Arrecife dos Navios. Pernambuco a besoin d'un port pour le sucre et l'équipement des moulins.", "Olinda ma kiepskie kotwicowisko. Za rafą rybacy i kupcy gromadzą się w Arrecife dos Navios. Pernambuco potrzebuje portu dla cukru i wyposażenia cukrowni.", "奧林達錨地欠佳。礁石外的阿雷西費-杜斯-納維烏斯聚集著漁民和商人。伯南布哥需要一座能裝運蔗糖和製糖設備的港口。", "올린다는 정박하기 좋지 않습니다. 암초 너머 아레시페 두스 나비우스에는 어부와 상인들이 모입니다. 페르남부쿠에는 설탕과 제당 장비를 위한 항구가 필요합니다."]],
    ["Olympus is not a single peak but a crown of ravines, cliffs, and high summits often hidden in cloud. From the sea it seems to have weather of its own.", ["奥林匹斯山并非一座孤峰，而是由沟壑、峭壁和常隐于云中的高峰组成的山冠。从海上望去，它仿佛自有一方气候。", "Олимп — не одна вершина, а целая корона ущелий, обрывов и высоких пиков, часто скрытых облаками. С моря кажется, что там своя погода.", "El Olimpo no es una sola cima, sino una corona de barrancos, acantilados y altas cumbres que a menudo ocultan las nubes. Desde el mar parece tener un clima propio.", "O Olimpo não é um único pico, mas uma coroa de ravinas, penhascos e altas cimeiras muitas vezes encobertas por nuvens. Do mar, parece ter clima próprio.", "オリンポスは一つの峰ではなく、渓谷や断崖、雲に隠れがちな高峰が連なる山塊です。海から見ると、そこだけ独自の天候があるようです。", "Der Olymp ist kein einzelner Gipfel, sondern ein Kranz aus Schluchten, Klippen und hohen, oft wolkenverhangenen Gipfeln. Vom Meer aus scheint er sein eigenes Wetter zu haben.", "L'Olympe n'est pas un sommet unique, mais une couronne de ravins, de falaises et de hauts pics souvent cachés dans les nuages. Depuis la mer, il semble avoir son propre climat.", "Olimp nie jest pojedynczym szczytem, lecz koroną wąwozów, urwisk i wysokich, często skrytych w chmurach gór. Z morza zdaje się mieć własną pogodę.", "奧林匹斯山並非一座孤峰，而是由溝壑、峭壁和常隱於雲中的高峰組成的山冠。從海上望去，它彷彿自有一方氣候。", "올림포스는 하나의 봉우리가 아니라 협곡과 절벽, 구름에 자주 가려지는 높은 봉우리들이 이룬 산마루입니다. 바다에서 보면 그곳만의 날씨가 있는 듯합니다."]],
    ["Overlapping plates riveted inside cloth can turn aside blades while keeping a sailor mobile.", ["铆接在布甲内的重叠铁片能挡开刀刃，又不妨碍水手行动。", "Перекрывающиеся пластины, вшитые в ткань, отражают клинки и не стесняют движений моряка.", "Las placas superpuestas, remachadas dentro de la tela, desvían las hojas sin restar movilidad al marinero.", "As placas sobrepostas, rebitadas por dentro do tecido, desviam lâminas sem limitar os movimentos do marinheiro.", "布の内側に重ねて鋲留めした板が刃をそらし、水夫の動きやすさも保ちます。", "Überlappende, in den Stoff genietete Platten wehren Klingen ab, ohne die Beweglichkeit des Seemanns einzuschränken.", "Des plaques superposées, rivetées dans le tissu, dévient les lames sans gêner les mouvements du marin.", "Nakładające się płytki nitowane wewnątrz tkaniny chronią przed ostrzami, nie krępując ruchów marynarza.", "鉚接在布甲內的重疊鐵片能擋開刀刃，又不妨礙水手行動。", "천 안쪽에 겹쳐 리벳으로 고정한 판이 칼날을 막아 주면서도 선원의 움직임을 방해하지 않습니다."]],
    ["Ox carts wait inland from the quay; anything unloaded here will be priced in inland markets before sunset.", ["牛车在码头内陆一侧等候；在此卸下的货物，日落前便会报出内陆市价。", "В стороне от причала ждут воловьи повозки; всё выгруженное здесь оценят на внутренних рынках ещё до заката.", "Los carros de bueyes esperan tierra adentro, más allá del muelle; antes del anochecer, los mercados del interior pondrán precio a todo lo que descarguemos aquí.", "Carros de bois aguardam além do cais, em direção ao interior; antes do anoitecer, os mercados do interior darão preço a tudo que for descarregado aqui.", "埠頭の先、内陸側では牛車が待っています。ここで荷揚げした品は、日暮れまでに内陸市場で値がつくでしょう。", "Hinter dem Kai warten Ochsenkarren landeinwärts. Alles, was hier gelöscht wird, erhält noch vor Sonnenuntergang einen Preis auf den Märkten im Inland.", "Des charrettes à bœufs attendent au-delà du quai, vers l'intérieur. Toute marchandise déchargée ici sera cotée sur les marchés intérieurs avant le coucher du soleil.", "Wozy ciągnione przez woły czekają za nabrzeżem, w głębi lądu. Wszystko wyładowane tutaj zostanie wycenione na rynkach śródlądowych przed zachodem słońca.", "牛車在碼頭內陸一側等候；在此卸下的貨物，日落前便會報出內陸市價。", "부두 안쪽에는 소달구지가 기다립니다. 여기서 내린 물건은 해 지기 전에 내륙 시장에서 값이 매겨집니다."]],
    ["Partnership indenture; dividends payable at the shipyard.", ["合伙契约；股息在船厂支付。", "Договор о товариществе; дивиденды выплачиваются на верфи.", "Contrato de sociedad; dividendos pagaderos en el astillero.", "Contrato de sociedade; dividendos pagos no estaleiro.", "共同出資の契約書。配当は造船所で支払われます。", "Gesellschaftsvertrag; Dividenden zahlbar auf der Werft.", "Contrat de partenariat ; dividendes payables au chantier naval.", "Umowa spółki; dywidendy wypłacane w stoczni.", "合夥契約；股息在船廠支付。", "동업 계약서, 배당금은 조선소에서 지급됩니다."]],
    ["Patrol the waters near {0}. Sink the marked wokou vessel or force its surrender. Pirates need no letter of marque.", ["巡逻{0}附近海域。击沉标记的倭寇船，或迫使其投降。海盗无需私掠许可证。", "Патрулируйте воды у {0}. Потопите отмеченное судно вако или вынудите его сдаться. Пиратам не нужна каперская грамота.", "Patrulla las aguas cerca de {0}. Hunde el barco wokou señalado o fuérzalo a rendirse. Los piratas no necesitan patente de corso.", "Patrulhe as águas perto de {0}. Afunde o navio wokou marcado ou force sua rendição. Piratas não precisam de carta de corso.", "{0}付近の海域を巡回してください。印の付いた倭寇船を沈めるか、降伏させてください。海賊に私掠免許状は不要です。", "Patrouilliert in den Gewässern nahe {0}. Versenkt das markierte Wokou-Schiff oder erzwingt seine Kapitulation. Piraten brauchen keinen Kaperbrief.", "Patrouillez près de {0}. Coulez le navire wokou désigné ou forcez-le à se rendre. Les pirates n'ont pas besoin de lettre de marque.", "Patroluj wody w pobliżu {0}. Zatop wskazany statek wokou lub wymuś jego kapitulację. Piraci nie potrzebują listu kaperskiego.", "巡邏{0}附近海域。擊沉標記的倭寇船，或迫使其投降。海盜無需私掠許可證。", "{0} 근해를 순찰하세요. 표시된 왜구선을 침몰시키거나 항복시키세요. 해적에게는 사략 허가장이 필요 없습니다."]]
  ];
  return Object.fromEntries(entries.map(([source, translations]) => [source, reviewedLocaleOverrides(source, translations)]));
}

function reviewedCatalogRange1950Overrides() {
  const entries = [
    ["Pitch-wrapped arrowheads threaten rigging and planking, though they fly shorter and slower.", ["箭头缠上浸油的布后能威胁索具和船板，但射程更短、速度更慢。", "Обмотанные паклей со смолой наконечники поджигают такелаж и обшивку, но летят медленнее и недалеко.", "Las puntas de flecha envueltas en brea amenazan el aparejo y las tablas, aunque vuelan menos y más despacio.", "As pontas de flecha envoltas em piche ameaçam o cordame e o madeirame, mas voam menos e mais devagar.", "ピッチを巻いた矢尻は帆装や船板を脅かしますが、射程は短く速度も落ちます。", "Mit Pech umwickelte Pfeilspitzen bedrohen Takelage und Planken, fliegen jedoch kürzer und langsamer.", "Les pointes de flèches enduites de poix menacent le gréement et le bordage, mais portent moins loin et volent plus lentement.", "Groty strzał owinięte smołą zagrażają takielunkowi i poszyciu, lecz lecą krócej i wolniej.", "箭頭纏上瀝青後能威脅索具和船板，但射程更短、速度更慢。", "송진을 감은 화살촉은 삭구와 선체 판재를 위협하지만, 사거리가 짧고 속도도 느립니다."]],
    ["Penn's Holy Experiment promises Quaker refuge and a green, spacious city along the Delaware. His charter still needs Lenape agreement.", ["佩恩的“神圣实验”承诺为贵格会教徒提供庇护，并在特拉华河畔建设绿地宽敞的城市。他的特许状仍需得到勒纳佩人的同意。", "«Священный эксперимент» Пенна обещает квакерам убежище и просторный зелёный город у Делавэра. Для его хартии ещё нужно согласие ленапе.", "El Santo Experimento de Penn promete refugio para los cuáqueros y una ciudad espaciosa y verde junto al Delaware. Su carta aún requiere el acuerdo de los lenape.", "O Santo Experimento de Penn promete refúgio aos quacres e uma cidade ampla e arborizada junto ao Delaware. Sua carta ainda depende do acordo dos lenapes.", "ペンの「聖なる実験」は、クエーカー教徒の避難所とデラウェア沿いの緑豊かで広々とした街を約束します。特許状にはレナペ族の同意がまだ必要です。", "Penns „Heiliges Experiment“ verspricht den Quäkern Zuflucht und eine grüne, weitläufige Stadt am Delaware. Seine Urkunde braucht noch die Zustimmung der Lenape.", "La « Sainte Expérience » de Penn promet un refuge aux quakers et une ville verdoyante et spacieuse le long du Delaware. Sa charte doit encore obtenir l'accord des Lenapes.", "„Święty Eksperyment” Penna obiecuje kwakrom schronienie oraz przestronne, zielone miasto nad Delaware. Karta kolonii wymaga jeszcze zgody Lenapów.", "潘恩的「神聖實驗」承諾為貴格會教徒提供庇護，並在特拉華河畔建設綠地寬敞的城市。他的特許狀仍需得到勒納佩人的同意。", "펜의 ‘성스러운 실험’은 퀘이커교도에게 피난처를 제공하고 델라웨어강을 따라 넓고 푸른 도시를 세우겠다는 약속입니다. 식민지 헌장에는 레나페족의 동의가 필요합니다."]],
    ["Philadelphia has become Penn's planned Quaker capital in Pennsylvania and a major Delaware River port. Its early peace depended on tolerance and negotiated relations with the Lenape.", ["费城已成为宾夕法尼亚州规划中的贵格会首府，也是特拉华河上的重要港口。早期和平有赖于宽容政策及与勒纳佩人的协商关系。", "Филадельфия стала задуманной Пенном столицей квакеров в Пенсильвании и важным портом на реке Делавэр. Первоначальный мир держался на веротерпимости и договорённостях с ленапе.", "Filadelfia se convirtió en la capital cuáquera que Penn planeó en Pensilvania y en un importante puerto del río Delaware. La paz inicial dependió de la tolerancia y de los acuerdos con los lenape.", "A Filadélfia tornou-se a capital quacre planejada por Penn na Pensilvânia e um importante porto no rio Delaware. A paz inicial dependeu da tolerância e de acordos com os lenapes.", "フィラデルフィアはペンが計画したペンシルベニアのクエーカー教徒の首都となり、デラウェア川の主要港にもなりました。当初の平和は寛容とレナペ族との交渉に支えられていました。", "Philadelphia wurde zu Penns geplanter Quäker-Hauptstadt in Pennsylvania und zu einem wichtigen Hafen am Delaware. Der frühe Frieden beruhte auf Toleranz und ausgehandelten Beziehungen zu den Lenape.", "Philadelphie est devenue la capitale quaker de Penn en Pennsylvanie et un important port sur le Delaware. La paix des débuts reposait sur la tolérance et les accords négociés avec les Lenapes.", "Filadelfia stała się planowaną przez Penna stolicą kwakrów w Pensylwanii i ważnym portem nad Delaware. Początkowy pokój opierał się na tolerancji i porozumieniach z Lenapami.", "費城已成為賓夕法尼亞州規劃中的貴格會首府，也是特拉華河上的重要港口。早期和平有賴於寬容政策及與勒納佩人的協商關係。", "필라델피아는 펜이 계획한 펜실베이니아의 퀘이커 수도이자 델라웨어강의 주요 항구가 되었습니다. 초기의 평화는 관용과 레나페족과의 협상에 달려 있었습니다."]],
    ["Pizarro chose the cultivated Rimac valley, ruled by curaca Taulichusco, for his City of Kings. The city must be seized and established on inhabited ground.", ["皮萨罗选择由库拉卡陶利库斯科统治的里马克河谷，这里已有耕作与居民，后来成为他的“王者之城”。必须先夺取此城，再在有人居住的土地上建立西班牙据点。", "Писарро выбрал возделанную долину Римака, которой правил курака Тауличуско, для своего Города королей. Город предстоит захватить и основать на уже обжитой земле.", "Pizarro eligió para su Ciudad de los Reyes el fértil valle del Rímac, gobernado por el curaca Taulichusco. La ciudad debe conquistarse y establecerse en tierras ya habitadas.", "Pizarro escolheu para sua Cidade dos Reis o vale cultivado do Rímac, governado pelo curaca Taulichusco. A cidade deve ser tomada e fundada em terras já habitadas.", "ピサロは、クラカのタウリチュスコが治める耕作地リマック渓谷を「王たちの都」の地に選びました。その町を奪い、すでに人々が暮らす土地に築く必要があります。", "Pizarro wählte für seine Stadt der Könige das bewirtschaftete Rímac-Tal unter der Herrschaft des Kuraka Taulichusco. Die Stadt muss eingenommen und auf bereits bewohntem Land gegründet werden.", "Pizarro choisit la vallée cultivée du Rímac, gouvernée par le curaca Taulichusco, pour sa Cité des Rois. Il faut conquérir la ville et l'établir sur des terres déjà habitées.", "Pizarro wybrał uprawną dolinę Rímac, rządzoną przez kurakę Taulichusco, na swoją Ciudad de los Reyes. Trzeba zdobyć miasto i założyć je na ziemi już zamieszkanej.", "皮薩羅選擇由庫拉卡陶利庫斯科統治的里馬克河谷，這裡已有耕作與居民，後來成為他的「王者之城」。必須先奪取此城，再在有人居住的土地上建立西班牙據點。", "피사로는 쿠라카 타울리추스코가 다스리는 경작지 리막 계곡을 왕들의 도시를 세울 곳으로 골랐습니다. 이미 사람이 사는 땅을 빼앗아 도시를 세우려 합니다."]],
    ["Portuguese trading agents keep a small post here, linking Patani to their routes through Malacca and Siam.", ["葡萄牙商行代理人在此经营一处小型商站，将北大年接入经马六甲和暹罗的航线。", "Португальские торговые факторы держат здесь небольшой торговый пост, связывая Патани с маршрутами через Малакку и Сиам.", "Los agentes comerciales portugueses mantienen aquí un pequeño puesto que conecta Patani con sus rutas por Malaca y Siam.", "Agentes comerciais portugueses mantêm aqui um pequeno posto, ligando Patani às rotas por Malaca e Sião.", "ポルトガルの商館員がここに小さな商館を置き、パタニをマラッカやシャムを経由する航路につないでいます。", "Portugiesische Handelsfaktoren unterhalten hier einen kleinen Stützpunkt, der Patani mit ihren Routen über Malakka und Siam verbindet.", "Des facteurs portugais tiennent ici un petit comptoir, reliant Patani à leurs routes par Malacca et le Siam.", "Portugalscy faktorzy prowadzą tu niewielki punkt handlowy, łącząc Patani ze szlakami przez Malakkę i Syjam.", "葡萄牙商行代理人在此經營一處小型商站，將北大年接入經馬六甲和暹羅的航線。", "포르투갈 무역상들이 이곳에 작은 교역소를 두어 파타니를 말라카와 시암을 지나는 항로에 연결합니다."]]
  ];
  return Object.fromEntries(entries.map(([source, translations]) => [source, reviewedLocaleOverrides(source, translations)]));
}

function reviewedCatalogRange2000Overrides() {
  const entries = [
    ["Prince-Archbishopric of Magdeburg", ["马格德堡大主教侯国", "Магдебургское архиепископство-княжество", "Principado-arzobispado de Magdeburgo", "Principado-arcebispado de Magdeburgo", "マクデブルク大司教侯領", "Fürsterzbistum Magdeburg", "Principauté archiépiscopale de Magdebourg", "Księstwo arcybiskupie Magdeburga", "馬格德堡大主教侯國", "마그데부르크 대주교후령"]],
    ["Prince-Bishopric of Liege", ["列日主教侯国", "Княжество-епископство Льеж", "Principado-obispado de Lieja", "Principado-bispado de Liège", "リエージュ司教侯領", "Fürstbistum Lüttich", "Principauté épiscopale de Liège", "Księstwo biskupie Liège", "列日主教侯國", "리에주 주교후령"]],
    ["Doubloons in the cove: {0} db.", ["海湾中的达布隆：{0} DB。", "Дублоны в бухте: {0} DB.", "Doblonas en la cala: {0} DB.", "Dobras na enseada: {0} DB.", "入り江のダブロン：{0} DB", "Dublonen in der Bucht: {0} DB.", "Doblons dans la crique : {0} DB.", "Dublony w zatoce: {0} DB.", "灣中的達布隆：{0} DB。", "후미의 더블룬: {0} DB."]],
    ["Powerful yew bows shoot farther across water but require skilled archers.", ["强劲的紫杉木弓射程更远，但需要熟练的弓手。", "Мощные тисовые луки стреляют дальше по воде, но требуют умелых лучников.", "Los potentes arcos de tejo alcanzan más lejos sobre el agua, pero requieren arqueros diestros.", "Os potentes arcos de teixo alcançam mais longe sobre a água, mas exigem arqueiros habilidosos.", "強力なイチイの弓は水上でも遠くまで届きますが、熟練の射手が必要です。", "Starke Eibenbögen reichen weiter über das Wasser, erfordern aber geübte Bogenschützen.", "Les puissants arcs en if portent plus loin au-dessus de l'eau, mais exigent des archers chevronnés.", "Potężne łuki cisowe strzelają dalej nad wodą, ale wymagają wprawnych łuczników.", "強勁的紫杉木弓射程更遠，但需要熟練的弓手。", "강력한 주목나무 활은 물 너머까지 더 멀리 쏠 수 있지만, 능숙한 궁수가 필요합니다."]],
    ["Quebec now secures New France at the narrow passage of the St. Lawrence, sustained by shipping, fur trade, and alliances with the Innu, Algonquin, and Wendat.", ["魁北克如今守住圣劳伦斯河的狭窄航道，成为新法兰西的支柱；航运、毛皮贸易以及与因努人、阿尔冈昆人和温达特人的联盟支撑着这里。", "Квебек теперь укрепляет Новую Францию у узкого прохода на реке Святого Лаврентия. Его поддерживают судоходство, торговля мехом и союзы с инну, алгонкинами и вендатами.", "Quebec afianza ahora Nueva Francia en el estrecho paso del San Lorenzo, sostenida por la navegación, el comercio de pieles y las alianzas con innu, algonquinos y wendat.", "Quebec consolida a Nova França na estreita passagem do São Lourenço, sustentada pela navegação, pelo comércio de peles e por alianças com os Innu, Algonquin e Wendat.", "ケベックはセントローレンス川の狭い水路を押さえ、新仏蘭西を支える拠点となりました。海運、毛皮交易、イヌー、アルゴンキン、ウェンダット各族との同盟がその力です。", "Quebec sichert Neufrankreich nun an der engen Passage des Sankt-Lorenz-Stroms. Schifffahrt, Pelzhandel und Bündnisse mit Innu, Algonkin und Wendat tragen den Ort.", "Québec assure désormais la présence de la Nouvelle-France dans le passage étroit du Saint-Laurent, grâce au commerce maritime et des fourrures ainsi qu'aux alliances avec les Innus, les Algonquins et les Wendats.", "Quebec umacnia Nową Francję przy wąskim przejściu na Rzece Świętego Wawrzyńca. Osadę wspierają żegluga, handel futrami oraz sojusze z Innu, Algonkinami i Wendatami.", "魁北克如今守住聖羅倫斯河的狹窄航道，成為新法蘭西的支柱；航運、毛皮貿易以及與因努人、阿爾岡昆人和溫達特人的聯盟支撐著這裡。", "퀘벡은 세인트로렌스강의 좁은 물길을 지켜 뉴프랑스를 뒷받침합니다. 해운과 모피 무역, 이누·알곤킨·웬다트족과의 동맹이 이곳을 지탱합니다."]],
    ["Plymouth has endured at Patuxet through Wampanoag aid and an uneasy alliance; English provisions alone would not have saved it.", ["普利茅斯在帕塔克塞特得以存续，仰赖万帕诺亚格人的援助和一段并不稳固的联盟；仅凭英国补给绝无可能救下殖民地。", "Плимут у Патуксета выстоял благодаря помощи вампаноагов и непрочному союзу; одних английских припасов было бы недостаточно.", "Plymouth sobrevivió en Patuxet gracias a la ayuda wampanoag y a una alianza frágil; las provisiones inglesas por sí solas no la habrían salvado.", "Plymouth resistiu em Patuxet graças à ajuda dos Wampanoag e a uma aliança instável; os mantimentos ingleses, sozinhos, não o teriam salvado.", "プリマスはパタクセットで、ワンパノアグ族の支援と不安定な同盟のおかげで持ちこたえました。イングランドからの補給だけでは救えなかったでしょう。", "Plymouth überstand die Zeit in Patuxet dank der Hilfe der Wampanoag und eines brüchigen Bündnisses; englische Vorräte allein hätten die Siedlung nicht gerettet.", "Plymouth a survécu à Patuxet grâce à l'aide des Wampanoags et à une alliance précaire ; les provisions anglaises n'auraient pas suffi.", "Plymouth przetrwało w Patuxet dzięki pomocy Wampanoagów i kruchemu sojuszowi; same angielskie zapasy nie wystarczyłyby, by je ocalić.", "普利茅斯在帕塔克塞特得以存續，仰賴萬帕諾亞格人的援助和一段並不穩固的聯盟；僅憑英國補給絕無可能救下殖民地。", "플리머스는 왐파노아그족의 도움과 위태로운 동맹 덕분에 파투셋에서 버텼습니다. 영국의 보급품만으로는 지켜 낼 수 없었을 것입니다."]],
    ["Ragusa pays every great power for peace. Your family merely added another instalment.", ["拉古萨向各大强权付钱求和。你的家族不过是又添了一笔分期债款。", "Рагуза платит каждой великой державе за мир. Ваша семья лишь добавила ещё один взнос.", "Ragusa paga a cada gran potencia para conservar la paz. Tu familia solo añadió otra cuota.", "Ragusa paga a cada grande potência para manter a paz. Sua família apenas acrescentou mais uma parcela.", "ラグーザは大国それぞれに金を払って平和を保っています。あなたの家族は分割払いを一件増やしただけです。", "Ragusa erkauft sich von jeder Großmacht den Frieden. Eure Familie fügte lediglich eine weitere Rate hinzu.", "Raguse paie chaque grande puissance pour préserver la paix. Votre famille n'a fait qu'ajouter une échéance.", "Dubrownik płaci każdemu mocarstwu za pokój. Twoja rodzina dodała tylko kolejną ratę.", "拉古薩向各大強權付錢求和。你的家族不過是又添了一筆分期債款。", "라구사는 모든 강대국에 돈을 주고 평화를 삽니다. 당신 가문은 할부금을 하나 더 보탰을 뿐입니다."]],
...
function reviewedSupplyAndBriefOverrides() {
  const entries = [
    ...
    ["{0} A timely resupply earns {1} doubloons and gives {2} the stores it needs to become a permanent city.", [
      "{0}及时补给可赚取{1}达布隆，并为{2}提供建成永久城市所需的物资。", "{0}Своевременное пополнение запасов принесёт {1} дублонов и даст {2} необходимые припасы, чтобы стать постоянным городом.",
...
function reviewedCrewOverrides() {
  const entries = [
    ...
    ["Crew still to dismiss for this loadout: {0}.", [
      "此配置还需遣散船员数：{0}。", "Для этой комплектации ещё нужно уволить членов экипажа: {0}.",
      "Tripulantes que aún debes despedir para esta configuración: {0}.", "Tripulantes ainda a dispensar para esta configuração: {0}.",
      "この編成で解雇する乗組員：残り{0}人。", "Für diese Besatzungsstärke noch zu entlassende Crewmitglieder: {0}.",
      "Membres d’équipage encore à congédier pour cette configuration : {0}.", "Członkowie załogi do zwolnienia dla tego wyposażenia: {0}.",
      "此配置還需遣散船員數：{0}。", "이 편성에서 추가로 해고할 선원: {0}명."
    ]],
