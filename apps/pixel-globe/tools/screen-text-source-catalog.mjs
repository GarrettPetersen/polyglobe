...
const EXCLUDED_FILES = new Set([
  ...
  // Capture/screenshot scenario labels are developer tooling, not player text.
  "captureScenarios.js",
...
const NON_DISPLAY_SOURCE_TEMPLATES = new Set([
  ...
  "character portrait manifest", "itemId", "LocalSaveWriteError", "UnrecoverableGameDataError", "playerPayouts", "salesPitch",
