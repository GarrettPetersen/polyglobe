...
export const PERK_ITEMS = Object.freeze([
  ...
  item("spare-sweeps", "Spare Sweeps", "Extra oars, kept ready when the first set splits.", 780, 1,
    "item:spare-sweeps", { staminaSecondsFlat: 24 }, ["global"],
    { grammaticalNumber: GRAMMATICAL_NUMBER_PLURAL }),
  item("kedge-and-warp", "Kedge and Warp", "A light anchor and a long line for hauling the ship off a lee shore.", 920, 1,
    "item:kedge-and-warp", { staminaSecondsFlat: 18 }, ["global"]),
  ...
  item("katana", "Katana", "A Japanese sword with a keen edge, well suited to a marine officer.", 1250, 2,
  ...
  item("bronze-fish-hooks", "Bronze Fish Hooks", "A set of sturdy hooks improves both line fishing and net work.", 650, 1,
    "item:bronze-fish-hooks", { fishingChanceMultiplier: 1.08, fishingHaulMultiplier: 1.1 }, ["global"],
    { grammaticalNumber: GRAMMATICAL_NUMBER_PLURAL }),
  item(
    HAJJ_PILGRIMAGE_PERK_ITEM_ID,
    "Zamzam Flask",
    "A pilgrim's flask filled at the Zamzam well, with a fitted cup for rationing water from the ship's casks.",
    1600,
    2,
    "item:zamzam-flask",
