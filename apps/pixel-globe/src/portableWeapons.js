...
export const PORTABLE_WEAPON_ITEMS = Object.freeze([
  ...
  portableItem({
    ...
    grammaticalNumber: GRAMMATICAL_NUMBER_PLURAL,
    detail: "Powerful yew bows shoot farther across water but require skilled archers.",
    price: 950,
    tier: 2,
  ...
  portableItem({
    ...
    grammaticalNumber: GRAMMATICAL_NUMBER_PLURAL,
    detail: "Pitch-wrapped arrowheads threaten rigging and planking, though they fly shorter and slower.",
    price: 1400,
    tier: 2,
