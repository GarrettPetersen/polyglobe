...
export const WORLD_TILE_ART_SIZE_PX = 36;
export const WORLD_CHART_VIEW_MARGIN_PX = 58;
export const WORLD_CHART_REBUILD_RADIUS_PX = 40;
export const WORLD_CHART_LOOKAHEAD_MARGIN_PX = 96;
export const WORLD_CHART_MARGIN_PX = WORLD_CHART_VIEW_MARGIN_PX +
  WORLD_CHART_REBUILD_RADIUS_PX + WORLD_TILE_ART_SIZE_PX +
  WORLD_CHART_LOOKAHEAD_MARGIN_PX;
