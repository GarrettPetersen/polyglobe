...
export const GAME_ICON_ASSET_VERSION = "resurrect-icons-54";
...
export const GAME_ICON_SOURCES = Object.freeze({
  ...
  "item:spare-sweeps": nikoichu("Tools_Crafting_Fishing_Harpoon_Spear.png", ICON_COLOR.timber),
  "item:kedge-and-warp": projectAsset("public/assets/ui/anchor.png", null, {
    lightMonotone: ICON_COLOR.timber
  }),
...
const DIALOGUE_ACTION_ICON_IDS = Object.freeze({
  ...
  "cancel-crew-dismissal": "action:back",
  "undo-crew-dismissals": "action:back",
  ...
  "prepare-prize-crew-dismissal": "action:passenger",
  "toggle-prize-crew-dismissal": "action:leave",
  "undo-prize-crew-dismissals": "action:back",
  "confirm-prize-crew-dismissals": "action:surrender",
  ...
  "petition-capture-commission": "action:letter",
  ...
  "enforce-trade-restriction": "action:letter",
  "begin-player-trade-enforcement": "action:letter",
  "pay-trade-embargo-fine": "action:buy",
  "surrender-trade-embargo-cargo": "action:surrender",
  ...
  "refuse-sound-dues": "action:leave",
  ...
  "select-shipyard-upgrade": "action:inventory",
  "buy-shipyard-upgrade": "action:buy",
  ...
  "deliver-exeter-canal": "action:quest",
  "serve-chef-feast": "action:quest",
  "finish-chef-feast": "action:quest",
  ...
  "inspect-colony-clue": "good:timber",
  "leave-colony-site": "action:leave",
  ...
  "confirm-market-undo": "action:back",
  "cancel-market-undo": "action:back",
  buy: "action:buy",
