...
export const ANIMAL_COMPANION_CATALOG = Object.freeze([
  companion({
    ...
    naturalistOffer: "A decisive rebuttal! Leave the panda in my care and I shall pay you {payment} doubloons. Think of what we can learn!",
  ...
  companion({
    ...
    naturalistOffer: "A remarkably nimble creature. Leave the raccoon in my care and I shall pay you {payment} doubloons. I shall begin by purchasing stronger locks.",
