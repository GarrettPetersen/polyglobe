import { PORT_ASSAULT_REAR_FEET_Y } from "../src/portAssaultGround.js";
...
export const CITY_PORT_ASSAULT_LANE_FEET_Y = Object.freeze(
  Array.from({ length: PORT_ASSAULT_LANE_COUNT }, (_, lane) =>
    PORT_ASSAULT_REAR_FEET_Y + lane * PORT_ASSAULT_LANE_SPACING * CITY_ASSAULT_TRACK_SPAN_PX * CITY_ASSAULT_GROUND_DEPTH_SCALE)
);
