...
const BUILD_DAYS_PER_HEX = 2;
const BUILD_DURATION_MS = BUILD_DAYS_PER_HEX * 24 * SIM_HOUR_MS;
// Future: support multiple construction crews per player to run builds in parallel.
